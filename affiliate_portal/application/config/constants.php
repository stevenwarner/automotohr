...
define('FROM_EMAIL_NOTIFICATIONS', 'notifications@automotohr.com');
...
// custom definitions
define('TALENT_NETWORK_SALE_CONTACTNO_TITLE', 'Sales Support'); // Talent network sales title heading
...
define('TALENT_NETWORK_SUPPORT_CONTACTNO_TITLE', 'Technical Support'); // Talent network support title heading

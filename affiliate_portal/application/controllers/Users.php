    ...
    public function Login() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($result['status'] == 'active') {
                ...
                if ($remember == 'on') {
                    setcookie("affiliate_admin[username]", $this->encryptCookie($username), time() + 3600);
                    setcookie("affiliate_admin[password]", $this->encryptCookie($password), time() + 3600);
                }

        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_e_signature" enctype="multipart/form-data" method="post" action="<?= base_url() ?>onboarding/ajax_e_signature">
                    ...
                    <input type="hidden" name="affiliate_sid" value="<?php echo $affiliate_detail['sid']; ?>" />
                    ...
                    <input type="hidden" name="full_name" value="<?php echo $affiliate_detail['full_name']; ?>" />
                    <input type="hidden" name="email_address" value="<?php echo $affiliate_detail['email']; ?>" />
                                    ...
                                    <tbody>
                                        <tr class="d-flex" bgcolor="#FFF">
                                            <tr class="d-flex">
                                                ...
                                                <td class="col-8"><?php echo ucwords($affiliate_detail['full_name']); ?></td>
                                            </tr>
                                            <tr class="d-flex">
                                                <th class="col-4">Email</th>
                                                <td class="col-8"><?php echo $affiliate_detail['email']; ?></td>
                                            </tr>   
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-sm">
                                    <thead class="thead-dark">
                                        <tr class="d-flex">
                                            <th class="col-12"><strong>Please select signature type</strong></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr class="d-flex" bgcolor="#FFF">
                                            <td class="col-sm-12">
                                                <div class="form-group autoheight">
                                                    <label class="control control--radio" style="margin-left: 16px;">
                                                        Type Signature
                                                    ...
                                                    <label class="control control--radio" style="margin-left: 36px;">
                                                        Draw Signature
                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                            <div class="table-responsive">
                                <table class="table table-bordered table-sm">
                                    <thead class="thead-dark">
                                        <tr class="d-flex">
                                            <th class="col-lg-12 col-md-12 col-xs-12 col-sm-12"><strong>Please select any font to type your Signature</strong></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr class="d-flex" bgcolor="#FFF">
                                            <td class="col-sm-3">
                                                <div class="form-group autoheight">
                                                    <label class="control control--radio e_signature_font_family_5">
                                                        John Doe
                                                        <input id="default_style" type="radio" class="active_font_family" name="select_font_family" value="5" checked="checked">
                                                        <div class="control__indicator"></div>
                                                    </label>
                                                </div>
                                            </td>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <button onclick="common_func_save_e_signature();" type="button" class="btn modal-button break-word-text" ><?php echo DEFAULT_SIGNATURE_CONSENT_BUTTON; ?></button>
                        </div>
                    </div>

                </form>
            </div>
            <div class="modal-footer footer-header-color">
                <button type="button" class="btn btn-default modal-footer-button" data-dismiss="modal">Cancel</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function save_e_signature () {
        setTimeout(function(){
            ...
            var myurl = "<?= base_url() ?>documents/save_e_signature";
    ...
    //  e_signature.
    function get_e_signature () {
        var company = 0;
        var user_sid = '<?php echo $affiliate_detail['sid']; ?>';
        var user_type = 'affiliate';
        var myurl = "<?= base_url() ?>documents/get_signature/"+user_sid+"/"+company+"/"+user_type;
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data == false){
                    ...
                    $('#init_tergit').removeClass();
                    $('#init_tergit').addClass('e_signature_type_fixed_p e_signature_font_family_5');
                    $('#default_style').prop("checked", true);

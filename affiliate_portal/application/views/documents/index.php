...
<!--                                        --><?php //echo  date_format (new DateTime($w9_form['sent_date']), 'M d Y h:i a'); ?>
                                    ...
                                    <td class="col-sm-3 text-center">
                                        <a class="btn btn-primary" href="<?php echo base_url('documents/view_w9'); ?>" title="View Document"><i class="fa fa-eye"></i></a>
                                        <a class="btn btn-primary" target="_blank" href="<?php echo base_url('documents/print_download_w9_form/'.($w9_form['sid']).'/print'); ?>" title="Print Document"><i class="fa fa-print"></i></a>
                                        <a class="btn btn-primary" target="_blank" href="<?php echo base_url('documents/print_download_w9_form/'.($w9_form['sid']).'/download'); ?>" title="Download Document"><i class="fa fa-download"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                                <!-- All documents -->
                                ...
                                <tr class="d-flex" bgcolor="#FFF" data-id="<?=$document['sid'];?>">
                                    ...
                                    <td class="col-sm-3 text-center">
                                    <?php if ($document['status'] == 'uploaded') {?>
                                            <a class="btn btn-primary jsReUpload" href="javascript:void(0)" title="Sign Document">Sign</a>
                                        <?php } elseif ($document['status'] == 'sent') { ?>
                                            <a class="btn btn-primary jsReUpload" href="javascript:void(0)" title="Sign Document">Sign</a>
                                        <?php } ?>
                                        <a class="btn btn-primary jsViewDocument" href="javascript:void(0)" title="View Document"><i class="fa fa-eye"></i></a>
                                        <a class="btn btn-primary" target="_blank" href="<?=AWS_S3_BUCKET_URL;?><?=!empty($document['client_aws_filename']) ? $document['client_aws_filename'] : $document['aws_document_name'];?>" title="Print Document"><i class="fa fa-print"></i></a>
                                        <a class="btn btn-primary"  href="<?=base_url('documents/download');?>/<?=!empty($document['client_aws_filename']) ? $document['client_aws_filename'] : $document['aws_document_name'];?>" title="Download Document"><i class="fa fa-download"></i></a>
                                    </td>
                                </tr>
                                <?php
                                        endforeach;
...
<script>
    $(function(){
        ...
        $('.jsViewDocument').click(function(e){
            ...
            $('#jsViewModal').find('.modal-footer').prepend('<a href="<?=base_url('documents/download');?>/'+( sd.client_aws_filename != '' && sd.client_aws_filename != null ? sd.client_aws_filename : sd.aws_document_name )+'" class="btn btn-primary jsDownloadBTN">Download</a>');
            $('#jsViewModal').find('.modal-footer').prepend('<a href="<?=AWS_S3_BUCKET_URL;?>'+( sd.client_aws_filename != '' && sd.client_aws_filename != null ? sd.client_aws_filename : sd.aws_document_name )+'" target="_blank" class="btn btn-primary jsDownloadBTN">Print</a>');

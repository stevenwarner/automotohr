...
<div class="content-wrapper <?php echo $this->uri->segment(2) == 'form_w9' ? 'ml-0' : ''; ?>">
    <div class="content-inner page-dashboard">
        <?php if ($this->uri->segment(2) != 'form_w9') { ?>
            <div class="row">
                <div class="col-xl-12">
                    <div class="page-header full-width">
                        <h1 class="float-left"><?= $title; ?></h1>
                        <div class="btn-panel float-right">
                            <a href="<?= base_url('documents') ?>" class="btn btn-primary btn-sm"><i class="fa fa-long-arrow-left"></i> Back</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                    <div class="btn-panel float-right">
                        <a target="_blank" href="<?php  echo base_url('documents/print_download_w9_form').'/'.$pre_form['sid'].'/print'; ?>" class="btn btn-success float-right">Print</a>
                        <a target="_blank" href="<?php  echo base_url('documents/print_download_w9_form').'/'.$pre_form['sid'].'/download'; ?>" class="btn btn-success" style="margin-right: 10px;">download</a>
                    </div>
                </div>
            </div>
        <?php } ?>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo isset($pre_form) && !empty($pre_form) ? $pre_form['w9_name']: ''?>" name="w9_name" class="form-control" />
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group">
                                    <label>2. Business name/disregarded entity name, if different from above. <span class="staric">*</span> </label>
                                    <input type="text" value="<?php echo isset($pre_form) && !empty($pre_form) ? $pre_form['w9_business_name']: ''?>" name="w9_business_name" class="form-control" />
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                                <div class="form-group autoheight">
                                    <label class="control control--checkbox">
                                        ...
                                        <input id="selectall" name="w9_federaltax_classification" <?php echo isset($pre_form) && !empty($pre_form) && $pre_form['w9_federaltax_classification'] == 'individual' ? 'checked': ''?> type="checkbox" value="individual">
                            ...
                            <div class="col-lg-3 col-md-3 col-xs-12 col-sm-4">
                                <div class="form-group autoheight">
                                    <label class="control control--checkbox">
                                        C Corporation
                                        <input id="selectall" name="w9_federaltax_classification" <?php echo isset($pre_form) && !empty($pre_form) && $pre_form['w9_federaltax_classification'] == 'c_corporation' ? 'checked': ''?> type="checkbox" value="c_corporation">
                                        <div class="control__indicator"></div>
                                    </label>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-xs-12 col-sm-4">
                                <div class="form-group autoheight">
                                    <label class="control control--checkbox">
                                        S Corporation
                                        <input id="selectall" name="w9_federaltax_classification" <?php echo isset($pre_form) && !empty($pre_form) && $pre_form['w9_federaltax_classification'] == 's_corporation' ? 'checked': ''?> type="checkbox" value="s_corporation">
                                        <div class="control__indicator"></div>
                                    </label>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                <div class="form-group autoheight">
                                    <label class="control control--checkbox">
                                        Partnership
                                        <input id="selectall" name="w9_federaltax_classification" <?php echo isset($pre_form) && !empty($pre_form) && $pre_form['w9_federaltax_classification'] == 'partnership' ? 'checked': ''?> type="checkbox" value="partnership">
                                        <div class="control__indicator"></div>
                                    </label>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                <div class="form-group autoheight">
                                    <label class="control control--checkbox">
                                        Trust/Estate
                                        <input id="selectall" name="w9_federaltax_classification" <?php echo isset($pre_form) && !empty($pre_form) && $pre_form['w9_federaltax_classification'] == 'trust_estate' ? 'checked': ''?> type="checkbox" value="trust_estate">
                                        <div class="control__indicator"></div>
                                    </label>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group autoheight">
                                    <label class="control control--checkbox">
                                        ...
                                        <input id="selectall" name="w9_federaltax_classification" <?php echo isset($pre_form) && !empty($pre_form) && $pre_form['w9_federaltax_classification'] == 'llc' ? 'checked': ''?> type="checkbox" value="llc">
                                        <div class="control__indicator"></div>
                                    </label>
                                </div>
                                <div class="form-group autoheight">
                                    <input type="text" id="llc_desc" value="<?php echo isset($pre_form) && !empty($pre_form) && $pre_form['w9_federaltax_classification'] == 'llc' ? $pre_form['w9_federaltax_description']: ''?>" name="w9_llc_federaltax_description" class="form-control" />
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group autoheight">
                                    <label class="control control--checkbox">
                                        ...
                                        <input id="selectall" name="w9_federaltax_classification" <?php echo isset($pre_form) && !empty($pre_form) && $pre_form['w9_federaltax_classification'] == 'other' ? 'checked': ''?> type="checkbox" value="other">
                                        <div class="control__indicator"></div>
                                    </label>
                                </div>
                                <div class="form-group autoheight">
                                    <input type="text" name="w9_other_federaltax_description" value="<?php echo isset($pre_form) && !empty($pre_form) && $pre_form['w9_federaltax_classification'] == 'other' ? $pre_form['w9_federaltax_description']: ''?>" class="form-control" id="other_desc"/>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group autoheight">
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                <div class="form-group autoheight">
                                    ...
                                    <input type="text" name="w9_exemption_payee_code" value="<?php echo isset($pre_form) && !empty($pre_form) ? $pre_form['w9_exemption_payee_code']: ''?>" class="form-control" />
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                <div class="form-group autoheight">
                                    <label>Exemption from FATCA reporting code (if any)</label>
                                    <input type="text" name="w9_exemption_reporting_code" class="form-control" value="<?php echo isset($pre_form) && !empty($pre_form) ? $pre_form['w9_exemption_reporting_code']: ''?>"/>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group autoheight">
                                    <label>5. Address (number, street, and apt. or suite no.) See instructions.</label>
                                    <input type="text" name="w9_address" class="form-control" value="<?php echo isset($pre_form) && !empty($pre_form) ? $pre_form['w9_address']: ''?>"/>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group autoheight">
                                    <label>6. City, state, and ZIP code</label>
                                    <input type="text" name="w9_city_state_zip" class="form-control" value="<?php echo isset($pre_form) && !empty($pre_form) ? $pre_form['w9_city_state_zip']: ''?>"/>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group autoheight">
                                    <label>Requester’s name and address (optional)</label>
                                    <textarea class="form-control textarea" name="w9_requester_name_address"><?php echo isset($pre_form) && !empty($pre_form) ? $pre_form['w9_requester_name_address']: ''?></textarea>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group autoheight">
                                    <label>7. List account number(s) here (optional)</label>
                                    <input type="text" name="w9_account_no" class="form-control" value="<?php echo isset($pre_form) && !empty($pre_form) ? $pre_form['w9_account_no']: ''?>"/>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="hr-box">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5 col-md-5 col-xs-12 col-sm-5">
                                                <div class="form-group autoheight">
                                                    ...
                                                    <input type="text" name="w9_social_security_number" value="<?php echo isset($pre_form) && !empty($pre_form) ? $pre_form['w9_social_security_number']: ''?>" class="form-control" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-5 col-md-5 col-xs-12 col-sm-5">
                                                <div class="form-group autoheight">
                                                    ...
                                                    <input type="text" name="w9_employer_identification_number" value="<?php echo isset($pre_form) && !empty($pre_form) ? $pre_form['w9_employer_identification_number']: ''?>" class="form-control" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="hr-box">
                                    ...
                                    <div class="hr-innerpadding">
                                        ...
                                        <ol class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                ...
                                                <div class="col-xs-9">
                                                    <?php if(isset($pre_form['user_consent']) && $pre_form['user_consent'] == 1) { ?>
                                                        <img style="max-height: 75px;" src="<?php echo $pre_form['signature_bas64_image']; ?>"  />
                                                    <?php } else { ?>
                                                        <a class="btn modal-button btn-sm get_signature" href="javascript:;">Create E-Signature</a>
                                                        <div class="img-full">
                                                            <img style="max-height: 75px;" src=""  id="draw_upload_img" />
                                                        </div>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        <thead>
                                                        <tr>
                                                            <th class="col-6">IF the payment is for . . .</th>
                                                            <th class="col-6">THEN the payment is exempt for . . .</th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                                        <tr>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        <thead>
                                                        <tr>
                                                            <th class="col-6 text-center">For this type of account:</th>
                                                            <th class="col-6 text-center">Give name and SSN of:</th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                                        <tr>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        <thead>
                                                        <tr>
                                                            <th class="col-6">IF the entity/person on line 1 is a(n) . . .</th>
                                                            <th class="col-6">THEN check the box for . . .</th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                                        <tr>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        <thead>
                                                        <tr>
                                                            <th class="col-6">For this type of account:</th>
                                                            <th class="col-6">Give name and EIN of:</th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                                        <tr>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                            ...
                                            <label class="control control--checkbox">
                                                ...
                                                <input <?php echo isset($pre_form['user_consent']) && $pre_form['user_consent'] == 1 ? 'disabled="disabled"' : ''; ?>  <?php echo set_checkbox('user_consent', 1, $consent == 1); ?> data-rule-required="true" type="checkbox" id="w9_user_consent" name="w9_user_consent" value="1" />
                                                <div class="control__indicator"></div>
                                            </label>
                                        </div>
                                    </div>
                                    <hr />
                                    <?php if(!isset($pre_form['user_consent']) && $pre_form['user_consent'] == 0) { ?>
                                        <div class="row">
                                            <div class="col-lg-12 text-center">
                                                <button <?php echo $signed_flag == true ? 'disabled="disabled"' : ''; ?> onclick="func_save_w9_form();" type="button" class="btn modal-button break-word-text"><?php echo DEFAULT_SIGNATURE_CONSENT_BUTTON; ?></button>
                                            </div>
                                        </div>
                                    <?php } ?>
                                </div>
...
<?php $this->load->view('documents/e_signature_popup'); ?>

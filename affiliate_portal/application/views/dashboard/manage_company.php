                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php echo $company['PhoneNumber']; ?></td>
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="dotted-border">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6"><?php echo my_date_format($admin_invoice['created']); ?></div>
                                                                    </div>  
                                                                </div>
                                                                <div class="dotted-border">
                                                                    <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="dotted-border">
                                                                    <div class="row">
                                                                        <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6"><strong>Date</strong></div>
                                                                        <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6"><?php echo my_date_format($marketplace_invoice['date']); ?></div>
                                                                    </div>  
                                                                </div>
                                                                <div class="dotted-border">
                                                                    <div class="row">

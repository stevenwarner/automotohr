<main>
      <div class="row">
        <div class="col-xs-12 background-image-css" style="background-image: url(<?= base_url('assets/images/'.'AffiliateLoginimage.png')?>">
            <div class="first column-flex-center first-div-padding">
                <div class="automoto-img-div margin-bottom-30">
                    <img alt="logo image " src=" <?= base_url('assets/images/'.'ahr_logo_new 1.png')?>" />
                ...
                <?php } ?>
                    ...
                    <a href="https://www.automotohr.com/can-we-send-you-a-check-every-month" class="not-automoto-affiliate dark-blue-text" target="_blank">Not An AutomotoHR Affiliate ?</a>
                 </div>

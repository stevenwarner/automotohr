                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-12 col-xs-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="from_username" name="from_username" class="form-control" value="<?php echo $from_username; ?>" />
                                            </div>
                                        </div>
...
<!--                                                    <input class="btn btn-danger" type="button" value="DELETE">-->
                                                    <a id="<?php echo $message['sid']; ?>" href="javascript:;" onclick="todo('delete', this.id);" class="btn btn-danger btn-block btn-sm">

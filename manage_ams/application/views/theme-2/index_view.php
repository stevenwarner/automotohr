...
<div class="main">		
    <div class="container">
        ...
        <header class="heading-title">
            <h2 class="page-title color">Latest Jobs</h2>                
                            ...
                            <article class="job-article">
                                <div class="job-title">
                                    <span class="title-no-jobs">
                                        <h4><?php echo 'No Active Jobs Available at the moment!'; ?> </h4>
                                    </span>									
                                </div>		
                            </article>
                        </div>
                    <?php } else { ?>
                        <?php foreach ($job_listings as $key => $value) { ?>
                            ...
                            <div class="content-wrapper">
                                <article class="job-article">
<!--                                    <div class="icon-job bg-color custom-theme"><i class="fa fa-cubes"></i></div>-->
                                    <div class="icon-job">
                                        <figure>
                                            
                                                <?php if (empty($value['pictures']) && !empty($company_details['Logo']) && ($value['user_sid']) == $company_details['sid']) { ?>
                                    ...
                                    <div class="job-title">
                                        ...
                                        <div class="job-location">
                                            <ul>
                                                ...
                                                <?php } ?>
                                                <li>
                                                    <i class=" color fa fa-clock-o"></i>
                                                    <div class="text "><?php echo $value['JobType']; ?></div>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="social-share">									
                                        <div class="share-icon"><i class="color fa fa-share-alt"></i></div>
                                        <!-- Social Media Start -->
                                    ...
                                    <div class="description-wrapper">
                                        ...
                                        <?php } ?>
                                        <div class="btn-wrap">                                            
                                            <?php echo anchor("/job_details/" . $value['sid'], "more details", array('class' => 'siteBtn custom-theme')); ?>                                             

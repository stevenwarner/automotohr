        ...
        <div class="wrapper">
            <header class="header">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="logo"><a href="<?php echo STORE_FULL_URL_SSL; ?>"><img src="<?php echo base_url('assets/default/images/new_logo.JPG'); ?>"></a></div>
                        </div>
                    </div>
                </div>
            </header>
            <div class="page-banner">
                <img src="<?php echo base_url('assets/default/images/automotohr_2.jpg'); ?>" alt="">			
            </div>

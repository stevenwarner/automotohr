                            ...
                            <li>
                                ...
                                <select class="form-fields" name="country" onchange="getStates(this.value, '<?php echo $states; ?>')" required="required">
                                    <?php foreach ($active_countries as $active_country) { ?>
                                        <option value="<?php echo $active_country['sid']; ?>" <?php if ($active_country['sid'] == $country_id) { ?> selected <?php
...
<script type="text/javascript">
    ...
    function show_popup(val, sm) {
        ...
        //
        $('.contactPreference[value="email"]').prop('checked', true);
        $('.jsContactPreference').hide(0);
        sm_enable = 0;
        if (sm == 1) {
            $('.jsContactPreference').show(0);
            sm_enable = 1;
        }

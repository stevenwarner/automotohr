                ...
                <div class="advance-search custom_search_bgcolor">
                    <form method="get" action="">
                        ...
                        <?php                   }
                                ...
                                <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
                                    <a href="<?php echo base_url('/job_feed/'); ?>" id="btn-clear-search" name="btn-clear-search" class="input-field form-btn theme4_search_btn">Clear Search</a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
                    ...
                    if(!empty($job_listings)) {
                            ...
                            <div class="text">
                                ...
                                <div class="btn-area">
                                    <ul>
                                        <li><button type="button" class="site-btn bg-color" onclick="show_popup(<?php echo $job['sid'] ?>)">Apply Now</button></li>
                                        <li><a href="<?= base_url(str_replace('display-job', 'job-feed-details', job_title_uri($job))); ?>" class="site-btn bg-color-v2">View Details</a></li>
                                        <a style="display:none;" id="show_hide<?php echo $job['sid'] ?>" data-toggle="modal" data-target="#myModal">&nbsp;</a>
                                    </ul>
                                </div>
                            </div>
       ...
       var $searchFormFields = $('.search-form-field');
        $searchFormFields.each(function () {
            $(this).on('keyup change', function () {
                ...
                var sUrl = '<?php echo base_url('/job_feed/') ?>' + '/' + encodeURI(sCountry) + '/' + encodeURI(sState) + '/' + encodeURI(sCity) + '/' + encodeURI(sCategory) + '/'+ encodeURI(sKeyword) + '/';
...
//                setTimeout(function(){
                    ...
                    $.ajax({
                        type: 'GET',
                        async: false,
                        url: '<?php echo base_url('/job_feed') ?>' + '/' + encodeURI(sCountry) + '/' + encodeURI(sState) + '/' + encodeURI(sCity) + '/' + encodeURI(sCategory) + '/' + encodeURI(sKeyword) + '/' + page++ + '/' + 1 ,

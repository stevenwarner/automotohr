    ...
    <div class="container-fluid">
        <div class="detail-banner-caption">
            <header class="heading-title">
                <h1 class="section-title">Video testing mode.</h1>
            </header>
        </div>
    </div>
</div>
        ...
        <div class="row">					
            <div class="col-md-12">
                <div class="text-column" style="width:100%;">
                    ...
                    <iframe id="player" class="embed-responsive-item" src="//www.youtube.com/embed/OL9Cp1_6FZg/autoplay=0&loop=1&rel=0&controls=0&showinfo=0&enablejsapi=0"></iframe>
                </div>
            </div>
        </div>
    </div>

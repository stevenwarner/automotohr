...
<!--                                <div class="icon-job">
                                        ...
                                        <?php if (!empty($value['pictures'])) { ?>
                                            <figure><img class="1" src="<?php echo AWS_S3_BUCKET_URL . $value['pictures']; ?>"></figure>
                                        <?php } else if(!empty($company_details['Logo'])) { ?>
                                            <figure><img class="2" src="<?php echo AWS_S3_BUCKET_URL . $company_details['Logo']; ?>"></figure>
                                        <?php } else { ?>
                                            <i class="fa fa-eye"></i>
                                            <figure><img src="<?php echo AWS_S3_BUCKET_URL . DEFAULT_JOB_IMAGE; ?>"></figure>
                                        <?php } ?>

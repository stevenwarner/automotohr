                    ...
                    <ul>
                        <form class="popup-form" method="post" name="register-form" enctype="multipart/form-data" id="register-form">
                            <li>
                                ...
                                <input class="form-fields" type="text" name="first_name" required placeholder="Enter First Name" value="<?php if (isset($formpost['first_name'])) {
                            ...
                            <li>
                                ...
                                <input class="form-fields" type="text" name="last_name" required placeholder="Enter Last Name"
                                       value="<?php if (isset($formpost['last_name'])) {
                            ...
                            <li>
                                ...
                                <input class="form-fields" type="text" name="YouTube_Video" id="YouTube_Video" placeholder="Youtube Video Link" onblur="return youtube_check()"
                                       value="<?php if (isset($formpost['YouTube_Video'])) {
                            ...
                            <li>
                                ...
                                <input class="form-fields" type="email" name="email" required placeholder="Enter Email"
                                       value="<?php if (isset($formpost['email'])) {
                                           echo $formpost['email'];
                                       } ?>">
                            ...
                            <li>
                                ...
                                <input class="form-fields" type="text" name="phone_number" required placeholder="Phone Number"
                                       value="<?php if (isset($formpost['phone_number'])) {
                            ...
                            <li>
                                ...
                                <input class="form-fields" type="text" name="address" placeholder="Enter Address"
                                       value="<?php if (isset($formpost['address'])) {
                            ...
                            <li>
                                ...
                                <input class="form-fields" type="text" name="city" required placeholder="Enter City"
                                       value="<?php if (isset($formpost['city'])) {
                                           echo $formpost['city'];
                                       } ?>">
                            ...
                            <li><?php
                                ...
                                <select class="form-fields" name="state" id="state" required >
                                    <?php
                                    if (empty($country_id)) {
                            ...
                            <li>
                                ...
                                <select class="form-fields" name="country" onchange="getStates(this.value, '<?php echo $states; ?>')" required >
...
<script>
    ...
    $('.eeo_check').click(function () {
        if ($('#eeo_yes').is(':checked')) { //show form

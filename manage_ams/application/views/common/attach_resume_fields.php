    ...
    <label class="resume-label-withradio" for="attachment_from_google">
        <input type="radio" id="attachment_from_google" name="attachment_from" value="google" class="attach_from"> <span>Cloud Storage</span>
    </label>
    <label class="resume-label-withradio" for="attachment_from_computer">
        <input type="radio" id="attachment_from_computer" name="attachment_from" value="computer" class="attach_from" checked="checked">
        <span>Computer</span>
    </label>
    ...
    <div id="attach_from_google">
        ...
        <input type="hidden" id="resume_from_google_drive" name="resume_from_google_drive" value=""/>

        <?php if (base_url() == 'http://ams.example/') { ?>
            <a id="get_resume_from_google" class="google-btn site-btn bg-color" target="_blank" href="http://localhost/automotoCI/google/<?php echo $unique_key; ?>">
                <i class="fa fa-cloud" aria-hidden="true"></i> Choose Cloud Storage</a>
        <?php } else { ?>
            <a id="get_resume_from_google" class="google-btn site-btn bg-color" target="_blank" href="<?php echo STORE_FULL_URL; ?>google/<?php echo $unique_key; ?>">
                <i class="fa fa-cloud" aria-hidden="true"></i> Choose Cloud Storage</a>
        <?php } ?>

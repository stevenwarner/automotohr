...
<script type="text/javascript">
    ...
    function validate_friend_form() {
        $("#friend-form").validate({ // Specify the validation error messages
            rules: {
                    ...
                    <form class="popup-form" method="post" name="register-form" enctype="multipart/form-data" id="register-form">
                        <ul>
                            ...
                            <li>
                                ...
                                <input class="form-fields" type="text" name="phone_number" required="required" placeholder="Phone Number"
                                       value="<?php

...
<?php } else if ($theme_name == 'theme-3') { ?>
    <?php if ($logo_location == 'left') { ?>
        <header class="header <?php echo $logo_class . ' ' . $logo_location_class; ?>">
            <div class="container">
                <div class="row">
...
<?php   if ($logo_location == 'left') { ?>
        <header class="header custom-theme <?php echo $logo_class . ' ' . $logo_location_class; ?>">
            <div class="container">
                <div class="row">
        ...
        <?php                   if ($logo_status == 1 && !empty($logo_image)) { ?>
                                    <div class="logo">
                                        <a href="<?php echo base_url('/'); ?>">
                                            <figure><img src="<?php echo AWS_S3_BUCKET_URL . $logo_image; ?>"></figure>
                                        </a>
                                    </div>  
        <?php                   } ?>
                            </div>

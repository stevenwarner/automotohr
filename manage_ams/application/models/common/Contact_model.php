...
class Contact_model extends CI_Model {
    ...
    function send_enquiry($employer_id, $name, $email, $message, $data) { // Contact us form email function
    ...
    // Join our talent network Function
    function talent_network_applicant($email, $first_name, $last_name, $country, $city, $phone_number, $desired_job_title, $resume, $data, $cover_letter, $state, $date_applied) {
        $sid                                                                    = $data['company_details']['sid'];
        $company_email                                                          = $data['company_details']['email'];
        $CompanyName                                                            = $data['company_details']['CompanyName'];
        $staus                                                                  = ''; // it is give the status whether email is sent or not

...
//
$route['reports/admin_report'] = 'reports/applicants_report/documentsReport';
$route['reports/admin_report/(:any)/(:any)/(:any)/(:any)'] = 'reports/applicants_report/documentsReport/$1/$2/$3/$4';

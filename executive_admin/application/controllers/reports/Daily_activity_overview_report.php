...
class Daily_activity_overview_report extends CI_Controller {
    ...
    public function index($company_sid) {
        ...
        if ($this->session->userdata('executive_loggedin')) {
            ...
            if (isset($_POST['export']) && $_POST['export'] == 'export_data') {
                ...
                $companies = $this->Reports_model->get_company_activity_overview($company_sid, $start_date, $end_date);
            ...
            $this->load->view('reports/daily_activity_overview_report');

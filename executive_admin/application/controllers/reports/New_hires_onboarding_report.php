...
class New_hires_onboarding_report extends CI_Controller {
    ...
    public function index($company_sid) {
        if ($this->session->userdata('executive_loggedin')) {
            ...
            $data['applicants'] = $this->Reports_model->GetAllApplicantsOnboarding($company_sid, $keyword, $start_date, $end_date, true);
            ...
            $this->load->view('reports/new_hires_onboarding_report');

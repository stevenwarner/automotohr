                    ...
                    <form id="form_applicant_information" method="POST" enctype="multipart/form-data" action="<?php echo current_url(); ?>">
                        ...
                        <div class="row">
                            ...
                            <?php if(IS_TIMEZONE_ACTIVE) { ?>
                                ...
                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                    <div class="form-group">
                                        <label for="video">Timezone:</label>
                                        <?= timezone_dropdown(
                                            $executive_user['timezone'],
                                            array(
                                                'name' => 'timezone',
                                                'id' => 'timezone',
...
<!--                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">-->
<!--                                <div class="form-group">-->
<!--                                    <label for="video">ComplyNet Dashboard Link:</label>-->
<!--                                    <input type="text" name="complynet_link" value="--><?php //echo set_value('complynet_link', $executive_user['complynet_dashboard_link']); ?><!--" class="form-control" id="complynet_link">-->
<!--                                </div>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        --><?php //}?>

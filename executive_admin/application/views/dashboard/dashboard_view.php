                                ...
                                <div class="table-responsive full-width">
                                    <table class="table table-bordered">
                                        ...
                                        <?php   if (empty($executive_user_companies)) { ?>
                                            <tr><td class="text-center" colspan="4">No Company is linked with your account.</td></tr>
                                        <?php   } else { ?>
                                            <?php       foreach ($executive_user_companies as $user_company) { ?>
                                                <tr>
                                                    <td><a><?php echo $user_company['company_name']; ?></a></td>
...
<script>
    function companyLogin(company_sid, logged_in_sid) {       
        ...
        $.post(url_to, {action: "login", company_sid: company_sid, logged_in_sid: logged_in_sid})
                .done(function (data) {
                    if(data == 1){
...
#js-applicant-block table{ position: relative; }
.js-loader{

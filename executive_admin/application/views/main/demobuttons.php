<div class="demo-btn-wrp">
    <div class="container-fluid">
        ...
        <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
            ...
            <?php //echo $class_name; ?>
            <?php if ( in_array($class_name, array('home','users' ))) { ?>
                <div class="demo-btn-box">
                    <div class="text">
                        <figure><a href="<?php echo STORE_FULL_URL ?>/schedule_your_free_demo" target=_black><img class="img-responsive" src="<?= base_url() ?>/assets/images/img-demo-btn-new.png" alt=""/></a>
                        </figure>
                    </div>              
                </div>
            <?php } ?>

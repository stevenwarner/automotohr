                    ...
                    <form method="GET" action="<?php echo base_url('reports/applicant_source_report/' . $company_sid); ?>" name="search" id="search">
                        ...
                        <div class="row">
                                    ...
                                    <select class="chosen-select" multiple="multiple" name="job_sid[]" id="job_sid">
                                        <?php if (!empty($jobs)) { ?>
                                            ...
                                            <?php foreach ($jobs as $job) { ?>
                                                ...
                                                <!--                                                <option --><?php //echo set_select('job_sid', $job['sid'], $job_sid == $job['sid']); 
                                                                                                                ?>
                                                <!-- value="--><?php //echo $job['sid']; 
                                                                ?>
                                                <!--">--><?php //echo $job['Title']; 
                                                            ?>
                                                <!--</option>-->
                            ...
                            <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
                                <div class="field-row">
                                    ...
                                    <?php $start_date = $this->uri->segment(7) != 'all' && $this->uri->segment(7) != '' ? urldecode($this->uri->segment(7)) : date('m-d-Y'); ?>
                            ...
                            <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
                                <div class="field-row">
                                    ...
                                    <?php $end_date = $this->uri->segment(8) != 'all' && $this->uri->segment(8) != '' ? urldecode($this->uri->segment(8)) : date('m-d-Y'); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-2 col-xs-12 col-sm-2">
                                <a id="btn_apply_filters" class="btn btn-success btn-block" href="<?php echo base_url('reports/applicant_source_report/' . $company_sid); ?>">Apply Filters</a>
                            </div>
                            <div class="col-lg-2 col-md-2 col-xs-12 col-sm-2">
                                <a id="btn_clear_filters" class="btn btn-success btn-block" href="<?php echo base_url('reports/applicant_source_report/' . $company_sid); ?>">Reset Filters</a>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-bordered table-striped table-hover" id="example">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="col-xs-4">Applicant Source</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php if (isset($applicants) && sizeof($applicants) > 0) { ?>
                                                <?php foreach ($applicants as $applicant) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="table-responsive applicant_source_link_in_table"><?php echo ucwords($applicant['applicant_source']); ?></div>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            <?php } else { ?>
...
<script type="text/javascript">
    ...
    function generate_search_url() {
        ...
        var url = '<?php echo base_url('reports/applicant_source_report/' . $company_sid); ?>' + '/' + keyword + '/' + job_sid + '/' + applicant_type + '/' + start_date_applied + '/' + end_date_applied;

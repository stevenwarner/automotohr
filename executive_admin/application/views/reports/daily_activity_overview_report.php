...
<script type="text/javascript">
    ...
    function get_inactivity_report() {
        ...
        {
            var request_data = { "perform_action" : "get_daily_activity_overview", "report_date" : report_date, "company_sid": company_sid};
            var my_request;
            var my_url = '<?php echo base_url('reports/daily_activity_overview_report/ajax_responder'); ?>';

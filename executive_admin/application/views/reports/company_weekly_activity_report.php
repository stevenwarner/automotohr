                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
                        <div class="field-row field-row-autoheight">
                            <label class="valign-middle">Week</label>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
                        <div class="field-row field-row-autoheight">
                            <button class="btn btn-success btn-equalizer btn-block" onclick="get_activity_report();">
                                Get Report
                            </button>
                        </div>
                    </div>
...
<script type="text/javascript">
    function fExportCSV(){
        ...
        if(
            (company_sid != '' && parseInt(company_sid) != 0 && company_sid != null && company_sid != undefined) &&
...
//            $('#hidden_company_sid').val($(this).val());
//        });
    });
    ...
    function get_activity_report() {
        ...
        if (week_span != '' && week_span != null && week_span != undefined) {
            var request_data = {
                "perform_action": "get_employers_weekly_activity",
            ...
            var my_request;
            var my_url = '<?php echo base_url('reports/company_weekly_activity_report/ajax_responder'); ?>';

            ...
            <div class="col-lg-12">
                ...
                <div class="hr-search-main" style="display: block;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-2">
                            <a id="btn_apply_filters" class="btn btn-success btn-block" href="<?php echo base_url('reports/time_to_fill_job_report/' . $company_sid); ?>">Apply Filters</a>
                        </div>
                        <div class="col-xs-2">
                            <a id="btn_clear_filters" class="btn btn-success btn-block" href="<?php echo base_url('reports/time_to_fill_job_report/' . $company_sid); ?>">Clear Filters</a>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-stripped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-xs-2 text-center">Average Days To Fill</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php if (isset($jobs) && sizeof($jobs) > 0) { ?>
...
<!--                                                --><?php //echo date_with_time($job['activation_date']); ?>
                                            ...
                                            <td class="text-center"><?php echo $job['average_days_to_fill']; ?> Day(s)</td>
                                        </tr>
...
<script type="text/javascript">
    ...
    function generate_search_url(){
        ...
        var url = '<?php echo base_url('reports/time_to_fill_job_report/' . $company_sid); ?>' + '/' + keyword;

        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
                        <div class="field-row field-row-autoheight">
                            <button id="btn_apply_filters" class="btn btn-success btn-equalizer btn-block"
...
<script type="text/javascript">
    ...
    function get_activity_overview_report() {
        ...
        if (week_span != '' && week_span != null && week_span != undefined) {
            ...
            var my_request;
            var my_url = '<?php echo base_url('reports/weekly_activity_overview_report/ajax_responder'); ?>';

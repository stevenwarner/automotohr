                    ...
                    <div class="panel-body">
                        <div class="table-responsive full-width">
                            <table  class="table table-bordered">
                                ...
                                <tr>
                                    <th class="success"><b>From <?php if ($page == 'Inbox') { echo 'Name'; } ?></b></th>
                                    <td><?php   echo $contact_details["from_name"]; ?>&nbsp;

                                        <?php   if ($page == 'Inbox' && $contact_details['message_type'] == 'applicant') {
                                            echo '<a style="' . DEF_EMAIL_BTN_STYLE_PRIMARY . '" href="' . $contact_details["from_profile_link"] . '" target="_blank">View Profile</a>';
                                        } ?></td>
                                </tr>
                                <?php if ($page == 'Inbox') { ?>
                                    <tr>
                                ...
                                <?php } ?>
                                <tr>
                                    <th class="success"><b>To <?php if ($page != 'Inbox') { echo 'Name'; } ?></b></th>

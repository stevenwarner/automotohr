                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $contact_details["from_name"]; ?>&nbsp;
                                            ...
                                            <?php if ($page == 'Inbox' && $contact_details['message_type'] == 'applicant') { ?>
                                                <a href="JavaScript:void(0);" style="<?php echo DEF_EMAIL_BTN_STYLE_PRIMARY ?>" id="<?php echo $company_id ?>" onclick="return companyLogin(this.id,<?php echo $loginAs; ?>,'<?php echo $contact_details['from_profile_link']; ?>');">View Profile</a>
                                                <?php  } ?>
                                        </td>
                                    </tr>
                                    <?php if ($page == 'Inbox') { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $contact_details["to_name"]; ?>&nbsp;
                                            ...
                                            <?php if ($page != 'Inbox' && $contact_details['message_type'] == 'applicant') {
                                                echo '<a style="' . DEF_EMAIL_BTN_STYLE_PRIMARY . '" href="' . $contact_details["to_profile_link"] . '" target="_blank" class="text-success pull-right">View Profile</a>';
                                            } ?></td>
                                    </tr>
                                    <?php if ($page != 'Inbox') { ?>
                                        <tr>
...
<script>
    ...
    function companyLogin(company_sid, logged_in_sid, profileLink) {
        ...
        $.post(url_to, {
            ...
            .done(function(data) {
                if (data == 1) {
                    window.open("<?= $parent_base_url ?>/" + profileLink, '_blank');
                } else {

                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                            ...
                            <div class="form-wrp">
                                ...
                                <form id="form_e_signature" enctype="multipart/form-data" method="post" action="<?php echo $save_post_url; ?>">
                                    ...
                                    <input type="hidden" id="user_sid" name="user_sid" value="<?php echo $exadminId; ?>" />
                                    ...
                                    <input type="hidden" id="first_name" name="first_name" value="<?php echo $executive_user['first_name']; ?>" />
                                    <input type="hidden" id="last_name" name="last_name" value="<?php echo $executive_user['last_name']; ?>" />
                                    <input type="hidden" id="email_address" name="email_address" value="<?php echo $executive_user['email']; ?>" />
                                                ...
                                                <table class="table table-bordered table-striped">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="col-xs-8"><?php echo ucwords($executive_user['first_name'] . ' ' . $executive_user['last_name']); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="col-xs-4">Email</th>
                                                            <td class="col-xs-8"><?php echo $executive_user['email']; ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>

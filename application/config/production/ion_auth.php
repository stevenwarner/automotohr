...
*/
$config['tables']['users']           = 'administrator_users';
$config['tables']['groups']          = 'administrator_groups';
$config['tables']['users_groups']    = 'administrator_users_groups';
$config['tables']['login_attempts']  = 'administrator_login_attempts';
 ...
 */
$config['site_title']                 = "automotoHR";       // Site Title, example.com
$config['admin_email']                = "dev@automotohr.com"; // Admin Email, admin@example.com
$config['default_group']              = 'Sub-Admin';           // Default group, use name

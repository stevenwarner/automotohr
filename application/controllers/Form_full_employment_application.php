            ...
            if (!empty($request_details) && $request_details['status'] == "sent") {
                ...
                if ($this->form_validation->run() == false) {
                    ...
                    if ($user_type == 'employee') {
                        ...
                        if (checkEmployeeAdpStatus($user_sid)) {
                            // load the model
                            ...
                            $this->adp_model->handleMultipleColumns(
                                [
                                 ...
                                 //   'rehire_date' => $user_info['rehire_date'],
                                    'Location_Address' => $user_info['Location_Address'],
                                    'Location_City' => $user_info['Location_City'],
                                    'Location_State' => $user_info['Location_State'],
                                    'Location_ZipCode' => $user_info['Location_ZipCode'],

    ...
    public function index($verification_key = null, $pre_fill_flag = null)
    {
        ...
        if ($verification_key != null) {
            ...
            if (!empty($document_record)) {
                ...
                $ip_track = $this->documents_model->get_document_ip_tracking_record($company_sid, 'end_user_license_agreement');
                ...
                if (!$this->form_validation->run()) {
                    ...
                    if ($pre_fill_flag != null && $pre_fill_flag == 'pre_fill') {
                        ...
                        $this->documents_model->insert_document_ip_tracking_record($company_sid, $employer_sid, getUserIP(), 'end_user_license_agreement', 'signed', $_SERVER['HTTP_USER_AGENT']);
                ...
                $this->load->view('form_end_user_license_agreement/index', $data);
            } else {

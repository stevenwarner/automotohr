...
class Hr_documents_management extends Public_Controller
{
    ...
    public function preview_verification_document()
    {
        ...
        $document_sid = $this->input->get('docid');
        if ($doctype == 'i9') {
            $print_link = isset($status) ? base_url('form_i9/print_i9_form/employee/' . $employer_sid) : base_url('form_i9/print_i9_form/');
            $download_link = isset($status) ? base_url('form_i9/download_i9form/employee/' . $employer_sid) : base_url('form_i9/download_i9form/');
            $data["pre_form"] = $this->hr_documents_management_model->getUserVarificationHistoryDoc($document_sid, "applicant_i9form");
        }
        if ($doctype == 'w9') {
            $print_link = isset($status) ? base_url('form_w9/print_w9_form/employee/' . $employer_sid) :  base_url('form_w9/print_w9_form/');
            $download_link = isset($status) ? base_url('form_w9/download_w9form/employee/' . $employer_sid) : base_url('form_w9/download_w9form/');
            $data["pre_form"] = $this->hr_documents_management_model->getUserVarificationHistoryDoc($document_sid, "applicant_w9form");
        }
        if ($doctype == 'w4') {
            $print_link = isset($status) ? base_url('form_w4/print_w4_form_2020/employee/' . $employer_sid) : base_url('form_w4/print_w4_form_2020/');
            $download_link = isset($status) ? base_url('form_w4/download_w4_form_2020/employee/' . $employer_sid) : base_url('form_w4/download_w4_form_2020/');
            $data["pre_form"] = $this->hr_documents_management_model->getUserVarificationHistoryDoc($document_sid, "form_w4_original");
        }

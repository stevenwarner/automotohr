        ...
        if ($verification_key != null) {
            ...
            if (!empty($document_record) && ($document_record['status'] != 'signed') || $pre_fill_flag == 'view') {
                ...
                if ($pre_fill_flag != null && $pre_fill_flag == 'pre_fill') {
                    ...
                    $this->form_validation->set_rules('term_number_of', 'Contract Term', 'required|xss_clean|trim');
                    $this->form_validation->set_rules('contract_term', 'Number of', 'required|xss_clean|trim');
                } else {
                ...
                if ($this->form_validation->run() == false) {
                    ...
                    $this->load->view('form_payroll_credit_card_authorization/index', $data);
                } else {

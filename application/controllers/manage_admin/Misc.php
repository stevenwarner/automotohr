            ...
            if (!empty($invoice_data)) {
                ...
                if ($this->form_validation->run() === FALSE) {
                    ...
                    if ($payment_state == 'approved') {
                        ...
                        mail('ahassan.egenie@gmail.com', 'Payment Invoice Notification billing contacts: ' . date('Y-m-d H:i:s'), print_r($company_billing_contacts, true));
                        mail('ahassan.egenie@gmail.com', 'Payment Invoice Notification company data: ' . date('Y-m-d H:i:s'), print_r($replacement_array, true));

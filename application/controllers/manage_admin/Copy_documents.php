...
class Copy_documents extends Admin_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('manage_admin/copy_documents_model');
    ...
    public function index() {
        ...
        $this->render('manage_admin/company/copy_documents', 'admin_master');
    }

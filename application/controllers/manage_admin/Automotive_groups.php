...
class Automotive_groups extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $automotive_groups = $this->automotive_groups_model->get_automotive_group_records();
    ...
    public function edit($automotive_group_sid = 0)
    {
        ...
        if ($automotive_group_sid > 0) {
            ...
            if (!empty($group_record)) {
                ...
                redirect('manage_admin/autmotive_groups', 'refresh');
            }
        } else {
            $this->session->set_flashdata('message', '<strong>Error:</strong> Automotive Group Not Found!');
            redirect('manage_admin/autmotive_groups', 'refresh');
    ...
    public function add_member_company($automotive_group_sid = 0)
    {
        ...
        if ($automotive_group_sid > 0) {
            ...
            if (!empty($group_record)) {
                ...
                $this->form_validation->set_rules('location_country', 'Country', 'required|trim|xss_clean');
                $this->form_validation->set_rules('location_state', 'State', 'required|trim|xss_clean');
                ...
                $this->render('manage_admin/automotive_groups/add_edit_member_company', 'admin_master');
            } else {
                $this->session->set_flashdata('message', '<strong>Error:</strong> Automotive Group Not Found!');
                redirect('manage_admin/autmotive_groups', 'refresh');
            }

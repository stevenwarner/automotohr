...
class Documents extends Admin_Controller {
    ...
    function default_categories_listing () {
        //
        $redirect_url       = 'manage_admin';
        $function_name      = 'default_categories_listing';
        ...
        //
        $this->render('manage_admin/documents/default_categories');
    }

    function add_default_category () {
        $redirect_url       = 'manage_admin';
        $function_name      = 'add_default_category';
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            //
            $this->render('manage_admin/documents/default_category_form');
        } else{
    ...
    function edit_default_category ($sid) {
        $redirect_url       = 'manage_admin';
        $function_name      = 'edit_default_category';
    ...
    public function change_status ($sid) {
        ...
        //
        $this->documents_model->update_category($sid, $data);
        //

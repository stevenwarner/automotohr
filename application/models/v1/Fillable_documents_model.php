...
class Fillable_documents_model extends CI_Model
{
    ...
    //
    function getFillableDocumentsSlug($company_sid, $slug)
    {
        $this->db->where('company_sid', $company_sid);
        $this->db->where('fillable_documents_slug', $slug);
    ...
    //
    function setFillableDocumentsSlug($insertData)
    {
        $this->db->insert('documents_management', $insertData);
    }



    //
    function get_assigned_document($document_sid, $doc = NULL)
    {
    ...
    function update_download_status($document_sid)
    {
        $this->db->where('sid', $document_sid);
        $this->db->where('status', 1);
        $this->db->set('downloaded', 1);

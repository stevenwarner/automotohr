...
class Company_model extends CI_Model
{
    ...
    function get_documents_status($company_sid)
    {
        ...
        $this->db->select('form_payroll_credit_card_authorization.status as payroll_cc_auth_status');
        ...
        $this->db->join('form_payroll_credit_card_authorization', 'form_payroll_credit_card_authorization.company_sid = users.sid', 'left');

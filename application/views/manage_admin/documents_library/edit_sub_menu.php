                                ...
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="heading-title">
                                        ...
                                        <?php   if($parent_type == 'sub_menu') { ?>
                                                    <a id="back_btn" href="<?php echo base_url('manage_admin/documents_library/view_details/'.$menu_id)?>" class="black-btn pull-right"><i class="fa fa-arrow-left"> </i> Back</a>
                                        <?php   } else { ?>
                                    ...
                                    <div class="row source-breadcrumb">
                                        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-4">
                                        </div>
                                    </div>
                                    <?php $sub_type = $parent_type == 'sub_menu' ? 'Menu' : 'Heading'?>
 
                                    <div class="add-new-company" id="doc_form">
                                            ...
                                            <div class="row">
                                                ...
                                                <?php   if($parent_type == 'sub_menu') {
                                                            if (sizeof($parent_name) > 0) { ?>
                                                                <span class="text-success"><?= $parent_name[0]['name'] ?></span> >
                                                                <span class="text-success"><?= $parent_name[0]['title'] ?></span>
                                                <?php       }
                                                        } else {
                                                            if (sizeof($parent_name) > 0) { ?>
                                                                <span class="text-success"><?= $parent_name[0]['name'] ?></span> >
                                                                <span class="text-success"><?= $parent_name[0]['menu'] ?></span> >
                                                                <span class="text-success"><?= $parent_name[0]['heading']?></span>
                                                <?php       }
                                                        } ?>
                                            <?php /*= $form == 'add' ? 'New Sub ' . $sub_type : 'Update Sub ' . $sub_type */?>
                                                        </h1>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                    <div class="field-row">
                                                        ...
                                                        <select name="type" id="type" class="hr-form-fileds">
                                                            <option value="content" <?php echo $pre_sub_menu['type'] == 'content' ? 'selected="selected"' : ''?>>Content Type</option>
                                                            <option value="anchor" <?php echo $pre_sub_menu['type'] == 'anchor' ? 'selected="selected"' : ''?>>Anchor Type</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                    <div class="field-row">
                                                        ...
                                                        <select name="status" class="hr-form-fileds">
                                                            <option value="1"  <?php echo $pre_sub_menu['status'] == 1 ? 'selected="selected"' : ''?>>Active</option>
                                                            <option value="0 " <?php echo $pre_sub_menu['status'] == 0 ? 'selected="selected"' : ''?>>In Active</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="anchor-section" style="display: none">
                                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                        <div class="field-row">
                                                            ...
                                                            <?php echo form_input('anchor-title', set_value('anchor-title',$pre_sub_menu['type'] == 'anchor' ? $pre_sub_menu['title'] : ''), 'class="hr-form-fileds" id="anchor-title"'); ?>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                        <div class="field-row">
                                                            ...
                                                            <?php echo form_input('anchor_href', set_value('anchor_href',$pre_sub_menu['type'] == 'anchor' ? $pre_sub_menu['anchor_href'] : ''), 'class="hr-form-fileds" id="anchor_href"'); ?>
                                                ...
                                                <div id="content-section">
                                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                        <div class="field-row">
                                                            <label for="anchor-title">Sub <?php echo $parent_type == 'sub_menu' ? 'Menu' : 'Heading'?> Title <span class="hr-required">*</span></label>
                                                            <?php echo form_input('title', set_value('title',$pre_sub_menu['type'] == 'content' ? $pre_sub_menu['title'] : ''), 'class="hr-form-fileds" id="anchor-title"'); ?>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                        <div class="field-row field-row-autoheight">
                                                            <label for="description">Sub <?php echo $sub_type?> Description<span class="hr-required">*</span></label>
                                                            <script type="text/javascript" src="<?php echo site_url('assets/ckeditor/ckeditor.js'); ?>"></script>
                                                            <textarea class="ckeditor textarea" name="description" rows="8" cols="60" required>
                                                                <?php echo set_value('description',$pre_sub_menu['description']); ?>
                                                            </textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                        <div class="field-row field-row-autoheight">
                                                            ...
                                                            <?php if($pre_sub_menu['banner_url'] != NULL && !empty($pre_sub_menu['banner_url'])) { ?>
                                                            <div class="row" id="banner-container">
                                                                <div class="col-xs-12">
                                                                    <div class="well well-sm">
                                                                        <img class="img-responsive" src="<?php echo AWS_S3_BUCKET_URL.$pre_sub_menu['banner_url']?>" alt="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <?php } ?>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                        <label for="banner_status">
                                                            <input type="checkbox" id="banner_status" name="banner_status" value="1" <?php echo $pre_sub_menu['banner_status'] ? 'checked':''?>>
                                                            Enable Banner Image
                                                        </label>
                                                    </div>

                                                    <?php if(!empty($pre_sub_menu['banner_url']) || $pre_sub_menu['banner_url'] != NULL){ ?>
                                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" id="delete-banner-btn">
                                                        <input type="button" class="search-btn" id="delete-banner" value="Delete Image" data-attr="<?php echo $pre_sub_menu['sid']?>" name="form-submit">
                                                    </div>
                                                    <?php }?>

                                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                        <div class="hr-box">
                                                            <div class="hr-box-header"><h4 class="hr-registered">Manage Video</h4></div>
                                                            <div class="hr-innerpadding">
                                                                <div class="field-row field-row-autoheight">
                                                                    <?php if($pre_sub_menu['video'] != NULL && !empty($pre_sub_menu['video'])) { ?>
                                                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="padding: 0px;">
                                                                            <div class="well well-sm">
                                                                                <div class="embed-responsive embed-responsive-16by9">
                                                                                <?php if($pre_sub_menu['video_type'] == 'youtube') { ?>
                                                                                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/<?php echo $pre_sub_menu['video']; ?>" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                                                                                <?php } elseif($pre_sub_menu['video_type'] == 'vimeo') { ?>
                                                                                    <iframe class="embed-responsive-item" src="https://player.vimeo.com/video/<?php echo $pre_sub_menu['video']; ?>"  frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                                                                                <?php } else {?> 
                                                                                    <video controls>
                                                                                        <source src="<?php echo base_url().'assets/uploaded_videos/'.$pre_sub_menu['video']; ?>" type='video/mp4'>
                                                                                    </video>
                                                                                <?php } ?>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <?php } ?>
                                                                    <div class="row">
                                                                        <?php $video_source = $pre_sub_menu['video_type']; ?>
                                                                        ...
                                                                        <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
                                                                            <div class="field-row">
                                                                                <label class="control control--radio"><?php echo YOUTUBE_VIDEO; ?>
                                                                                    <input type="radio" name="video_source" class="video_source" value="youtube" <?php echo $video_source == 'youtube' && !empty($pre_sub_menu['video']) ? 'checked="checked"' : ''; ?>>
                                                                                    <div class="control__indicator"></div>
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
                                                                            <div class="field-row field-row-autoheight">
                                                                                <label class="control control--radio"><?php echo VIMEO_VIDEO; ?>
                                                                                    <input type="radio" name="video_source" class="video_source" value="vimeo" <?php echo $video_source == 'vimeo' && !empty($pre_sub_menu['video']) ? 'checked="checked"' : ''; ?>>
                                                                                    <div class="control__indicator"></div>
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
                                                                            <div class="field-row">
                                                                                <label class="control control--radio"><?php echo UPLOAD_VIDEO; ?>
                                                                                    <input type="radio" name="video_source" class="video_source" value="uploaded" <?php echo $video_source == 'uploaded' && !empty($pre_sub_menu['video']) ? 'checked="checked"' : ''; ?>>
                                                                                    <div class="control__indicator"></div>
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                                            <div class="field-row field-row-autoheight" id="youtube_vimeo_input">
                                                                                <?php 
                                                                                    if (!empty($pre_sub_menu['video']) && $pre_sub_menu['video_type'] == 'youtube') {
                                                                                        $video_link = 'https://www.youtube.com/watch?v='.$pre_sub_menu['video'];
                                                                                    } else if (!empty($pre_sub_menu['video']) && $pre_sub_menu['video_type'] == 'vimeo') {
                                                                                        $video_link = 'https://vimeo.com/'.$pre_sub_menu['video'];
                                                                                    } else {
                                                                                        $video_link = '';
                                                                                    }
                                                                                ?>
                                                                                <label for="video" id="label_youtube">Youtube Video:</label>
                                                                            ...
                                                                            <div class="field-row field-row-autoheight" id="upload_input" style="display: none">
                                                                                <div class="upload-file form-control">
                                                                                    <?php 
                                                                                        if (!empty($pre_sub_menu['video']) && $pre_sub_menu['video_type'] == 'uploaded') {
                                                                                    ?>
                                                                                            <input type="hidden" id="pre_upload_video_url" name="pre_upload_video_url" value="<?php echo $pre_sub_menu['video']; ?>">
                                                                                    <?php        
                                                                                        } else {
                                                                                    ?>
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                                            <label for="video_status">
                                                                                <input type="checkbox" id="video_status" name="video_status" value="1" <?php echo $pre_sub_menu['video_status'] == 1 ? 'checked="checked"' : ''; ?>>
                                                                                Enable Video
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <?php if(sizeof($word_doc)>0) { ?>
                                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                            <div class="field-row field-row-autoheight">
                                                                <label>Word Documents :</label>
                                                                <?php foreach ($word_doc as $file) { ?>
                                                                    <div class="form-control full-width"
                                                                         style="height: auto; float: left;margin: 5px 0 0 0;">
                                                                        <div class="pull-left">
                                                                            <?php echo $file['sort_order']?>- <span class="uploaded-file-name"><?php echo $file['file_name']?></span>
                                                                        </div>
                                                                        <div class="pull-right">
                                                                            <a href="javascript:;" title="Edit File" class="btn btn-success edit-word-doc" data-word='<?= addslashes($file['word_content'])?>' data-fedral="<?php echo $file['federal_check']?>" data-country="<?php echo $file['country']?>" data-state="<?php echo $file['states']?>" data-order="<?php echo $file['sort_order']?>" data-file-name="<?php echo $file['file_name']?>" data-attr="<?= $file['sid']?>"><i class="fa fa-pencil"></i></a>
                                                                            <a href="javascript:;" title="<?= $file['status'] ? 'Disable' : 'Enable'?>" class="btn <?= $file['status'] ? 'btn-warning delete-file' : 'btn-primary enable-file'?>" data-attr="<?= $file['sid']?>"><i class="fa fa-<?= $file['status'] ? 'ban' : 'shield'?>"></i></a>
                                                                            <a href="javascript:;" title="Delete File" class="btn btn-danger delete-record" data-attr="<?= $file['sid']?>"> <i class="fa fa-times"></i></a>
                                                                        </div>
                                                                    </div>
                                                                <?php } ?>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                        <div class="hr-box">
                                                            <div class="hr-box-header"><h4 class="hr-registered">Upload Related Documents </h4></div>
                                                            <div class="hr-innerpadding">
                                                                ...
                                                                <div class="field-row field-row-autoheight">
                                                                    <div class="row">
                                                                        <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                                            <div class="field-row">
                                                                                <label for="file_name">Doc Name</label>
                                                                        ...
                                                                        <!--                                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">-->
                                                                        <!--                                                                    <div class="field-row field-row-autoheight">-->
                                                                        <!--                                                                        <strong>Federal </strong><input type="checkbox" name="federal_check" value="1" checked="checked">-->
                                                                        <!--                                                                    </div>-->
                                                                        <!--                                                                </div>-->
                                                                    </div>
                                                                </div>
                                                ...
                                                <input type="hidden" name="pre_id" id="pre_id" value="<?php echo $pre_sub_menu['sid']?>">
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-center hr-btn-panel">
                                                    <input type="submit" class="search-btn" id="form-submit" value="Update" name="form-submit">
                                                    <a class="search-btn black-btn" href="<?php echo $parent_type == 'sub_menu' ? base_url('manage_admin/documents_library/view_details/'.$menu_id) : base_url('manage_admin/documents_library/view_sub_heading/'.$lib_id. '/'. $menu_id); ?>">Cancel</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>

                                    <div class="add-new-company" id="edit_doc_form" style="display: none">
                                        <form action="" method="POST" autocomplete="off" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                    <div class="field-row">
                                                        <label for="edit_file_name">Doc Name <span class="hr-required">*</span></label>
                                                        <?php echo form_input('edit_file_name', set_value('edit_file_name'), 'class="hr-form-fileds" id="edit_file_name"'); ?>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                    <div class="field-row">
                                                        ...
                                                        <input type="number" name="edit_sort_order" class="hr-form-fileds" id="edit_sort_order">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                    <div class="field-row field-row-autoheight">
                                                        ...
                                                        <select class="invoice-fields" name="federal_check" id="edit_federal_check" >
                                                            <option value="1">Yes</option>
                                                            <option value="0">No</option>
                                                        </select>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                    <div class="field-row">
                                                        ...
                                                        <select class="invoice-fields" name="country" id="edit_country" data-attr="<?php echo $states; ?>">
                                                            <?php if(sizeof($active_countries)>0){?>
                                                                <option value="0">All</option>
                                                                <?php foreach ($active_countries as $active_country) { ?>
                                                                    <option value="<?= $active_country["sid"]; ?>" >
                                                ...
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                    <div class="field-row field-row-autoheight">
                                                        ...
                                                        <div class="hr-select-dropdown">
                                                            <select multiple="multiple" name="states[]" id="edit_state">
                                                                <?php   if (empty($country_id)) { ?>
                                                                    <option value="all">All States</option>
                                                                    <?php foreach ($active_states[$country_id] as $active_state) { ?>
                                                                        <option value="<?= $active_state["id"] ?>"
                                                ...
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                    <div class="field-row field-row-autoheight">
                                                        <label for="word_editor">Document Description</label>
                                                        <script type="text/javascript" src="<?php echo site_url('assets/ckeditor/ckeditor.js'); ?>"></script>
                                                        <textarea class="ckeditor textarea" name="word_editor" id="edit_doc_editor" rows="8" cols="60">
                                                            <?php echo set_value('word_editor'); ?>
                                                        </textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                    <div class="field-row field-row-autoheight">
                                                        ...
                                                        <div class="upload-file form-control">
                                                            <span class="selected-file" id="name_edit-file">No file selected</span>
                                                            <input name="edit-file" id="edit-file" onchange="check_edit_file('edit-file')" type="file">
                                                            <a href="javascript:;">Choose File</a>
                                                        </div>
                                                    </div>
                                            ...
                                            <!--<a href="javascript:void(0);" onclick="fLaunchModal(this);" >View</a>-->
                                                ...
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-center hr-btn-panel">
                                                    <input type="button" class="search-btn" id="edit-form-submit" value="Update Document" name="form-submit">
                                                    <input type="button" class="search-btn" id="cancel" value="Cancel">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                            ...
                                            <div class="add-new-company" id="generate_form" style="display: none">
                                                <form action="" method="POST" autocomplete="off" enctype="multipart/form-data">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                            <div class="field-row">
                                                                <label for="generate_file_name">Doc Name</label>
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                            <div class="field-row">
                                                                <label for="generate_sort_order">Sort Order</label>
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" id="upload-word-div"  style="display: none;">
                                                            <div class="hr-box">
                                                                <div class="hr-box-header"><h4 class="hr-registered">Uploaded Word Documents </h4></div>
                                                                <div class="hr-innerpadding">
                                                                    <div class="field-row field-row-autoheight">
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-center hr-btn-panel">
                                                            ...
                                                            <!--<input type="button" class="search-btn" id="generate-cancel" value="Cancel">-->
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var pre_selected = '<?php echo $pre_sub_menu['video_type']; ?>';
        ...
        var edit_select = $('#edit_state').selectize({
            plugins: ['remove_button'],
            delimiter: ',',
            persist: true,
            create: function(input) {
        ...
        $('.edit-file').click(function(){
            ...
            $('#edit_federal_check').val(federal);
            $('#edit_doc_editor').val(word_content);
            ...
            CKEDITOR.instances.edit_doc_editor.setData(word_content);
            $('#file-id').val(id);
            var states = $('#edit_country').attr('data-attr');
            var allstates = $.parseJSON(states)[country];
            edit_state_select.clearOptions();
            edit_state_select.load(function(callback) {
            ...
            if(country == 0 || country == 'all') {
                ...
                $.each(selected_job, function (i, item) {
                    edit_state_select.addItems(item);
                });
                edit_state_select.refreshItems();
            });
        ...
        $('.edit-word-doc').click(function(){
            ...
            $('#generate_country').val(country);
            $('#generate_file_name').val(name);
            $('#generate_sort_order').val(order);
            $('#generate_federal_check').val(federal);
            $('#word_editor').val(data_word);
            CKEDITOR.instances.word_editor.setData(data_word);
            $('#file-id').val(id);
            var states = $('#edit_country').attr('data-attr');
            var allstates = $.parseJSON(states)[country];
            gen_sel.clearOptions();
        ...
        var type = '<?php echo $pre_sub_menu['type']?>';
        ...
        $(document).on('click','.delete-file',function() {
            ...
            alertify.confirm('Confirmation', "Are you sure you want to disable this file?",
                function () {
                    $.ajax({
                        url: '<?= base_url('manage_admin/documents_library/delete_file_ajax') ?>',
                        type: 'post',
                        data: {
                            id: id,
                            action: 'disable'
                        ...
                        success: function(data){
                            alertify.success('File Disabled Successfully');
                            btn_obj.removeClass('btn-warning');
                            btn_obj.removeClass('delete-file');
                            btn_obj.addClass('enable-file');
                            btn_obj.addClass('btn-primary');
                            btn_obj.find('i').removeClass('fa-ban');
                            btn_obj.find('i').addClass('fa-shield');
                        },
                        error: function(){
                        }
                    });
        ...
        $(document).on('click','.delete-record',function() {
            ...
            alertify.confirm('Confirmation', "Are you sure you want to disable this file?",
                function () {
                    $.ajax({
                        url: '<?= base_url('manage_admin/documents_library/delete_record_ajax') ?>',
                        type: 'post',
                        data: {
                            id: id,
                            action: 'delete'
        ...
        $(document).on('click','.enable-file',function() {
            var id = $(this).attr('data-attr');
            var btn_obj = $(this);
            alertify.confirm('Confirmation', "Are you sure you want to enable this file?",
                function () {
                    $.ajax({
                        url: '<?= base_url('manage_admin/documents_library/delete_file_ajax') ?>',
                        type: 'post',
                        ...
                        success: function(data){
                            alertify.success('File Enabled Successfully');
                            btn_obj.removeClass('enable-file');
                            btn_obj.removeClass('btn-primary');
                            btn_obj.addClass('btn-warning');
                            btn_obj.addClass('delete-file');
                            btn_obj.find('i').removeClass('fa-shield');
                            btn_obj.find('i').addClass('fa-ban');
                        },
                        error: function(){
                        }
                    });
        ...
        $(document).on('click','#word-doc-submit',function() {
            ...
            $('#word-loader').show();
            $('#word-doc-submit').addClass('disabled-btn');
            $('#word-doc-submit').prop('disabled', true);
        ...
        $(document).on('click','#word-doc-edit',function(){
            var name = $('#generate_file_name').val();
            var sort_order = $('#generate_sort_order').val();
            var federal_check = $('#generate_federal_check').val();
            var country = $('#generate_country').val();
            ...
            $.ajax({
                url: '<?= base_url('manage_admin/documents_library/generate_edit_file') ?>',
                cache: false,
                contentType: false,
                processData: false,
                type: 'post',
                ...
                success: function(data){
                    ...
                    $('#word-doc-submit').removeClass('disabled-btn');
                    $('#word-doc-submit').prop('disabled', false);
                    alertify.success('Word document updated successfully');
        ...
        $('#edit-form-submit').click(function(){
            var file_data = $('#edit-file').prop('files')[0];
            var form_data = new FormData();
            form_data.append('edit-file', file_data);
            form_data.append('country', $('#edit_country').val());
            form_data.append('states' , $('#edit_state').val());
            form_data.append('federal_check' , $('#edit_federal_check').val());
            form_data.append('sort_order' , $('#edit_sort_order').val());
            form_data.append('file_name' , $('#edit_file_name').val());
            form_data.append('word_content' , $.trim(CKEDITOR.instances.edit_doc_editor.getData()));
            form_data.append('id' , $('#file-id').val());
            $('#edit-loader').show();
            $('#edit-form-submit').addClass('disabled-btn');
            ...
            $.ajax({
                ...
                success: function(data){
                    $('#edit-loader').hide();
                    $('#edit-form-submit').removeClass('disabled-btn');
    ...
    $(document).on('click','#delete-banner',function(){
        ...
        alertify.confirm('Confirmation', "Are you sure you want to delete this banner?",
            function () {
                $.ajax({
                    url: '<?= base_url('manage_admin/documents_library/delete_banner')?>',
                    data:{
                        id:id
                    },
                    type: 'POST',
                    success: function(){
                        ...
                        alertify.success('Banner Image Deleted Successfully');
                    },
                    error: function (){

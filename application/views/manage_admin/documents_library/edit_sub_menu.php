                                        ...
                                        <form action="" method="POST" id="add_ques" autocomplete="off" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div id="content-section">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                        <div class="field-row field-row-autoheight">
                                                            <label>Hybrid Documents :</label>
                                                            <?php if (sizeof($filesHybrid) > 0) {
                                                                foreach ($filesHybrid as $file) { ?>
                                                                    <div class="form-control full-width" style="height: auto; float: left;margin: 5px 0 0 0;">
                                                                        <div class="pull-left">
                                                                            <?php echo $file['sort_order'] ?>- <span class="uploaded-file-name"><a href="<?= AWS_S3_BUCKET_URL . $file['file_code'] ?>" download="<?php echo $file['file_name'] ?>"><?php echo $file['file_name'] ?></a></span>
                                                                        </div>
...
<script type="text/javascript">
    ...
    //
    function CancelUploadHybrid() {
        $('.hybrid-upload-file').show();

        if ($('#hybrid-uploaded-files').html() != '') {

                                ...
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-4">
                                            <a id="back_btn" href="<?php echo base_url('manage_admin/reports/compliance_reporting/view_compliance_questions/'.$inc_id)?>" class="btn btn-success"><i class="fa fa-arrow-left"> </i> Go Back</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="add-new-company">
                                        <form action="" method="POST" id="add_ques" autocomplete="off">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                    <div class="heading-title">
                                                        <h1 class="page-title"><?= $form == 'add' ? $sub_title : 'Update Compliance Question'?></h1>
                                                    </div>
                                                </div>

                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                    <div class="field-row field-row-autoheight">
                                                        <label for="label">Compliance Question<span class="hr-required">*</span></label>
...
//                                                                }
                                                ...
                                                <input type="hidden" name="compliance_type_id" value="<?= $inc_id?>">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#add_ques").validate({
            ...
            messages: {
                label: {
                    required: 'Compliance Question is required'
                },
                question_type: {
                    required: 'Compliance Question Type is required'
                },
                status: {
                    required: 'Compliance Question Status is required'
                },
                option: {
            ...
            submitHandler: function (form) {
                ...
                if (instances.length === 0) {
                    alertify.alert('Error! Question Missing', "Compliance Question cannot be Empty");
                    return false;
                }
                form.submit();
            }

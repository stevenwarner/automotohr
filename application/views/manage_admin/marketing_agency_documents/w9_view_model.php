<!-- Modal -->
<div id="w9_document_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header modal-header-bg">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="w9_document_modal_title">W9 Form</h4>
            </div>
            <div id="w9_document_modal_body" class="modal-body">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        <div class="btn-panel float-right">
                            <a target="_blank" href="<?php  echo base_url('manage_admin/marketing_agency_documents/print_download_w9_form').'/'.$pre_form['sid'].'/print'; ?>" class="btn btn-success float-right">Print</a>
                            <a target="_blank" href="<?php  echo base_url('manage_admin/marketing_agency_documents/print_download_w9_form').'/'.$pre_form['sid'].'/download'; ?>" class="btn btn-success" style="margin-right: 10px;">Download</a>
                        </div>
                    </div>
                </div>        
                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?php echo isset($pre_form) && !empty($pre_form) ? $pre_form['w9_name']: ''?>" name="w9_name" class="form-control" readonly/>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                        <div class="form-group">
                                            <label>2. Business name/disregarded entity name, if different from above. <span class="staric">*</span> </label>
                                            <input type="text" value="<?php echo isset($pre_form) && !empty($pre_form) ? $pre_form['w9_business_name']: ''?>" name="w9_business_name" class="form-control" readonly/>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                        <div class="form-group autoheight">
                                            ...
                                            <input type="text" name="w9_exemption_payee_code" value="<?php echo isset($pre_form) && !empty($pre_form) ? $pre_form['w9_exemption_payee_code']: ''?>" class="form-control" readonly />
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                        <div class="form-group autoheight">
                                            <label>Exemption from FATCA reporting code (if any)</label>
                                            <input type="text" name="w9_exemption_reporting_code" class="form-control" value="<?php echo isset($pre_form) && !empty($pre_form) ? $pre_form['w9_exemption_reporting_code']: ''?>" readonly/>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                        <div class="form-group autoheight">
                                            <label>5. Address (number, street, and apt. or suite no.) See instructions.</label>
                                            <input type="text" name="w9_address" class="form-control" value="<?php echo isset($pre_form) && !empty($pre_form) ? $pre_form['w9_address']: ''?>" readonly/>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                        <div class="form-group autoheight">
                                            <label>6. City, state, and ZIP code</label>
                                            <input type="text" name="w9_city_state_zip" class="form-control" value="<?php echo isset($pre_form) && !empty($pre_form) ? $pre_form['w9_city_state_zip']: ''?>" readonly/>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                        <div class="form-group autoheight">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-5 col-md-5 col-xs-12 col-sm-5">
                                                        <div class="form-group autoheight">
                                                            ...
                                                            <input type="text" name="w9_social_security_number" value="<?php echo isset($pre_form) && !empty($pre_form) ? $pre_form['w9_social_security_number']: ''?>" class="form-control" readonly/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-5 col-md-5 col-xs-12 col-sm-5">
                                                        <div class="form-group autoheight">
                                                            ...
                                                            <input type="text" name="w9_employer_identification_number" value="<?php echo isset($pre_form) && !empty($pre_form) ? $pre_form['w9_employer_identification_number']: ''?>" class="form-control" readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                        ...
                                                        <div class="col-xs-9">
                                                            ...
                                                            <?php } else { ?>
                                                                <a class="btn btn-success modal-button btn-sm get_signature" href="javascript:;">Create E-Signature</a>
                                                                <div class="img-full">
            ...
            <div id="w9_document_modal_footer" class="modal-footer">

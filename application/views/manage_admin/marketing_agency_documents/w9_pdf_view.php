...
<body class="A4">
    <section class="sheet padding-10mm" id="download_w9_form">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="vertical-align: bottom;">
                      <span><strong><small>Date ▶</small></strong></span><span> <?php echo !empty($pre_form['signature_timestamp']) ? DateTime::createFromFormat('Y-m-d H:i:s', $pre_form['signature_timestamp'])->format('M d Y') : ''; ?></span>
                    </td>
                </tr>
            </tbody>
        </table>

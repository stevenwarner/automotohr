                                ...
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="hr-add-new-promotions">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <?php if(empty($sid)){ ?>
                                                    <a class="site-btn" href="<?php echo site_url('manage_admin/'.$uri_segment);?>">Cancel</a> 
                                                <?php } else { ?> 
                                                    <a href="<?php echo site_url('manage_admin/'.$uri_segment.'/view_details/'.$sid);?>" class="site-btn">Cancel</a>
                                                <?php } ?>

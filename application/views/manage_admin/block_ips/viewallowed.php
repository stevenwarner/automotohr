                                    ...
                                    <div class="add-new-promotions">
                                        <div class="row">
                                            <div class="col-sm-12 col-xs-12">
                                                <a href="javascript:void(0)" type="button" class="btn btn-success pull-right js-ip-view" style="margin-left: 10px; display: none;">View White List IPs</a>
                                                <a href="javascript:void(0)" type="button" class="btn btn-success pull-right js-ip-add">Add New IP</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!--  -->
                                        ...
                                        <div class="col-xs-12">
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-bordered table-hover table-striped" id="js-ip-table">
                                                    <thead>
                                                        <tr>
                                                            <th class="col-xs-3">White List By</th>
                                                            <th class="col-xs-4">White List IP</th>
                                                            <th class="col-xs-4">White List At</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>

                ...
                <div class="col-lg-9 col-md-9 col-xs-12 col-sm-9 no-padding">
                    <div class="dashboard-content">
                        <div class="dash-inner-block">
                            ...
                            <div class="row">
                                <div class="heading-title page-title">
                                    ...
                                    <div class="col-sm-8 text-right">
                                        ...
                                        <?php if ($page["is_footer_link"]) { ?>
                                            <button class="btn btn-danger jsPageFooterLink" data-key="0">
                                                <i class="fa fa-ban"></i>
                                                &nbsp;
                                                Hide Link on Footer
                                            </button>
                                        <?php } else { ?>
                                            <button class="btn btn-success jsPageFooterLink" data-key="1">
                                                <i class="fa fa-shield"></i>
                                                &nbsp;
                                                 Show Link on Footer
                                            </button>
                            ...
                            <!-- Slider -->
                            <?php $this->load->view("manage_admin/cms/v1/partials/legal_hub_cp/section_0"); ?>
                        </div>
                    </div>
                </div>
            </div>

        ...
        <form action="javascript:void(0)" id="jsSection1Form">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <textarea rows="5" class="form-control" name="mainHeadingContent"><?= $contentToShow["mainHeadingContent"]; ?></textarea>
                </div>
                <div class="form-group">
                    <label>
                        Details (content)&nbsp;
                    ...
                    <textarea rows="5" class="form-control" name="detailsContent"><?= $contentToShow["detailsContent"]; ?></textarea>
                </div>

<div class="container">
    ...
    <div class="panel panel-default">
        ...
        <form id="jsEditTeamForm" action="javascript:void(0)">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <textarea id="detailsEditTeam" name="details" rows="10" class="form-control"><?= $data["details"]; ?></textarea>
                </div>
            ...
            <div class="panel-footer text-center">
                <button class="btn btn-success jsEditTeamBtn" type="submit">

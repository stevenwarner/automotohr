                ...
                <div class="form-group">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <input type="file" name="point1File" id="jsSection2Point1File" class="hidden" accept="<?= ALLOWED_EXTENSIONS; ?>" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <input type="file" name="point2File" id="jsSection2Point2File" class="hidden" accept="<?= ALLOWED_EXTENSIONS; ?>" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <input type="file" name="point3File" id="jsSection2Point3File" class="hidden" accept="<?= ALLOWED_EXTENSIONS; ?>" />
                        </div>
                    </div>
                </div>

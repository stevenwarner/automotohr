...
<div class="container">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control jsCarrierEin" value="<?= $carrier['ein']; ?>"/>
                </div>

                <!--  -->
                <div class="form-group">
                    <label class="csF16">What do you want to refer to this carrier as? <strong class="text-danger">*</strong></label>
                    <input type="text" class="form-control jsCarrierName" value="<?= $carrier['name']; ?>"/>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control jsCarrierNumber" value="<?= $carrier['code']; ?>"/>
                </div>

                <div class="form-group">
                    <label class="csF16">Carrier Logo <strong class="text-danger">*</strong></label>
                    <input type="text" id="jsOldCarrierAttachmentUpload" class="hidden" value="<?= $carrier['logo']; ?>"/>
        ...
        <div class="panel-footer text-right">
            <input type="hidden" class="jsKey" value="<?= $carrier['sid']; ?>" />
            <button class="btn csW csBG4 csF16 jsModalCancel">
                <i class="fa fa-times-circle csF16" aria-hidden="true"></i>
                &nbsp;Cancel
            </button>
            <button class="btn csW csBG3 csF16 jsBenefitCarrierUpdate">

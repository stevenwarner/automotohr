                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="hr-search-main search-collapse-area" <?php
                                                                                        ...
                                                                                        ?>>
                                        <form method="GET" action="<?php echo base_url('manage_admin/reports/new_hires_report'); ?>" name="search" id="search">
                                            <div class="row">
                                                ...
                                                <div class="field-row field-row-autoheight col-lg-12 text-right">
                                                    ...
                                                    <a class="btn btn-success" href="<?php echo base_url('manage_admin/reports/new_hires_report'); ?>">Reset Filters</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
...
<script>
    ...
    function generate_search_url() {
        ...
        var url = '<?php echo base_url('manage_admin/reports/new_hires_report'); ?>' + '/' + company_sid + '/' + start_date_applied + '/' + end_date_applied + '/' + brand_sid + '/' + all + '/' + keyword;

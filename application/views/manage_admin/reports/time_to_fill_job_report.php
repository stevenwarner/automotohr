                        ...
                        <div class="dash-inner-block">
                            <div class="row">                                
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    ?>>
                                        <form method="GET" action="<?php echo base_url('manage_admin/reports/time_to_fill_job_report'); ?>" name="search" id="search">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2 col-md-2 col-xs-12 col-sm-6 field-row field-row-autoheight">
                                                    <a class="btn btn-equalizer btn-block btn-success" href="<?php echo base_url('manage_admin/reports/time_to_fill_job_report'); ?>">Reset Filters</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
...
<script>
    ...
    function generate_search_url(){
        ...
        var url = '<?php echo base_url('manage_admin/reports/time_to_fill_job_report'); ?>' + '/' + company + '/' + brand + '/' + all ;

                        ...
                        <div class="dash-inner-block">
                            <div class="row">                                
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    ?>>
                                        <form method="GET" action="<?php echo base_url('manage_admin/reports/applicants_referrals_report'); ?>" name="search" id="search">
                                            <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
                                                                <label class="control control--radio">Company
                                                                    <input type="radio" name="company_or_brand" value="company" id="company" checked>
                                                                ...
                                                                <?php if (sizeof($companies) > 0) { ?>
                                                                    <select class="invoice-fields" name="company_sid" id="company_sid">
                                                                        ...
                                                                        <?php foreach ($companies as $active_company) { ?>
                                                                            <option <?php if (isset($search['company_sid']) && $search['company_sid'] == $active_company['sid']) { ?> selected="selected" <?php } ?> value="<?php echo $active_company['sid']; ?>">
                                                                ...
                                                                <?php if (sizeof($brands) > 0) { ?>
                                                                    <select class="invoice-fields" name="brand_sid" id="brand_sid">
                                                                        ...
                                                                        <?php foreach ($brands as $brand) { ?>
                                                                            <option <?php if (isset($search['brand_sid']) && $search['brand_sid'] == $brand['sid']) { ?>
                                                ...
                                                <div class="col-lg-2 col-md-2 col-xs-12 col-sm-6 field-row field-row-autoheight">
                                                    <a class="btn btn-equalizer btn-block btn-success" href="<?php echo base_url('manage_admin/reports/applicants_referrals_report'); ?>">Reset Filters</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                                                ...
                                                                <?php if (isset($references) && sizeof($references) > 0) { ?>
                                                                    <?php foreach ($references as $reference) { ?>
                                                                        <tr>
                                                                            ...
                                                                            <?php if (isset($search['company_or_brand']) && $search['company_or_brand'] == 'brand') { ?>
                                                                                <td><?php echo ucwords($reference['CompanyName']); ?></td>
                                                                            <?php } ?>
                                                                        </tr>
                                                                    <?php } ?>
                                                                <?php } else { ?>
...
<script>
    ...
    $(document).ready(function () {
        var div_to_show = $('input[name="company_or_brand"]').val();
        var search = '<?php echo isset($search['company_or_brand']) ? $search['company_or_brand'] : ''; ?>';
        if (search != '') {
            div_to_show = search;
        }
        display(div_to_show);

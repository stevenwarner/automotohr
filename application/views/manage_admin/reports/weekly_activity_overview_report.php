                                        ...
                                        <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
                                            <div class="field-row field-row-autoheight">
                                                <button class="btn btn-success btn-equalizer btn-block"
                                                        onclick="get_activity_overview_report();">Get Report
                                                </button>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    function get_activity_overview_report() {
        ...
        if (week_span != '' && week_span != null && week_span != undefined) {
            ...
            var my_request;
            var my_url = '<?php echo base_url('manage_admin/reports/weekly_activity_overview_report/ajax_responder'); ?>';

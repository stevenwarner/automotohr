                        ...
                        <div class="dash-inner-block">
                            <div class="row">                                
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    ?>>
                                        <form method="GET" action="<?php echo base_url('manage_admin/reports/job_categories_report'); ?>" name="search" id="search">
                                            <div class="row">
...
<!--                                                    <input type="submit" class="btn btn-equalizer btn-block btn-success" value="Apply Filters" name="submit" id="apply_filters_submit">-->
                                                ...
                                                <div class="col-lg-2 col-md-2 col-xs-12 col-sm-6 field-row field-row-autoheight">
                                                    <a class="btn btn-equalizer btn-block btn-success" href="<?php echo base_url('manage_admin/reports/job_categories_report'); ?>">Reset Filters</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
...
<!--                                                                    <th class="col-xs-1 text-center">Company Name</th>-->
<!--                                                                --><?php //} ?>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
...
<!--                                                                        --><?php //if ($company_or_brand == 'brands' || $company_or_brand == 'all' ) { ?>
<!--                                                                            <td>--><?php //echo ucwords($category['Title']); ?><!--</td>-->
<!--                                                                        --><?php //} ?>
                                                                    </tr>
                                                                <?php } ?>
                                                            <?php } else { ?>
...
//                                                                        }
                                                                    ?>3">
                                                                        ...
                                                                        <?php } else if (isset($categories) && sizeof($categories) <= 0) { ?>
...
<script>
    ...
    function generate_search_url(){
        ...
        var url = '<?php echo base_url('manage_admin/reports/job_categories_report'); ?>' + '/' + company + '/' + brand + '/' + all ;

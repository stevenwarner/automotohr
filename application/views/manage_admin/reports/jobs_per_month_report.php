                        ...
                        <div class="dash-inner-block">
                            <div class="row">                                
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    ?>>
                                        <form method="GET" action="<?php echo base_url('manage_admin/reports/jobs_per_month_report'); ?>" name="search" id="search">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 field-row field-row-autoheight">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-xs-8 col-sm-4">
                                                        <div class="hr-select-dropdown">
                                                            <select class="invoice-fields" name="year" id="year">
                                                                <?php $year = $this->uri->segment(7) != 'all' ? urldecode($this->uri->segment(7)) : '';?>
...
<!--                                                    <input type="submit" class="btn btn-success" value="Apply Filters" name="submit" id="apply_filters_submit">-->
                                                    ...
                                                    <a class="btn btn-success" href="<?php echo base_url('manage_admin/reports/jobs_per_month_report'); ?>">Reset Filters</a>
                                                </div>                                             
                                            </div>
                                        </form>
                                    </div>
                                                                    ...
                                                                    <table class="table table-bordered table-stripped table-hover">
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <?php if ($company_or_brand == 'brands') { ?>
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <?php if (!empty($jobList)) { ?>
                                                                                <?php foreach ($jobList as $job){?>
                                                                                    <tr>
                                                                                        <td style="color:<?php echo (($job['Title'] != 'Job Deleted' && $job['Title'] != '') ? 'green' : 'red'); ?>">
                                                                                        <?php
                                                                                           $city = '';
                                                                                           $state='';
                                                                                            ...
                                                                                            echo ($job['Title'] != '' ? $job['Title'].$city.$state : 'Job Removed From System'); 
                                                                                         ?>
                                                                                        </td>
                                                                                        <td class="">  <?php echo date_with_time($job['hired_date']); ?></td>
                                                                                        <?php if ($company_or_brand == 'brands') { ?>
                                                ...
                                                <div class="hr-box">
                                                    <div class="table-responsive hr-innerpadding">
                                                        <table class="table table-bordered table-stripped table-hover">
                                                            ...
                                                            <tbody>
                                                                <tr><td class="text-center" colspan="2"><div class="no-data">Please select company.</div></td></tr>
                                                            </tbody>
                                                        </table>                                                        
                                                    </div>
                                                </div>
...
<script>
    ...
    function generate_search_url(){
        ...
        status = status != '' && status != null && status != undefined && status != 0 ? encodeURIComponent(status) : 0;
        year = year != '' && year != null && year != undefined && year != 0 ? encodeURIComponent(year) : 'all';
        ...
        var url = '<?php echo base_url('manage_admin/reports/jobs_per_month_report'); ?>' + '/' + company + '/' + brand + '/' + status + '/' + year;

                        ...
                        <div class="dash-inner-block">
                            <div class="row">                                
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    ?>>
                                        <form method="GET" action="<?php echo base_url('manage_admin/reports/job_views_report'); ?>" name="search" id="search">
                                            <div class="row">
                                                <!-- radio buttons -->
...
<!--                                                    <input type="submit" class="btn btn-equalizer btn-block btn-success" value="Apply Filters" name="submit" id="apply_filters_submit">-->
                                                ...
                                                <div class="col-lg-2 col-md-2 col-xs-12 col-sm-6 field-row field-row-autoheight">
                                                    <a class="btn btn-equalizer btn-block btn-success" href="<?php echo base_url('manage_admin/reports/job_views_report'); ?>">Reset Filters</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                                        ...
                                                        <tbody>
                                                            <?php if (isset($all_jobs) && !empty($all_jobs)) {  ?>
                                                                <?php foreach ($all_jobs as $job) { ?>
                                                                    <tr>
                                                                        <td><?php echo convert_date_to_frontend_format($job['activation_date']); ?></td>
                                                                        <td>
                                                                            <?php
                                                                                $city = '';
                                                                                $state='';
                                                                                    ...
                                                                                    echo ucwords($job['Title']).$city.$state; 
                                                                            ?>
                                                                         </td>
                                                                        <?php if ($company_or_brand == 'brands' || $company_or_brand == 'all') { ?>
                                                                            <td><?php echo ucwords($job['company_title']); ?></td>
                                                                        <?php } ?>
                                                                        <?php if($job['active'] == 0) { ?>
...
<script>
    ...
    function generate_search_url(){
        ...
        var url = '<?php echo base_url('manage_admin/reports/job_views_report'); ?>' + '/' + company + '/' + brand + '/' + all ;

                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="hr-search-main search-collapse-area" <?php
                                                                                        ...
                                                                                        ?>>
                                        <form method="GET" action="<?php echo base_url('manage_admin/reports/applicant_status_report'); ?>" name="search" id="search">
                                            <div class="row">
                                                                ...
                                                                <?php if (sizeof($brands) > 0) { ?>
                                                                    <select class="invoice-fields" name="brand_sid" id="brand_sid">
                                                                        ...
                                                                        <?php foreach ($brands as $brand) { ?>
                                                                            <option <?php if ($this->uri->segment(11) == $brand['sid']) { ?> selected="selected" <?php } ?> value="<?php echo $brand['sid']; ?>">
                                                ...
                                                <div class="field-row field-row-autoheight">
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                        <div class="row">
                                                            <div class="col-lg-4 col-md-4 col-xs-12 col-sm-4">
                                                                <label class="valign-middle">Keyword</label>
                                                            </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                        <div class="row">
                                                            <div class="col-lg-4 col-md-4 col-xs-12 col-sm-4">
                                                                <label class="valign-middle">Applicant Status</label>
                                                            </div>
                                                            <div class="col-lg-8 col-md-8 col-xs-12 col-sm-8">
                                                                ...
                                                                <div class="hr-select-dropdown">
                                                                    <select name="applicant_status" id="applicant_status" class="invoice-fields">
                                                                        ...
                                                                        <!--                                                                            <option --><?php //echo $applicant_status == 'all' ? 'selected="selected"' : ''; 
                                                                                                                                                                    ?>
                                                ...
                                                <div class="field-row field-row-autoheight col-lg-12 text-right">
                                                    ...
                                                    <a class="btn btn-success" href="<?php echo base_url('manage_admin/reports/applicant_status_report'); ?>">Reset Filters</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                                                ...
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <?php if ($company_or_brand == 'brands' || $company_or_brand == 'all') { ?>
                                                                            <th class="col-xs-3 col-sm-3 col-md-3 col-lg-3">Company Name</th>
                                                                        <?php } ?>
                                                                    ...
                                                                    <?php if (isset($applicants) && !empty($applicants)) { ?>
                                                                        <?php foreach ($applicants as $applicant) { ?>
                                                                            <tr>
                                                                                ...
                                                                                <!--                                                                                    <td>--><?php //echo date('m-d-Y', strtotime(str_replace('-', '/', $applicant['date_applied']))); 
                                                                                                                                                                                ?>
                                                                                <!--</td>-->
                                                                                <td><?php echo ucwords($applicant['first_name'] . ' ' . $applicant['last_name']); ?></td>
                                                                                <td style="color:<?php echo ($applicant['Title'] != 'Job Deleted' ? 'green' : 'red'); ?>">
                                                                                    <?php
                                                                                    $city = '';
                                                                                    $state = '';
                                                                                    ...
                                                                                    echo ($applicant['Title'] != '' ? $applicant['Title'] . $city . $state : 'Job Removed From System'); ?></td>
...
<script>
    ...
    function generate_search_url() {
        ...
        if (all == 1 || brand_sid != 'all') {
            applicant_status = 'all';
        }

        var url = '<?php echo base_url('manage_admin/reports/applicant_status_report'); ?>' + '/' + company_sid + '/' + keyword + '/all/all/' + applicant_status + '/' + start_date_applied + '/' + end_date_applied + '/' + brand_sid + '/' + all;
    ...
    $(document).ready(function() {
        ...
        if (div_to_show == 'brand') {
            ...
            $('#company_sid').removeProp('disabled', 'disabled');
            $('#brand_sid').removeProp('disabled', 'disabled');
            $('#applicant_status').removeProp('disabled', 'disabled');
            load_statuses();
        } else {

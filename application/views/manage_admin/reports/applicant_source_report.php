                                                            ...
                                                            <?php if (sizeof($brands) > 0) { ?>
                                                                <select class="invoice-fields" name="brand_sid" id="brand_sid">
                                                                    ...
                                                                    <?php foreach ($brands as $brand) { ?>
                                                                        <option <?php if ($this->uri->segment(11)!= 'all' && urldecode($this->uri->segment(11)) == $brand['sid']) { ?>
                                    ...
                                    <div class="hr-box">
                                        ...
                                        <div class="table-responsive hr-innerpadding" id="print_div">
                                            <table class="table table-bordered" id="example">
                                                ...
                                                <tbody>
                                                    <?php if (isset($applicants) && sizeof($applicants) > 0) { $count = 0;?>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('body').on('change', '#company_sid', function(){
            ...
            var my_data = {'company_sid': selected, 'perform_action': 'load_jobs'};
            var myRequest = $.ajax({
                type: "POST",
...
//        var url = '<?php //echo base_url('manage_admin/reports/applicant_source_report'); ?>//' + '/' + company_sid + '/' + keyword + '/' + job_sid + '/' + applicant_type + '/all/' + start_date_applied + '/' + end_date_applied + '/' + brand_sid + '/' + all + '/' + source;

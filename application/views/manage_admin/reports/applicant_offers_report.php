                        ...
                        <div class="dash-inner-block">
                            <div class="row">                                
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    ?>>
                                        <form method="GET" action="<?php echo base_url('manage_admin/reports/applicant_offers_report'); ?>" name="search" id="search">
                                            <div class="row">
...
<!--                                                    <input type="submit" class="btn btn-success" value="Apply Filters" name="submit" id="apply_filters_submit">-->
                                                    ...
                                                    <a class="btn btn-success" href="<?php echo base_url('manage_admin/reports/applicant_offers_report'); ?>">Reset Filters</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                            ...
                                            <div class="hr-box">
                                                <div class="hr-box-header bg-header-green">
                                                    <span class="pull-left">
                                                        <h1 class="hr-registered">Offers Report</h1>
                                                    </span>
                                                    ...
                                                    <table class="table table-bordered table-stripped table-hover">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="col-xs-2 col-sm-2 col-md-2 col-lg-2">Job Title</th>
                                                                ...
                                                                <?php if ($company_or_brand == 'brands' || $company_or_brand == 'all') { ?>
                                                                    <th class="col-xs-2 col-sm-2 col-md-2 col-lg-2">Company Name</th>
                                                                <?php } ?>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <?php if (isset($applicants) && !empty($applicants)) { ?>
                                                                ...
                                                                <tr>
                                                                    <td><?php echo date_with_time($candidate['registration_date']); ?></td>
                                                                    <td style="color:<?php echo ($candidate['job_title'] != 'Job Deleted' ? 'green' : 'red'); ?>">
                                                                    <?php
                                                                            $city = '';
                                                                            $state='';
                                                                    ...
                                                                    echo ($candidate['job_title'] != 'Job Deleted' ? $candidate['job_title'].$city.$state : 'Job Removed From System'); ?></td>
                                                                    ...
                                                                    <?php if ($company_or_brand == 'brands' || $company_or_brand == 'all') { ?>
                                                                    <td><?php echo ucwords($candidate['CompanyName']); ?></td>
                                                                    <?php } ?>
                                                                </tr>
                                                                <?php } ?>
                                                            <?php } else { ?>
...
<script>
    ...
    function generate_search_url(){
        ...
        var url = '<?php echo base_url('manage_admin/reports/applicant_offers_report'); ?>' + '/' + company_sid + '/' + start_date_applied + '/' + end_date_applied + '/' + brand_sid + '/' + all + '/' + keyword;

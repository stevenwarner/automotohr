                        ...
                        <div class="dash-inner-block">
                            <div class="row">                                
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    ?>>
                                        <form method="GET" action="<?php echo base_url('manage_admin/reports/applicants_between_period_report'); ?>" name="search" id="search">
                                            <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-xs-12 col-sm-9">
                                                            <div class="hr-select-dropdown">
                                                                <?php if (sizeof($brands) > 0) { ?>
                                                                    <?php $oem = $this->uri->segment(7) != 'all' ? urldecode($this->uri->segment(7)) : '';?>
                                                ...
                                                <div class="field-row field-row-autoheight col-lg-12 text-right">
                                                    ...
                                                    <a class="btn btn-success" href="<?php echo base_url('manage_admin/reports/applicants_between_period_report'); ?>">Reset Filters</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                                                    ...
                                                                    <tbody>
                                                                        <?php if (isset($applicants) && sizeof($applicants) > 0) { ?>
                                                                            <?php foreach ($applicants as $applicant) { ?>
                                                                                <tr>
                                                                                    <td style="color:<?php echo (($applicant['Title'] != 'Job Deleted' && $applicant['Title'] != 'Job Not Applied') ? 'green' : 'red'); ?>">
                                                                                    <?php 
                                                                                    $city = '';
                                                                                    $state='';
...
<script>
    ...
    function generate_search_url(){
        ...
        var url = '<?php echo base_url('manage_admin/reports/applicants_between_period_report'); ?>' + '/' + company_sid + '/' + start_date_applied + '/' + end_date_applied + '/' + brand_sid + '/' + all + '/' + keyword;

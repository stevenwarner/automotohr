                                ...
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="heading-title page-title">
                                        ...
                                        <?php if ($this->uri->segment(2) == 'free_demo') { ?>
                                            <a id="back_btn" href="<?php echo base_url('manage_admin/enquiry_message_details/'.$reply[0]["demo_sid"])?>" class="black-btn pull-right"><i class="fa fa-arrow-left"> </i> Go Back</a>
                                        <?php } else if ($this->uri->segment(2) == 'referred_clients') { ?>
                                            <a id="back_btn" href="<?php echo base_url('manage_admin/referred_clients/enquiry_message_details/'.$reply[0]["demo_sid"])?>" class="black-btn pull-right"><i class="fa fa-arrow-left"> </i> Go Back</a>
                                        <?php } ?> 
                                    </div>

                        ...
                        <div class="dash-inner-block">
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <?php if ($this->uri->segment(2) == 'free_demo') { ?>
                                    ...
                                    <?php } else { ?>
                                        <a class="site-btn" href="<?php echo site_url('manage_admin/referred_clients/add_demo_request');?>"> Add Potential Client </a>
                                    <?php } ?>    
                                    <div class="hr-box">
                                                ...
                                                <table class="table">
                                                    ...
                                                    <?php foreach ($messages as $message) { 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php if ($page == 'inbox') { ?>
                                                                <?php if ($this->uri->segment(2) == 'free_demo') { ?>
                                                                    <td><a href="<?php echo base_url('manage_admin/enquiry_message_details'); ?>/<?= $message["sid"] ?>"><input type="button" class="site-btn" value="View Details"></a></td>
                                                                <?php } else if ($this->uri->segment(2) == 'referred_clients') { ?>
                                                                    <td><a href="<?php echo base_url('manage_admin/referred_clients/enquiry_message_details'); ?>/<?= $message["sid"] ?>"><input type="button" class="site-btn" value="View Details"></a></td>
                                                                <?php } ?>
                                                            <?php } ?>
                                                            <!--                                                            <td><input type="button" id="<?php echo $message["sid"]; ?>" onclick="todo('delete', this.id);" class="hr-delete-btn" value="DELETE"></td>-->
                                                        </tr>
                                                    <?php } ?>
                                                    <tr>

                                ...
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 text-right">
                                            <a target="_blank" class="btn btn-success" href="<?php echo base_url('manage_admin/financial_reports/print_monthly_marketplace_products_sales')."/". $vendor . "/" . $year . "/" . $month; ?>">Print</a>

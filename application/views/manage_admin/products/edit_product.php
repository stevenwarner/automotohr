                                    ...
                                    <div class="hr-add-new-promotions">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <input type="hidden" value="<?= $edit_data['product_image'] ?>" name="old_picture">
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                <div class="hr-fields-wrap">
                                                    <div class="hr-half-width-field">
                                                        <?php echo form_input('cost_price', set_value('cost_price', $edit_data['cost_price']), 'class="hr-form-fileds"'); ?>
                                                        <!--<small>Leave empty or zero for free</small>-->
                                            ...
                                            <?php if (in_array('full_access', $security_details) || in_array('activate_deactivate_products', $security_details)) { ?>
                                                <li>
                                                    <label>Active</label>
                                                    <div class="hr-fields-wrap registration-date">
                                                        <div class="hr-register-date">
                                            ...
                                            <?php } else { ?>
                                                <?php if ($edit_data['active'] == 'checked') { ?>
                                            ...
                                            <li><input type="submit" value="Update Product" class="site-btn"></li>
                                        </ul>
                                        </form>
                                    </div>
                                </div>

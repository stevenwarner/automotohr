                                        ...
                                        <form id="form_add_edit_member_company" action="<?php echo current_url(); ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                    ...
                                                    <?php } ?>
                                                        <input type="hidden" name="company_is_registered" id="company_is_registered" value="no">
                                                    <a class="black-btn btn full-on-small" href="<?php echo base_url('manage_admin/corporate_groups/member_companies/' . $automotive_group['sid']); ?>">Cancel</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>

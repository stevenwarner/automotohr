                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                        <div class="field-row">
                                                            ...
                                                            <input data-rule-email="true" type="email" id="email" name="email" value="<?php echo set_value('email', $temp); ?>" class="hr-form-fileds" />
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                        <div class="field-row field-row-autoheight">
                                                            ...
                                                            <?php echo form_textarea('address', set_value('address', $temp), 'class="hr-form-fileds field-row-autoheight" autocomplete="off"'); ?>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                        <div class="field-row">
                                                            ...
                                                            <select class="invoice-fields" name="access_level">
                                                                <?php $level = isset($marketing_agency['access_level']) ? $marketing_agency['access_level'] : ''?>
                                                                <?php foreach($user_groups as $group){
                                                                    $selected = $level == ucwords($group['name']) ? 'selected="selected"' : '';
                                                                    echo '<option value="'.ucwords($group['name']).'" '.$selected.'>'.ucwords($group['name']).'</option>';
                                                                }?>
                                                            </select>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 text-right">
                                                        <div class="field-row">
                                                            ...
                                                            <?php } ?>
                                                            <a href="<?php echo base_url('manage_admin/marketing_agencies/get_agency_users/'.$this->uri->segment(5)); ?>" class="btn black-btn">Cancel</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>

                                                                ...
                                                                <?php if (!empty($pending_jobs)) { ?>
                                                                    <?php foreach ($pending_jobs as $pending_job) { ?>
                                                                        <tr>
                                                                            ...
                                                                            <td class="col-xs-1">
                                                                                <button type="button"
                                                                                        onclick="func_activate_job_on_feed(<?php echo $pending_job['sid']; ?>);"
                                                                                        id="btn_activate_job_feed"
                                                                                        class="btn btn-success btn-block btn-sm">Activate
                                                                                </button>
                                                                                <form id="form_activate_job_on_feed_<?php echo $pending_job['sid']; ?>"
                                                                                    ...
                                                                                    <input type="hidden"
                                                                                           id="perform_action"
                                                                                           name="perform_action"
                                                                                           value="activate_job_on_feed"/>
                                                                                    <input type="hidden"
                                                                                           id="company_sid"
                                                                                           name="company_sid"
                                                                                           value="<?php echo $pending_job['company_sid']; ?>"/>
                                                                                    <input type="hidden" id="job_sid"
                                                                                           name="job_sid"
                                                                                           value="<?php echo $pending_job['job_sid']; ?>"/>
                                                                                    <input type="hidden"
                                                                                           id="product_sid"
                                                                                           name="product_sid"
                                                                                           value="<?php echo $pending_job['product_sid']; ?>"/>
                                                                                    <input type="hidden"
                                                                                           id="no_of_days"
                                                                                           name="no_of_days"
                                                                                           value="<?php echo $pending_job['no_of_days']; ?>"/>
                                                                                    <input type="hidden"
                                                                                           id="jobs_to_feed_sid"
                                                                                           name="jobs_to_feed_sid"
                                                                                           value="<?php echo $pending_job['sid']; ?>"/>
                                                                                </form>
                                                                            </td>
                                                                            <td class="col-xs-1">
                                                                                <button type="button"
                                                                                        id="btn_refund_product"
                                                                                        onclick="func_refund_product(<?php echo $pending_job['sid']; ?>);"
                                                                                        class="btn btn-info btn-block btn-sm">Refund</button>
                                                                                <form id="form_refund_product_<?php echo $pending_job['sid']; ?>"
                                                                                      enctype="multipart/form-data"
                                                                                      method="post"
                                                                                      action="<?php echo current_url(); ?>">
                                                                                    <input type="hidden"
                                                                                    ...
                                                                                    <input type="hidden"
                                                                                           id="employer_sid"
                                                                                           name="employer_sid"
                                                                                           value="<?php echo $pending_job['employer_sid']; ?>"/>
                                                                                </form>
                                                                            </td>
                                                                            <td class="col-xs-1">

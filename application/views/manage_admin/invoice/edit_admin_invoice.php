                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <div class="hr-fields-wrap">
                                                        ...
                                                        <input class="hr-form-fileds datepicker" type="text" name="created" value="<?php echo set_value('created', date('m-d-Y', $created)); ?>" />
                                                ...
                                                <?php if ($payment_status == 'paid') { ?>
                                                    <li>
                                                        ...
                                                        <div class="hr-fields-wrap">
                                                            ...
                                                            <input class="hr-form-fileds datepicker" type="text" name="payment_date" value="<?php echo set_value('payment_date', date('m-d-Y', $payment_date)); ?>" />
                                                    ...
                                                    <?php if (strtolower($payment_method) == 'check') { ?>
                                                        <li>
                                                            ...
                                                            <div class="hr-fields-wrap">
                                                                ...
                                                                <input class="hr-form-fileds datepicker" type="text" name="check_number" value="<?php echo set_value('check_number', $check_number); ?>" />
                                                    ...
                                                    <?php if (strtolower($payment_method) == 'credit-card') { ?>
                                                        <li>
                                                            ...
                                                            <div class="hr-fields-wrap">
                                                                ...
                                                                <input class="hr-form-fileds" type="text" name="credit_card_number" value="<?php echo set_value('credit_card_number', $credit_card_number); ?>" />
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="hr-fields-wrap">
                                                            ...
                                                            <input class="hr-form-fileds datepicker" type="text" name="payment_description" value="<?php echo set_value('payment_description', $payment_description); ?>" />

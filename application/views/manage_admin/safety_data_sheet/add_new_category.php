                                ...
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-4">
                                            <a id="back_btn" href="<?php echo base_url('manage_admin/safety_data_sheet/category_management')?>" class="btn btn-success"><i class="fa fa-arrow-left"> </i> Go Back</a>
                                        </div>
                                    </div>
                                        ...
                                        <form action="" method="POST" id="add_cat">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-center hr-btn-panel">
                                                    <input type="submit" class="search-btn" value="<?php echo isset($category) ? 'Update Category' : 'Add Category'; ?>" name="form-submit">
                                                </div>
                                            </div>
                                        </form>
                                    </div>

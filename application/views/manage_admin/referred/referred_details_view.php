                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="heading-title page-title">
                                        <h1 class="page-title"><i class="glyphicon glyphicon-envelope"></i>Referral Reply Details</h1>
                                        <a id="back_btn" href="<?php echo base_url('manage_admin/referred_clients/view_details/'.$reply[0]["referred_sid"])?>" class="black-btn pull-right"><i class="fa fa-arrow-left"> </i> Go Back</a> 
                                    </div>

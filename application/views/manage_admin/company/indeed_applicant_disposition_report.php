                                        ...
                                        <form action="<?= current_url(); ?>" type="GET" id="js-indeedform">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <input type="text" name="applicantname"  class="form-control"  value="<?= $filter["applicantName"]; ?>" />
                                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 text-right">
                                                    ...
                                                    <a class="btn btn-default" href="<?= base_url("indeed_applicant_disposition_report"); ?>">

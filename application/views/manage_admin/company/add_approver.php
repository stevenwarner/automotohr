                                ...
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="edit-email-template">
                                        ...
                                        <div class="edit-template-from-main">
                                            <?php echo form_open('javascript:void(0)', array('class' => 'form-horizontal js-form','id'=> 'approver_add')); ?>
                                            <ul>
                                                            ...
                                                            <?php
                                                                if(sizeof($employees)){
                                                                    foreach ($employees as $k => $v) {
                                                                        ...
                                                                        echo '<option  value="'.( $v['sid'] ).'">'.( $text ).'</option>';
                                                                    }
                                                                } 
                                                            ?>
                                                        </select>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="hr-fields-wrap">
                                                        <label class="control control--radio">
                                                            <input type="radio" value="yes"  name="archive" /> Yes &nbsp;
                                                            <div class="control__indicator"></div>
                                                        </label>
                                                        <label class="control control--radio">
                                                            <input type="radio" value="no" checked="true" name="archive" /> No
                                                            <div class="control__indicator"></div>
                                                        </label>
                                                    </div>
                                                </li>
...
<script>
    $(function(){
        ...
        //
        $('#approver_add').submit(function(e){
            e.preventDefault();
            //
            var megaOBJ = {};
            ...
            loader(true);
            //
            $.post("<?=base_url('manage_admin/companies/add_approver_process');?>", 
                megaOBJ, 
                function(resp) {
                    loader();
                    ...
                    alertify.alert('SUCCESS!', resp.Response, function(){
                        window.location.href = "<?=base_url('manage_admin/companies/timeoff_approvers/'.( $companySid ).'');?>";
                    });

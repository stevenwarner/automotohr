                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="heading-title page-title">
                                        ...
                                        <a href="<?php echo base_url('manage_admin/additional_content_boxes/'.$company_sid) ?>" class="black-btn pull-right"><i class="fa fa-long-arrow-left"></i> Back</a>
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                    <div class="field-row">
                                                        ...
                                                        <?php echo form_input('video', set_value('video'), 'class="hr-form-fileds video-url"'); ?>
                                                    ...
                                                    <div class="field-row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
                                                                <input id="video_id" type="radio" name="show_video_or_image" value="video"> <label for="video_id">Video</label> </input>
                                                            </div>
                                                            <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
                                                                <input id="image_id" type="radio" name="show_video_or_image" value="image" checked="checked"> <label for="image_id">Image</label> </input>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>

                                                <input name="company_sid" value="<?= $company_sid?>" type="hidden">
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-center hr-btn-panel">
                                                    <input type="submit" class="search-btn pull-right" value="Save" name="box_submit">
                                                </div>

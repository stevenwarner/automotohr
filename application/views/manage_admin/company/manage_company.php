                                                            ...
                                                            <form enctype="multipart/form-data" method="post" action="<?php //base_url('manage_admin/companies/manage_company/') ?>" >
                                                                ...
                                                                <ul>
                                                                    <li class="lineheight">
                                                                        <div class="row">
                                                                            <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                                                                                <input type="radio" id="powered_by_active" name="footer_powered_by_logo" value="1" <?php //echo ($company_portal_status['footer_powered_by_logo'] == 1 ? 'checked="checked"' : '' ); ?> />&nbsp;<label for="powered_by_active" style="color: green; float: none;">Enable</label>
                                                                            </div>
                                                                            <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                                                                                <input type="radio" id="powered_by_inactive" name="footer_powered_by_logo" value="0" <?php //echo ($company_portal_status['footer_powered_by_logo'] == 0 ? 'checked="checked"' : '' ); ?> />&nbsp;<label for="powered_by_inactive" style="color: red; float: none;">Disable</label>
                                                                            </div>
                                                                            <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                                                                <button type="submit" href="javascript:;" class="site-btn pull-right">update</button>
                                                                            </div>

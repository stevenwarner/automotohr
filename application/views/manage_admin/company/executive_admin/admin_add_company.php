                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="add-new-company">
                                        <form action="" method="POST" name='edit_admin' id='edit_admin'>
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                    <div class="heading-title page-title">
                                                        <h1 class="page-title">Administrator Companies</h1>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                    <div class="field-row">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-center hr-btn-panel">
                                                    <a href='<?php echo base_url().'manage_admin/companies/manage_executive_administrators/'.$admin_id; ?>' class="search-btn black-btn">Cancel</a>
                                                    <input type="submit" class="search-btn" value="Add Company" name="submit" onclick="return validate_form();">                        
                                                </div>                                        
                                            </div>
                                        </form>
                                    </div>

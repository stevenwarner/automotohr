                                        ...
                                        <div class="hr-displayResultsTable">
                                            <div class="hr-box-header">
                                                <div class="hr-items-count">
                                                    <strong class="employerCount"><?php echo count($administrators); ?></strong> Executive Admins
                                                </div>
                                                ...
                                                <div class="hr-actionSelected">
                                                    <select name="selectedAction_header" id="top_select_box">
                                                        ...
                                                        <option value="1" class="activate_all">Mark Admin Plus</option>
                                                        <option value="0" id="deactivate_all">Unmark Admin Plus</option>
                                                    </select>
            ...
            if (action) {
                if ($(".my_checkbox:checked").size() > 0) {
                    alertify.confirm('Please confirm ' + action, popup_msg,
                        function() {
                            $('#multiple_actions_company').append('<input type="hidden" name="action" value="' + action + '" />');
                            $("#multiple_actions_company").submit();
                    ...
                    alertify.alert('Error! No  selected', 'Please Select at-least one Executive Admin');
                }
            } else {

...
<style>
    ...
    #js-applicant-list-block{ display: none; }
    ...
    $(function copyApplicants(){
        ...
        function fetchJobEvent(e){
            ...
            if(obj.fromCompanyId == 0){
                alertify.alert('ERROR!', 'From company is mandatory.'); return;
            }
            if(obj.toCompanyId == 0){
                alertify.alert('ERROR!', 'To company is mandatory.'); return;
            }
            if(obj.fromCompanyId === obj.toCompanyId){
                alertify.alert('ERROR!', 'From and To company can not be same.'); return;
            }
        ...
        // moveApplicantByJobId_new added on 12/18/2019
         ...
         if(paginate.selectedApplicants.currentApplicant == paginate.selectedApplicants.totalApplicants){
              ...
              paginate.Applicant_Selected.totalRecords = paginate.Applicant_Selected.totalApplicants
                     = paginate.Applicant_Selected.currentApplicant = paginate.Applicant_Selected.existedApplicants
                     = paginate.Applicant_Selected.failedApplicants = paginate.Applicant_Selected.copiedApplicants
                     = 0;
            //  loadCopiedApplicantsReport(); applicant_info_array
        ...
        function moveApplicantByJobId(job){
            ...
            $.post(baseURI+'copy-job-with-applicants', job, function(resp, textStatus) {
                ...
                if(paginate.applicant.currentPage <= paginate.applicant.totalPages){
                    ...
                    //
                    paginate.applicant.totalRecords = paginate.applicant.totalPages
                    = paginate.applicant.currentPage = paginate.applicant.existedApplicants
                    = paginate.applicant.failedApplicants = paginate.applicant.copiedApplicants
                    = 0;
                    //
        ...
        function makeJobView(records, page){
            ...
            $.each(records, function(i, v) {
                ...
                rows += '   <td>'+( v.sid )+'</td>';
                rows += '   <td class="js-job-title">'+( v.job_title )+'</td>';

                                    ...
                                    <div class="edit-email-template">
                                        ...
                                        <div class="edit-template-from-main">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <?php echo form_label('Company Status', 'company_status'); ?>
                                                    <div class="hr-fields-wrap">
                                                        <div class="hr-select-dropdown">
                                                            <select class="invoice-fields" id="company_status" name="company_status">
                                                                <option value="1" <?php if ($data["company_status"] == 1) { ?> selected <?php } ?>> Open</option>
                                                                <option value="0" <?php if ($data["company_status"] == 0) { ?> selected <?php } ?>>Closed</option>
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
...
<script>
    ...
    function fSetCompanyStatus(source) {
        ...
        var dataToSend = {
            perform_action: 'set_company_status',

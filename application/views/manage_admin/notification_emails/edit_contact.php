                                                ...
                                                <div class="universal-form-style-v2">
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                        <div class="field-row">
                                                            ...
                                                            <input type="text" id="contact_name" name="contact_name" value="<?php echo isset($contact['contact_name']) ? $contact['contact_name'] : ''; ?>" class="hr-form-fileds">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                        <div class="field-row">
                                                            ...
                                                            <input type="text" id="contact_no" name="contact_no" value="<?php echo isset($contact['contact_no']) ? $contact['contact_no'] : ''; ?>" class="hr-form-fileds">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                        <div class="field-row">
                                                            ...
                                                            <input type="text" name="short_description" value="<?php echo isset($contact['short_description']) ? $contact['short_description'] : ''; ?>" class="hr-form-fileds">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                        <div class="field-row">
                                                            ...
                                                            <input type="text" name="email" value="<?php echo isset($contact['email']) ? $contact['email'] : ''; ?>" class="hr-form-fileds">								
                                                    ...
                                                    <div class="col-xs-12 col-md-12 col-xs-12 col-sm-12">
                                                        <div class="field-row">
                                                            <label id="lbl_is_registers_in_ahr" class="control control--checkbox">
                                                                ...
                                                                <input <?php echo isset($contact['status']) && $contact['status'] == 'active' ? ' checked="checked" ' : ''; ?> class="status" id="status" name="status" value="1" type="checkbox">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                        <div class="field-row">
                                                            <input type="submit" value="Save" onclick="return validate_form()"class="site-btn">
                                                        </div>
                                                    </div>

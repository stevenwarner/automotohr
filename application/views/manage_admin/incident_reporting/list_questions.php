...
<!--                                            --><?php //if (check_access_permissions_for_view($security_details, 'add_question')) { ?>
                                                <a id="search_btn" href="<?php echo base_url('manage_admin/reports/incident_reporting/add_new_question/'.$inc_id)?>" class="btn btn-success"><i class="fa fa-plus-square"> </i> Add New Question</a>
<!--                                            --><?php //} ?>
                                            <a id="back_btn" href="<?php echo base_url('manage_admin/reports/incident_reporting/checklists')?>" class="btn btn-success"><i class="fa fa-arrow-left"> </i> Go Back</a>
...
<!--                                                                --><?php //if (check_access_permissions_for_view($security_details, 'edit_question')) { ?>
                                                                    <td><?php echo anchor('manage_admin/reports/incident_reporting/edit_question/'.$question['id'], 'Edit', 'class="btn btn-success btn-sm" title="Edit Incident"'); ?></td>
<!--                                                                --><?php //} ?>
        ...
        $('.type').click(function(){
            ...
            if(status == 'Disable'){
                $.ajax({
                    ...
                    url: '<?= base_url('manage_admin/reports/incident_reporting/enable_disable_question')?>/' + id,

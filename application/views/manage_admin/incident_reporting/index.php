                                    ...
                                    <div class="row">
                                        <?php if($this->uri->segment(4) == '') { ?>
                                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                ...
                                                <?php } ?>
                                                <a id="back_btn" href="<?php echo base_url('manage_admin/reports/incident_reporting/checklists')?>" class="btn btn-success"><i class="fa fa-list"> </i> Check Lists</a>
                                            </div>
                                                        ...
                                                        <?php if(sizeof($incident_types)>0) {
                                                            foreach ($incident_types as $type) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <?php if($this->uri->segment(4) == '') { ?>
                                                                        <?php if($type['fillable_by']== 'manager') { ?>
                                                                             <td>Manager</td>
                                                                        <?php } elseif ($type['fillable_by']== 'team') { ?>
                                                                             <td>Team</td>
                                                                        <?php } ?>    
                                                                    <?php } ?>
                                                                    ...
                                                                    <?php if (check_access_permissions_for_view($security_details, 'edit_type')) { ?>
                                                                        <td>
                                                                            <a title="Edit Type" href="<?php echo base_url()?>manage_admin/reports/incident_reporting/add_new_type/<?php echo $type['id']; ?>" class="btn btn-info btn-sm pencil_useful_link">
                                                                    ...
                                                                    <?php if (check_access_permissions_for_view($security_details, 'view_question')) { ?>
                                                                        <td><a href="<?php echo base_url('manage_admin/reports/incident_reporting/view_incident_questions/'.$type['id'])?>"

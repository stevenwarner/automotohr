...
<!--                                                                    --><?php //echo form_input('url', set_value('url'), 'class="hr-form-fileds" id="url"'); ?>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                                <div class="field-row">
                                                                    ...
                                                                    <select name="type" id="type" class="hr-form-fileds">
                                                                        ...
                                                                        <option value="Paid/Organic">Paid/Organic</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
                                                                    <div class="field-row">
                                                                        <label class="control control--radio">No
                                                                            <input type="radio" name="accept_url" class="video_source" value="0" checked="">
                                                                ...
                                                                <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
                                                                    <div class="field-row">
                                                                        <label class="control control--radio">Yes
                                                                            <input type="radio" name="accept_url" class="video_source" value="1" >
                                                                            <div class="control__indicator"></div>
                                                                        </label>
                                                                    </div>
                                                                </div>

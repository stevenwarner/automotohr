                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <!--                                    <div class="add-new-promotions">
                                                                            <a class="site-btn" href="javascript:;"> Inbox  (13) </a>
                                                                            <a class="site-btn" href="javascript:;"> Outbox </a> 
                                                                            <a class="site-btn" href="javascript:;"> Compose Message </a>
                                                                        </div>-->
                                    ...
                                    <div class="hr-promotions table-responsive">
                                        <form method="post">
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td width="20%"><b>Message From</b></td>
                                                        <td><?= $log["name"] ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td><b>Date</b></td>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <p class="msg_setting">
                                                                <a class="hr-edit-btn" title="Back" href="<?=base_url('manage_admin/contactus_enquiries')?>">Back</a>
                                                            </p>
                                                        </td>

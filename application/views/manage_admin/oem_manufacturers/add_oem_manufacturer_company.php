                                    ...
                                    <div class="add-new-company">
                                        <form action="" method="POST" name='add_brand_company' id='add_brand_company'>
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                    <div class="heading-title page-title">
                                                        <h1 class="page-title">OEM, Independent, Vendor Companies</h1>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                    <div class="field-row">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-center hr-btn-panel">
                                                    <a href='<?php echo base_url().'manage_admin/oem_manufacturers/manage_oem_manufacturer/'.$oem_sid; ?>' class="search-btn black-btn">Cancel</a>

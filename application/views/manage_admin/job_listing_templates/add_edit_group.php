                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                    ...
                                                    <div class="hr-setting-page">
                                                        <?php echo form_open('manage_admin/job_template_groups/add'); ?>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <div class="hr-promotions table-responsive">
                                                                    <div class="heading-title page-title">
                                                                        <h1 class="page-title"><i class="fa fa-list-alt"></i>Mark Available Templates</h1>
                                                                    </div>
                                                                    <table>
                                                                        <thead>
                                                                        <tr>
                                                                        ...
                                                                        <?php foreach($templates as $template){?>
                                                                            <tr>
                                                                                <td>
                                                                                    <?php echo form_checkbox('templates[]', $template['sid'], set_checkbox('templates' , $template['sid'], in_array($template['sid'], $templatesArray)));?>

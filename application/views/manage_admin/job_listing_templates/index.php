                                    ...
                                    <div>
                                        <div class="add-new-promotions">
                                            <?php if(check_access_permissions_for_view($security_details, 'add_edit_group')){ ?>
                                                <a class="site-btn" href="<?php echo base_url('manage_admin/job_template_groups/add/'); ?>">Add New Group</a>
                                            <?php } ?>
                                            <?php if(check_access_permissions_for_view($security_details, 'add_edit_job_listing_templates')){ ?>
                                                <a class="site-btn" href="<?php echo base_url('manage_admin/job_templates/add/'); ?>">Add New Template</a>
                                            <?php } ?>
                                        </div>
                                            ...
                                            <table>
                                                ...
                                                <?php foreach($groups as $group){?>
                                                    <tr>
                                                        ...
                                                        <?php if(check_access_permissions_for_view($security_details, 'add_edit_group')){ ?>
                                                            <td>
                                                                <a href="<?php echo base_url('manage_admin/job_template_groups/edit') . '/' . $group['sid']; ?>" class="hr-edit-btn" >EDIT</a>
                                                            </td>
                                                        <?php } ?>
                                                        <?php if(check_access_permissions_for_view($security_details, 'fDeleteTemplateGroup')){ ?>
                                                            <td>
                                                                <form method="post" action="<?php echo base_url('manage_admin/job_template_groups/add')?>" id="form_delete_template_group_<?php echo $group['sid'];?>">
                                                        ...
                                                        <?php if(check_access_permissions_for_view($security_details, 'fSwitchStatus')){ ?>
                                                            <td>
                                                                <form method="post" action="<?php echo base_url('manage_admin/job_template_groups/add')?>" id="form_switch_template_group_status_<?php echo $group['sid'];?>">
                                                                    <input type="hidden" id="sid" name="sid" value="<?php echo $group['sid'];?>" />
                                        ...
                                        <div class="hr-promotions table-responsive">
                                            <div class="heading-title page-title">
                                                <h1 class="page-title"><i class="fa fa-list-alt"></i>Templates</h1>
                                            </div>
                                            <table>
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    <?php foreach($templates as $template){?>
                                                        <tr>
                                                            ...
                                                            <?php if(check_access_permissions_for_view($security_details, 'add_edit_job_listing_templates')){ ?>
                                                            <td>
                                                                <a href="<?php echo base_url('manage_admin/job_templates/edit') . '/' . $template['sid']; ?>" class="hr-edit-btn" >EDIT</a>
                                                            </td>
                                                            <?php } ?>
                                                            <?php if(check_access_permissions_for_view($security_details, 'fDeleteTemplate')){ ?>
                                                                <td>
                                                                    <form method="post" action="<?php echo base_url('manage_admin/job_templates/add')?>" id="form_delete_template_<?php echo $template['sid'];?>">
                                                            ...
                                                            <?php if(check_access_permissions_for_view($security_details, 'fSwitchStatus')){ ?>
                                                                <td>
                                                                    <form method="post" action="<?php echo base_url('manage_admin/job_templates/add')?>" id="form_switch_template_status_<?php echo $template['sid'];?>">
                                                                        <input type="hidden" id="sid" name="sid" value="<?php echo $template['sid'];?>" />

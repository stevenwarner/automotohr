                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="heading-title">
                                        <h1 class="page-title"><i class="fa fa-users"></i>Add A Company Default Category</h1>
                                        <a id="back_btn" href="<?php echo base_url('manage_admin/companies/default_document_category_listing/'.$company_sid)?>" class="btn black-btn float-right">

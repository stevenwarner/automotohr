        ...
        <div class="panel-body">
            <div class="email">
                <?php if ($complianceSafetyEmail) { ?>
                    <?php foreach ($complianceSafetyEmail as $userId => $otherEmails) { ?>
                        <?php //_e($emails, true); 
                        ?>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" href="#user_email_block_<?php echo $userId ?>">
                                                <span class="glyphicon glyphicon-eye-open js-parent-gly"></span>
                                                <?php
                                                echo getUserNameBySID($userId);
                                    ...
                                    <div id="user_email_block_<?php echo $userId; ?>" class="panel-collapse collapse js-parent-coll">
                                        <div class="panel-body">
                                            <div class="email">
                                                <?php if ($otherEmails) { ?>
                                                    <?php foreach ($otherEmails as $email) { ?>
                                                        <div class="accordion-colored-header header-bg-gray">
                                                            <div class="panel-group">
                                                                <div class="panel panel-default">
                                                                    <div class="panel-heading">
                                                                        <h4 class="panel-title">
                                                                            <a data-toggle="collapse" href="#other_email_block_<?php echo $email['userId'] ?>">
                                                                                <span class="glyphicon glyphicon-eye-open js-parent-gly"></span>
                                                                                <span>
                                                                                    <?php
                                                                    ...
                                                                    <div id="other_email_block_<?php echo $email['userId']; ?>" class="panel-collapse collapse js-parent-coll">
                                                                        <div class="panel-body">
                                                                            <!-- System Email -->
                                                                                            ...
                                                                                            <div class="panel panel-default">
                                                                                                <div class="panel-heading">
                                                                                                    <h4 class="panel-title">
                                                                                                        ...
                                                                                                        ?>
                                                                                                        <a class="collapsed" data-toggle="collapse" aria-expanded="false" data-parent="#accordion" href="#other_email_<?php echo $key . '_' . $email['userId']; ?>">
                                                                                                ...
                                                                                                <div id="other_email_<?php echo $key . '_' . $email['userId']; ?>" class="panel-collapse collapse js-main-coll">
                                                                                                    <div class="panel-body">
                                                                                                        <div class="form-wrp">
                                                                                                            <table class="table table-bordered table-hover table-stripped">
                                                                                                                <tbody>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <?php if ($incident_email['sender_sid'] == $current_user || $incident_email['sender_sid'] == 0) { ?>
                                                                                                                                ...
                                                                                                                                <?php if ($receiver_user !=  $incident_email['manual_email']) { ?>
                                                                                                                                    ...
                                                                                                                                    ?>
                                                                                                                                    <a href="javascript:;" class="pull-right print-incident modify-comment-btn" data-title="<?php echo 'resend'; ?>" data-type="system" data-sid="<?php echo $receiver_sid; ?>" data-email="<?php echo $receiver_email; ?>" data-subject="<?php echo $receiver_subject; ?>" onclick="send_email(this);">
                                                                                                                                        <i class="fa fa-retweet"></i>
                                                                                                                                        Resend Email
                                                                                                                                    </a>
                                                                                                                                <?php } else { ?>
                                                                                                                                    <?php if ($email['receiver_sid'] != 0) { ?>
                                                                                                                                        <a href="javascript:;" class="pull-right print-incident modify-comment-btn" data-title="<?php echo 'reply'; ?>" data-type="manual" data-sid="<?php echo $email['manual_email']; ?>" data-subject="<?php echo $email["subject"]; ?>" onclick="send_email(this);">
                                                                                                                                            <i class="fa fa-reply"></i>
                                                                                                                                            Reply Email
                                                                                                                                        </a>
                                                                                                                                    <?php } else { ?>
                                                                                                                                        <a href="javascript:;" class="pull-right print-incident modify-comment-btn" data-title="<?php echo 'resend'; ?>" data-type="manual" data-sid="<?php echo $email['manual_email']; ?>" data-subject="<?php echo $email["subject"]; ?>" onclick="send_email(this);">
                                                                                                                                            <i class="fa fa-retweet"></i>
                                                                                                                                            Resend Email
                                                                                                                                        </a>
                                                                                                                                    <?php } ?>
                                                                                                                    ...
                                                                                                                    $attachments = get_email_attachment($email['incidentId'], $email_sid);
                                                                                                                    ?>

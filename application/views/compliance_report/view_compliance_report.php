        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                ...
                <?php if (sizeof($assigned_incidents) > 0) { ?>
                        ...
                        <div class="table-responsive table-outer">
                            <div class="panel panel-blue">
                                <div class="panel-heading incident-panal-heading">
                                    ...
                                    <a target="_blank" href="<?php echo base_url('compliance_report/download_compliance_report_all_documents_and_videos/media/0') . '/' . $id; ?>" class="pull-right print-incident modify-comment-btn"><i class="fa fa-download"></i> Download All Media</a>
                                </div>
                                <div class="panel-body">
                        ...
                        <div class="table-responsive table-outer">
                            <div class="panel panel-blue">
                                <div class="panel-heading incident-panal-heading">
                                    ...
                                    <a target="_blank" href="<?php echo base_url('compliance_report/download_compliance_report_all_documents_and_videos/document/0') . '/' . $id; ?>" class="pull-right print-incident modify-comment-btn"><i class="fa fa-download"></i> Download All Documents</a>
                                </div>
                                <div class="panel-body">
                                                        ...
                                                        <?php if (!empty($get_incident_document)) { ?>
                                                            <?php foreach ($get_incident_document as $key => $document) { ?>
                                                                ...
                                                                if ($document_extension == 'pdf') {
                                                                    ...
                                                                    $print_url = base_url('compliance_report/print_image/' . $document['id']);
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-2 col-md-2 col-xs-2 col-sm-2">
                                                                                        <a 
                                                                                            ...
                                                                                            href="<?php echo base_url('compliance_report/download_compliance_report_document') . '/' . $download_url; ?>" 
                                                                                            class="btn btn-block btn-info">
                    ...
                    <?php if ($myEmails) { ?>
                        <?php $this->load->view('compliance_report/manager_safety_incident_email_section', $myEmails); ?>
                    <?php } ?>

                    <?php if ($complianceSafetyEmail) { ?>
                        <?php $this->load->view('compliance_report/other_manager_email_section', $complianceSafetyEmail); ?>
                    <?php } ?>
                    <!-- Email Section End -->
                                ...
                                <div class="panel-body">
                                    <div class="respond">
                                        <?php foreach ($comments as $comment) { ?>
                                            ...
                                            //
                                            if (empty($name)) {
                                                $split_email = explode('@', $comment['manual_email']);
                                                $name = $split_email[0];
                                            }
                                            //
                                            ...
                                            ?>
                                            <?php if ($comment['response_type'] != 'Personal') { ?>
                                            ...
                                            <?php } else if ($comment['response_type'] == 'Personal' && $comment['emp_id'] == $current_user) { ?>
                                                <article <?php echo empty($comment['user2']) ? '' : 'class="reply"' ?>>
                                                    <figure><img class="img-responsive" src="<?= $url ?>"></figure>
                                                    <div class="text">
                                                        <div class="message-header">
...
<script type="application/javascript">
    $(document).on('click', '.jsMarkItResolved', function() {
        ...
        alertify.confirm('Resolved?', 'Are you sure, you want to mark this incident resolved?', function() {
            $.ajax({
                type: 'POST',
                url: '<?= base_url('compliance_report/mark_resolved') ?>',
                data: {
                    id: iid
                },
    ...
    $('#save_updated_video').on('click', function() {
        ...
        if (flag == 1) {
            ...
            var update_url = '<?php echo base_url('compliance_report/update_compliance_video'); ?>';
    ...
    $('.js-archive-video').click(function(e) {
        ...
        alertify.confirm('Do you really want to move this video to Archive?', function() {
            $.post("<?= base_url('compliance_report/handler') ?>", {
    ...
    $('#save_updated_doc').on('click', function() {
        ...
        if (flag == 1) {
            ...
            var update_url = '<?php echo base_url('compliance_report/update_compliance_document'); ?>';
        ...
        if (attachment_size > 0 && flag == 0) {
            ...
            $('#attachment_listing_data > .manual_upload_items').each(function(key) {
                ...
                if (item_status == 'pending') {
                    ...
                    var save_attachment_url = '<?php echo base_url('compliance_report/save_email_manual_attachment'); ?>';
    ...
    function mark_read(email_sid) {
        var update_url = '<?php echo base_url('compliance_report/update_email_read_flag'); ?>';
        var targit_document = $('#update_document_sid').val();
        var form_data = new FormData();

                                                                                    ...
                                                                                    <?php 
                                                                                        foreach ($attachments as $key => $attach_item) {
                                                                                            ...
                                                                                            if ($attach_item_type == 'Media') {
                                                                                                ...
                                                                                                $download_url   = base_url('compliance_report/download_Compliance_report_media/'.$item_path);
                                                                                                ...
                                                                                                $print_url = '';
                                                                                                $download_url   = base_url('compliance_report/download_compliance_report_document/'.$item_path);
                                                                                                ...
                                                                                                if ($item_source == 'pdf') {
                                                                                                    ...
                                                                                                    $item_source    = "image";
                                                                                                    $print_url = base_url('compliance_report/print_image/'.$item_sid);
                                                                                                }
                                                                                            }
                                                                                    ?>

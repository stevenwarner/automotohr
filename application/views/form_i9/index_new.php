                                ...
                                <div class="form-wrp">
                                    ...
                                    <form action="<?php echo base_url("forms/i9/authorized/section/") . $pre_form['sid']; ?>" id="i9-form" method="post" autocomplete="nope">
                                        ...
                                        <?php if ($section2_flag && $signed_flag == true) { ?>
                                            ...
                                            $employerPrefill = getDataForEmployerPrefill($company_sid, $users_sid);
                                            ?>
                                            ...
                                            <div class="form-group autoheight">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <input type="text" name="section2_firstday_of_emp_date" id="section2_firstday_of_emp_date" class="form-control date_picker2" readonly autocomplete="off" value="<?= isset($pre_form['section2_firstday_of_emp_date']) && !empty($pre_form['section2_firstday_of_emp_date']) ? date('m-d-Y', strtotime($pre_form['section2_firstday_of_emp_date'])) : $employerPrefill['first_day_of_employment']; ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="hr-box">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-5 col-md-5 col-xs-12 col-sm-5">
                                                        <label class="control control--radio">
                                                            ...
                                                            <input class="" name="section1_preparer_or_translator" value="not-used" type="radio" <?= $pre_form['section1_preparer_or_translator'] == 'not-used' ? 'checked' : ''; ?> <?php if (!$this->session->userdata('logged_in')['employer_detail']['access_level_plus']) {
                                                                                                                                                                                                                                            echo 'disabled="disabled"';
                                                                                                                                                                                                                                        } ?>>
                                                            <div class="control__indicator"></div>
                                                        </label>
                                                    ...
                                                    <div class="col-lg-7 col-md-7 col-xs-12 col-sm-7">
                                                        <label class="control control--radio">
                                                            ...
                                                            <input class="" name="section1_preparer_or_translator" value="used" type="radio" <?= $pre_form['section1_preparer_or_translator'] == 'used' ? 'checked' : ''; ?> <?php if (!$this->session->userdata('logged_in')['employer_detail']['access_level_plus']) {
                                                                                                                                                                                                                                    echo 'disabled="disabled"';
                                                                                                                                                                                                                                } ?>>
                                                            <div class="control__indicator"></div>
                                                        </label>

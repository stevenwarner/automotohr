    ...
    <div class="row <?= $i % 2 === 0 ? 'csBG5 p10' : '' ?>">
        <div class="col-lg-3 col-md-12 col-xs-12 col-sm-12">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control date_picker2" readonly value="<?= isset($authorizedArray[$i]['section3_rehire_date']) && !empty($authorizedArray[$i]['section3_rehire_date']) ? $authorizedArray[$i]['section3_rehire_date'] : ""; ?>" id="section3_authorized_rehire_date_<?= $i; ?>" name="section3_authorized_rehire_date_<?= $i; ?>" autocomplete="off">
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-xs-12 col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?= isset($authorizedArray[$i]['section3_last_name']) && !empty($authorizedArray[$i]['section3_last_name']) ? $authorizedArray[$i]['section3_last_name'] : ""; ?>" id="section3_authorized_last_name_<?= $i; ?>" name="section3_authorized_last_name_<?= $i; ?>" autocomplete="nope">
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-xs-12 col-sm-4">
                    <div class="form-group">
                        <label>First Name <i class="fa fa-question-circle-o modalShow" src="section_8_first_name"></i></label>
                        <input type="text" class="form-control" value="<?= isset($authorizedArray[$i]['section3_first_name']) && !empty($authorizedArray[$i]['section3_first_name']) ? $authorizedArray[$i]['section3_first_name'] : ""; ?>" id="section3_authorized_first_name_<?= $i; ?>" name="section3_authorized_first_name_<?= $i; ?>" autocomplete="nope">
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-xs-12 col-sm-4">
                    <div class="form-group">
                        <label>Middle Initial <i class="fa fa-question-circle-o modalShow" src="section_8_middle_initial"></i></label>
                        <input type="text" class="form-control" value="<?= isset($authorizedArray[$i]['section3_middle_initial']) && !empty($authorizedArray[$i]['section3_middle_initial']) ? $authorizedArray[$i]['section3_middle_initial'] : ""; ?>" id="section3_authorized_middle_initial_<?= $i; ?>" name="section3_authorized_middle_initial_<?= $i; ?>" autocomplete="nope">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="select">
                                    <select class="form-control" id="section3_authorized_document_title_<?= $i; ?>" name="section3_authorized_document_title_<?= $i; ?>">
                        ...
                        <div class="col-lg-4 col-md-6 col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?= isset($authorizedArray[$i]['section3_document_number']) && !empty($authorizedArray[$i]['section3_document_number']) ? $authorizedArray[$i]['section3_document_number'] : ""; ?>" id="section3_authorized_document_number_<?= $i; ?>" name="section3_authorized_document_number_<?= $i; ?>">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 col-xs-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?= isset($authorizedArray[$i]['section3_expiration_date']) && !empty($authorizedArray[$i]['section3_expiration_date']) ? $authorizedArray[$i]['section3_expiration_date'] : ""; ?>" class="form-control date_picker2" readonly name="section3_authorized_expiration_date_<?= $i; ?>" id="section3_authorized_expiration_date_<?= $i; ?>" autocomplete="off">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12 col-xs-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="section3_authorized_name_of_emp_<?= $i; ?>" name="section3_authorized_name_of_emp_<?= $i; ?>" value="<?= $first_name . ' ' . $last_name ?>">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-xs-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <?php if (empty($employeePrefillSignature)) {
                                ?>
                                ...
                                <div class=" img-full">
                                    ...
                                    $signatureSurce = '';
                                    $signatureVal = '';
                                    if (!empty($employeePrefillSignature)) {
                                        $signatureSurce = 'src="' . $employeePrefillSignature . '"';
                                        $signatureVal = 'value="' . $employeePrefillSignature . '"';
                                    }
                                    ?>
                                    <img style="max-height: <?= SIGNATURE_MAX_HEIGHT ?>" alt="" class="authorized_signature_img_<?= $i; ?>" <?= $signatureSurce; ?> />
                                </div>
                                <input type="hidden" id="section3_authorized_signature_<?= $i; ?>" id="section3_authorized_signature_<?= $i; ?>" name="section3_authorized_signature_<?= $i; ?>" <?= $signatureVal; ?> />
                        ...
                        <div class="col-lg-4 col-md-6 col-xs-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" readonly value="<?= isset($authorizedArray[$i]['section3_signature_date']) && !empty($authorizedArray[$i]['section3_signature_date']) ? $authorizedArray[$i]['section3_signature_date'] : date('m-d-Y'); ?>" class="form-control date_picker" readonly id="section3_authorized_today_date_<?= $i; ?>" name="section3_authorized_today_date_<?= $i; ?>" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="row">

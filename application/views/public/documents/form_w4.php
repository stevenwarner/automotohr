                ...
                <div class="form-wrp">
                    ...
                    <form id="w4-form" action="" method="post">
                        ...
                        <?php //if(!empty($e_signature_data)) { ?>
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <input type="hidden" id="perform_action" name="perform_action" value="sign_w4_document" />
                                ...
                                <?php if( $pre_form['user_consent'] == 0) { ?>
                                    <div class="row">
                                        <div class="col-lg-12 text-center">
                                            <button <?php //echo $signed_flag == true ? 'disabled="disabled"' : ''; ?> onclick="func_save_e_signature();" type="button" class="btn blue-button break-word-text" <?php echo !empty($pre_form) && $pre_form['user_consent'] == 1 ? 'disabled="disabled"' : '' ?>><?php echo SIGNATURE_CONSENT_BUTTON; ?></button>
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>

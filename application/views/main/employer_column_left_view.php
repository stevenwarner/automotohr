<div class="dashboard-menu">
    <ul>
        ...
        <?php if(check_access_permissions_for_view($security_details, 'add_listing')) { ?>
                <li>
                    <a <?php if (strpos(base_url(uri_string()), site_url('add_listing')) !== false) { echo 'class="active"'; } ?>
        ...
        <?php if(check_access_permissions_for_view($security_details, 'market_place')) { ?>
                <li>
                    <a <?php if (base_url(uri_string()) == site_url('market_place')) { echo 'class="active"'; } ?> 
        ...
        <?php if(check_access_permissions_for_view($security_details, 'my_listings')) { ?>
                <li>
                    <a <?php if (strpos(base_url(uri_string()), site_url('my_listings')) !== false || strpos(base_url(uri_string()), site_url('edit_listing')) !== false || strpos(base_url(uri_string()), site_url('clone_listing')) !== false) { echo 'class="active"'; } ?>
        ...
        <?php if(check_access_permissions_for_view($security_details, 'application_tracking')) { ?>
                <li>
                    <a <?php if (strpos(base_url(uri_string()), site_url('application_tracking_system')) !== false || strpos(base_url(uri_string()), site_url('manual_candidate')) !== false || strpos(base_url(uri_string()), site_url('archived_applicants')) !== false) { echo 'class="active"'; } ?>
        ...
        <?php if(check_access_permissions_for_view($security_details, 'my_events')) { ?>    
                <li>
                    <a <?php if (strpos(base_url(uri_string()), site_url('calendar/my_events')) !== false) { echo 'class="active"'; } ?>
        ...
        <?php if(check_access_permissions_for_view($security_details, 'private_messages')) { ?>    
                <li>
                    <a <?php if (strpos(base_url(uri_string()), site_url('private_messages')) !== false || strpos(base_url(uri_string()), site_url('inbox_message_detail')) !== false || strpos(base_url(uri_string()), site_url('outbox')) !== false || strpos(base_url(uri_string()), site_url('compose_message')) !== false || strpos(base_url(uri_string()), site_url('reply_message')) !== false) { echo 'class="active"'; } ?>
...
<!--                    <li>
                        <a <?php if (strpos(base_url(uri_string()), site_url('resume_database')) !== false) { echo 'class="active"'; } ?>
        ...
        <?php if(check_access_permissions_for_view($security_details, 'my_settings')) { ?>
                <li>
                    <a <?php if (strpos(base_url(uri_string()), site_url('my_settings')) !== false || strpos(base_url(uri_string()), site_url('order_history')) !== false || strpos(base_url(uri_string()), site_url('order_detail')) !== false || strpos(base_url(uri_string()), site_url('job_products_report')) !== false) { echo 'class="active"'; } ?>
        ...
        <?php if(check_access_permissions_for_view($security_details, 'screening_questionnaires')) { ?>    
                <li>
                    <a <?php if (strpos(base_url(uri_string()), site_url('screening_questionnaires')) !== false) { echo 'class="active"'; } ?> 
        ...
        <?php if(check_access_permissions_for_view($security_details, 'interview_questionnaire')) { ?>
                <li>
                    <a <?php if (strpos(base_url(uri_string()), site_url('interview_questionnaire')) !== false) { echo 'class="active"'; } ?> 
        ...
        <?php if(check_access_permissions_for_view($security_details, 'background_check')) { ?>
                <li>
                    <a <?php if (strpos(base_url(uri_string()), site_url('background_check')) !== false) { echo 'class="active"'; } ?> 
        ...
        <?php if(check_access_permissions_for_view($security_details, 'referral_network')) { ?>
            <li>
                <a <?php if (strpos(base_url(uri_string()), site_url('referral_network')) !== false) { echo 'class="active"'; } ?>
        ...
        <?php $company_sid = $data["session"]["company_detail"]["sid"]; ?>
            ...
            <?php if(in_array($company_sid, array())) { ?>
                <li>
                    <a <?php if (strpos(base_url(uri_string()), site_url('attendance')) !== false) { echo 'class="active"'; } ?>
        ...
        <?php if(check_access_permissions_for_view($security_details, 'support_tickets')) { ?>
            <li>
                <a <?php if (strpos(base_url(uri_string()), site_url('support_tickets')) !== false) { echo 'class="active"'; } ?>
...
<!--            </li>-->
        ...
        <?php if(check_resource_permission($session['company_detail']['sid']) && check_access_permissions_for_view($security_details, 'resource_center_panel')) { ?>
            <li>
                <a <?php if (strpos(base_url(uri_string()), site_url('resource_center')) !== false) { echo 'class="active"'; } ?>

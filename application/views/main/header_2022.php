                            ...
                            <nav class="navbar navigation">
                                ...
                                <div id="main_nav" class="collapse navbar-collapse">
                                    ...
                                    <ul class="nav navbar-nav pull-right">
                                        <li>
                                            <a data-toggle="dropdown" href="#" class="dropdown-toggle _csB3">Quick Links&nbsp;&nbsp;<span class="caret"></span></a>
                                        ...
                                        <li><a href="<?php echo base_url('logout'); ?>" class="_csB3"><i class="fa fa-fw fa-lock"></i>&nbsp;&nbsp;Logout</a></li>
                                    </ul>

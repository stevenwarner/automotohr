    ...
    <div class="container-fluid">
            ...
            <div class="demo-btn-box">
                ...
                <div class="text">
                    <div class="demo-link-wrp">
                        <a class="demo-link" href="<?= base_url('schedule_your_free_demo') ?>"><i class="fa fa-calendar"></i>Schedule Your FREE DEMO</a>
                    </div>
                </div>		        
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12">
            ...
            <?php if ( in_array($class_name, array('home','users','affiliates', 'demo' ))) { ?>
                <div class="demo-btn-box">
                    <div class="text">
                        <figure><a href="<?= base_url('schedule_your_free_demo') ?>"><img class="img-responsive" src="<?= base_url() ?>/assets/images/img-demo-btn-new.png" alt=""/></a>
                        </figure>
                    </div>              
                </div>
            <?php } ?>

                            ...
                            <div class="col-xs-6 col-sm-2 col-md-2 col-lg-2">
                                <div class="logo">
                                    <?php if (isset($session['company_detail']) && $session['portal_detail']['enable_company_logo'] == 1) { ?>
                                        <a href="javascript:;">
                                            <img src="<?= getImageURL($session['company_detail']['Logo']); ?>"
                                                alt="company logo" />
                                        </a>
                                                ...
                                                <li>
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="<?php echo base_url('employee_management_system'); ?>"><i
                                                                    class="fa fa-fw fa-th"></i>&nbsp;&nbsp;Dashboard</a>
                                                        </li>
                                                        ...
                                                        <li><a
                                                                href="<?php echo base_url('hr_documents_management/my_documents'); ?>"><i
                                                                    class="fa fa-fw fa-file"></i>&nbsp;&nbsp;Documents</a>
                                                        </li>
                                                        ...
                                                        if (check_access_permissions_for_view($securityDetails, 'complynet') && $comply_status && $access_level != 'Employee' && $loggedInEmployee_status) { ?>
                                                            ...
                                                            <?php if ($complyNetLink) { ?>
                                                                <li><a href="<?= base_url('cn/redirect'); ?>"><i
                                ...
                                <div class="col-md-12">
                                        ...
                                        if ($this->uri->segment(1) == '') { /* home-demo-btn */
                                            ...
                                            <ul>
                                                <?php if ($this->uri->segment(1) != 'demo' && $this->uri->segment(1) != 'schedule_your_free_demo') { ?>
                                                    <li><a href="<?= base_url('schedule_your_free_demo') ?>"><i
                                                                class="fa fa-calendar"></i>Schedule Your FREE DEMO</a></li>
                                                <?php } ?>
                                            </ul>
                                        </div>
                                    <?php } ?>
                                    <div class="logo">
                                        <?php if ($this->uri->segment(1) == 'demo' || $this->uri->segment(1) == 'schedule_your_free_demo' || $this->uri->segment(1) == 'thank_you' || $this->uri->segment(1) == 'affiliate-program' || $this->uri->segment(1) == 'can-we-send-you-a-check-every-month') { ?>
                                            <a href="<?= base_url() ?>">
                                                <img class=""
                                                    src="<?= base_url() ?>assets/images/affiliates/ahr_logo_demo_new.png">
                                            </a>
                                        <?php } else { ?>
                                            <a href="<?= base_url() ?>">
                                                        ...
                                                        <div class="view-cart outter-view-cart" id="view-cart">
                                                            ...
                                                            <div class="cart-footer" id="hide_cart_footer">
                                                                ...
                                                                <div class="check-out-btn">
                                                                    <a data-toggle="modal" id="checkout_cart_click"
                                                                        data-target="#checkout_cart_model"
                                                                        href="javascript:;">Checkout</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                        ...
                                                                        <div class="row">
                                                                                    ...
                                                                                    <div class="table-responsive table-outer">
                                                                                        <div class="product-detail-area">
                                                                                            <table>
                                                                                                <thead>
                                                                                                    <tr>
                                                                                                        <td colspan="2" width="60%">Item
                                                                                                        </td>
                                                                                                        <td class="text-align">Qty /
                                                                                                            Day(s) </td>
                                                                                                        <td class="text-align">Price
                                                                                                        </td>
                                                                                                        <td class="text-align">Sub Total
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </thead>
                                                                                                <tbody>
                                                                                                    <?php foreach ($cart_content as $key => $value) { ?>
                                                                                                        <tr
                                                                                                            id="checkoutcart_<?php echo $value['sid']; ?>">
                                                                                                            <td>
                                                                                                                <figure>
                                                                                                                    <?php if (!empty($value['product_image'])) { ?>
                                                                                                                        <img
                                                                                                                            src="<?php echo AWS_S3_BUCKET_URL . $value['product_image']; ?>">
                                                                                                                    <?php } ?>
                                                                                                                </figure>
                                                                                                            </td>
                                                                                                            <td>
                                                                                                                <h3
                                                                                                                    class="details-title--polite">
                                                                                                                    <?php echo $value['name']; ?>
                                                                                                                </h3>
                                                                                                                <p class="error noproducterrors"
                                                                                                                    id="noproduct_<?php echo $value['sid']; ?>">
                                                                                                                </p>
                                                                                                            </td>
                                                                                                            <?php if (empty($value['price'])) {
                                                                                                                $cart_price = 0;
                                                                                                ...
                                                                                                <tfoot>
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td class="text-align">
                                                                                                            <p id="checkout_subtotal">
                                                                                                                <?php echo '$' . $sub_total; ?>
                                                                                                            </p>
                                                                                                        </td>
                                                                                                        <p style="display: none;"
                                                                                                            id="checkout_subtotal_value">
                                                                                                            <?php echo $sub_total; ?>
                                                                                                        </p>
                                                                                                        <p style="display: none;"
                                                                                                            id="coupon_code">
                                                                                                    ...
                                                                                                    <?php if ($has_coupon) { ?>
                                                                                                        ...
                                                                                                        <tr id="show_coupon_amount">
                                                                                                            <td colspan="2" width="60%">
                                                                                                                &nbsp;</td>
                                                                                                            <td>&nbsp;</td>
                                                                                                            <td class="text-align"><b>Coupon
                                                                                                                    (<?php echo $coupon_data['coupon_code']; ?>)</b>
                                                                                                            </td>
                                                                                                            <td class="text-align">
                                                                                                                <p id="coupon_amount">
                                                                            ...
                                                                            <div class="form-col-100">
                                                                                ...
                                                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                                                    <li>
                                                                                        <label>&nbsp;</label>
                                                                                        <input type="button" id="apply_coupon"
                                                                                            value="Apply Coupon" class="submit-btn">
                                                                                        <div id="coupon_spinner" class="spinner hide"><i
                                                                            ...
                                                                            <div id="free_no_payment">
                                                                                <div class="form-col-100">
                                                                                    <form id="form_free_checkout">
                                                                                        <?php foreach ($cart_content as $key => $value) { ?>
                                                                                            <div
                                                                                                id="removeitfromcart_free_<?php echo $value['sid']; ?>">
                                                                                                <input type="hidden"
                                                                                                    name="product[<?php echo $key; ?>][mid]"
                                                                                                    value="<?php echo $value['sid']; ?>">
                                                                                                <input type="hidden"
                                                                                                    name="product[<?php echo $key; ?>][id]"
                                                                                                    value="<?php echo $value['product_sid']; ?>">
                                                                                                <input type="hidden"
                                                                                                    name="product[<?php echo $key; ?>][qty]"
                                                                                                    value="<?php echo $value['qty']; ?>">
                                                                                                <input type="hidden"
                                                                                                    name="product[<?php echo $key; ?>][name]"
                                                                                                    value="<?php echo $value['name']; ?>">
                                                                                                <input type="hidden"
                                                                                                    name="product[<?php echo $key; ?>][no_of_days]"
                                                                                                    value="<?php echo $value['no_of_days']; ?>">
                                                                                                <input type="hidden"
                                                                                                    name="product[<?php echo $key; ?>][price]"
                                                                                        ...
                                                                                        <div id="maincartcouponarea_free">
                                                                                            <?php if ($has_coupon) { ?>
                                                                                                <input type="hidden" name="coupon_code"
                                                                                                    value="<?php echo $coupon_data['coupon_code']; ?>">
                                                                                                <input type="hidden" name="coupon_type"
                                                                                                    value="<?php echo $coupon_data['coupon_type']; ?>">
                                                                                                <input type="hidden" name="coupon_discount"
                                                                                                    value="<?php echo $coupon_data['coupon_discount']; ?>">
                                                                                            <?php } ?>
                                                                                        </div>
                                                                                        <div class="col-xs-12">
                                                                                            <input id="btn-free-checkout"
                                                                                                class="submit-btn"
                                                                                                style="width: 50%; margin:0 auto;"
                                                                                                type="button" id="free_order_btn"
                                                                                                name="free_order_btn"
                                                                                                value="Process Free Order"
                                                                                                onclick="fProcessFreeCheckout();" />
                                                                                            <div id="free_spinner" class="spinner hide">
                                                                                                <i class="fa fa-refresh fa-spin"></i>
                                                                                                Processing...
                                                                                            </div>
                                                                                            <input type="hidden" id="is_free_checkout"
                                                                                                name="is_free_checkout" value="0" />
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                            </div>
                                                                                        ...
                                                                                        <li>
                                                                                            ...
                                                                                            <div class="hr-select-dropdown">
                                                                                                <select name="p_with_main"
                                                                                                    id="p_with_main"
                                                                                                    onchange="check_ccd(this.value)"
                                                                                                    class="invoice-fields">
                                                                                                    <option value="new">Add new credit
                                                                                                        card </option>
                                                                                ...
                                                                                <div class="form-col-100 autoheight">
                                                                                    <div
                                                                                        ...
                                                                                        <div class="checkbox-field savedccd">
                                                                                            <input type="checkbox"
                                                                                                name="cc_future_payment"
                                                                                                id="future-payment">
                                                                                            <label for="future-payment">Save this card
                                                                                                for future payment</label>
                                                                                        </div>
                                                                                        <?php foreach ($cart_content as $key => $value) { ?>
                                                                                            <div
                                                                                                id="removeitfromcart_<?php echo $value['sid']; ?>">
                                                                                                <input type="hidden"
                                                                                        ...
                                                                                        <div class="btn-panel">
                                                                                            <input type="submit" id="cc_send"
                                                                                                value="Confirm payment"
                                                                                                onclick="return pp_confirm_main()"
                                                                                                class="submit-btn">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-8 col-md-8 col-xs-12 col-sm-6">
                                                                        <div class="media-content">
                                                                            ...
                                                                            <p class="details-desc">This is a secure 256-bit SSL
                                                                                encrypted payment</p>
                                                                        </div>
                                                                    </div>
                                    ...
                                    <nav class="navigation">
                                        ...
                                        if ($this->uri->segment(1) == 'schedule_your_free_demo' || $this->uri->segment(1) == 'demo') {
                                            ...
                                            <?php if (null !== ($this->session->userdata('logged_in'))) { ?>
                                                ...
                                                <ul id="menus">
                                                    <li class="active"><a href="javascript:void(0)">Quick Links<i
                                                        ...
                                                        <ul>
                                                            ...
                                                            <?php if (checkIfAppIsEnabled('performance_management')) { ?>
                                                                <li>
                                                                    <?php $get_data = $this->session->userdata('logged_in'); ?>
                                                                    <a
                                                                        href="<?php echo base_url('performance-management/dashboard'); ?>">
                                                                        <figure><i class="fa fa-pencil-square-o"></i></figure>
                                                            ...
                                                            <li>
                                                                <?php $get_data = $this->session->userdata('logged_in');
                                                                $sub_domain_url = db_get_sub_domain($get_data['company_detail']['sid']); ?>
                                                                <a href="<?php echo STORE_PROTOCOL_SSL . $sub_domain_url; ?>"
                                                                    target="_blank">

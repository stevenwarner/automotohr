<div class="dashboard-menu">
    <ul>
        ...
        <?php if (check_access_permissions_for_view($security_details, 'onboarding_configuration')) { ?>
            <li>
                <a <?php if (strpos(base_url(uri_string()), site_url('onboarding/configuration')) !== false || strpos(base_url(uri_string()), site_url('onboarding/edit_welcome_video')) !== false) {
                        echo 'class="active"';
        ...
        <?php if (check_access_permissions_for_view($security_details, 'employee_ems_notification')) { ?>
            <li>
                <a <?php if (strpos(base_url(uri_string()), site_url('add_ems_notification')) !== false || strpos(base_url(uri_string()), site_url('edit_ems_notification')) !== false) {
                        echo 'class="active"';
        ...
        <?php if (check_access_permissions_for_view($security_details, 'announcements')) { ?>
            ...
            <?php if ($this->session->userdata('logged_in')['company_detail']['ems_status']) { ?>
                <li>
                    <a <?php if (strpos(base_url(uri_string()), site_url('announcements')) !== false || strpos(base_url(uri_string()), site_url('list_announcements')) !== false) {
                            echo 'class="active"';
        ...
        <?php if (check_access_permissions_for_view($security_details, 'Learning_center_panel')) { ?>
            <?php if ($this->session->userdata('logged_in')['company_detail']['ems_status']) { ?>
                ...
                <?php if (in_array($company_sid, explode(',', TEST_COMPANIES))) { ?>
                    <li>
                        <a <?php if (strpos(base_url(uri_string()), site_url('learning_center')) !== false) {
                                echo 'class="active"';
        ...
        <?php if (check_access_permissions_for_view($security_details, 'safety_sheet_portal')) { ?>
            <?php if ($this->session->userdata('logged_in')['company_detail']['ems_status']) { ?>
                <li>
                    <a <?php if (strpos(base_url(uri_string()), site_url('safety_sheets')) !== false) {
                            echo 'class="active"';
        ...
        <?php if ($this->session->userdata('logged_in')['company_detail']['ems_status']) { ?>
            <li>
                <a <?php if (strpos(base_url(uri_string()), site_url('department_management')) !== false) {
                        echo 'class="active"';
        ...
        <?php if ($this->session->userdata('logged_in')['company_detail']['ems_status']) { ?>
            <li>
                <a <?php if ('onboarding_block' == uri_string()) {
                        echo 'class="active"';
        ...
        <?php if ($this->session->userdata('logged_in')['company_detail']['ems_status']) { ?>
            <li>
                <a <?php if (strpos(base_url(uri_string()), site_url('onboarding_block/manage_company_help_box')) !== false) {
                        echo 'class="active"';
                    } ?> href="<?php echo base_url("onboarding_block/manage_company_help_box"); ?>">
                    <figure><i class="fa fa-info-circle"></i></figure>Company Help Box
                </a>
            </li>
        <?php  } ?>
    </ul>

<?php
    $company_detail['sid'] = $company_detail['sid'];

    $footer_logo_data  = get_footer_logo_data($company_detail['sid']);
    ...
    $footer_copyright_data  = get_footer_copyright_data($company_detail['sid']);

                        ...
                        <div class="js-content-area">
                            <div class="row margin-top">
                                <div class="col-sm-6 col-xs-12">
                                    <label class="">Policy <span class="cs-required">*</span> <i data-toggle="popovers" data-trigger="hover" data-title="Info" data-placement="right" data-content="<?php echo get_policy_item_info('policy_title_info'); ?>" class="fa fa-question-circle"></i></label>
                                    <div class="">
                            ...
                            <div class="row margin-top">
                                <div class="col-sm-6 col-xs-12">
                                    <label>Entitled Employee <i data-toggle="popovers" data-trigger="hover" data-title="Info" data-placement="right" data-content="<?php echo get_policy_item_info('entitled_employee_info'); ?>" class="fa fa-question-circle"></i></label>
                                    <div class="">

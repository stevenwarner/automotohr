...
<style>
    .cs-sidebar-timeoff-container{
        font-size: 15px;
    }
    .cs-sidebar-timeoff-text{
        font-size: 12px;
        font-weight: normal;
    }
</style>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="btn-filter-reset-custom">
                                            <button id="js-filter-apply-btn" type="button" class="btn btn-apply-custom"  style="background-color: #3554dc">APPLY</button>
...
<?php $this->load->view('timeoff/lms/fmla-popup'); ?>
<?php $this->load->view('timeoff/lms/scripts/holiday-list-modal'); ?>
<?php $this->load->view('timeoff/lms/scripts/common'); ?>
<?php $this->load->view('timeoff/lms/scripts/attachments'); ?>
<?php $this->load->view('timeoff/lms/scripts/create-modal'); ?>
<?php $this->load->view('timeoff/lms/scripts/draft-modal'); ?>
<?php $this->load->view('timeoff/lms/scripts/edit-modal'); ?>
<?php $this->load->view('timeoff/lms/scripts/view-modal'); ?>
<?php $this->load->view('timeoff/lms/scripts/index'); ?>
...
.cs-loader-box i{ font-size: 14em; color: #3554dc ; }
...
/**/
.ajs-button{ background-color: #3554dc  !important; color: #ffffff !important; padding-left: 5px !important; padding-right: 5px !important; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; -o-border-radius: 4px; border-color: #4cae4c !important; }
.ajs-header{ background-color: #3554dc  !important; color: #ffffff !important; }
/**/
.modal-footer a.btn-info{ background-color: #3554dc; }
#js-company-holidays-btn{ background-color: #3554dc; }
</style>
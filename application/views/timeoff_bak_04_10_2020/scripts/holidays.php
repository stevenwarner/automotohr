<script type="text/javascript">
    ...
    $(function(){
        ...
        $('#js-save-add-btn').click(function(e){
            ...
            megaOBJ.workOnHoliday = $('input[name="allow_work_on_holiday"]:checked').val();
        ...
        $('#js-save-edit-btn').click(function(e){
            ...
            megaOBJ.workOnHoliday = $('input[name="edit_work_on_holiday"]:checked').val();
        ...
        function showEditPage(holiday){
            ...
            if(holiday.work_on_holiday == 1) {
                $("#allow_work_from_home").prop("checked", true);
            } else {
                $("#not_allow_work_from_home").prop("checked", true);
            }
            //
            loader('hide');
        }

    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content model-content-custom">
            ...
            <div class="modal-body full-width modal-body-custom">
                ...
                <div class="tab-content js-em-page" id="js-detail-page">
                    <div>
                        ...
                        <!--  -->
                        <div class="row" id="js-archive-note-section" style="display: none;">
                            <div class="col-sm-12 col-sm-12">
                                <div class="form-group">
                                    <label>Archive Reason</label>
                                    <textarea class="archive_reason ckeditor" id="js-add-archive-reason"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-sm-12">
                                <div class="form-group">
                                    <label>Reason</label>
                                    <textarea class="ckeditor" id="js-edit-modal-reason"></textarea>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-warning btn-rounded" id="js-edit-modal-archive-btn" style="display: none;">ARCHIVE</button>
                <button type="button" class="btn blue-button btn-rounded" id="js-edit-modal-active-btn" style="display: none;">ACTIVATE</button>

                        ...
                        <div class="js-content-area">
                            ...
                            <div class="row margin-top">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <label class="control control--radio">
                                        <input type="radio" name="allow_work_on_holiday" class="allow_work_on_holiday" value="1" checked="true">Yes
                                        <div class="control__indicator"></div>
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="right-content-2 js-page" id="js-page-edit" <?=$page != 'edit' && $holidaySid != null ? 'style="display: none;"' : '';?>>
                        ...
                        <div class="js-content-area">
                            ...
                            <div class="row margin-top">
                                ...
                                <div class="col-sm-12">
                                    <label class="control control--radio">
                                        <input type="radio" name="edit_work_on_holiday" id="not_allow_work_from_home" class="allow_work_on_holiday" value="0">No&nbsp;
                                        <div class="control__indicator"></div>
                                    </label>
                                    <label class="control control--radio">
                                        <input type="radio" name="edit_work_on_holiday" id="allow_work_from_home" class="allow_work_on_holiday" value="1">Yes
                                        <div class="control__indicator"></div>
                                    </label>
                                </div>
                            </div>

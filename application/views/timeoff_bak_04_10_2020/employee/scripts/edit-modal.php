    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content model-content-custom">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="js-edit-modal-comment" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                        <hr />
            ...
            <div class="modal-footer">
                <!-- <button type="button" class="btn btn-success" data-dismiss="modal" id="js-edit-modal-save-btn">RESPOND</button> -->
                <button type="button" class="btn btn-success" data-dismiss="modal" id="js-cancel-btn">CLOSE</button>
            </div>
        </div>
  </div>
</div>
...
.pto-tabs .nav-tabs > li.active > a{
    color: #81c432 !important;
}

                    ...
                    <div class="col-sm-12">
                        ...
                        <div>
                            ...
                            <label class="control control--radio">
                                <input type="radio" class="is_course_expired" name="is_course_expired" value="yes" <?php echo isset($lms) && $lms['is_course_expired'] == 'yes' ? 'checked="checked"' : ''; ?>/> Yes &nbsp;
                                <div class="control__indicator"></div>
                            </label>
                            <label class="control control--radio">
                                <input type="radio" class="is_course_expired" name="is_course_expired" value="no" <?php echo isset($lms) && $lms['is_course_expired'] == 'no' ? 'checked="checked"' : $default_check; ?> /> No &nbsp;
                                <div class="control__indicator"></div>
                            </label>
                        </div>
                    </div>
                            ...
                            <div class="hr-innerpadding">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 col-xs-12">
                                        <input type="text" value="<?php echo isset($lms) ? $lms['expired_number'] : ''; ?>" class="form-control" id="course_expired_day" placeholder="2" /> 
                                    </div>
                                    <div class="col-sm-3 col-xs-12">
                    ...
                    <div class="col-sm-12">    
                        <div class="form-group">
                            ...
                            <div>
                                ...
                                <label class="control control--radio">
                                    <input type="radio" name="course_status" value="1" checked="checked" /> Active &nbsp;
                                    <div class="control__indicator"></div>
                                </label>
                                <label class="control control--radio">
                                    <input type="radio" name="course_status" value="0" /> Inactive &nbsp;
                                    <div class="control__indicator"></div>
                                </label>
                            </div>
                        </div>

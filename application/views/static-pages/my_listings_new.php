                            ...
                            <div class="table-wrp">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><input type="checkbox"></td>
                                            <td width="40%">New job new theme</td>
                                            <td>12-07-2015</td>
                                            <td>Yes</td>
                                            <td>6</td>
                                            <td>
                                            ...
                                            <td>
                                                <a class="action-btn deactivate" href="javascript:;">
                                                    ...
                                                    <span class="btn-tooltip">Activate Job</span>
                                                </a>
                                            </td>
                                            <td>
                                                <a class="action-btn clone-job" href="javascript:;">
                                        ...
                                        <tr>
                                            <td><input type="checkbox"></td>
                                            <td width="40%">Retail Clothing Sales Specialist -TEAM LATUS MOTORS </td>
                                            <td>12-07-2015</td>
                                            <td>Yes</td>
                                            <td>6</td>
                                            <td>

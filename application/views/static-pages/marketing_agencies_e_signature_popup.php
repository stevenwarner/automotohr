        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_e_signature" enctype="multipart/form-data" method="post" action="<?= base_url() ?>onboarding/ajax_e_signature">
                    ...
                    <input type="hidden" id="affiliate_and_license_record_sid" name="affiliate_and_license_record_sid" value="<?php echo $company_document['sid']; ?>" />
                    <input type="hidden" id="marketing_agency_sid" name="marketing_agency_sid" value="<?php echo $agent_record['sid']; ?>" />
                    <input type="hidden" id="marketing_agency_email" name="marketing_agency_email" value="<?php echo $agent_record['email']; ?>" />
                    <input type="hidden" id="marketing_agency_ip_address" name="marketing_agency_ip_address" value="<?php echo getUserIP(); ?>" />
                    <input type="hidden" id="marketing_agency_user_agent" name="marketing_agency_user_agent" value="<?php echo $_SERVER['HTTP_USER_AGENT']; ?>" />
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-xs-8"><?php echo ucwords($agent_record['full_name']); ?></td>
                                    </tr>
                                    <tr>
                                        <th class="col-xs-4">Email</th>
                                        <td class="col-xs-8"><?php echo $agent_record['email']; ?></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                            <div class="form-wrp">
                                ...
                                <div class="form-group autoheight" id="upload_init_img"></div>
                                <div class="custom_loader">
                                    <div id="loader" class="loader" style="display: none">
                                        <i style="font-size: 25px; color: #81b431;" class="fa fa-cog fa-spin"></i>
                                        <span>Uploading...</span>
                        ...
                        <div class="col-xs-12">
                            <div class="form-col-100">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-xs-7 col-sm-9">
                                <span>
                                    <?php $date_time = date('m/d/Y h:i A'); ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <button onclick="common_func_save_e_signature();" type="button" class="btn btn-success break-word-text" <?php echo $consent == 1 ? 'disabled="disabled"' : '' ?>><?php echo DEFAULT_SIGNATURE_CONSENT_BUTTON; ?></button>
                        </div>
                    </div>
                </form>
            </div>
...
<script type="text/javascript">
    ...
    inputBox.onkeyup = function(){ 
        // var type_signature = capitalize_Words(inputBox.value);
    ...
    //  This function take string and convert first character into
    //  capital of each word.
    ...
    //  This function save signature in different tables but not in 
    //  e_signature_data table in DB through Common helper and 
    //  E_Signature.php controller and function name is "ajax_agent_e_signature".
    function save_e_signature () {
        setTimeout(function(){

            var myurl = "<?= base_url() ?>E_signature/ajax_agent_e_signature";
            $.ajax({
                type: 'POST',
    ...
    //  its e_signature exist in specific tables then populate it in 
    //  e_signature image tag, if it's not exist then show e_signature_popup 
    //  model to take login user e_signature.
    function common_get_e_signature () {
        
        var page_url = $('#page_url').val();
        var marketing_agency_sid = '<?php echo $agent_record['sid']; ?>';
        var record_sid = '<?php echo $company_document['sid']; ?>';
        var user_type = '<?php echo $user_type; ?>';
        var myurl = "<?= base_url() ?>E_signature/get_agent_signature/"+marketing_agency_sid+"/"+record_sid+"/"+user_type+"/"+page_url;
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data == false){
                    ...
                    $('#signature_base64').val(src);
                    $('#signature_bas64_image').val(src);
                    $('#draw_upload').show();
                    $('.get_signature').hide();
                }
            },

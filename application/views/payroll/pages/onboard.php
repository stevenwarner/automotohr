...
<div class="container-fluid">
    <div class="csPageWrap">
        ...
        <div class="row">
            <div class="col-sm-12">
                <button class="btn btn-orange csF16 csB7 <?=$hasPrimaryAdmin ? 'jsPayrollMoveCompanyToPayroll' : 'disabled';?> ">
                    <i class="fa fa-long-arrow-right" aria-hidden="true"></i>&nbsp;
                    Continue
                </button>
                <?php if(!$hasPrimaryAdmin): ?>
                    <button class="btn btn-orange csF16 csB7 jsPayrollSetAdmin">
                        <i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;
                        Set Admin
                    </button>
                <?php else: ?>
                    <button class="btn btn-orange csF16 csB7 jsPayrollViewAdmin">

                                    ...
                                    <div class="csPR">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-xs-12 text-right">
                                                ...
                                                <button class="btn btn-success csF16 csB7 jsTaxRefresh"><i
                                                        class="fa fa-refresh csF16" aria-hidden="true"></i>&nbsp;Refresh
                                                    Status</button>
                                                <?php } ?>
                                                <button class="btn btn-success csF16 csB7 jsTaxHistory"><i
                                                        class="fa fa-eye csF16" aria-hidden="true"></i>&nbsp;Show Tax
                                                    History</button>
                                            </div>
                                        </div>
                                        <!--  -->
                                        <div class="row">
                                            <div class="col-md-12 col-xs-12 text-left">
                                                <label class="csF16">EIN Verified: <strong
                                                        class="jsStatus">NO</strong></label>
                                                <p class="csF14 jsLastModified dn">Last modified by <strong
                                                        class="jsLastModifiedPerson"></strong> on <strong
                                                        class="jsLastModifiedTime"></strong></p>
                                            </div>
                                        </div>
                                        <br>
                                        <!--  -->
                                        <div class="row">
                                            <div class="col-md-12 col-xs-12">
                                                <p class="csF14 csB7">Fields marked with an asterisk (<span
                                                        class="csRequired"></span>) are mandatory.</p>
                                            </div>
                                        </div>
                                        <!--  -->
                                        <div class="row">
                                            <div class="col-md-12 col-xs-12">
                                                ...
                                                <input type="text" class="form-control jsTaxLegalName"
                                                    placeholder="AutomotoHR" />
                                            </div>
                                        </div>
                                        <br>
                                        <!--  -->
                                        <div class="row">
                                            <div class="col-md-12 col-xs-12">
                                                ...
                                                <p class="csF14">The EIN of of the company.</p>
                                                <input type="text" class="form-control jsTaxEIN"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-xs-12">
                                                ...
                                                <p class="csF14">What type of tax entity the company is.</p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-xs-12">
                                                ...
                                                <p class="csF14">The form used by the company for federal tax
                                                    filing.</p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-xs-12">
                                                ...
                                                <p class="csF14">Whether the company is taxed as an
                                                    S-Corporation.</p>
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 text-right">
                                                <button class="btn btn-success csF16 csB7 jsTaxUpdateBtn">
                                                    <i class="fa fa-edit csF16" aria-hidden="true"></i>&nbsp;Update
                                                    Company Tax
                                                </button>
                                            </div>
                                        </div>

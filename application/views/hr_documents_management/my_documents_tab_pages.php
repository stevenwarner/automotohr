                                                    ...
                                                    <?php if (!empty($completed_w4)) { ?>
                                                        <?php foreach ($completed_w4 as $w4_form) { ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="col-lg-2">
                                                                    <a href="javascript:;" data-type="W4_Form" data-status="<?php echo $w4_form['form_status']; ?>" data-doc_sid="<?php echo $w4_form['sid']; ?>" class="btn btn-info btn-block jsShowVarificationDocument" title="" placement="top" data-original-title="View W4 form">View Sign</a>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
                                                    <?php } ?>
                                                    ...
                                                    <?php if (!empty($completed_w9)) { ?>
                                                        <?php foreach ($completed_w9 as $w9_form) { ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="col-lg-2">
                                                                    <a href="javascript:;" data-type="W9_Form" data-status="<?php echo $w9_form['form_status']; ?>" data-doc_sid="<?php echo $w9_form['sid']; ?>" class="btn btn-info btn-block jsShowVarificationDocument" title="" placement="top" data-original-title="View W9 form">View Sign</a>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
                                                    <?php } ?>
                                                    ...
                                                    <?php if (!empty($completed_i9)) { ?>
                                                        <?php foreach ($completed_i9 as $i9_form) { ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="col-lg-2">
                                                                    <a href="javascript:;" data-type="I9_Form" data-status="<?php echo $i9_form['form_status']; ?>" data-doc_sid="<?php echo $i9_form['sid']; ?>" class="btn btn-info btn-block jsShowVarificationDocument" title="" placement="top" data-original-title="View I9 form">View Sign</a>
                                                                </td>

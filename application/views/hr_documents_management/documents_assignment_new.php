                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="hr-box">
                                        <div class="hr-box-header">
                                            All Document
                                            <?=getDocumentTabPagesButton([], 'manual_document_upload', ['action_btn_flag' => $action_btn_flag]) ?>  
                                            <?=getDocumentTabPagesButton([], 'add_offer_letter', ['action_btn_flag' => $action_btn_flag]) ?> 
                                            <?=getDocumentTabPagesButton([], 'add_specific_document', ['user_type' => $user_type, 'user_sid' => $EmployeeSid, 'action_btn_flag' => $action_btn_flag]) ?>  
                                            <?=getDocumentTabPagesButton([], 'add_bulk_documents', ['user_type' => $user_type, 'user_sid' => $EmployeeSid, 'bulk_btn_access' => $bulk_btn_access]) ?>
                                        </div>
                                        <div class="hr-innerpadding">
                                                                ...
                                                                <div class="panel panel-default hr-documents-tab-content js-search-header">
                                                                    <div class="panel-heading">
                                                                        <h4 class="panel-title">
                                                                            ...
                                                                            <?=getDocumentTabPagesButton([], 'document_groups', ['user_type' => $user_type, 'user_sid' => $user_sid, 'action_btn_flag' => $action_btn_flag, 'active_group' => $active_group, 'assigned_groups' => $assigned_groups]) ?>
                                                                        </h4>
                                                                    </div>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <?php if (in_array($document['sid'], $assigned_sids) || in_array($document['sid'], $revoked_sids) || in_array($document['sid'], $completed_sids) || in_array($document['sid'], $signed_document_sids)) { ?>
                                                                                                                ...
                                                                                                                <?php if (in_array($document['sid'], $assigned_sids)) { ?>
                                                                                                                    <!-- revoke here  -->
                                                                                                                    <?=getDocumentTabPagesButton($document, 'revoke_assigned_document', ['permissions' => $document_all_permission, 'current_url' => current_url()]) ?>
                                                                                                                    <?php if (array_key_exists($document['sid'], $assignIdObj)) { ?>
                                                                                                                        <?=getDocumentTabPagesButton($document, 'modify_document', ['data_type' => 'notCompletedDocuments','permissions' => $document_all_permission, 'location' => "group"]) ?>
                                                                                                                    <?php }
                                                                                                                    ?>
                                                                                                                <?php } else if (in_array($document['sid'], $signed_document_sids)) { ?>
                                                                                                                    <?=getDocumentTabPagesButton($document, 'modify_assign_document', ['text' => 'Completed and Reassign', 'color' => 'blue-button','permissions' => $document_all_permission]) ?>
                                                                                                                <?php } else { ?>
                                                                                                                    <?=getDocumentTabPagesButton($document, 'modify_assign_document', ['text' => 'Modify and Reassign', 'color' => 'btn-warning','permissions' => $document_all_permission]) ?>
                                                                                                                <?php } ?>
                                                                                                            <?php } else { ?>
                                                                                                                <?=getDocumentTabPagesButton($document, 'modify_assign_document', ['text' => 'Modify and Assign', 'color' => 'btn-success','permissions' => $document_all_permission]) ?>
                                                                                                            <?php } ?>
                                                                                                        </td>
                                                                                                    <?php } ?>
                                                                                                <?php } ?>
                                                                                                <td>
                                                                                                    <?=getDocumentTabPagesButton($document, 'preview_company') ?>
                                                                                                </td>
                                                                                                <td>
                                                                                                    <?=getDocumentTabPagesButton($document, 'print', ['document_tab' => 'company']) ?>
                                                                                                </td>
                                                                                                <td>
                                                                                                    <?=getDocumentTabPagesButton($document, 'download', ['document_tab' => 'company']) ?>
                                                                                                </td>
                                                                                            </tr>
                                                                                        <?php } ?>
                                                                                    <?php } else { ?>
                                                                                            ...
                                                                                            <td>
                                                                                                <?php if (in_array($document['sid'], $assigned_sids) || in_array($document['sid'], $revoked_sids) || in_array($document['sid'], $completed_sids) || in_array($document['sid'], $signed_document_sids)) { ?>
                                                                                                    <?php if (in_array($document['sid'], $assigned_sids)) { ?>
                                                                                                        ...
                                                                                                        <?=getDocumentTabPagesButton($document, 'revoke_assigned_document', ['permissions' => $action_btn_flag, 'current_url' => current_url()]) ?>

                                                                                                        <?php if (array_key_exists($document['sid'], $assignIdObj)) { ?>
                                                                                                            <?=getDocumentTabPagesButton($document, 'modify_document', ['data_type' => 'notCompletedDocuments','permissions' => $action_btn_flag, 'location' => "group"]) ?>
                                                                                                        <?php } ?>
                                                                                                    <?php } else if (in_array($document['sid'], $signed_document_sids)) { ?>
                                                                                                        <?=getDocumentTabPagesButton($document, 'modify_assign_document', ['text' => 'Completed and Reassign', 'color' => 'blue-button','permissions' => $action_btn_flag]) ?>
                                                                                                    <?php } else { ?>
                                                                                                        <?=getDocumentTabPagesButton($document, 'modify_assign_document', ['text' => 'Modify and Reassign', 'color' => 'btn-warning','permissions' => $action_btn_flag]) ?>
                                                                                                    <?php } ?>
                                                                                                <?php } else { // assign here 
                                                                                                ?>
                                                                                                    <?=getDocumentTabPagesButton($document, 'modify_assign_document', ['text' => 'Modify and Assign', 'color' => 'btn-success','permissions' => $action_btn_flag]) ?>
                                                                                                <?php } ?>
                                                                                            </td>
                                                                                        <?php } ?>
                                                                                        <td>
                                                                                    ...
                                                                                    <?php foreach ($access_level_manual_doc as $document) { ?>
                                                                                        <?php if ($document['document_type'] == 'confidential') { ?>
                                                                                            <tr class="js-search-row">
                                                                                                ...
                                                                                                <td>
                                                                                                    <?=getDocumentTabPagesButton($document, 'preview_assigned',['button_text' => "View Doc"]) ?>
                                                                            ...
                                                                            <?php if (count($archived_assign_document) > 0) { ?>
                                                                                <?php foreach ($archived_assign_document as $document) {
                                                                                    ...
                                                                                    <tr class="js-search-row">
                                                                                        ...
                                                                                        <td class="col-lg-1">
                                                                                            <?=getDocumentTabPagesButton($document, 'edit_manual_document', ['action_btn_flag' => $action_btn_flag, 'permissions' => $action_btn_flag, 'data_type' => 'noActionDocuments', 'no_action_document_categories' => $archived_no_action_document_categories]) ?>
                                                                                        </td>
                                                                                        <td class="col-lg-1">
                                                                                            <?=getDocumentTabPagesButton($document, 'activate_archived_document', ['permissions' => $action_btn_flag, 'current_url' => current_url()]) ?>
                                                                                        </td>
                                                                                        <td class="col-lg-1">
                                                                                            <?=getDocumentTabPagesButton($document, 'preview_assigned',['button_text' => "View Doc"]) ?>
                                                                                        </td>
                                                                            ...
                                                                            <?php if (count($user_assigned_manual_documents) > 0) { ?>
                                                                                <?php foreach ($user_assigned_manual_documents as $document) { ?>
                                                                                    <tr class="js-search-row">
                                                                                        ...
                                                                                        <td class="col-lg-1">
                                                                                            <?=getDocumentTabPagesButton($document, 'archive_manual_upload_document', ['action_btn_flag' => $action_btn_flag, 'permissions' => $action_btn_flag, 'security_details' => $security_details, "current_url" => current_url()]) ?>
                                                                                        </td>
                                                                                        <td class="col-lg-1">
                                                                                            <?=getDocumentTabPagesButton($document, 'preview_assigned',['button_text' => "View Doc"]) ?>
                                                                                        </td>
                                        ...
                                        <div class="hr-innerpadding">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                                    <div class="form-group">
                                                        <label>Last Name (Family Name) <span class="staric">*</span> <i aria-hidden="true" class="fa fa-question-circle-o modalShow" src="section_7_last_name"></i>
                                                        </label>
                                                        <input type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['section1_last_name'] : '' ?>" class="form-control" name="section3_pre_last_name" <?php if (!$this->session->userdata('logged_in')['employer_detail']['access_level_plus']) {
                                                                                                                                                                                                                        echo 'readonly';
                                                                                                                                                                                                                    } ?>>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                                    <div class="form-group">
                                                        <label>First Name (Given Name) <span class="staric">*</span> <i aria-hidden="true" class="fa fa-question-circle-o modalShow" src="section_7_first_name"></i></label>
                                                        <input type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['section1_first_name'] : '' ?>" class="form-control" name="section3_pre_first_name" <?php if (!$this->session->userdata('logged_in')['employer_detail']['access_level_plus']) {
                                                                                                                                                                                                                        echo 'readonly';
                                                                                                                                                                                                                    } ?>>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['section1_middle_initial'] : '' ?>" class="form-control" name="section3_pre_middle_initial" <?php if (!$this->session->userdata('logged_in')['employer_detail']['access_level_plus']) {
                                                                                                                                                                                                                                echo 'readonly';
                                                                                                                                                                                                                            } ?>>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="hr-innerpadding">
                                                            <div class="row">
                                                                <div class="col-lg-4 col-md-6 col-xs-12 col-sm-6">
                                                                    <div class="form-group">
                                                                        <label>Document Title <i aria-hidden="true" class="fa fa-question-circle-o modalShow" src="section_8_document_title"></i></label>
                                                                ...
                                                                <div class="col-lg-4 col-md-6 col-xs-12 col-sm-6">
                                                                    <div class="form-group">
                                                                        <label>Document Number <i aria-hidden="true" class="fa fa-question-circle-o modalShow" src="section_8_document_number"></i></label>
                                                    ...
                                                    <div class="hr-box">
                                                        <div class="hr-innerpadding">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4 col-md-12 col-xs-12 col-sm-12">
                                                                    <div class="form-group">
                                                                        <label>Name of Authorized Representative <span class="staric">*</span> <i aria-hidden="true" class="fa fa-question-circle-o modalShow" src="section_8_authorized"></i></label>

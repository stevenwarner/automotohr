                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                            ...
                            <div class="col-lg-8 col-md-8 col-xs-12 col-sm-12">
                                ...
                                <form id="form_upload_document" enctype="multipart/form-data" method="post" action="<?php echo current_url(); ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <input type="hidden" name="document_title" value="<?php
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12"><br><label> Description</label>

                                            <?php
                                            $fillableView = 'hr_' . str_replace('-', '_', $document_info['fillable_documents_slug']);
                                            ?>
                                            <div style="margin-bottom:5px;"><?php $this->load->view('v1/fillable_documents/' . $fillableView); ?></div>

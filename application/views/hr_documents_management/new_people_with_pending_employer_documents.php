                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select id="js-filter-employees" name="employees[]"
                                                                            multiple="true">
                                                                            <?php 
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <span class="pull-right">
                                                                        <button
                                                                            class="btn btn-success js-filter-search">Search</button>
                                                                        <button type="button"
                                                                            class="btn btn-success js-filter-clear">Clear
                                                                            Filter</button>
                                                                    </span>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    foreach ($pendingAD as $employeeId => $employee) {
                                                                        ...
                                                                        ?>
                                                                                <tr data-id="<?=$employeeId;?>">
                                                                                    ...
                                                                                    <td><?=$name;?></td>
                                                                                    <td class="text-right">
                                                                                        <a class=" btn-sm btn-default csCP jsToggleDocuments"
...
$(function() {
    ...
    $('.jsSendEmailReminder2').click(function(event){
        ...
        employeeList.map(function(emp){
            //
            if(emp.access_level_plus == "1") {
                selectedEmployees[emp.sid] = true;
            }
        });
        //
       dd();

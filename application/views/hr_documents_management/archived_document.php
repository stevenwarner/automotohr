                                                                                ...
                                                                                <td class="col-xs-1">
                                                                                    ...
                                                                                    <?php                                                           } else { ?>
                                                                                        <?php if ($document['fillable_documents_slug'] != null && $document['fillable_documents_slug'] != '') { ?>
                                                                                            ...
                                                                                            <button class="btn btn-info btn-sm btn-block" onclick="fLaunchModalFillable(this);" data-preview-url="<?php echo $document['fillable_documents_slug']; ?>" data-download-url="" data-print-url="test_file_01" data-document-sid="<?php echo $document['sid']; ?>" data-file-name="" data-document-title="<?php echo $document['fillable_documents_slug']; ?>">Preview</button>
                                                                                        <?php } else { ?>
...
<script>
    ...
    function fLaunchModalFillable(source) {
        ...
        let title_text = $(source).attr('data-document-title');;
        let doc_title = title_text.replace(/-/g, " ");


        var url_segment_original = $(source).attr('data-print-url');
        var document_preview_url = $(source).attr('data-preview-url');
        var document_download_url = $(source).attr('data-download-url');
        var document_title = doc_title.charAt(0).toUpperCase() + doc_title.slice(1);
        var document_file_name = $(source).attr('data-file-name');

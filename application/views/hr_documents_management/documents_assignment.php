                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php if ($this->session->userdata('logged_in')['portal_detail'][$user_type == 'applicant' ? 'eeo_on_applicant_document_center' : 'eeo_on_employee_document_center']) { ?>
                                                                <tr>
                                                                    <td class="col-lg-2">
                                                                        EEOC FORM
                                                                        <img class="img-responsive pull-left" style=" width: 22px; height: 22px; margin-right:5px;" alt="" title="Signed" data-toggle="tooltip" data-placement="top" src="<?php echo site_url('assets/manage_admin/images/' . ($eeo_form_info['status'] && $eeo_form_info['is_expired'] ? 'off' : 'on') . '.gif'); ?>">
                                                                    </td>
                                                                    <td class="col-lg-1 text-center">
                                                                        <i aria-hidden="true" class="fa fa-2x fa-file-text"></i>
                                                                    </td>

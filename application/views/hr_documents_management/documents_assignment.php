...
<style>
    #model_generated_offer_letter .select2-container--default .select2-selection--multiple .select2-selection__rendered{ height: auto !important; }
    #collapse_adh_1 .nav-justified .active .jsTabBTN{ color: #fff !important; }
</style>
                                                                                            ...
                                                                                            <tr class="js-search-row">
                                                                                                ...
                                                                                                <td>
                                                                                                    <button class="btn btn-success btn-sm btn-block"
                                                                                                        ...
                                                                                                        data-s3-name="<?php echo $document['document_s3_name']; ?>">View Doc</button>        
                                                                                        ...
                                                                                        <td class="col-lg-1">
                                                                                            <?php if ($document['document_type'] == 'hybrid_document') { ?>
                                                                                                <button 
                                                                                                    ...
                                                                                                    data-type="document"
                                                                                                    class="btn btn-success btn-sm btn-block js-hybrid-preview">View Doc</button>
                                                                                            ...
                                                                                            <?php } else { ?> 
                                                                                                <button class="btn btn-success btn-sm btn-block"
                                                                                                    ...
                                                                                                    data-on-action="assigned"
                                                                                                    data-from="assigned_document">View Doc</button>
                                                                                            <?php } ?>               
                                                                                        </td>
                                                                                        <?php if ($document['document_type'] == 'hybrid_document'){?>
                                                                                        <td colspan="2"></td>
                                    ...
                                    <div class="hr-innerpadding">
                                        <div class="row">
                                            ...
                                            if (sizeof($pre_form) > 0) {
                                                ...
                                                if($pre_form['section1_penalty_of_perjury'] == 'citizen'){$citizen ='1';}
                                                if($pre_form['section1_penalty_of_perjury'] == 'noncitizen'){$citizen ='2';}
                                                if($pre_form['section1_penalty_of_perjury'] == 'permanent-resident'){$citizen ='3';}
                                                if($pre_form['section1_penalty_of_perjury'] == 'alien-work'){$citizen ='4';}
...
<script>
    $(function(){
        ...
        function SearchDocumentProcessStart(e){
            ...
            setTimeout(function(){ SearchDocument( e.key, s );}, 200 );
        }

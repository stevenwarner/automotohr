                                    ...
                                    <div class="hr-innerpadding">
                                        <div class="row">
                                            ...
                                            if (sizeof($pre_form) > 0) {
                                                $citizen = ''; 
                                                if($pre_form['section1_penalty_of_perjury'] == 'citizen'){
                                                    $citizen = 1;
                                                 }
                                                 if($pre_form['section1_penalty_of_perjury'] == 'noncitizen'){
                                                    $citizen = 2;
                                                 }
                                                 if($pre_form['section1_penalty_of_perjury'] == 'permanent-resident'){
                                                    $citizen = 3;
                                                 }
                                                 if($pre_form['section1_penalty_of_perjury'] == 'alien-work'){
                                                    $citizen = 4;
                                                 }
                                            }
                                            ?>

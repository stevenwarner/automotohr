                                                        ...
                                                        <td class="col-lg-1 text-center">
                                                            ...
                                                            <?php } else { ?>
                                                                ...
                                                                <?php if ($document['fillable_documents_slug'] != null && $document['fillable_documents_slug'] != '') { ?>
                                                                    <button class="btn btn-success btn-sm btn-block" onclick="fLaunchModalFillable(this);" date-letter-type="generated" data-on-action="assigned" data-preview-url="<?php echo $document['fillable_documents_slug']; ?>" data-s3-name="<?php echo $document['fillable_documents_slug']; ?>" data-document-sid="<?php echo $document['sid']; ?>" data-document-title="Assigned Document">
                                                                        Preview Assigned
                                                                    </button>
                                                                <?php } else { ?>
...
<script type="text/javascript">
    ...
    function fLaunchModalFillable(source) {
        ...
        if (document_preview_url != '') {
            iframe_url = 'http://automotohr.local/v1/fillable_documents/previeFillable/' + document_preview_url;
            modal_content = '<iframe src="' + iframe_url + '" id="preview_iframe" class="uploaded-file-preview"  style="width:100%; height:500px;" frameborder="0"></iframe>';
        } else {
            modal_content = '<h5>No ' + document_title + ' Uploaded.</h5>';
            footer_content = '';
        ...
        //
        var download_url = '';
        var print_url = 'http://automotohr.local/v1/fillable_documents/PrintPrevieFillable/' + document_preview_url + '/' + document_sid + '/original/' + 'print';
        var download_url = 'http://automotohr.local/v1/fillable_documents/PrintPrevieFillable/' + document_preview_url + '/' + document_sid + '/original/' + 'download';

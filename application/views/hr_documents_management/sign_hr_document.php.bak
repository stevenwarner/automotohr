                                ...
                                <div class="row">
                                    <div class="col-xs-12" id="required_fields_div" style="padding: 0 30px">
                                        <?php if ((isset($document['document_type']) && $document['document_type'] == 'hybrid_document') || (isset($document['letter_type']) && $document['letter_type'] == 'hybrid_document')) { ?>
                                            ...
                                            <?php if ($consent == 0 || ($consent == 1 && !empty($document['form_input_data']))) { ?>
                            ...
                            <?php if (!empty($attached_video) && $attached_video['video_required'] == 1 && !empty($attached_video['video_source'])) { ?>
                                <div class="hr-box">
                                    <div class="alert alert-info">
                                        <strong>Attachment Videos</strong>
                                    </div>
                                    <div class="hr-innerpadding">
                                        <div class="row">
                                            <div class="col-xs-12">
...
<script>
    $(document).ready(function () {
        ...
        kendo.pdf.defineFont({
            ...
            "DejaVu Sans|Bold|Italic": "<?php echo base_url('assets/employee_panel/fonts/DejaVuSans-Oblique.ttf'); ?>",
            "DejaVu Sans|Italic": "<?php echo base_url('assets/employee_panel/fonts/DejaVuSans-Oblique.ttf'); ?>",
            "WebComponentsIcons": "<?php echo base_url('assets/employee_panel/fonts/WebComponentsIcons.ttf'); ?>"
        });
    ...
    function save_print() {
        ...
        var myurl = "<?= base_url() ?>Hr_documents_management/downloaded_generated_doc/" + user_sid + "/" + company_sid + "/" + document_sid + "/employee";

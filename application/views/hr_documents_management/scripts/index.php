...
<script>
	...
	$(function() {
		...
		function getTags() {
			...
			rows += '        <div class="col-md-6">';
			rows += '            <div class="form-group autoheight">';
			rows += '                <input type="text" class="form-control tag" readonly="" value="{{short_text_required}}">';
			rows += '            </div>';
			rows += '        </div>';
			rows += '        <div class="col-md-6">';
			rows += '            <div class="form-group autoheight">';
			rows += '                <input type="text" class="form-control tag" readonly="" value="{{text_required}}">';
			rows += '            </div>';
			rows += '        </div>';
			rows += '        <div class="col-md-6">';
			rows += '            <div class="form-group autoheight">';
			rows += '                <input type="text" class="form-control tag" readonly="" value="{{text_area_required}}">';
			rows += '            </div>';
			rows += '        </div>';
			rows += '        <div class="col-md-6">';
			rows += '            <div class="form-group autoheight">';
			rows += '                <input type="text" class="form-control tag" readonly="" value="{{checkbox_required}}">';
			rows += '            </div>';
			rows += '        </div>';
			rows += '    </div>';
			rows += '    <div class="tags-arae">';

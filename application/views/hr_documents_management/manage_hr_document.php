                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="document-action-required">
                                                    ...
                                                    <?php if ($document['document_type'] == 'hybrid_document') { ?>
                                                        <a target="_blank" href="<?= base_url('hr_documents_management/pd/assigned/print/both/' . ($document['sid']) . ''); ?>" class="btn btn-success pull-right margin-right">
                                                    ...
                                                    <?php } else { ?>
                                                        ...
                                                        <?php } else { ?>
                                                            <a class="btn <?php echo $btn_class; ?> pull-right margin-right" href="javascript:void(0);" onclick="fLaunchModal(this);" data-preview-url="<?= AWS_S3_BUCKET_URL . $document_filename; ?>" data-download-url="<?= AWS_S3_BUCKET_URL . $document_filename; ?>" data-file-name="<?php echo $document_filename; ?>" data-document-title="<?php echo $document_filename; ?>" data-preview-ext="<?php echo $document_extension ?>">Print Assigned Document</a>
                                                        <?php } ?>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
                                                                ...
                                                                <?php if (!empty($document['uploaded_file'])) { ?>
                                                                    ...
                                                                    <a class="btn btn-success btn-equalizer btn-block" href="javascript:void(0);" onclick="fLaunchModal(this);" data-preview-url="<?= AWS_S3_BUCKET_URL . $document_filename; ?>" data-download-url="<?= AWS_S3_BUCKET_URL . $document_filename; ?>" data-file-name="<?php echo $document_filename; ?>" data-document-title="<?php echo $document_filename; ?>" data-preview-ext="<?php echo $document_extension ?>">Preview Uploaded</a>
                                                                <?php } ?>
                                                                <?php

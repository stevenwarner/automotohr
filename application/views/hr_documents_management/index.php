                                                                        ...
                                                                        foreach ($active_group['documents'] as $document) { ?>
                                                                            <tr>
                                                                                ...
                                                                                <td class="col-xs-1">
                                                                                    ...
                                                                                    <?php } elseif ($document['fillable_documents_slug'] != null && $document['fillable_documents_slug'] != '') { ?>
                                                                                        <button class="btn btn-info btn-sm btn-block" onclick="fLaunchModalFillable(this);" data-preview-url="<?php echo $document['fillable_documents_slug']; ?>" data-download-url="<?php echo AWS_S3_BUCKET_URL . $document['uploaded_document_s3_name']; ?>" data-print-url="<?php echo $url_segment_original; ?>" data-document-sid="<?php echo  $document['sid']; ?>" data-file-name="<?php echo $document['uploaded_document_original_name']; ?>" data-document-title="<?php echo $document['document_title']; ?>">Preview</button>
                                                                                    <?php } else if ($document['document_type'] == 'uploaded') {
                                                                        ...
                                                                        foreach ($active_group['documents'] as $document) { ?>
                                                                            <tr>
                                                                                ...
                                                                                <td class="col-xs-1">
                                                                                    <?php if ($document['fillable_documents_slug'] != null && $document['fillable_documents_slug'] != '') { ?>
                                                                                        <button class="btn btn-info btn-sm btn-block" onclick="fLaunchModalFillable(this);" data-preview-url="<?php echo $document['fillable_documents_slug']; ?>" data-download-url="<?php echo AWS_S3_BUCKET_URL . $document['uploaded_document_s3_name']; ?>" data-print-url="<?php echo $url_segment_original; ?>" data-document-sid="<?php echo  $document['sid']; ?>" data-file-name="<?php echo $document['uploaded_document_original_name']; ?>" data-document-title="<?php echo $document['document_title']; ?>">Preview</button>
                                                                                    <?php } elseif ($document['document_type'] == 'uploaded') {
                                                                                        $document_filename = !empty($document['uploaded_document_s3_name']) ? $document['uploaded_document_s3_name'] : '';
                                                                                        $document_file = pathinfo($document_filename);
                                                                                        $name = explode(".", $document_filename);
                                                                                        $url_segment_original = $name[0]; ?>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="panel panel-default ems-documents">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse_fillable_documents">
                                                        <span class="glyphicon glyphicon-plus"></span>
                                                        Fillable Documents
                                                        <div class="btn btn-xs btn-info">Uncategorized</div>
                                                        <div class="pull-right total-records"><b><?php echo 'Total: ' . count($uncategorized_documents); ?></b></div>
                                            ...
                                            <div id="collapse_fillable_documents" class="panel-collapse collapse">
                                                <div class="table-responsive">
                                                    <table class="table table-plane">
                                                        <thead>
                                                            <tr>

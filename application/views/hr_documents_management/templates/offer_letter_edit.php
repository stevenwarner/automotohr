					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<label class="control control--checkbox">
								Visible To Payroll
								<input type="checkbox" name="visible_to_payroll" class="js-payroll-offer-letter-edit" value="1"/>
								<div class="control__indicator"></div>
							</label>
							<hr />
							<!-- Roles -->
							<label>Roles</label>
							<select name="roles[]" id="js-roles-offer-letter-edit" multiple>
							</select>
							<br />
							<br />
							<!-- Departments -->
							<label>Departments</label>
							<select name="departments[]" id="js-department-offer-letter-edit" multiple>
							</select>
							<br />
							<br />
							<!-- Teams -->
							<label>Teams</label>
							<select name="teams[]" id="js-teams-offer-letter-edit" multiple>
							</select>
							<br />
							<br />
							<!-- Employees -->
							<label>Employees</label>
							<select name="employees[]" id="js-employees-offer-letter-edit" multiple>
							</select>
						</div>
					</div>
				</div>

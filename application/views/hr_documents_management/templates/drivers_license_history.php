...
<div class="row">
    <div class="col-sm-12 col-xs-12">
        <div class="panel panel-success">
            ...
            <span class="glyphicon glyphicon-plus" style="color: #fff;"> </span> <a data-toggle="collapse" href="#collapse<?=$k;?>" style="color: #fff;"><?=reset_datetime(array('datetime' => $v['logged_at'],'format' => 'M d Y, D H:i:s', '_this' => $this));?></a>   </div>

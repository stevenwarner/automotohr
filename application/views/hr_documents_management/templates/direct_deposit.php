...
<div class="A4">
    ...
    <div id="jsPDF" style="width: 100%; margin: auto;">
        <div>
            <div class="row">
                <div class="col-xs-12">
            ...
            <div class="row" style="margin-bottom: 10px;">
                ...
                <div class="col-sm-12">
                    <p class="text-justify text-danger">
                        <stron>Note: Describes how the payment will be split. If Deposit Type is Percentage, then the split amounts must add up to exactly 100. If Deposit Type is Amount, then the last split amount must be nil to capture the remainder.</stron>
                    </p>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    ...
                    <p><input type="text" style="width: 100%" value="<?= $employee_number; ?>" /></p>
                </div>
            </div>

                    ...
                    <div class="row">
                        <div class="col-xs-12" style="margin-bottom: 12px;">
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 text-right">
                                <a target="_blank" class="btn btn-success" href="<?php echo base_url('hr_documents_management/perform_action_on_document_content').'/'.$document['sid'].'/'.$document_status.'/'.'assigned_document/print'; ?>">Print</a>
                                <a target="_blank" class="btn btn-success" href="<?php echo base_url('hr_documents_management/perform_action_on_document_content').'/'.$document['sid'].'/'.$document_status.'/'.'assigned_document/download'; ?>">Download</a>
                            </div>
                        </div>
                    </div> 

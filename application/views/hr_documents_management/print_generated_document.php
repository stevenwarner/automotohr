...
<body cz-shortcut-listen="true">
    <main role="main" class="container">
        <section class="sheet padding-10mm" id="download_generated_document">
            ...
            <?php } else if ($document_type == 'generated') {
                echo html_entity_decode($original_document_description);
            ?>
            <?php     } else if ($document_type == 'hybrid_document') { ?>

                <?php echo html_entity_decode($document_description); ?>

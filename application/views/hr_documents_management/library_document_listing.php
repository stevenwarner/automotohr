                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                            <div class="page-header full-width">
                                ...
                                <p>
                                <strong class="text-danger csF18"><i>This "Employee Forms Library" allows Employee Team Members the ability to initiate and complete forms on their own.</i></strong></p>

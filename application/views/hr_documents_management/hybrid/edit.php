                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-md-8 col-xs-12 col-sm-12">
                                    ...
                                    <form id="form_new_document" enctype="multipart/form-data" method="post" action="<?=base_url('hr_documents_management/hybrid_document/edit/'.(  $document_info['sid'] ).'');?>">
                                        <input type="hidden" id="perform_action" name="perform_action" value="hybrid_edit_document" />
                                                        ...
                                                        <div class="hr-box">
                                                            ...
                                                            <div class="hr-innerpadding">
                                                                <div class="row">
                                                                    <div class="col-xs-12">
                                                                        <label class="control control--radio font-normal">
                                                                            <input class="disable_doc_checkbox" name="isRequired" type="radio" value="0" <?php if($document_info['is_required']!=1){?> checked="true" <?php }?> />
                                                                            No &nbsp;
                                                                            <div class="control__indicator"></div>
                                                                        </label>
                                                                        <label class="control control--radio font-normal">
                                                                            <input class="disable_doc_checkbox" name="isRequired" type="radio" value="1" <?php if($document_info['is_required']==1){?> checked="true" <?php }?> />
                                                                            Yes &nbsp;
                                                                            <div class="control__indicator"></div>
                                                                        </label>
                                                                    </div>
...
<script>
    ...
    //
    $('.js-show-current-document').click(function(e) {
        e.preventDefault();
        //
        var f = getUploadedFileAPIUrl( $(this).data('file'), 'original' );
        //
        $('.js-preview-hyrid-modal-title').html( $(this).data('file') );
        $('.js-uploaded-document .panel-body').html( f.getHTML() );
        // Full Download
        $('#js-preview-hybrid-modal .modal-footer').find('a.btn-success').remove();
        $('#js-preview-hybrid-modal .modal-footer').prepend( f.getButtonHTML() );
        //
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body js-preview-hyrid-modal-body">
                ...
                <div class="js-uploaded-document">

...
<script>
    $(function() {
        ...
        function previewHybridDocument(
            ...
            console.log(<?= json_encode($page_content); ?>);

            var d = <?= json_encode($page_content); ?>;
            ...
            //
            var buttons = '';
            buttons += '<a href="<?= base_url('hr_documents_management/print_download_hybird_document_resource_center'); ?>/' + (d.sid) + '" target="_blank" class="btn btn-success">Print</a>';
            buttons += '<a href="<?= base_url('hr_documents_management/print_download_hybird_document_resource_center'); ?>/' + (d.sid) + '" class="btn btn-success">Download</a>';
            //
            $('.js-preview-hyrid-modal-title').html(d.title);
            // File section
            ...
            //
                ...
                print_url = "<?= base_url('hr_documents_management/print_download_hybird_document_resource_center'); ?>/" + (d.sid);
                download_url = "<?= base_url('hr_documents_management/print_download_hybird_document_resource_center'); ?>/" + (d.sid);
        ...
        function getDocument(
            ...
            for (i; i < il; i++)
                if (arr[i][searchIndex] == matchValue) return arr[i];
        ...
        function getGeneratedOBJ(
            ...
            //
            var documentBody = d.description;
            if (s == 'submitted') {
                documentBody = d.description;
            }
            r.getHTML = () => `
			<div class="row">
				<div class="col-sm-12">

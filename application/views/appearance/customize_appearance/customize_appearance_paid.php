                                                                                            ...
                                                                                            <?php foreach ($testimonials as $testimonial): ?>
                                                                                                <tr id="testimonial-row-<?php echo $testimonial['sid']; ?>">
                                                                                                    ...
                                                                                                    <td>
                                                                                                        ...
                                                                                                        ?>
                                                                                                        <img id="img-testimonial-<?php echo $testimonial['sid']; ?>" width="100" class="img-responsive" src="<?php echo $img_url ?>" alt="<?php echo $testimonial['resource_name']; ?>" /></td>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        ...
                                                                                                        <button
                                                                                                            data-author="<?php echo htmlentities($testimonial['author_name']); ?>"
                                                                                                            data-short_description="<?php echo htmlentities($testimonial['short_description']); ?>"
                                                                                                            data-full_description="<?php echo htmlentities($testimonial['full_description']); ?>"
                                                                                                            data-youtube_video_id="<?php echo htmlentities($testimonial['youtube_video_id']); ?>"
                                                                                                            data-image="<?php echo htmlentities($testimonial['resource_name']); ?>"
                                                                                                            data-status="<?php echo htmlentities($testimonial['status']); ?>"
                                                                                                            data-record="<?php echo htmlentities($testimonial['sid']); ?>" class="btn btn-sm btn-default" onclick="fEditTestimonial(this);"><i class="fa fa-edit"></i></button>
                                                                                                        <!--
                                                                                                               <input type="hidden" value="<?php //echo $testimonial['author_name'];   ?>" id="author-<?php echo $testimonial['sid']; ?>" name="author-<?php echo $testimonial['sid']; ?>" />
                                                                                                               <input type="hidden" value="<?php //echo $testimonial['short_description'];   ?>" id="short_description-<?php echo $testimonial['sid']; ?>" name="short_description-<?php echo $testimonial['sid']; ?>" />
                                                                                                               <input type="hidden" value="<?php //echo $testimonial['full_description'];   ?>" id="full_description-<?php echo $testimonial['sid']; ?>" name="full_description-<?php echo $testimonial['sid']; ?>" />
                                                                                                               <input type="hidden" value="<?php //echo $testimonial['youtube_video_id'];   ?>" id="youtube_video_id-<?php echo $testimonial['sid']; ?>" name="youtube_video_id-<?php echo $testimonial['sid']; ?>" />
                                                                                                               <input type="hidden" value="<?php //echo $testimonial['resource_name'];   ?>" id="image-<?php echo $testimonial['sid']; ?>" name="image-<?php echo $testimonial['sid']; ?>" />
                                                                                                               <input type="hidden" value="<?php //echo $testimonial['status'];   ?>" id="status-<?php echo $testimonial['sid']; ?>" name="status-<?php echo $testimonial['sid']; ?>" />
                                                                                                               <input type="hidden" value="<?php //echo $testimonial['sid'];  ?>" id="record-<?php echo $testimonial['sid']; ?>" name="record-<?php echo $testimonial['sid']; ?>" />
                                                                                                        -->
                                                                                                    </td>
                                                                                                </tr>
                                                                                            <?php endforeach; ?>
                                                                                        ...
                                                                                        <form method="post" id="save_jobs_banner_image" enctype="multipart/form-data">
                                                                                            ...
                                                                                            <div class="btn-panel">
                                                                                                ...
                                                                                                <button
                                                                                                        ...
                                                                                                        data-banner="main"
                                                                                                        data-page="jobs"
                                                                                                        data-def_image="banner-1-kvinR.jpg"
                                                                                                        data-theme="<?php echo $theme['theme_name']; ?>"
                                                                                                        type="button"
                                                                                                        class="delete-all-btn active-btn"
                                                                                                        onclick="fRestoreDefaultBanner(this);" ><i class="fa fa-reply"></i>&nbsp;Restore Default Banner</button>
                                                                                            </div>
                                                                                        </form>
                                                                                    </div>
                                                                                </div>
                                                                                    ...
                                                                                    <div class="universal-form-style-v2">
                                                                                        <form method="POST" action="<?php echo current_url() ?>" id="save_jobs_detail_banner_image" enctype="multipart/form-data">
                                                                                            ...
                                                                                            <div class="btn-panel">
                                                                                                <button type="submit"
                                                                                                        class="delete-all-btn active-btn"
                                                                                                        onclick="return fSaveJobsDetailPageBanner();">Save
                                                                                                </button>
                                                                                                &nbsp;&nbsp;
                                                                                            </div>
                                                                                        </form>
                                                                    ...
                                                                    <div class="panel panel-default">
                                                                        <div class="panel-heading">
                                                                            <h4 class="panel-title">
                                                                                <a data-toggle="collapse" data-parent="#<?php echo $page['page_name']; ?>-accordion"
                                                                                   href="#<?php echo $page['page_name']; ?>-collapseTwo"><span class="glyphicon glyphicon-plus"></span>Content
                                                                                </a>
                                                                            </h4>
                                                                        </div>
                                                                        <div id="<?php echo $page['page_name']; ?>-collapseTwo"
                                                                        ...
                                                                        <div class="panel-heading">
                                                                            <h4 class="panel-title">
                                                                                <a data-toggle="collapse"
                                                                                   data-parent="#<?php echo $page['page_name']; ?>-accordion"
                                                                                   href="#<?php echo $page['page_name']; ?>-collapseOne"><span class="glyphicon glyphicon-plus"></span>Banner Image</a>
                                                                            </h4>
                                                                        </div>
                                                                        <div id="<?php echo $page['page_name']; ?>-collapseOne"
                                                                            ...
                                                                            <div class="panel-body">
                                                                                            ...
                                                                                            <li class="form-col-100 autoheight">
                                                                                                <div class="form-group">
                                                                                                    <label for="page_banner_status">
                                                                                                        <input type="checkbox" id="page_banner_status" name="page_banner_status" 
                                                                                                            <?php if ($page['page_banner_status'] == 1) { echo 'checked="checked"'; } ?> />
                                                                                                        &nbsp;Enable Banner </label>
                                                                                                </div>
                                                                                            </li>
                                                                                        </form>
                                                                                ...
                                                                                <div class="btn-panel">
                                                                                    ...
                                                                                    <button
                                                                                        data-pageid="<?php echo $page['sid'] ?>"
                                                                                        data-banner="<?php echo $page['page_name'] ?>"
                                                                                        data-page="<?php echo $page['page_name'] ?>"
                                                                                        data-def_image="<?php echo $page['page_default_banner'] ?>"
                                                                                        data-theme="<?php echo $theme['theme_name']; ?>"
                                                                                        type="button"
                                                                                        class="delete-all-btn active-btn"
                                                                                        onclick="fRestoreDefaultBanner(this);" ><i class="fa fa-reply"></i>&nbsp;Restore Default Banner</button>
                                                                    ...
                                                                    <div class="panel panel-default">
                                                                        <div class="panel-heading">
                                                                            <h4 class="panel-title">
                                                                                <a data-toggle="collapse"
                                                                                   data-parent="#<?php echo $page['page_name']; ?>-accordion"
                                                                                   href="#<?php echo $page['page_name']; ?>-collapseThree"><span class="glyphicon glyphicon-plus"></span>Youtube Video</a>
                                                                            </h4>
                                                                        </div>
                                                                                    ...
                                                                                    <div class="col-xs-12">
                                                                                        <div class="well well-sm">
                                                                                            <div class="embed-responsive embed-responsive-16by9">
                                                                                                <iframe class="embed-responsive-item" src="//www.youtube.com/embed/<?php echo $page['page_youtube_video']; ?>"></iframe>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="universal-form-style-v2">
                                                                                            <ul>
                                                                                                <form id="form_youtube_video_<?php echo $page['page_name']; ?>" enctype="multipart/form-data" method="post">
                                                                                                    ...
                                                                                                    <li class="form-col-100 autoheight">
                                                                                                        <div class="form-group">
                                                                                                            <?php $video_id = (!empty($page['page_youtube_video']) ? $page['page_youtube_video'] : ''); ?>
                                                                                                            <?php $youtube_url = !empty($video_id) ? 'https://www.youtube.com/watch?v=' . $video_id : '';?>
                                                                                                            <label for="page_youtube_video">Video Url</label>
                                                                                                            <input class="form-control invoice-fields" type="text" id="page_youtube_video" name="page_youtube_video" placeholder="Video Url" value="<?php echo $youtube_url; ?>" />
                                                                                                        </div>
                                                                                                    </li>
                                                                                                    <li class="form-col-100 autoheight">
                                                                                                        <div class="form-group">
                                                                                                            <label for="page_youtube_video_status">
                                                                                                                <input type="checkbox" id="page_youtube_video_status" name="page_youtube_video_status"
                                                                                                                    <?php if ($page['page_youtube_video_status'] == 1) { echo 'checked="checked"'; } ?> />
                                                                                                                &nbsp;Enable Video </label>
                                                                                                        </div>
                                                                                                    </li>
                                                                                                    <li class="form-col-100 autoheight">
                                                                                                        ...
                                                                                                        <div class="form-group">
                                                                                                            <label>
                                                                                                                <input type="radio" id="video_location" name="video_location" value="top" <?php if ($page['video_location'] == 'top') { echo 'checked="checked"'; } ?> />&nbsp;Top
                                                                                                            </label>
                                                                                                        </div>
                                                                                                        <div class="form-group">
                                                                                                            <label>
                                                                                                                <input type="radio" id="video_location" name="video_location" value="bottom" <?php if ($page['video_location'] == 'bottom') { echo 'checked="checked"'; } ?> />&nbsp;Bottom
                                                                                                            </label>
                                                                                                        </div>
                                                                                                    </li>
                                                                                                </form>
...
<script>                                                                                     
    $(function () {
        ...
        $(".home_page_status").change(function(){
            ...
            var myRequest = $.ajax({
                url: myUrl,
                data: { 'page_name' : page_name, 'is_published' : is_published },
                type: 'POST'
            });

                                    ...
                                    <tr>
                                        <td>
                                            <div class="employee-info">
                                                <div class="text">
                                                    <h4><?=$employees[$balance['UserId']]['first_name'];?> <?=$employees[$balance['UserId']]['last_name'];?></h4>
                                                    <p><?=remakeEmployeeName($employees[$balance['UserId']]);?></p>
                                                    <p>
                                                        <a>
                                                            Id:
                                                            <?=!empty($employees[$balance['UserId']]['employee_number']) ? $employees[$balance['UserId']]['employee_number'] : $employees[$balance['UserId']]['userId'];?>
                                                        </a>
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <?=empty($employees[$balance['UserId']]['joined_at']) ? '-' : formatDate(
                                                $employees[$balance['UserId']]['joined_at'],
                                                'Y-m-d',
                                                'M d Y, D'
                                            ); ?>
                                        </td>

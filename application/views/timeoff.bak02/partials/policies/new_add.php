                        ...
                        <div class="row mb10 csRow" id="js-policy-categories-add">
                            <div class="col-md-12 offset-md-3">
                                <div class="form-group margin-bottom-custom">
                                    <label><?php echo $get_policy_item_info['select_a_template_label']; ?> <span
                                            class="cs-required">*</span></label>
                                    <br />
                                    <div>
                    ...
                    <div class="js-step" data-type="add" data-step="1">
                        ...
                        <div class="row mb10 csRow">
                            <div class="col-sm-6 col-xs-12">
                                ...
                                <div>
                                    <select class="invoice-fields" name="template22[]" id="js-employee-type-add"
                                        multiple="true">
                        ...
                        <div class="row mb10 csRow js-fmla-range-wrap-add hidden" style="display: none;">
                            ...
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <label class="control control--radio">
                                        <input type="radio" name="fmla-range-add" value="end_year"
                                            class="js-fmla-range-add" />&nbsp;Ending
                                        on
                            ...
                            <div class="col-sm-6">
                                ...
                                <div>
                                    ...
                                    <div>
                                        <label class="control control--radio">
                                            Hours &nbsp;&nbsp;
                                            <input type="radio" name="js-minimum-applicable-time-add"
                                                class="js-minimum-applicable-time-add" checked="true" value="hours" />
                                            <div class="control__indicator"></div>
                                        </label>
                                        <label class="control control--radio">
                                            Days &nbsp;&nbsp;
                                            <input type="radio" name="js-minimum-applicable-time-add"
                                                class="js-minimum-applicable-time-add" value="days" />
                                            <div class="control__indicator"></div>
                                        </label>
                                        <label class="control control--radio">
                                            Months &nbsp;&nbsp;
                                            <input type="radio" name="js-minimum-applicable-time-add"
                                                class="js-minimum-applicable-time-add" value="months" />
                                            <div class="control__indicator"></div>
                                        </label>
                                        <label class="control control--radio">
                                            Years &nbsp;&nbsp;
                                            <input type="radio" name="js-minimum-applicable-time-add"
                                                class="js-minimum-applicable-time-add" value="years" />
                                            <div class="control__indicator"></div>
                                        </label>
                                    </div>
                                    <div style="margin-top: 5px;">
                                        <input class="invoice-fields" name="template"
                                            id="js-minimum-applicable-hours-add" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="jsCustomBoxAdd" style="margin-top: 5px; display: none;">
                                        ...
                                        <div class="form-group form-group-custom form-group-custom-settings">
                                            <input class="form-control form-control-custom"
                                                id="js-accrual-frequency-val-add" />
                                        </div>
                                        <span> month(s).</span>
                                    </div>
                                </div>
                        ...
                        <div class="row mb10 csRow js-hider-add">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <input class="form-control" name="template" id="js-accrual-rate-add"
                                                autocomplete="off" />
                                        </div>
                                        <div class="col-sm-4">
                                            <select class="form-control jsTimeTypeSelect-add"
                                                id="js-accrual-rate-type-add">
                                    ...
                                    <div class="col-lg-12">
                                        <h4 class="timeline-title allowed-time-off-title-custom csHeading">
                                            ...
                                            <i class="fa fa-question-circle" data-hint="js-hint"
                                                data-target="plans"></i>
                                            <span class="pull-right">
                                                <button class="btn btn-orange js-plan-btn-add" data-type="add"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control jsTimeTypeSelect-add"
                                                id="js-accrual-carryover-type"></select>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <label class="control control--radio">
                                            ...
                                            <input type="radio" name="js-policy-reset-date-add"
                                                class="js-policy-reset-date-add" checked="true" value="policyDate" />
                                            <div class="control__indicator"></div>
                                        </label>
                                        <br />
                                        <label class="control control--radio">
                                            ...
                                            <input type="radio" name="js-policy-reset-date-add"
                                                class="js-policy-reset-date-add" value="policyDateCustom" />
                                            <div class="control__indicator"></div>
                                        </label>
                                        <div class="jsResetDateBox-add" style="display: none; margin-top: 5px;">
                                            <input type="text" readonly="true" class="invoice-fields"
                                                id="js-custom-reset-date-add" />
                                        </div>
                                    </div>
                                </div>
                            </div>

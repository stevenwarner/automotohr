                ...
                <div class="table-responsive">
                    <table class="table table-striped table-condensed pto-policy-table csCustomTableHeader">
                        <thead class="js-table-head">
                            <tr>
                                <th class="col-sm-2">Policy / Type</th>
                                <th class="col-sm-3">Accrual</th>
                                <th class="col-sm-3">New Hire</th>
                                <th class="col-sm-2">Applicable Date</th>
                                <th class="col-sm-1">Carryover</th>

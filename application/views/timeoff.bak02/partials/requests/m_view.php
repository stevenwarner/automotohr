...
<div class="js-page p10" id="js-page-view">
    <div class="row mg-lr-0">
        <div class="border-top-section border-bottom csHeader">
            ...
            <div class="col-xs-12">
                    <button class="cs-btn-add btn-success jsMobileBTN jsCalendarView" style="margin-top: 2px;"><i
                            class="fa fa-plus"></i> &nbsp;VIEW CALENDAR </button>
                    <button class="cs-btn-add jsMobileBTN hidden" style="margin-top: 2px;"><i class="fa fa-calendar"></i>

                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <span class="pull-right">
                            <a href="<?=base_url('timeoff/print/balance');?>" target="_blank" class="btn btn-orange"><i class="fa fa-print"></i> Print</a>
                            <a href="<?=base_url('timeoff/dwnload/balance');?>" target="_blank" class="btn btn-orange"><i class="fa fa-download"></i> Download</a>
            ...
            <div class="csPageBody">
                ...
                <div class="csBalanceBox csShadow csRadius5 jsFilterBoxBalance dn">
                    ...
                    <div class="col-sm-5">
                        ...
                        <select id="js-filter-policies" multiple="true"></select>
                    </div>
                    <div class="col-sm-2">
                        <span class="pull-right">
                            <br />
                            <button id="btn_apply" type="button"
                                class="btn btn-success btn-theme js-apply-filter-btn">APPLY</button>

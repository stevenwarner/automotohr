...
<div class="row mb10">
    <div class="col-sm-12">
        <strong>Note:</strong> Please click on '<i class="fa fa-question-circle" aria-hidden="true"></i>' next to the
        title for help.
    </div>
</div>
...
<!-- Policy Type - Edit -->
<div class="row margin-top" id="js-policy-categories-edit">
    <div class="col-md-6 offset-md-3">
        <div class="form-group margin-bottom-custom">
            <label>Type <span class="cs-required">*</span>
                <i class="fa fa-question-circle" data-hint="js-hint" data-target="type"></i>
            </label>
            <p class="js-hint js-hint-type"><?php echo $get_policy_item_info['type_info']; ?></p>
            <div>
...
<div class="row margin-top">
    <div class="col-sm-6 col-xs-12">
        <div class="form-group margin-bottom-custom">
            <div class="form-group margin-bottom-custom">
                <label class="">Policy Title <span class="cs-required">*</span>
                    <i class="fa fa-question-circle" data-hint="js-hint" data-target="info"></i>
                </label>
                <p class="js-hint js-hint-info"><?php echo $get_policy_item_info['policy_title_info']; ?></p>
                <div>
...
<div class="row margin-top">
    <div class="col-sm-6 col-xs-12">
        <label>Sort Order <i class="fa fa-question-circle" data-hint="js-hint" data-target="sort"></i></label>
        <p class="js-hint js-hint-sort"><?php echo $get_policy_item_info['sort_order_info']; ?></p>
        <div>
...
<div class="row margin-top">
    <div class="col-sm-6 col-xs-12">
        <label>Entitled Employee(s) <i class="fa fa-question-circle" data-hint="js-hint"
                data-target="employee"></i></label>
...
<div class="row mb10">
    <div class="col-sm-6 col-xs-12">
        <div class="">
            ...
            <i class="fa fa-question-circle" data-hint="js-hint" data-target="approver"></i>
...
<div class="row mb10">
    <div class="col-sm-6 col-xs-12">
        <div class="">
            ...
            <i class="fa fa-question-circle" data-hint="js-hint" data-target="deactive"></i>
            <p class="js-hint js-hint-deactive"><?php echo $get_policy_item_info['type_info']; ?></p>
        </div>
    </div>
</div>
    ...
    <div class="col-sm-6">
        <div>
            <h5 class="timeline-title allowed-time-off-title-custom">Accrual Method <span class="cs-required">*</span>
                <i class="fa fa-question-circle" data-hint="js-hint" data-target="ami"></i>
            </h5>
...
<div class="row mb10 js-hider-edit">
    <div class="col-sm-6">
        <div class="form-group">
            <h5 class="timeline-title allowed-time-off-title-custom">Accrual Time <span class="cs-required">*</span> <i
                    class="fa fa-question-circle" data-hint="js-hint" data-target="ati"></i></h5>
            ...
            <div>
                <select class="invoice-fields" name="template" id="js-accrual-time-edit">
                    ...
                    <option value="start_of_period">Start of the period</option>
...
<div class="row mb10 js-hider-edit">
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <div class="jsCustomBoxEdit" style="margin-top: 5px; display: none;">
                <span>Every</span>
                <div class="form-group form-group-custom form-group-custom-settings">
                    <input class="form-control form-control-custom" id="js-accrue-custom-frequency-edit" />
                </div>
                <span> month(s).</span>
            </div>
        </div>
...
<div class="row mb10 js-hider-edit">
    <div class="col-sm-6">
        <div class="form-group">
            <h5 class="timeline-title allowed-time-off-title-custom">Accrual Rate <span class="cs-required">*</span> <i
                    class="fa fa-question-circle" data-hint="js-hint" data-target="ari"></i></h5>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            <h5 class="timeline-title allowed-time-off-title-custom">Allow Carryover Cap? (use it or lose it) <span
                    class="cs-required">*</span> <i class="fa fa-question-circle" data-hint="js-hint"
                    data-target="acop"></i></h5>
            <p class="js-hint js-hint-acop"><?php echo $get_policy_item_info['allow_carryover_cap_info']; ?></p>
            <div>
...
<div class="row mb10 js-hider-edit js-carryover-box-edit">
    <div class="col-sm-6">
        <div class="form-group">
            <h5 class="timeline-title allowed-time-off-title-custom">Carryover Cap <i class="fa fa-question-circle"
                    data-hint="js-hint" data-target="cci"></i></h5>
...
<div class="row mb10 js-hider-edit">
    <div class="col-sm-6">
        <div class="form-group">
            <h5 class="timeline-title allowed-time-off-title-custom">Allow Negative Balance <i
                    class="fa fa-question-circle" data-hint="js-hint" data-target="anbi"></i></h5>
...
<div class="row mb10 js-hider-edit js-negative-box-edit">
    <div class="col-sm-6">
        <div class="form-group">
            <h5 class="timeline-title allowed-time-off-title-custom">Allowed negative balance (Hours/Days) <i
                    class="fa fa-question-circle" data-hint="js-hint" data-target="nhmdohi"></i></h5>
            <p class="js-hint js-hint-nhmdohi"><?php echo $get_policy_item_info['new_hire_maximum_days_off_HD_info']; ?>
            </p>
            <div>
...
<div class="row mb10">
    <div class="col-lg-12">
        <h5 class="timeline-title allowed-time-off-title-custom">Applicable Date for Policy <i
                class="fa fa-question-circle" data-hint="js-hint" data-target="ad"></i></h5>
        <p class="js-hint js-hint-ad"><?php echo $get_policy_item_info['applicable_date_for_policy_info']; ?></p>
    </div>
    <div class="col-lg-6">
        <div class="">
...
<div class="row mb10">
    <div class="col-sm-6">
        <div class="form-group">
            <h5 class="timeline-title allowed-time-off-title-custom">Reset Date <i class="fa fa-question-circle"
                    data-hint="js-hint" data-target="rd"></i></h5>
            <p class="js-hint js-hint-rd"><?php echo $get_policy_item_info['reset_date_info']; ?></p>
            <div class="">
                <label class="control control--radio">
...
<div class="row mb10">
    <div class="col-sm-6">
        <!--  -->
        <div>
            <h5 class="timeline-title allowed-time-off-title-custom">Minimum Applicable Time <i
                    class="fa fa-question-circle" data-hint="js-hint" data-target="maph"></i></h5>
            <p class="js-hint js-hint-maph"><?php echo $get_policy_item_info['minimum_applicable_hours_info']; ?></p>
            <div>
                <label class="control control--radio">
                    Hours &nbsp;&nbsp;
                    <input type="radio" name="js-minimum-applicable-time-edit" class="js-minimum-applicable-time-edit"
...
<div class="row">
    <div class="col-lg-12">
        <h4 class="timeline-title allowed-time-off-title-custom csHeading">New Hire
            <small><?php echo $get_policy_item_info['new_hire_tag']; ?></small></small></h4>
    </div>
</div>
...
<div class="row mb10">
    <div class="col-lg-12 js-hider-edit accrual-settings-line-1 margin-top">
        <h5 class="timeline-title allowed-time-off-title-custom">Waiting period <i class="fa fa-question-circle"
                data-hint="js-hint" data-target="wpi"></i></h5>
...
<div class="row mb10 js-hider-edit">
    <div class="col-sm-6">
        <div class="form-group">
            <h5 class="timeline-title allowed-time-off-title-custom">New hire maximum days off <i
                    class="fa fa-question-circle" data-hint="js-hint" data-target="nhmdoi"></i></h5>
...
<div class="row mb10">
    <div class="col-lg-12">
        <h4 class="timeline-title allowed-time-off-title-custom csHeading">Accrual Plans
            <i class="fa fa-question-circle" data-hint="js-hint" data-target="ap"></i>
            <p class="js-hint js-hint-ap"><?php echo $get_policy_item_info['accrual_plans']; ?></p>
            <span class="pull-right">
                <button class="btn btn-success js-plan-btn-edit" data-type="edit" style="margin-top: -5px;"><i
...
<!-- FMLA Range -->
<div class="row mb10 js-fmla-range-wrap-edit" style="display: none;">
    <div class="col-lg-12">
        ...
        <div class="">
            ...
            <label class="control control--radio">
                <input type="radio" name="fmla-range-edit" value="start_year"
                    class="js-fmla-range-edit" />&nbsp;Starting from First FMLA usage

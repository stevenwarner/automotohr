                ...
                <div class="col-lg-9 col-md-9 col-xs-12 col-sm-12">
                    ...
                    <div class="dashboard-conetnt-wrp">
                        <div class="page-header-area">
                            <span class="page-heading down-arrow"><?php $this->load->view('manage_employer/company_logo_name'); ?>EMS Notification</span>
                        </div>
                                            ...
                                            <div class="universal-form-style-v2">
                                                <ul>
                                                    ...
                                                    <li class="form-col-100">
                                                        ...
                                                        <input type="button" value="Cancel" class="submit-btn btn-cancel" onclick="document.location.href = '<?php echo base_url('add_ems_notification'); ?>'">
                                                    </li>
                                                </ul>

...
<body class="A4">
    <div class="sheet padding-10mm" id="w4_pdf" style="width: 800px; margin: 0 auto;">
                ...
                <tbody>
                    <tr>
                        <td style="width: 50%;">
                            ...
                            <span class="heading-text">Exemption from withholding.</span> <?php echo W4_EXEMPTION_FROM_WITHHOLDING_25; ?><br>
                            ...
                            <span class="heading-text">When to use the estimator.</span>

                            Consider using the estimator at
                            www.irs.gov/W4App if you:<br>
                            1. Are submitting this form after the beginning of the year;<br>
                            2. Expect to work only part of the year;<br>
                            ...
                            or Net Investment Income Tax; or<br>
                            5. Prefer the most accurate withholding for multiple job
                            situations.<br>


                            <span class="heading-text">TIP:</span> Have your most recent pay stub(s) from this year available
                            ...
                            year, use the estimator again to recheck your withholding. <br>
                ...
                <table class="table bordered-table table-border-collapse" id="footer-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="86%">
                                Enter an estimate of your <?php echo W4_YEAR_24 ?> itemized deductions (from Schedule A (Form 1040)). Such deductions may include qualifying home mortgage interest, charitable contributions, state and local taxes (up to $10,000), and medical expenses in excess of 7.5% of your income . . . . . . .
                            </td>
                            <td width="2%">
                                <strong class="indicator-box-2">1</strong>
                            </td>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width: 50%;">
                                ...
                                from you. See the instructions for your income tax return. </td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <?php $this->load->view("form_w4/partials/married_filing_2025"); ?>
        <br>
        <?php $this->load->view("form_w4/partials/single_married_2025"); ?>
        <br>
        <?php $this->load->view("form_w4/partials/head_of_household_2025"); ?>

            ...
            <table class="table table-border-collapse">
                ...
                <tr>
                    <td class="border-right-bottom" width="50%">
                        ...
                        <input class="plane-input" type="text" value="<?php echo sizeof($pre_form)>0 ? $pre_form['home_address']: ''?>" readonly />
                    </td>
            ...
            <table class="table table-border-collapse">
                ...
                <tr>
                    <td class="border-right-bottom" width="50%">
                        ...
                        <input class="plane-input" type="text" value="<?php echo sizeof($pre_form)>0 ? $pre_form['city']: 'NIL'?>, <?php echo sizeof($pre_form)>0 ? $pre_form['state']: 'NIL'?>, <?php echo sizeof($pre_form)>0 ? $pre_form['zip']: 'NIL'?> " readonly />
                    </td>
                    <td class="border-bottom" width="50%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="border-right-bottom">
                            ...
                            <input class="plane-input" type="text" value="<?php echo sizeof($pre_form)>0 ? $pre_form['emp_name']: 'NIL'?>, <?php echo sizeof($pre_form)>0 ? $pre_form['emp_address']: 'NIL'?>" readonly />
                        </td>
                        <td class="border-right-bottom">
                            <span>9. First date of employment</span>
                             <input type="text" value="<?php echo sizeof($pre_form)>0 && $pre_form['first_date_of_employment'] != '0000-00-00' ? date("d-m-Y",strtotime($pre_form['first_date_of_employment'])): ''?>" class="plane-input"/>
                        </td>
                        <td class="border-bottom">

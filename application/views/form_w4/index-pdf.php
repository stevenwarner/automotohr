...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .table > thead > tr > td,
        .table > tbody > tr > th,
        .table > tbody > tr > td { vertical-align: top; font-size: 12px; padding: 5px; }
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border-right-bottom">
                            ...
                            <input class="plane-input" type="text" value="<?php echo isset($pre_form['first_date_of_employment']) && !empty($pre_form['first_date_of_employment']) && $pre_form['first_date_of_employment'] != NULL && $pre_form['first_date_of_employment'] != '0000-00-00 00:00:00' && $pre_form['first_date_of_employment'] != '0000-00-00' ? DateTime::createFromFormat('Y-m-d', $pre_form['first_date_of_employment'])->format('m/d/Y') : ''; ?>" readonly />
                        </td>
                        <td class="border-bottom">

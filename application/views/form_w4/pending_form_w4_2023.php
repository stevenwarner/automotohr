...
<body class="A4">
            ...
            <table class="table table-border-collapse">
                <tbody>
                    <tr>
                        ...
                        <td class="border-bottom">
                            <input class="plane-input" type="text" value="<?php echo !empty($pre_form['number_of_allowance']) ? $pre_form['number_of_allowance']: ''?>" readonly  style="border: none; font-weight: bold; display: block;"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="border-right">
                        ...
                        <td class="border-bottom">
                            <input class="plane-input" type="text" value="<?php echo !empty($pre_form['additional_amount']) ? $pre_form['additional_amount']: ''?>" readonly style="border: none; font-weight: bold; display: block;" />
                        </td>
                    </tr>
                    <tr>
                        <td class="border-right-bottom">
                        ...
                        <td class="border-bottom">
                            <input class="plane-input" type="text" value="<?php echo !empty($pre_form['claim_exempt']) ? $pre_form['claim_exempt']: ''?>" readonly  style="border: none; font-weight: bold; display: block;"/>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border-bottom">
                            ...
                            <input class="plane-input" type="text" value="<?php echo !empty($pre_form['emp_identification_number']) ? $pre_form['emp_identification_number']: ''?>" readonly  style="border: none; font-weight: bold; display: block;"/>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <table class="table bordered-table table-border-collapse" id="footer-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['paw_yourself']) ? $pre_form['paw_yourself']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['paw_married']) ? $pre_form['paw_married']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['paw_head']) ? $pre_form['paw_head']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['paw_single_wages']) ? $pre_form['paw_single_wages']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['paw_child_tax']) ? $pre_form['paw_child_tax']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['paw_dependents']) ? $pre_form['paw_dependents']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['paw_other_credit']) ? $pre_form['paw_other_credit']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['paw_accuracy']) ? $pre_form['paw_accuracy']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                ...
                <table class="table bordered-table table-border-collapse" id="footer-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['daaiw_estimate']) ? $pre_form['daaiw_estimate']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['daaiw_enter_status']) ? $pre_form['daaiw_enter_status']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['daaiw_subtract_line_2']) ? $pre_form['daaiw_subtract_line_2']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['daaiw_estimate_of_adjustment']) ? $pre_form['daaiw_estimate_of_adjustment']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['daaiw_add_line_3_4']) ? $pre_form['daaiw_add_line_3_4']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['daaiw_estimate__of_nonwage']) ? $pre_form['daaiw_estimate__of_nonwage']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['daaiw_subtract_line_6']) ? $pre_form['daaiw_subtract_line_6']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['daaiw_divide_line_7']) ? $pre_form['daaiw_divide_line_7']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['daaiw_enter_number_personal_allowance']) ? $pre_form['daaiw_enter_number_personal_allowance']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['daaiw_add_line_8_9']) ? $pre_form['daaiw_add_line_8_9']: ''?>" readonly />
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="table bordered-table table-border-collapse" id="footer-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['temjw_personal_allowance']) ? $pre_form['temjw_personal_allowance']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['temjw_num_in_table_1']) ? $pre_form['temjw_num_in_table_1']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['temjw_more_line2']) ? $pre_form['temjw_more_line2']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                        ...
                        <tr>
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['temjw_num_from_line2']) ? $pre_form['temjw_num_from_line2']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['temjw_num_from_line1']) ? $pre_form['temjw_num_from_line1']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['temjw_subtract_5_from_4']) ? $pre_form['temjw_subtract_5_from_4']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['temjw_amount_in_table_2']) ? $pre_form['temjw_amount_in_table_2']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['temjw_multiply_7_by_6']) ? $pre_form['temjw_multiply_7_by_6']: ''?>" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td width="2%">
                            ...
                            <td width="10%">
                                <input class="input-with-bottom-border" style="border: none; border-bottom: 1px solid #000; width: 100%; height: 20px;" type="text" value="<?php echo !empty($pre_form['temjw_divide_8_by_period']) ? $pre_form['temjw_divide_8_by_period']: ''?>" readonly />
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <script type="text/javascript">
       ...
       $('#w4_download_pdf').on("click", function() {

...
<body class="A4">
    ...
    <?php if ($pre_form['user_consent'] != 0) { ?>
        <div class="row mb-2">
            <?php if ($pre_form['uploaded_file'] != NULL) { ?>
                ...
                <div class="col-lg-3 pull-right">
                    ...
                    if (in_array($dcoument_extension, ['pdf'])) { ?>
                        <a target="_blank" href="<?php echo 'https://docs.google.com/viewerng/viewer?url=https://automotohrattachments.s3.amazonaws.com/'.$pre_form['uploaded_file']; ?>" class="btn btn-success btn-block">Prints</a>
            ...
            <?php } else{ ?>
                <div class="col-lg-3 pull-right">
                    <a target="_blank" href="<?php echo base_url('form_w4/download_w4_form'.'/'. $pre_form['user_type'] . '/' . $pre_form['employer_sid']); ?>" class="btn btn-success btn-block">
                        Download PDF
                    </a>
                </div>
                <div class="col-lg-3 pull-right">
                    <a target="_blank" href="<?php echo base_url('form_w4/print_w4_form'.'/'. $pre_form['user_type'] . '/' . $pre_form['employer_sid']); ?>" class="btn btn-success btn-block">
                        Print PDF
                    </a>
                </div>
            <?php }?>

<?php if (!isset($doUpload)) { ?>
    ...
    <?php if (!isset($doUpload)) { ?>
        ...
        <body class="A4" style="width: 800px;">
        <?php } else { ?>
            <div class="A4" style="margin-left: -1000px !important; overflow: none !important;">
            <?php }  ?>
            <div class="sheet padding-10mm" id="w4_pdf">
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 33.3333%;">
                                        ...
                                        <span class="heading-text" style="font-size: 22px;">General Instructions</span><br>
                                    ...
                                    <td style="width: 33.3333%;">
                                        <span class="heading-text" style="font-size: 22px;">Specific Instructions</span><br>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center border-right-bottom-bold">
                                    <strong style="font-size: 30px;">Employee’s Withholding Allowance Certificate</strong><br>
                                    <strong>▶ Whether you’re entitled to claim a certain number of allowances or exemption from withholding is subject to review by the IRS. Your employer may be required to send a copy of this form to the IRS</strong>
                                </td>
                        ...
                        <tbody>
                            <tr>
                                <td class="border-right-bottom">
                                    ...
                                    <input class="plane-input" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['first_name'] : '' ?> <?php echo sizeof($pre_form) > 0 ? $pre_form['middle_name'] : '' ?>" readonly />
                                </td>
                                <td class="border-right-bottom">
                                    <span>Last name</span>
                                    <input class="plane-input" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['last_name'] : '' ?>" readonly />
                                </td>
                                <td class="border-bottom">
                                    <span>2 Your social security number</span>
                                    <input class="plane-input" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['ss_number'] : '' ?>" readonly />
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td class="border-right-bottom" width="50%">
                                    ...
                                    <input class="plane-input" type="text" style="display:block; width: 100%;" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['home_address'] : '' ?>" readonly />
                                </td>
                                <td class="border-bottom" width="50%">
                                    <span class="text-bold" style="float: left;">3</span>
                                    <table>
                                        <tr>
                                            <td>
                                                <div style="width: 100px;"><input type="checkbox" value="" readonly <?php echo sizeof($pre_form) > 0 && $pre_form['marriage_status'] == 'single' ? 'checked="checked"' : '' ?> />Single</div>
                                            </td>
                                            <td>
                                                <div style="width: 100px;"><input type="checkbox" value="" readonly <?php echo sizeof($pre_form) > 0 && $pre_form['marriage_status'] == 'married' ? 'checked="checked"' : '' ?> />Married</div>
                                            </td>
                                            <td>
                                                <div style="width: 280px;"><input type="checkbox" value="" readonly <?php echo sizeof($pre_form) > 0 && $pre_form['marriage_status'] == 'complex' ? 'checked="checked"' : '' ?> />Married, but withhold at higher Single rate.</div>
                                            </td>
                                        </tr>
                                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td class="border-right-bottom" width="50%">
                                    ...
                                    <input class="plane-input" style="width: 100%;" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['city'] : 'NIL' ?>, <?php echo sizeof($pre_form) > 0 ? $pre_form['state'] : 'NIL' ?>, <?php echo sizeof($pre_form) > 0 ? $pre_form['zip'] : 'NIL' ?> " readonly />
                                </td>
                                <td class="border-bottom" width="50%">
                                    ...
                                    <input type="checkbox" value="1" readonly <?php echo sizeof($pre_form) > 0 && $pre_form['different_last_name'] == 1 ? 'checked="checked"' : '' ?> />
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="table table-border-collapse">
                        <tbody>
                            <tr>
                                ...
                                <td class="border-bottom">
                                    <input class="plane-input" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['number_of_allowance'] : '' ?>" readonly />
                                </td>
                            </tr>
                            <tr>
                                <td class="border-right">
                                ...
                                <td class="border-bottom">
                                    <input class="plane-input" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['additional_amount'] : '' ?>" readonly />
                                </td>
                            </tr>
                            <tr>
                                <td class="border-right-bottom">
                                ...
                                <td class="border-bottom">
                                    <input class="plane-input" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['claim_exempt'] : '' ?>" readonly />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td colspan="2" class="border-bottom text-center" style="vertical-align: bottom"><span class="heading-text">Date</span>
                                    <?php echo sizeof($pre_form) > 0 ? date("d-m-Y", strtotime($pre_form['signature_timestamp'])) : '' ?>
                                </td>
                            </tr>
                            <tr>
                                <td class="border-right-bottom">
                                    ...
                                    <input class="plane-input" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['emp_name'] : 'NIL' ?>, <?php echo sizeof($pre_form) > 0 ? $pre_form['emp_address'] : 'NIL' ?>" readonly style="display: block; width: 100%;" />
                                </td>
                                <td class="border-right-bottom">
                                    <span>9. First date of employment</span>
                                    <input class="plane-input" type="text" value="<?php echo isset($pre_form['first_date_of_employment']) && $pre_form['first_date_of_employment'] != '0000-00-00' && $pre_form['first_date_of_employment'] != '' && $pre_form['first_date_of_employment'] != null ? DateTime::createFromFormat('Y-m-d', $pre_form['first_date_of_employment'])->format('m/d/Y') : ''; ?>" readonly />
                                </td>
                                <td class="border-bottom">
                                    <span>10. Employer identification number (EIN)</span>
                                    <input class="plane-input" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['emp_identification_number'] : '' ?>" readonly />
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <table class="table bordered-table table-border-collapse" id="footer-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['paw_yourself'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['paw_married'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['paw_head'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['paw_single_wages'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['paw_child_tax'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['paw_dependents'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['paw_other_credit'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['paw_accuracy'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                        ...
                        <table class="table bordered-table table-border-collapse" id="footer-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['daaiw_estimate'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['daaiw_enter_status'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['daaiw_subtract_line_2'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['daaiw_estimate_of_adjustment'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['daaiw_add_line_3_4'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['daaiw_estimate__of_nonwage'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['daaiw_subtract_line_6'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['daaiw_divide_line_7'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['daaiw_enter_number_personal_allowance'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['daaiw_add_line_8_9'] : '' ?>" readonly />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table bordered-table table-border-collapse" id="footer-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['temjw_personal_allowance'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['temjw_num_in_table_1'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['temjw_more_line2'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                ...
                                <tr>
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['temjw_num_from_line2'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['temjw_num_from_line1'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['temjw_subtract_5_from_4'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['temjw_amount_in_table_2'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['temjw_multiply_7_by_6'] : '' ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="2%">
                                    ...
                                    <td width="10%">
                                        <input class="input-with-bottom-border" type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['temjw_divide_8_by_period'] : '' ?>" readonly />
                                    </td>
                                </tr>
                            </tbody>
                        </table>

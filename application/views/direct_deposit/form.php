                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control js-account-percentage validate_error" value="<?= $account['account_percentage']; ?>" error_key="acc_per_<?php echo $i; ?>" id="DTV_<?php echo $i; ?>" />
                                </div>
        ...
        function getData() {
            ...
            $('.js-dd-row').map(function(el, i) {
                ...
                if (account_title == '' && account_type == undefined && account_routing_no == '' && account_number == '' && account_percentage == '' && financial_institution_name == '') {
                    ...
                    if (tit_flag == 0 && typ_flag == 0 && ac_no_flag == 0 && pre_flag == 0 && pic_flag == 0 && fin_flag == 0 && dt_flag == 0) {
                        let obj = {};

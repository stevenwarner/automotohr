        ...
        <div class="col-sm-12 col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <span class="glyphicon glyphicon-plus" style="color: #fff;"> </span> <a data-toggle="collapse" href="#collapse1" style="color: #fff;">fsdf sdfsfsdf</a>
                </div>
                        ...
                        <div id="jsPDF" style="width: 600px; margin: auto; padding: 5px;">
                            ...
                            <?php if (count($data)) { ?>
                                <?php foreach ($data as $k0 => $account) { ?>
                                    <div class="row">
                                        <div class="col-xs-12"> <?= $account['logged_at'] ?>

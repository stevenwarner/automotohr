                                    ...
                                    <ul>
                                        <div class="container-fluid">
                                            ...
                                            <label style="line-height: 40px;">
                                                <span class="staric" style="font-size: 16px; font-style: italic;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                    <li>
                                                        ...
                                                        <?php
                                                        $def_value = (isset($user_info[$key]) ? $user_info[$key] : '');
                                                        $def_value = strtolower($def_value);
                                                        ?>
                                                        <?php // echo $def_value;
                                                        ?>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                    <li>
                                                        ...
                                                        <input autocomplete="new" <?php echo $readonly_check; ?> class="invoice-fields" required="required" name="TextBoxAddressEmailConfirm" value="<?php echo keepSecret(set_value($key, $def_value), "start"); ?>" type="email" id="TextBoxAddressEmailConfirm">
                                                        <?php echo form_error($key); ?>
                                                    </li>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                ...
                                                <div class="form-col-100">
                                                    ...
                                                    <!--                                                            <input --><?php //echo $readonly_check; 
                                                                                                                                ?><!-- class="invoice-fields" name="TextBoxEmploymentEmployerCompensationBegin1" value="--><?php //echo set_value($key, $def_value); 
                                                                                                                                                                                                                            ?><!--" type="text">-->
                                                    <?php //echo form_error($key); 
                                                    ?>
                                                    <!--                                                        </li>-->
                                                    ...
                                                    <!--                                                            <input --><?php //echo $readonly_check; 
                                                                                                                                ?><!-- class="invoice-fields" name="TextBoxEmploymentEmployerCompensationEnd1" value="--><?php //echo set_value($key, $def_value); 
                                                                                                                                                                                                                            ?><!--" type="text">-->
                                                    <?php //echo form_error($key); 
                                                    ?>
                                                    <!--                                                        </li>-->
                                                ...
                                                <div class="bg-color">
                                                    ...
                                                    <div class="form-col-100">
                                                        ...
                                                        <!--                                                                <label>Starting Compensation</label>-->
                                                        <!--                                                                <input --><?php //echo $readonly_check; 
                                                                                                                                        ?><!-- class="invoice-fields" name="TextBoxEmploymentEmployerCompensationBegin2" value="--><?php //echo set_value($key, $def_value); 
                                                                                                                                                                                                                                    ?><!--" type="text">-->
                                                        <?php //echo form_error($key); 
                                                        ?>
                                                        <!--                                                            </li>-->
                                                        ...
                                                        <!--                                                                <label>Ending Compensation</label>-->
                                                        <!--                                                                <input --><?php //echo $readonly_check; 
                                                                                                                                        ?><!-- class="invoice-fields" name="TextBoxEmploymentEmployerCompensationEnd2" value="--><?php //echo set_value($key, $def_value); 
                                                                                                                                                                                                                                    ?><!--" type="text">-->
                                                        <?php //echo form_error($key); 
                                                        ?>
                                                        <!--                                                            </li>-->
                                                ...
                                                <div class="form-col-100">
                                                    ...
                                                    <!--                                                            <label>Starting Compensation</label>-->
                                                    <!--                                                            <input --><?php //echo $readonly_check; 
                                                                                                                                ?><!-- class="invoice-fields" name="TextBoxEmploymentEmployerCompensationBegin3" value="--><?php //echo set_value($key, $def_value); 
                                                                                                                                                                                                                            ?><!--" type="text">-->
                                                    ...
                                                    <!--                                                            <label>Ending Compensation</label>-->
                                                    <!--                                                            <input --><?php //echo $readonly_check; 
                                                                                                                                ?><!-- class="invoice-fields" name="TextBoxEmploymentEmployerCompensationEnd3" value="--><?php //echo set_value($key, $def_value); 
                                                                                                                                                                                                                            ?><!--" type="text">-->
                                                    <?php //echo form_error($key); 
                                                    ?>
                                                    <!--                                                        </li>-->

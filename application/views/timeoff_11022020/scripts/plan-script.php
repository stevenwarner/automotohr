    ...
    $(function(){
        ...
        function setTable(resp){
            ...
            $.each(resp.Data, function(i, v){
                ...
                rows += '            <a href="javascript:void(0)" data-toggle="tooltip" title="Edit Plan" class="action-edit js-edit-plan-btn"><i class="fa fa-pencil-square-o fa-fw icon_blue"></i></a>';

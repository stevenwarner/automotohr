                    ...
                    <div class="right-content-2 js-page" id="js-page-add" <?=$page != 'add' ? 'style="display: none;"' : '';?>>
                        ...
                        <div class="js-content-area">
                            ...
                            <div class="js-accural-settings">
                                <div class="row">
                                    <div class="col-sm-6 col-xs-12">
                                        <h4 class="timeline-title allowed-time-off-title-custom">Settings</h4>
                                        <div class="form-group">
                                            <label class="font-wieght-light">Duration Type <span class="cs-required">*</span></label>
                                            <div class="">
                                                <select class="invoice-fields" name="template" id="js-accural-type-add">
                                                    <option value="0">None</option>
                                                    <option value="pay_per_year">Pay Per Year</option>
                                                    <option value="pay_per_period">Pay Per Month</option>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <h4 class="timeline-title allowed-time-off-title-custom">Date Settings</h4>
                                </div>
                                <div class="col-lg-2">

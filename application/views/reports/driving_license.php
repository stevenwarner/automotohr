                                    ...
                                    <div class="col-xs-12">
                                        <div class="hr-box">
                                            ...
                                            <div class="hr-innerpadding">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                                                    <div class="field-row">
                                                                        ...
                                                                        <select id="js-employee" name="dd-employee"></select>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                                                    <div class="field-row">
                                                                        <label>Licence Type</label>
                                                                        <select id="js-license-type" name="dd-license-type">
                                                                            ...
                                                                            <option value="Basic Driver’s License">BasicDriver’s License</option>
                                                                ...
                                                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                                                    <div class="field-row">
                                                                        ...
                                                                        <select id="js-license-class" name="dd-license-class">
                                                                            <option value="all">All</option>
                                                                ...
                                                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                                                    <div class="field-row">
                                                                        ...
                                                                        <input class="invoice-fields"
                                                                               placeholder="<?=date('m-d-Y');?>"
                                                                               type="text"
                                                                               name="txt-expiration-date"
                                                                               id="js-expiration-date"
                                                                       />
                                                                    </div>
                                                                </div>
                                                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                                                    <div class="field-row">
                                                                        ...
                                                                        <input type="text" id="js-license-number" name="txt-license-number" class="form-control" />
                                                                    </div>
                                                                </div>
                                                ...
                                                <!-- Pagination -->
                                                <div class="row">
                                                    <div class="col-sm-12"><div class="js-ip-pagination"></div></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(function(){
        ...
        function resetFilter(e){
            ...
            $('#js-license-type').select2('val', 'all');
            $('#js-license-class').select2('val', 'all');
            $('#js-license-number').val('');
            $('#js-issue-date').val('');
            ...
            filterOBJ.licenseType = 'all';
            filterOBJ.licenseClass = 'all';
            filterOBJ.licenseNumber = 'all';
            filterOBJ.issueDate = 'all';
            filterOBJ.expirationDate = 'all';
        ...
        function applyFilter(e){
            ...
            filterOBJ.licenseType = $('#js-license-type').val().toLowerCase();
            filterOBJ.licenseClass = $('#js-license-class').val().toLowerCase();
            filterOBJ.licenseNumber = $('#js-license-number').val() != '' ? $('#js-license-number').val() : 'all';
            filterOBJ.issueDate = $('#js-issue-date').val() != '' ? $('#js-issue-date').val() : 'all';
            filterOBJ.expirationDate = $('#js-expiration-date').val() != '' ? $('#js-expiration-date').val() : 'all';
        ...
        function fetchFilter(){
            $.post(baseHandlerURI, {
                ...
                $('#js-employee').select2();
                $('#js-license-class').select2();
                $('#js-license-type').select2();
            })
        }
...
<style>
    .select2-container .select2-selection--single .select2-selection__rendered{ border: 1px solid #ccc; padding-left: 8px !important; }
    .pagination{ margin: 0;}
    .cs-pagination li a{ color: #5cb85c;}
    .cs-pagination li:hover a,
    .cs-pagination li.active:hover a,
    .cs-pagination li.active a{ background-color: #81b431;color: #fff; border-color: #81b431;}
</style>

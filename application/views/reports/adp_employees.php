                                    ...
                                    <div class="col-xs-12">
                                        <div class="hr-box">
                                            ...
                                            <div class="hr-innerpadding">
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <form action="<?= base_url('reports/adp_employees'); ?>" method="POST">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                                                    <div class="field-row">
                                                                        ...
                                                                        <select id="js-employee" name="employeeSid"></select>
                                                                    </div>
                                                                </div>
...
<script>
    $(function() {
        ...
        function resetFilter(e) {
            ...
            filterOBJ.adpStatus = 'all';
            filterOBJ.licenseClass = 'all';
            filterOBJ.licenseNumber = 'all';
            filterOBJ.fromDate = 'all';
            filterOBJ.toDate = 'all';
        ...
        function applyFilter(e) {
            ...
            filterOBJ.adpStatus = $('#js-adp-status').val().toLowerCase();
            filterOBJ.fromDate = $('#js-from-date').val() != '' ? $('#js-from-date').val() : 'all';
            filterOBJ.toDate = $('#js-to-date').val() != '' ? $('#js-to-date').val() : 'all';
        ...
        function fetchFilter() {
            $.post(baseHandlerURI, {
                action: 'get_adp_employee_filter'
            }, function(resp) {
                //

                                                                        ...
                                                                        <ul class="row">
                                                                            ...
                                                                            <li class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                                                                ...
                                                                                <div class="hr-select-dropdown">
                                                                                    ...
                                                                                    <select class="invoice-fields" name="week" id="week">
                                                                                        <?php for($count = 1; $count <= 52; $count++) { ?>
                                                                                            <?php $default_selected = $temp == $count ? true : false;?>
                                                                                            <option <?php echo set_select('week', $count, $default_selected); ?> value="<?php echo $count; ?>"><?php echo str_pad($count,2,0,STR_PAD_LEFT) ; ?></option>
                                                                                        <?php } ?>
                                                                                    </select>
                                                                                </div>
                                                                            </li>
...
<script>
    ...
    $(document).ready(function () {
        $('#my_search_btn').on('click', function(e){
            e.preventDefault();
    ...
    function update_search_url(){
        ...
        var my_url = '<?php echo base_url('reports/employee_weekly_attendance_report')?>/' + employee_sid +'/' + year + '/' + week;

                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-2">
                                    <a href="<?php echo base_url('reports/generate_time_to_fill'); ?>" id="btn_clear_filters" class="btn btn-success btn-block">Clear Filters</a>
                                </div>
                            </div>
                                                    ...
                                                    <table class="table table-stripped table-bordered table-hover">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="col-xs-3">Average Days To Fill</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <?php if (isset($jobs) && sizeof($jobs) > 0) { ?>
...
<script>
    ...
    function generate_search_url(){
        ...
        var url = '<?php echo base_url('reports/generate_time_to_fill'); ?>' + '/' + keyword;

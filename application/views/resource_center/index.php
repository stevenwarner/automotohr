                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <?php if ($page_content['doc_type'] != 'Hybrid') { ?>
                                                    <td><a class="btn btn-success " href="<?php echo base_url('resource_center') ?>" download="<?php echo $page_content['file_code'] ?>"><i class="fa fa-download"></i>Download</a></td>
                                                <?php } else { ?>
                                                    <td><a class="btn btn-success " href="<?php echo base_url('hr_documents_management/print_download_hybird_document_resource_center/').$page_content['sid'] ?>"  target="_blank"><i class="fa fa-download"></i>Download</a></td>

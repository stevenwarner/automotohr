                    ...
                    <div class="dashboard-conetnt-wrp">
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3 pull-left search-job-btn">
                                <b><?php echo $tickets_count; ?></b> support tickets found.
                            </div>
                            <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3 pull-right search-job-btn">
                                <a style="margin:0 0 10px;" href="<?php echo base_url('support_tickets/add'); ?>" class="form-btn">+ Create New Support Ticket</a>
                            </div>
                        </div>
                                            ...
                                            <?php foreach ($tickets as $ticket) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a class="delete-all-btn active-btn" href="<?php echo base_url('support_tickets/view').'/'.$ticket['sid']; ?>">View</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                            </tbody>
...
<?php } else { ?>
    <?php $this->load->view('tickets/tickets_list_ems'); ?>
<?php } ?>

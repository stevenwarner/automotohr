...
<html lang="en">
    ...
    <body class="A4">
        <div>
            <section class="sheet padding-10mm" id="eeoc_pdf">
                ...
                <table class="i9-table">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <input type="checkbox" name="" onclick="return false;" <?php echo !empty($eeo_form_info['us_citizen']) && $eeo_form_info['us_citizen'] == 'Yes' ? 'checked="checked"' : ''; ?>> Yes
                                <input type="checkbox" name="" onclick="return false;" <?php echo !empty($eeo_form_info['us_citizen']) && $eeo_form_info['us_citizen'] == 'No' ? 'checked="checked"' : ''; ?>> NO
                            </td>
                        </tr>

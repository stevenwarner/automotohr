...
<body class="A3" id="safety_checklist">
        ...
        <?php if ($reports) { ?>
            <?php foreach ($reports as $report) { ?>
                <section class="sheet padding-10mm jsReportSection" id="jsReportSection<?php echo $report['sid']; ?>" data-id="<?php echo $report['sid']; ?>" data-title="<?php echo $report['title']; ?>">
    ...
    <a href="<?php echo base_url('compliance_safety_report/download_reports_zip'); ?>"  id="JsCreateZipFile"></a>
    ...
    <script type="text/javascript">
        ...
        $(window).on( "load", function() {
            ...
            if (action == 'print') {
                ...
                $('.jsReportSection').each(function() {
                    sendReportBase64($(this).data("id"));
                });
                //
        ...
        async function sendReportBase64(reportId) {
            //
            if (XHR === null) {
                //
                //
                var draw = kendo.drawing;
                draw.drawDOM($("#jsReportSection"+reportId), {
                    avoidLinks: false,
                    paperSize: "auto",
                    multiPage: true,
                    margin: { bottom: "1cm" },
                ...
                .done(function(report_data) {
                    XHR = $.ajax({
                        ...
                        url: "<?php echo base_url('compliance_safety_report/save_compliance_reports_pdf'); ?>",

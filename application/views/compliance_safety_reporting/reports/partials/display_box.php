    ...
    <article class="article-sec" style="padding: 0 10px 10px;overflow-x: hidden">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12 text-center">
                <a class="btn btn-orange" href="<?= base_url("compliance_safety_reporting/report/" . $report["sid"]) . "/incident/edit/" . $display_box_data["sid"]; ?>">
                    <i class="fa fa-pencil"></i>
                    Edit
                </a>
                <a class="btn btn-green" target="_blank" href="<?= base_url("compliance_safety_reporting/download_incident/" . $display_box_data["reportId"] . '/' .$display_box_data["sid"]); ?>">

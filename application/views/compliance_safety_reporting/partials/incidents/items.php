    ...
    <div class="panel-collapse collapse" id="mia">
        <div class="panel-body">
            <p class="alert alert-danger">
                <strong>
                    Instructions: To add issues to the incident, click the checkbox.
                </strong>
            </p>
            <?php if ($report["incident_items"]): ?>
                ...
                <?php foreach ($report["incident_items"] as $k0 => $item): ?>
                    ...
                    <div class="row jsIncidentItemRow"
                        style="padding-top: 10px; padding-bottom: 10px;background-color: <?= $k0 % 2 == 0 ? '#f2f2f2' : '#f1f1f1'; ?>">
                        <div class="col-md-1">
                        ...
                        <div class="col-sm-4" style="vertical-align: middle">
                            <div class="candidate-status">
                                <input type="hidden" name="jsIncidentSeverityLevel" class="jsIncidentSeverityLevel"
                                    value="<?= $cspRecord["severity_level_sid"] ? $cspRecord["severity_level_sid"] : $severity_status[1]["sid"]; ?>" />
                                <div class="label-wrapper-outer">
                                    <div class="row">
                                        <div class="col-xs-10 jsSelectedPill">
                                            <?php if ($cspRecord["severity_level_sid"]): ?>
                                                <div data-id="<?= $cspRecord["severity_level_sid"]; ?>"
                                                    class="csLabelPill jsSelectedLabelPill text-center"
                                                    style="background-color: <?= $severity_status[$cspRecord["severity_level_sid"]]["bg_color"]; ?>; color: <?= $severity_status[$cspRecord["severity_level_sid"]]["txt_color"]; ?>;">
                                                    Severity Level
                                                    <?= $severity_status[$cspRecord["severity_level_sid"]]["level"]; ?>
                                                </div>
                                            <?php else: ?>

                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="bg-black" scope="col">Status</th>
                            ...
                            <tr data-id="<?= $item["sid"]; ?>">
                                ...
                                <td style="vertical-align: middle;">
                                    ...
                                    <?php if ($item["status"] == "completed"): ?>
                                        <?= checkAndShowUser($item['completed_by'], []) ?>
                                        <br>
                                        <?= formatDateToDB($item['completed_at'], DB_DATE_WITH_TIME, DATE_WITH_TIME); ?>
                                    <?php endif; ?>
                                </td>
                                <td style="vertical-align: middle;">
                                    <?= checkAndShowUser($item['created_by'], $item) ?>
                                    <br>
                                ...
                                <td style="vertical-align: middle;">
                                    ...
                                    <a class="btn btn-black" target="_blank"
                                        href="<?= base_url("compliance_safety_reporting/download_incident/" . $report["sid"] . '/' . $item["sid"]); ?>">

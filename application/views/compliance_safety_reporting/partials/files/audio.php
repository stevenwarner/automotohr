 ...
 <div class="panel panel-default">
     <div class="panel-heading">
         <h1 class="panel-heading-text text-medium">
             <strong>Upload Audios/Videos</strong>
         </h1>
     </div>
     <div class="panel-body">
         <div class="row">
             <div class="col-lg-12">
                 <div class="form-group">
                     <label for="video_title">Title <strong class="text-danger">*</strong></label>
         ...
         <div class="row">
             <div class="col-lg-12">
                 <div class="form-group">
                     <input type="file" class="form-control hidden" id="report_video" name="report_video" />
                 </div>
             </div>
         </div>
     </div>
     <div class="panel-footer text-right">
         <button class="btn btn-orange jsAddVideo" type="button">

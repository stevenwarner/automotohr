            ...
            <?php elseif ($file["file_type"] === "document"): ?>
                <?php if (preg_match("/doc|docx|xls|xlsx|ppt|pptx/i", $file["s3_file_value"])): ?>
                    <iframe style="width: 100%; height: 700px;"
                        src="https://view.officeapps.live.com/op/embed.aspx?src=<?= urlencode(AWS_S3_BUCKET_URL . $file["s3_file_value"]); ?>"
                        frameborder="0"></iframe>
                <?php else: ?>
                    <iframe style="width: 100%; height: 700px;" src="<?= (AWS_S3_BUCKET_URL . $file["s3_file_value"]); ?>"
                        frameborder="0"></iframe>
                <?php endif; ?>

        ...
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-md-1 col-xs-1">
                    <button class="btn btn-theme pull-right csF16 csB7">
                        <i class="fa fa-minus-circle csF16 csB7" aria-hidden="true"></i>
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-1 col-xs-1">
                    <div class="pull-right pa10 csCP">
                        <i class="fa fa-minus-circle csF18 csB7 jsHintBtn" data-target="jsDepartmentHint" aria-hidden="true"></i>
                    </div>

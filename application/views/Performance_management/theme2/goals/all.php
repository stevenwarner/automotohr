<div class="col-md-12 col-sm-12" style="padding-left: 0px;padding-right: 0px;">
    ...
    <div class="panel panel-theme">
        ...
        <div class="panel-body">
            <?php if ($type == 'department' || $type == 'team') {
                if (!empty($MyGoals)) {
                    foreach ($MyGoals as $department) {
            ?>
                        <?php if (!empty($department['goals'])) { ?>
                            <div class="row">
                                <div class="col-md-12 col-sm-12" style="background-color: #333;color:#fff;padding-top:10px;padding-bottom:10px;font-size: 16px !important;">
                        ...
                        <?php
                        if (!empty($department['goals'])) { ?>
                            <div class="row">
                                <?php
                                foreach ($department['goals'] as $goal) {
                                    //

...
<div id="jsReviewQuestionAddBox" class="dn">
    ...
    <div class="row">
        ...
        <div class="col-sm-4 col-xs-12">
            ...
            <p class="csF14 jsHintBody" data-hint="help">Explain the reviewer what they need to add into the answer.</p>
        </div>
        <div class="col-sm-8 col-xs-12">
    ...
    <div class="row">
        ...
        <div class="col-sm-4 col-xs-12">
            ...
            <p class="csF14 jsHintBody" data-hint="video_help">Record/Upload a video explaining the reviewer what to add
                into the answer.</p>
        </div>
        <div class="col-sm-8 col-xs-12">

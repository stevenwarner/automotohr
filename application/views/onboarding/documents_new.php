            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php if (empty($eev_i9) && empty($i9_form) && empty($eev_w4) && empty($w4_form) && empty($eev_w9) && empty($w9_form) && empty($assigned_offer_letter) && empty($documents) && empty($NotCompletedGeneralDocuments) && empty($CompletedGeneralDocuments) && empty($eeoc_form)) {?>
                            <div class="panel panel-default ems-documents">
                                <div class="panel-heading">
                                    <strong>Documents Details</strong>
                                </div>

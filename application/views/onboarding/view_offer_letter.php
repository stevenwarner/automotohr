                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-xs-12 col-sm-3">
                                                                ...
                                                                <?php if(!empty($offer_letter['uploaded_file'])) { ?>
                                                                    ...
                                                                    ?>
                                                                    <a href="javascript:;"class="btn blue-button btn-equalizer btn-block"
                                                                        onclick="show_uploaded_offer_letter(this);"
                                                                        data-preview-url="<?php echo $upload_offer_letter_iframe_url; ?>"
                                                                        data-file-name="<?php echo 'Uploaded Signed Offer Letter / Pay Plan'; ?>">Preview Uploaded
                                                                    </a>
                                                                <?php } ?>
                                                            </div>
                                                        </div>
    ...
    function func_save_offer_letter() {
        if ($('#user_consent_form').valid()) {
            alertify.confirm(
                ...
                function () {
                    alertify.error('Cancelled!');
                }).set('labels', {ok: 'Save Offer Letter!', cancel: 'Cancel'});
        }
    }

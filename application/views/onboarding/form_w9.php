...
<!--                                </div>-->
                                ...
                                <div class="col-lg-2 cs-btn-setting">
                                    ...
                                    <?php } ?>
                                </div><div class="col-lg-3 cs-btn-setting">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo sizeof($pre_form)>0 ? $pre_form['w9_name']: ''?>" name="w9_name" class="form-control" />
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group">
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group autoheight">
                                    ...
                                    <input type="text" name="w9_address" class="form-control" value="<?php echo sizeof($pre_form)>0 ? $pre_form['w9_address']: ''?>"/>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group autoheight">
                                    <label>6. City, state, and ZIP code</label>
                                    <input type="text" name="w9_city_state_zip" class="form-control" value="<?php echo sizeof($pre_form)>0 ? $pre_form['w9_city_state_zip']: ''?>"/>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group autoheight">

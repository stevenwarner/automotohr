...
<script>
    ...
    $( "#edit_location_button" ).click(function() {
        ...
        if (location_title === "" && location_address === "") {
            ...
            if (location_title === "") {$('#edit_location_title_error').html('<strong>Title is required.</strong>');}
            if (location_address === "") {$('#edit_location_address_error').html('<strong>Address is required.</strong>');}   
        } else {

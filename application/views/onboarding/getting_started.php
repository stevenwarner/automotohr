                                                    ...
                                                    <?php if ($document['archive'] != 1) { ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php if ($document['document_type'] != 'hybrid_document' ) { ?>
                                                                <a href="<?= base_url("hr_documents_management/print_generated_and_offer_later_new/original/generated/" . ($document['sid']) . "/print"); ?>" class="btn btn-orange" target="_blank">Print</a>
                                                               <?php }?>
                                                                ...
                                                                <?php }else if($document['document_type'] == 'hybrid_document'){
                                                                    ...
                                                                    <a href="<?= base_url("hr_documents_management/print_generated_and_offer_later_new/original/generated/" . ($document['sid']) . "/download"); ?>" class="btn btn-black" target="_blank">Download</a>
                                                                <?php } ?>

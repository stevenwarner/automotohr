                                                        ...
                                                        <?php if (!empty($offer_letters)) { ?>
                                                            ...
                                                            ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button 
                                                                            data-id="<?php echo $offer_letter['letter_status'] == 'Current' ? $offer_letter['letter_sid'] : $offer_letter['sid']; ?>"
                                                                            data-table="<?php echo $offer_letter['letter_status'] == 'Current' ? 'documents_assigned' : 'documents_assigned_history'; ?>"
                                                                            data-title="<?php echo $offer_letter['letter_title']; ?>"
                                                                            data-type="<?php echo $offer_letter['letter_type']; ?>"
                                                                            data-vpr="<?php echo $offer_letter['visible_to_payroll']; ?>"
                                                                            date-assign="<?php echo date('m-d-Y', strtotime($offer_letter['assigned_date'])); ?>"
                                                                            date-signed="<?php echo !empty($offer_letter['signature_timestamp']) ? date('m-d-Y', strtotime($offer_letter['signature_timestamp'])) : date('m-d-Y'); ?>"
                                                                            data-file="<?php echo isset($offer_letter['uploaded_file']) && !empty($offer_letter['uploaded_file']) ? $offer_letter['uploaded_file'] : ''; ?>"
                                                                            data_description="<?php echo isset($offer_letter['document_description']) && !empty($offer_letter['document_description']) ? '' : ''; ?>"
                                                                            class="btn btn-success btn-sm btn-block manage_offer_letter">
                                                                    ...
                                                                    <td>
                                                                        <?php if ($offer_letter['letter_type'] == 'hybrid_document') { ?>
                                                                            <button 
                                                                                data-id="<?=$offer_letter['letter_sid'];?>"
                                                                        ...
                                                                        <?php } else if ($offer_letter['letter_type'] == 'uploaded') { ?>
                                                                            <button class="btn btn-success btn-sm btn-block"
                                                                                ...
                                                                                data-preview-url="<?php echo AWS_S3_BUCKET_URL . $offer_letter_url; ?>"
                                                                                data-s3-name="<?php echo $offer_letter_url; ?>">
                                                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                                                    Preview
                                                                            </button> 
                                                                        <?php } else { ?>
                                                                            <button class="btn btn-success btn-sm btn-block"
                                                                                ...
                                                                                data-doc-sid="<?php echo $offer_letter['letter_sid']; ?>"
                                                                                data-on-action="submitted"
                                                                                data-from="<?=$offer_letter['letter_status'] == 'Current' ? 'assigned_document' : 'assigned_document_history'; ?>">
                                                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                                                    Preview
                                                                            </button>
                                                                        <?php } ?>       

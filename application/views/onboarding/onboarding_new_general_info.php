            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                ...
                <div class="accordion-colored-header">
                    <div class="panel-group" id="accordion">
                        ...
                        <?php if (checkGeneralDocumentActive('drivers_license_flag')) { ?>
                                        ...
                                        <div class="form-wrp">
                                            <form method="POST" enctype="multipart/form-data" autocomplete="off">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6" style="margin-top: 30px;">
                        ...
                        <?php if (checkGeneralDocumentActive('occupational_license_flag')) { ?>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                        ...
                        <?php if (checkGeneralDocumentActive('dependents_flag')) { ?>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <?php echo form_label('Date of Birth', $field_name); ?>
                                                            <?php echo form_input($field_name, '', 'class="form-control" id="' . $field_name . '" readonly'); ?>
                                                            <?php echo form_error($field_name); ?>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                        ...
                        <?php if (checkGeneralDocumentActive('emergency_contacts_flag')) { ?>    
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                        ...
                        <?php if (checkGeneralDocumentActive('direct_deposit_flag')) { ?>    
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="collapsed" data-toggle="collapse" aria-expanded="false" data-parent="#accordion" href="#equipment"><span class="glyphicon glyphicon-plus"></span>Equipment Info <strong data-id="equipment_info" class="jsGeneralAssignDocument"></strong></a>
                                </h4>
                            </div>

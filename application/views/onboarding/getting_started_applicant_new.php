                            ...
                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 text-left">
                                <div class="text">
                                    <?php if (!empty($timings)) { ?>
                                        <div class="text">
                                            <?php if(isset($timings[0]['start_time'])){?>
                                           ...
                                           <?php  } else{?>
                                            <i class="fa fa-clock-o"></i> <b><?php echo $timings[0]['hour_title']; ?></b>, <?php echo DateTime::createFromFormat('H:i:s', $timings[0]['hour_start_time'])->format('h:i a') . ' - ' . DateTime::createFromFormat('H:i:s', $timings[0]['hour_end_time'])->format('h:i a'); ?>
                                           <?php }?>
                                        </div>
                                    <?php               } ?>

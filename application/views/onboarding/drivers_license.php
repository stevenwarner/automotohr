        ...
        <div class="row">
            ...
            <div class="col-lg-10 col-md-9 col-xs-12 col-sm-8">
                <div class="page-header">
                    <h1 class="title-heading">Drivers License</h1>
                </div>
                <div class="btn-wrp">
                    <div class="row">
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                            <a href="<?php echo base_url('onboarding/occupational_license/' . $unique_sid); ?>" class="btn btn-success btn-block"><i class="fa fa-arrow-left"></i>&nbsp;Previous</a>
                        </div>
                        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                            <!--<a href="javascript:;" class="btn btn-danger btn-block">Skip</a>-->
                        </div>
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                            <a href="<?php echo base_url('onboarding/dependents/' . $unique_sid); ?>" class="btn btn-success btn-block">Next&nbsp;<i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="hr-box">

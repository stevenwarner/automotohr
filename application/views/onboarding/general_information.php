        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <!--                    <a href="--><?php //echo $back_url; 
                                                    ?>
                <!--" class="btn btn-info"><i class="fa fa-angle-left"></i> Dashboard</a>-->
                <!--                    <a href="--><?php //echo base_url('incident_reporting_system/list_incidents')
                                                    ?>
                <!--" class="btn btn-info"><i class="fa fa-heartbeat"></i> Login Credentials</a>-->
                <!--                </div>                -->
            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="hr-select-dropdown">
                                        <select class="form-control" name="employee_type">
                                            <option <?= $user_information["employee_status"] == 'permanent' ? 'selected' : ''; ?> value="permanent">
                                                Permanent
                                            </option>
                                            <option <?= $user_information["employee_status"] == 'contractual' ? 'selected' : ''; ?> value="contractual">
                                                Contractual
                                            </option>
                                        </select>
                                    </div>

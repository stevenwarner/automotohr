                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="offer_letter_select" name="offer_letter_select">
                                                            ...
                                                            <?php foreach ($offer_letters as $offer_letter) { ?>
                                                                ...
                                                                ?>
                                                                <option 
                                                                    value="<?=$offer_letter['sid'];?>"
                                                                ><?=$offer_letter['letter_name'];?> (<?=$offer_letter['letter_type'];?>)</option>
                                                            <?php } ?>
                                                        </select>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <?php } else if($document['document_type'] == 'uploaded') { ?>
                                                                                        ...
                                                                                        <button class="btn btn-success btn-sm btn-block" 
                                                                                            ...
                                                                                            data-preview-url="<?php echo AWS_S3_BUCKET_URL . $document['uploaded_document_s3_name']; ?>"
                                                                                            data-s3-name="<?php echo $document['uploaded_document_s3_name']; ?>">
                                                                                            View Doc
                                                                                        </button>        
                                                                                    <?php } else { ?>
                                                                                        ...
                                                                                        <button class="btn btn-success btn-sm btn-block"
                                                                                            ...
                                                                                            data-on-action="company"
                                                                                            data-from="company_document">
                                                                                            View Doc
                                                                                        </button>
                                                                                    <?php } ?>
                                                                                </td>
                                                            ...
                                                            <div class="hr-select-dropdown">
                                                                <select class="invoice-fields" name="employee-status" id="employee-status">
                                                                    <?php foreach($employment_statuses as $key => $employee_status) { ?>
                                                                        <option value="<?= $key ?>" <?php if(strtolower($user_info['employee_status']) == $key){echo 'selected' ;}?>><?= $employee_status ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>                                                
                                                            <?php echo form_error($field_id); ?>
                                                        ...
                                                        <div class="hr-select-dropdown">
                                                            <select class="invoice-fields" name="employee-type" id="employee-type">
                                                                <?php foreach($employment_types as $key => $employment_type) { ?>
                                                                    <option value="<?= $key ?>" <?php if($user_info['employee_type'] == $key){echo 'selected' ;}?>><?= $employment_type ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                        <?php echo form_error($field_id); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#offer_letter_select').on('change', function () { loadOfferLetterView($(this).val()); });

...
<!--                                <a href="--><?php //echo base_url('onboarding/dependents/' . $unique_sid); ?><!--" class="btn btn-success btn-block"><i class="fa fa-arrow-left"></i>&nbsp;Previous</a>-->
<!--                            </div>-->
<!--                            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">-->
<!--                                <!--<a href="javascript:;" class="btn btn-danger btn-block">Skip</a>-->
<!--                            </div>-->
<!--                            <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">-->
<!--                                <a href="--><?php //echo base_url('onboarding/eeoc_form/' . $unique_sid); ?><!--" class="btn btn-success btn-block">Next&nbsp;<i class="fa fa-arrow-right"></i></a>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
                <?php }?>
...
<!--                                                    <input  class="form-control" name="TextBoxEmploymentEmployerCompensationBegin1" value="--><?php //echo set_value($key, $def_value); ?><!--" type="text">-->
<!--                                                    --><?php //echo form_error($key); ?>
<!--                                                </div>-->
<!--                                            </div>-->
<!--                                            <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">-->
...
<!--                                                    <input  class="form-control" name="TextBoxEmploymentEmployerCompensationEnd1" value="--><?php //echo set_value($key, $def_value); ?><!--" type="text">-->
<!--                                                    --><?php //echo form_error($key); ?>
<!--                                                </div>-->
<!--                                            </div>-->
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
...
<!--                                                        --><?php //$def_value = (isset($application[$key]) ? $application[$key] : '' );?>
<!--                                                        <label>Starting Compensation</label>-->
<!--                                                        <input  class="form-control" name="TextBoxEmploymentEmployerCompensationBegin2" value="--><?php //echo set_value($key, $def_value); ?><!--" type="text">-->
<!--                                                        --><?php //echo form_error($key); ?>
<!--                                                    </div>-->
<!--                                                </div>-->
<!--                                                <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">-->
...
<!--                                                        --><?php //$def_value = (isset($application[$key]) ? $application[$key] : '' );?>
<!--                                                        <label>Ending Compensation</label>-->
<!--                                                        <input  class="form-control" name="TextBoxEmploymentEmployerCompensationEnd2" value="--><?php //echo set_value($key, $def_value); ?><!--" type="text">-->
<!--                                                        --><?php //echo form_error($key); ?>
<!--                                                    </div>-->
<!--                                                </div>-->
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
...
<!--                                                    --><?php //$def_value = (isset($application[$key]) ? $application[$key] : '' );?>
<!--                                                    <label>Starting Compensation</label>-->
<!--                                                    <input  class="form-control" name="TextBoxEmploymentEmployerCompensationBegin3" value="--><?php //echo set_value($key, $def_value); ?><!--" type="text">-->
...
<!--                                                    --><?php //$def_value = (isset($application[$key]) ? $application[$key] : '' );?>
<!--                                                    <label>Ending Compensation</label>-->
<!--                                                    <input  class="form-control" name="TextBoxEmploymentEmployerCompensationEnd3" value="--><?php //echo set_value($key, $def_value); ?><!--" type="text">-->
<!--                                                    --><?php //echo form_error($key); ?>
<!--                                                </div>-->
<!--                                            </div>-->
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">

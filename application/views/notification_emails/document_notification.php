                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-4">
                                                        <form action="<?php echo current_url(); ?>" id="form_document_status" method="post" enctype="multipart/form-data">
                                                            <input type="hidden" id="perform_action" name="perform_action" value="document_status" />
                                                            <input type="hidden" id="notifications_status" name="document_status" value="<?php echo ($current_notification_status == 1 ? 0 : 1); ?>" />
                                                            <input type="hidden" id="company_sid" name="company_sid" value="<?php echo $company_sid; ?>" />
                                                            <?php if ($current_notification_status == 1) { ?>
                                                                <button type="button" onclick="func_course_status('Disable', '<?php echo $title_for_js_dialog; ?>'); " class="btn btn-danger btn-block">Disable Notifications</button>
                                                            <?php } else { ?>
                                                                <button type="button" onclick="func_course_status('Enable', '<?php echo $title_for_js_dialog; ?>');" class="btn btn-success btn-block">Enable Notifications</button>
                                                            <?php } ?>
                                                        </form>
                                                    </div>
                                                </div>
...
<script language="JavaScript" type="text/javascript">
    function func_course_status(status, notifications) {
        alertify.confirm(
            'Are you sure?',
            'Are you sure you want to "' + status + '" "' + notifications + '" ?',
            function() {
                $('#form_document_status').submit();
            },
            function() {

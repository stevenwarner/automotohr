                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-4">
                                                        <form action="<?php echo current_url(); ?>" id="form_course_status" method="post" enctype="multipart/form-data">
                                                            <input type="hidden" id="perform_action" name="perform_action" value="course_status" />
                                                            <input type="hidden" id="notifications_status" name="course_status" value="<?php echo ($current_notification_status == 1 ? 0 : 1); ?>" />

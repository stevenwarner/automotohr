                            ...
                            <div class="page-header-area">
                                <span
                                    ...
                                    <a class="dashboard-link-btn"
                                        href="<?php echo base_url('notification_emails'); ?>"><i
                                            class="fa fa-chevron-left"></i>Notification Email Management</a>
                                    <?php echo $title; ?>
                                </span>
                            </div>
                            <div class="row">
                                        ...
                                        <div class="panel panel-success">
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-lg-8 col-md-8 col-xs-12 col-sm-8">
                                                        <div class="pull-left">
                                                            <h4 style="margin-top: 6px; margin-bottom: 0;"
                                                                class="text-success" style="font-size: 18px;">
                                                                <strong>Send Notification Emails: </strong> <span
                                                                    class="<?php echo ($current_notification_status == 1 ? 'Paid' : 'Unpaid'); ?>"
                                                                    style="font-size: 18px;"><?php echo ($current_notification_status == 1 ? 'Enabled' : 'Disabled'); ?></span>
                                                            </h4>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-4">
                                                        <form action="<?php echo current_url(); ?>"
                                                            id="form_set_notifications_status" method="post"
                                                            enctype="multipart/form-data">
                                                            <input type="hidden" id="perform_action"
                                                                name="perform_action"
                                                                value="set_notifications_status" />
                                                            <input type="hidden" id="notifications_status"
                                                                name="notifications_status"
                                                                value="<?php echo ($current_notification_status == 1 ? 0 : 1); ?>" />
                                                            <input type="hidden" id="company_sid" name="company_sid"
                                                                value="<?php echo $company_sid; ?>" />
                                                            <?php if ($current_notification_status == 1) { ?>
                                                                <button type="button"
                                                                    onclick="func_set_notifications_status('Disable', '<?php echo $title_for_js_dialog; ?>'); "
                                                                    class="btn btn-danger btn-block">Disable
                                                                    Notifications</button>
                                                            <?php } else { ?>
                                                                <button type="button"
                                                                    onclick="func_set_notifications_status('Enable', '<?php echo $title_for_js_dialog; ?>');"
                                                                    class="btn btn-success btn-block">Enable
                                                                    Notifications</button>
                                                            <?php } ?>
                                                        </form>
                                                    </div>
                                        ...
                                        <div class="panel panel-success">
                                            <div class="panel-body">
                                                <?php if ($notification_type != 'approval_management') { ?>
                                                    <a href="javascript:;" id="add_new_notification"
                                                        class="btn btn-success btn-block"><i class="fa fa-plus"></i> Non
                                                        Employee Notification Email</a>
                                                <?php } ?>
                                                <a href="javascript:;" id="add_new_notification_employee"
                                        ...
                                        <?php } else { ?>
                                            <?php foreach ($notifications_emails as $notifications_email) { ?>
                                                <tr id="tr_row_<?php echo $notifications_email['sid'] ?>">
                                                    <td><?php echo $notifications_email["contact_name"]; ?><?php if ($notifications_email['employer_sid'] != 0 || $notifications_email['employer_sid'] == '') { ?><br /><?php echo remakeEmployeeName(array("access_level_plus" => $notifications_email['access_level_plus'], "pay_plan_flag" => $notifications_email['pay_plan_flag'], "access_level" => $notifications_email['access_level'], "is_executive_admin" => $notifications_email['is_executive_admin'], "job_title" => $notifications_email['job_title']), false) ?><?php } ?>
                                                    </td>
                                                    ...
                                                    <td><?php echo ($notifications_email['employer_sid'] == 0) ? 'No' : 'Yes'; ?>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        <a data-toggle="tooltip" data-placement="top" title="Edit"
                                                            href="<?php echo base_url('notification_emails/edit_contact') . '/' . $notifications_email['sid'] . '/' . $notification_type; ?>"
                                                            class="btn btn-success btn-sm" title="Edit Contact"><i
                                                                class="fa fa-pencil"></i></a>
                                                    </td>
                                                    <td class="text-center">
                                                        <a data-toggle="tooltip" data-placement="top" title="Delete"
                                                            class="btn btn-danger btn-sm" title="Remove Contact"
                                                            onclick="remove_contact(<?php echo $notifications_email['sid'] ?>)"><i
                    ...
                    <div class="row">
                        <div class="add-credit-card-container payment-area-wrp">
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="page-header-area">
                                    <span
                                        class="page-heading down-arrow"><?php $this->load->view('manage_employer/company_logo_name'); ?><?php echo $sub_title; ?></span>
                                </div>
                                <div class="create-job-wrap">
                                    <div class="universal-form-style-v2">
                                        <ul>
                                            <li class="form-col-50-left">
                                                <label for="contact_name">Contact Name <span
                                            ...
                                            <li class="form-col-100 autoheight">
                                                <label class="control control--checkbox">
                                                    Enable Emails <small class="text-success">Check to enable email
                                                        notifications to this contact.</small>
                                                    <input class="status" id="status" name="status" value="1"
                                                        type="checkbox" />
                                            ...
                                            <li class="form-col-100 autoheight">
                                                <input type="hidden" id="perform_action" name="perform_action"
                                                    value="add_notification_email" />
                                                <input type="hidden" name="notifications_type"
                                                    value="<?php echo $notification_type; ?>">
                                                <input type="submit" value="Save" onclick="return validate_form()"
                                                    class="submit-btn">
                                                <input type="button" value="Cancel" id="cancel_button_employee"
                                                    class="submit-btn btn-cancel" />
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <ul>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="field-row">
                                                            <?php if (sizeof($employees) > 0) { ?>
                                                                <select class='invoice-fields' name='employee'
                                                                    id='employee'>
                                            ...
                                            <li class="form-col-100 autoheight">
                                                <input type="hidden" name="notifications_type"
                                                    value="<?php echo $notification_type; ?>">
                                                <input type="hidden" id="perform_action" name="perform_action"
                                                    value="add_notification_employee" />

                            ...
                            <div class="row">
                                <div class="col-xs-9">
                                    <form id="form_new_document" enctype="multipart/form-data" method="post" action="<?php echo current_url(); ?>">
                                        <input type="hidden" id="perform_action" name="perform_action" value="generate_new_offer_letter" />
                                        <input type="hidden" id="company_sid" name="company_sid" value="<?php echo $company_sid; ?>" />
                                        <input type="hidden" id="employer_sid" name="employer_sid" value="<?php echo $employer_sid; ?>" />

                                        <?php if(isset($offer_letter_info['sid'])) { ?>
                                            <input type="hidden" id="offer_letter_sid" name="offer_letter_sid" value="<?php echo $offer_letter_info['sid']; ?>" />
                                        <?php } ?>

                                        <div class="row margin-top">
                                            <div class="col-xs-12">
                                                <?php $save_value = isset($offer_letter_info['target_user_type']) ? $offer_letter_info['target_user_type'] : 'applicant'; ?>
                                        ...
                                        <div class="row margin-top">
                                            <div class="col-xs-12">
                                                <?php $field_id = 'letter_name'; ?>
                                                <?php $save_value = isset($offer_letter_info[$field_id]) ? $offer_letter_info[$field_id] : ''; ?>
                                        ...
                                        <div class="row margin-top">
                                            <div class="col-xs-12">
                                                ...
                                                <?php $save_value = isset($offer_letter_info[$field_id]) ? html_entity_decode($offer_letter_info[$field_id]) : ''; ?>

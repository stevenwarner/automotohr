            ...
            <div class="col-lg-9 col-md-9 col-xs-12 col-sm-12">
                ...
                <div class="dashboard-conetnt-wrp">
                    <div class="page-header-area">
                        <span class="page-heading down-arrow"><a class="dashboard-link-btn" href="<?php echo base_url('documents_management/people_with_pending_documents'); ?>"><i class="fa fa-chevron-left"></i>People With Pending Documents</a><?php echo $title; ?> </span>
                    </div>

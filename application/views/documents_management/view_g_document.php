                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    <div class="document_container" style="padding: 40px; background-color: #FFFFFF;">
                                                        ...
                                                        <?php
                                                            ...
                                                            $view_data['users_sid'] = $document['user_sid'];
                                                            $view_data['first_name'] = $document['first_name'];
                                                            $view_data['last_name'] = $document['last_name'];
                                                            $view_data['email'] = $document['email_address'];
                                                            $view_data['save_post_url'] = current_url();
                                                            $view_data['documents_assignment_sid'] = $document['sid'];
                                                            $view_data['signed_flag'] = true;
                                                            $view_data['e_signature_data'] = $document;

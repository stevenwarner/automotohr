                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['w9_name'] : '' ?>" name="w9_name" class="form-control input-grey" />
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    <div class="form-group">
                                        <label>2. Business name/disregarded entity name, if different from above. <span class="staric">*</span> </label>
                                        <input type="text" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['w9_business_name'] : '' ?>" name="w9_business_name" class="form-control input-grey" />
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                ...
                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                                    <div class="form-group autoheight">
                                        <label class="control control--checkbox">
                                            ...
                                            <input id="selectall" name="w9_federaltax_classification" class="input-grey" <?php echo sizeof($pre_form) > 0 && $pre_form['w9_federaltax_classification'] == 'individual' ? 'checked' : '' ?> type="checkbox" value="individual">
                                ...
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="form-group autoheight">
                                        <input type="text" id="llc_desc" value="<?php echo sizeof($pre_form) > 0 && $pre_form['w9_federaltax_classification'] == 'llc' ? $pre_form['w9_federaltax_description'] : '' ?>" name="w9_llc_federaltax_description" class="form-control input-grey" />
                                ...
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="form-group autoheight">
                                        <input type="text" name="w9_other_federaltax_description" value="<?php echo sizeof($pre_form) > 0 && $pre_form['w9_federaltax_classification'] == 'other' ? $pre_form['w9_federaltax_description'] : '' ?>" class="form-control input-grey" id="other_desc" />
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    <div class="form-group autoheight">
                                ...
                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                    <div class="form-group autoheight">
                                        ...
                                        <input type="text" name="w9_exemption_payee_code" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['w9_exemption_payee_code'] : '' ?>" class="form-control input-grey" />
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                    <div class="form-group autoheight">
                                        <label>Exemption from FATCA reporting code (if any)</label>
                                        <input type="text" name="w9_exemption_reporting_code" class="form-control input-grey" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['w9_exemption_reporting_code'] : '' ?>" />
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    <div class="form-group autoheight">
                                        <label>5. Address (number, street, and apt. or suite no.) See instructions.</label>
                                        <input type="text" name="w9_address" class="form-control input-grey" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['w9_address'] : '' ?>" />
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    <div class="form-group autoheight">
                                        <label>6. City, state, and ZIP code</label>
                                        <input type="text" name="w9_city_state_zip" class="form-control input-grey" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['w9_city_state_zip'] : '' ?>" />
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    <div class="form-group autoheight">
                                        <label>Requester’s name and address (optional)</label>
                                        <textarea class="form-control textarea input-grey" name="w9_requester_name_address"><?php echo sizeof($pre_form) > 0 ? $pre_form['w9_requester_name_address'] : '' ?></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    <div class="form-group autoheight">
                                        <label>7. List account number(s) here (optional)</label>
                                        <input type="text" name="w9_account_no" class="form-control input-grey" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['w9_account_no'] : '' ?>" />
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="hr-box">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-5 col-md-5 col-xs-12 col-sm-5">
                                                    <div class="form-group autoheight">
                                                        ...
                                                        <input type="text" name="w9_social_security_number" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['w9_social_security_number'] : '' ?>" class="form-control input-grey" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-5 col-md-5 col-xs-12 col-sm-5">
                                                    <div class="form-group autoheight">
                                                        ...
                                                        <input type="text" name="w9_employer_identification_number" value="<?php echo sizeof($pre_form) > 0 ? $pre_form['w9_employer_identification_number'] : '' ?>" class="form-control input-grey" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <?php if ($signed_flag == false) { ?>
                                            <div class="row">
                                                <div class="col-lg-12 text-center">
                                                    <button <?php echo $signed_flag == true ? 'disabled="disabled"' : ''; ?> type="button" class="btn blue-button break-word-text"><?php echo SIGNATURE_CONSENT_BUTTON; ?></button>
                                                </div>
                                            </div>
                                        <?php } ?>
                                    </div>
...
<script language="JavaScript" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        <?php if ($signed_flag == true) {
            echo "$('input[type=checkbox]:not(:checked)').prop('disabled', true)";
        } ?>
    });

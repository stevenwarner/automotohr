                                        ...
                                        <?php if($pre_form['user_consent'] == 1){?>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-lg-3 pull-right">
                                                    <a target="_blank" href="<?php echo base_url('form_w9/download_w9form/' . $pre_form['user_type'] . '/' . $pre_form['user_sid'])?>" class="btn btn-success btn-block">Download PDF</a>
                                                </div>
                                                <div class="col-lg-3 pull-right">
                                                    ...
                                                    <?php if($signed_flag == false) { ?>
                                                        <div class="row">
                                                            <div class="col-lg-12 text-center">
                                                                <button <?php echo $signed_flag == true ? 'disabled="disabled"' : ''; ?> onclick="func_save_e_signature();" type="button" class="btn btn-success break-word-text"><?php echo SIGNATURE_CONSENT_BUTTON; ?></button>
                                                            </div>
                                                        </div>
                                                    <?php } ?>
                                                </div>
...
<?php }  else if ($load_view == 'new') { ?>
    <?php $this->load->view('form_w9/index_ems'); ?>
<?php } ?>
...
//            if(!checked){
//                alertify.alert("Warning", 'Federal Tax Classification is required');
//                flag = 1;
//                return false;
//            }
//            if(check_val=='llc' && $('#llc_desc').val() == ''){
//                alertify.alert("Warning", 'Enter The Tax Classification (C=C Corporation, S=S Corporation, P=Partnership)');
//                flag = 1;
//                return false;
//            }
//            if(check_val=='other' && $('#other_desc').val() == ''){
//                alertify.alert("Warning", 'Enter Other Federal Tax Classification');
//                flag = 1;
//                return false;
//            }
//            if(flag){

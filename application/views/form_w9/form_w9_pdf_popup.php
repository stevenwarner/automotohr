...
<style type="text/css">
    ...
    .sheet.padding-10mm { padding: 0 !important; }
...
<body class="A4">
    <div class="sheet padding-10mm" style="width: 797px;padding: 10px 10mm; margin: 0px 17px;">
        <?php if ($pre_form['user_consent'] != 0) { ?>
            <div class="row mb-2">
                <?php if ($pre_form['uploaded_file'] != NULL) { ?>
                    ...
                    <div class="col-lg-3 pull-right">
                        ...
                        <?php } else if (in_array($dcoument_extension, ['jpe', 'jpg', 'jpeg', 'png', 'bmp', 'gif', 'svg'])) { ?>
                            <a target="_blank" href="javascript:;"  onclick="PrintElem('#w9_pdf')" class="btn btn-success btn-block">Print</a>
                ...
                <?php } else{ ?>
                    <div class="col-lg-3 pull-right">
                        <a target="_blank" href="<?php echo base_url('form_w9/download_w9form'.'/'. $user_type . '/' . $user_sid); ?>" class="btn btn-success btn-block">
                            Download PDF
                        </a>
                    </div>
                    <div class="col-lg-3 pull-right">
                        <a target="_blank" href="<?php echo base_url('form_w9/print_w9_form'.'/'. $user_type . '/' . $user_sid); ?>" class="btn btn-success btn-block">
                            Print PDF
                        </a>
                    </div>
                <?php }?>
        ...
        <?php } else{ ?>
            <div class="row mb-8">
                <div class="form">
                    <form method="post" action="<?php echo base_url('form_w9/upload_signed_form')?>" enctype="multipart/form-data">
                        <div class="col-lg-10">
                            <label> Upload Signed Form</label>
                            <input type="file" name="upload_file" required="required" id="upload_file_w9" class="choose-file">
    ...
    <section class="sheet padding-10mm" id="w9_pdf" style="overflow: hidden; position: relative; box-sizing: border-box; page-break-after: always; font-size: 14px; font-family: Arial,Helvetica Neue,Helvetica,sans-serif;">
        <?php if ($pre_form['uploaded_file'] == NULL){ ?>
        <article class="sheet-header" style=" float: left; width: 100%; padding: 0 0 2px 0; margin: 0 0 5px 0; border-bottom: 5px solid #000;">
            <div class="header-logo" style="float: left; width: 20%;">
            ...
            <div class="center-col" style="float: left; width: 60%; text-align: center;">
            <h2 style="margin: 0 0 5px 0;">Request for Taxpayer<br>Identification Number and Certification</h2>
            <p style="margin: 0 0 5px 0;">▶ Go to www.irs.gov/FormW9 for instructions and the latest information.</p>
            </div>
            <div class="right-header" style="float: left; width: 20%; text-align: center;">
            <h4>Give Form to the<br>requester. Do not<br>send to the IRS.</h4>
            </div>
        </article>
        <table class="w9-table" style="width: 100%; max-width: 100%; margin-bottom: 5px; border: 1px solid #000; text-align: left; border-collapse: collapse;">
            <tbody>
                <tr>
                    <td colspan="2" style="padding: 8px; border: 1px solid #000; vertical-align: top;">
                        ...
                        <span class="value-box bg-gray" style="background-color: #C9C9C9; float: left; width: 100%; min-height: 20px; padding: 3px; -webkit-box-sizing: border-box; box-sizing: border-box;"><?php echo $pre_form['w9_name']?></span>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="padding: 8px; border: 1px solid #000; vertical-align: top;">
                        <label><strong>2.</strong> Business name/disregarded entity name, if different from above</label>
                        <span class="value-box bg-gray" style="background-color: #C9C9C9; float: left;
        width: 100%;
        min-height: 20px;
        padding: 3px;
        -webkit-box-sizing: border-box;
        box-sizing: border-box;"><?php echo $pre_form['w9_business_name']?></span>
                    </td>
                </tr>
                <tr>
                    <td style="width: 70%; padding: 8px; border: 1px solid #000; vertical-align: top;">
                        ...
                        <table class="w9-table no-border" style="width: 100%; max-width: 100%; margin-bottom: 5px; border: 1px solid #000; text-align: left; border-collapse: collapse;">
                          <tr>
                            <td width="500" style="border:none !important;">
        ...
        padding: 3px;
        -webkit-box-sizing: border-box;
        box-sizing: border-box;"><?php echo sizeof($pre_form)>0 && $pre_form['w9_federaltax_classification'] == 'llc' ? $pre_form['w9_federaltax_description']: ''?></span>
                            </td>
                          </tr>
                          <tr>
                            <td colspan="3" style="border:none !important;"><strong>Note:</strong> Check the appropriate box in the line above for the tax classification of the single-member owner. Do not check
                          ...
                          <tr>
                            <td colspan="1" style="border:none !important;">
        ...
        padding: 3px;
        -webkit-box-sizing: border-box;
        box-sizing: border-box;"><?php echo sizeof($pre_form)>0 && $pre_form['w9_federaltax_classification'] == 'other' ? $pre_form['w9_federaltax_description']: ''?></span>
                            </td>
                          </tr>
                        </table>
                    </td>
                    <td style="width: 30%; padding: 8px; border: 1px solid #000; vertical-align: top;">
                        ...
                        <table class="w9-table no-border" style="border:none !important; width: 100%;
        max-width: 100%;
        margin-bottom: 5px;
        border: 1px solid #000;
        text-align: left;
        ...
        padding: 3px;
        -webkit-box-sizing: border-box;
        box-sizing: border-box;"><?php echo sizeof($pre_form)>0 ? $pre_form['w9_exemption_payee_code']: ''?></span>
                            </td>
                          </tr>
                          <tr>
                            <td style="border:none !important;">
        ...
        padding: 3px;
        -webkit-box-sizing: border-box;
        box-sizing: border-box;"><?php echo sizeof($pre_form)>0 ? $pre_form['w9_exemption_reporting_code']: ''?></span>
                            </td>
                          </tr>
                          <tr>
                            <td style="border:none !important;">
        ...
        padding: 3px;
        -webkit-box-sizing: border-box;
        box-sizing: border-box;"><?php echo sizeof($pre_form)>0 ? $pre_form['w9_address']: ''?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
        ...
        padding: 3px;
        -webkit-box-sizing: border-box;
        box-sizing: border-box;"><?php echo sizeof($pre_form)>0 ? $pre_form['w9_city_state_zip']: ''?></span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
        ...
        padding: 3px;
        -webkit-box-sizing: border-box;
        box-sizing: border-box;"><?php echo sizeof($pre_form)>0 ? $pre_form['w9_requester_name_address']: ''?></span>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="padding: 8px; border: 1px solid #000; vertical-align: top;">
        ...
        padding: 3px;
        -webkit-box-sizing: border-box;
        box-sizing: border-box;"><?php echo sizeof($pre_form)>0 ? $pre_form['w9_account_no']: ''?></span>
                    </td>
                </tr>
            </tbody>
        </table>
        <table class="w9-table" style="width: 100%; max-width: 100%; margin-bottom: 5px; border: 1px solid #000; text-align: left; border-collapse: collapse;">
            <thead>
                <tr class="bg-gray">
                  <th colspan="2" style="padding: 8px; border: 1px solid #000; vertical-align: top;">
            ...
            <tbody>
                <tr>
                    <td width="65%" style="padding: 8px; border: 1px solid #000; vertical-align: top;">
        ...
        <table class="w9-table" style="width: 100%; max-width: 100%; margin-bottom: 5px; border: 1px solid #000; text-align: left; border-collapse: collapse;">
            <tbody>
                <tr>
                    <td width="5%" style="padding: 8px; border: 1px solid #000; vertical-align: top;">
                        <strong>Sign<br/>Here</strong>
                    </td>
                    <td width="60%" style="padding: 8px; border: 1px solid #000; vertical-align: top;">
                    ...
                    <td style="padding: 8px; border: 1px solid #000; vertical-align: bottom;">
                      <span><strong><small>Date </small></strong></span><span> <?php echo $pre_form['dated']; ?></span>
                    </td>
                </tr>
            </tbody>
        </table>
        <table class="w9-table" style="width: 100%; max-width: 100%; margin-bottom: 5px; border: 1px solid #000; text-align: left; border-collapse: collapse;">
            <tbody>
                <tr>
                    <td width="50%" style="padding: 8px; border: 1px solid #000; vertical-align: top;">
                        ...
                        <ul style="padding: 0 0 0 15px; margin: 0; list-style-type: none; list-style-position:inside; ">
                        ...
                        <table class="w9-table">
                            <thead>
                            <tr>
                                <th width="50%" style="padding: 8px; border: 1px solid #000; vertical-align: top;">IF the payment is for . . .</th>
                                <th width="50%" style="padding: 8px; border: 1px solid #000; vertical-align: top;">THEN the payment is exempt for . . .</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">Interest and dividend payments</td>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">All exempt payees except for 7</td>
                            </tr>
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">Broker transactions</td>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">Exempt payees 1 through 4 and 6
                            ...
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">Barter exchange transactions and
                                    patronage dividends</td>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">Exempt payees 1 through 4</td>
                            </tr>
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">Payments over $600 required to be
                                    reported and direct sales over
                                    $5,0001</td>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">Generally, exempt payees
                                    1 through 52</td>
                            </tr>
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">Payments made in settlement of
                        ...
                        <table class="w9-table">
                            <thead>
                            <tr>
                                <th width="50%" style="padding: 8px; border: 1px solid #000; vertical-align: top;">For this type of account:</th>
                                <th width="50%" style="padding: 8px; border: 1px solid #000; vertical-align: top;">Give name and SSN of:</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">1. Individual</td>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">The individual</td>
                            </tr>
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">2. Two or more individuals (joint
                                    account) other than an account
                                    maintained by an FFI</td>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">The actual owner of the account or, if
                                    combined funds, the first individual on
                                    the account1</td>
                            </tr>
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">3. Two or more U.S. persons
                                    (joint account maintained by an FFI)</td>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">Each holder of the account </td>
                            </tr>
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">4. Custodial account of a minor
                                    (Uniform Gift to Minors Act)</td>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">The minor<sup>2</sup></td>
                            </tr>
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">5. a. The usual revocable savings trust
                            ...
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">6. Sole proprietorship or disregarded
                                    entity owned by an individual</td>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">The owner<sup>3</sup></td>
                            </tr>
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">7. Grantor trust filing under Optional
                                    Form 1099 Filing Method 1 (see
                                    Regulations section 1.671-4(b)(2)(i)
                                    (A))
                                </td>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">The grantor<sup>*</sup></td>
                            </tr>
                            <tr>
                                <th style="padding: 8px; border: 1px solid #000; vertical-align: top; text-align: center;">For this type of account:</th>
                                <th style="padding: 8px; border: 1px solid #000; vertical-align: top; text-align: center;">Give name and EIN of:</th>
                            </tr>
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">8. Disregarded entity not owned by an
                                    individua</td>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">The owner</td>
                            </tr>
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">9. A valid trust, estate, or pension trust</td>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">Legal entity <sup>4</sup></td>
                            </tr>
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">10. Corporation or LLC electing
                                    corporate status on Form 8832 or
                                    Form 2553</td>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">The corporation</td>
                            </tr>
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">11. Association, club, religious,
                                    charitable, educational, or other taxexempt
                                    organization</td>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">The organization</td>
                            </tr>
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">12. Partnership or multi-member LLC</td>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">The partnership</td>
                            </tr>
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">13. A broker or registered nominee</td>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">The broker or nominee</td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <td width="50%" style="padding: 8px; border: 1px solid #000; vertical-align: top;">
                        ...
                        <table class="w9-table">
                            <thead>
                            <tr>
                                <th width="50%" style="padding: 8px; border: 1px solid #000; vertical-align: top;">IF the entity/person on line 1 is a(n) . . .</th>
                                <th width="50%" style="padding: 8px; border: 1px solid #000; vertical-align: top;">THEN check the box for . . .</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                        ...
                        <table class="w9-table">
                            ...
                            <tr>
                                <th width="50%" style="padding: 8px; border: 1px solid #000; vertical-align: top;">For this type of account:</th>
                                <th width="50%" style="padding: 8px; border: 1px solid #000; vertical-align: top;">Give name and EIN of:</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">14. Account with the Department of
                                    Agriculture in the name of a public
                                    entity (such as a state or local
                                    government, school district, or
                                    prison) that receives agricultural
                                    program payments</td>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">The public entity</td>
                            </tr>
                            <tr>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">15. Grantor trust filing under the Form
                                    1041 Filing Method or the Optional
                                    Form 1099 Filing Method 2 (see
                                    Regulations section 1.671-4(b)(2)(i)(B))
                                </td>
                                <td style="padding: 8px; border: 1px solid #000; vertical-align: top;">The trust</td>
                            </tr>
                            </tbody>
                        </table>
...
<script type="text/javascript" src="<?php echo base_url('assets/employee_panel/js/kendoUI.min.js'); ?>"></script>
        <script type="text/javascript">
            $('#w9_download_pdf').on( "click", function() {
        ...
        function Popup(data) {
            ...
            mywindow.document.write('<html><head><title>Form W9</title>');
            /*optional stylesheet*/

                                            ...
                                            <div class="row">
                                                    ...
                                                    <li>
                                                        ...
                                                        <input class="invoice-fields" type="email" required="required" name="email" value="<?php
                                                                                                                                            if (isset($employer['email'])) {
                                                                                                                                                echo strtolower($employer['email']);
                                                                                                                                            }
                                                                                                                                            ?>">
                                                    ...
                                                    <li>
                                                        ...
                                                        <input class="invoice-fields" type="email" required="required" name="TextBoxAddressEmailConfirm" value="<?php
                                                                                                                                                                if (isset($formpost['TextBoxAddressEmailConfirm']) && !empty($formpost['TextBoxAddressEmailConfirm'])) {
                                                                                                                                                                    echo strtolower($formpost['TextBoxAddressEmailConfirm']);
                                                                                                                                                                } else {
                                                                                                                                                                    echo strtolower($employer['email']);
                                                                                                                                                                }
                                                                                                                                                                ?>" id="TextBoxAddressEmailConfirm">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                        <li class="form-col-100 autoheight">
                                                            ...
                                                            <div class="hr-radio-btns">
                                                                <input type="radio" id="is_already_employed_yes" class="check_value validate_affiliate_company" value="Yes" name="is_already_employed" <?php
                                                            ...
                                                            <div class="hr-radio-btns">
                                                                <input type="radio" id="is_already_employed_no" class="check_value validate_affiliate_company" value="No" name="is_already_employed" <?php
                                                ...
                                                <div class="bg-color">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                        <li class="form-col-100 autoheight">
                                                            <div class="hr-radio-btns">
                                                                <input id="RadioButtonListPostionTime_0" type="radio" value="full_time" name="RadioButtonListPostionTime" <?php
                                                            ...
                                                            <div class="hr-radio-btns">
                                                                <input id="RadioButtonListPostionTime_1" type="radio" value="part_time" name="RadioButtonListPostionTime" <?php
                                                            ...
                                                            <div class="hr-radio-btns">
                                                                <input id="RadioButtonListPostionTime_2" type="radio" value="full_or_parttime" name="RadioButtonListPostionTime" <?php
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                    <li class="form-col-100 autoheight">
                                                        <div class="hr-radio-btns">
                                                            <input type="radio" value="Yes" id="RadioButtonListWorkTransportation_0" name="RadioButtonListWorkTransportation" <?php
                                                        ...
                                                        <div class="hr-radio-btns">
                                                            <input type="radio" value="No" id="RadioButtonListWorkTransportation_1" name="RadioButtonListWorkTransportation" <?php
                                                ...
                                                <div class="bg-color-v2">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                        <li class="form-col-100 autoheight">
                                                            <div class="hr-radio-btns">
                                                                <input type="radio" value="Yes" id="RadioButtonListWorkOver18_0" name="RadioButtonListWorkOver18" <?php
                                                            ...
                                                            <div class="hr-radio-btns">
                                                                <input type="radio" value="No" id="RadioButtonListWorkOver18_1" name="RadioButtonListWorkOver18" <?php
                                                                                                                                                                    if (isset($formpost['RadioButtonListWorkOver18'])) {
                                                ...
                                                <div class="col-lg-2 col-md-2 col-xs-12 col-sm-3">
                                                    <li class="form-col-100 autoheight">
                                                        <div class="hr-radio-btns">
                                                            <input type="radio" value="Yes" id="RadioButtonListAliases_0" name="RadioButtonListAliases" <?php
                                                        ...
                                                        <div class="hr-radio-btns">
                                                            <input type="radio" value="No" id="RadioButtonListAliases_1" name="RadioButtonListAliases" <?php
...
<?php echo form_error('arrested_pending_trail_details'); ?>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                    <li class="form-col-100 autoheight">
                                                        ...
                                                        <div class="hr-radio-btns">
                                                            <input type="radio" id="RadioButtonListDriversLicenseQuestion_0" value="Yes" name="RadioButtonListDriversLicenseQuestion" class="validate_driving_license" <?php
                                                        ...
                                                        <div class="hr-radio-btns">
                                                            <input type="radio" id="RadioButtonListDriversLicenseQuestion_1" value="No" name="RadioButtonListDriversLicenseQuestion" class="validate_driving_license" <?php
                                                ...
                                                <div class="bg-color">
                                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                        <li class="form-col-100 autoheight">
                                                            ...
                                                            <div class="hr-radio-btns">
                                                                <input type="radio" id="RadioButtonListDriversLicenseTraffic" value="Yes" name="RadioButtonListDriversLicenseTraffic" <?php
                                                            ...
                                                            <div class="hr-radio-btns">
                                                                <input type="radio" id="RadioButtonListDriversLicenseTraffic_1" value="No" name="RadioButtonListDriversLicenseTraffic" <?php
                                                ...
                                                <div class="education-level-block">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-xs-12 col-sm-6">
                                                        <li class="form-col-100 autoheight">
                                                            <div class="hr-radio-btns">
                                                                <input type="radio" value="Yes" id="RadioButtonListEducationHighSchoolGraduated_0" name="RadioButtonListEducationHighSchoolGraduated" <?php
                                                            ...
                                                            <div class="hr-radio-btns">
                                                                <input type="radio" value="No" id="RadioButtonListEducationHighSchoolGraduated_1" name="RadioButtonListEducationHighSchoolGraduated" <?php
                                                                ...
                                                                <div class="hr-select-dropdown">
                                                                    <select class="invoice-fields" name="DropDownListEducationHighSchoolDateAttendedYearBegin">
                                                                        <?php for ($i = $starting_year_loop; $i <= date('Y'); $i++) { ?>
                                                                            <option value="<?php echo $i; ?>" <?php if (isset($formpost['DropDownListEducationHighSchoolDateAttendedYearBegin']) && $formpost['DropDownListEducationHighSchoolDateAttendedYearBegin'] == $i) { ?> selected <?php } ?>>
                                                                                <?php echo $i; ?>
                                                                            </option>
                                                                        <?php } ?>
                                                                    </select>
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="hr-select-dropdown">
                                                                    <select class="invoice-fields" name="DropDownListEducationHighSchoolDateAttendedYearEnd">
                                                                        <?php for ($i = $starting_year_loop; $i <= date('Y'); $i++) { ?>
                                                                            <option value="<?php echo $i; ?>" <?php if (isset($formpost['DropDownListEducationHighSchoolDateAttendedYearEnd']) && $formpost['DropDownListEducationHighSchoolDateAttendedYearEnd'] == $i) { ?> selected <?php } ?>>
                                                                                <?php echo $i; ?>
                                                                            </option>
                                                                        <?php } ?>
                                                                    </select>
                                                ...
                                                <div class="bg-color">
                                                    <div class="education-level-block">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-xs-12 col-sm-6">
                                                            <li class="form-col-100 autoheight">
                                                                <div class="hr-radio-btns">
                                                                    <input type="radio" value="Yes" id="RadioButtonListEducationCollegeGraduated_0" name="RadioButtonListEducationCollegeGraduated" <?php
                                                                ...
                                                                <div class="hr-radio-btns">
                                                                    <input type="radio" value="No" id="RadioButtonListEducationCollegeGraduated_1" name="RadioButtonListEducationCollegeGraduated" <?php
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="hr-select-dropdown">
                                                                        <select class="invoice-fields" name="DropDownListEducationCollegeDateAttendedYearBegin">
                                                                            <?php for ($i = $starting_year_loop; $i <= date('Y'); $i++) { ?>
                                                                                <option value="<?php echo $i; ?>" <?php if (isset($formpost['DropDownListEducationCollegeDateAttendedYearBegin']) && $formpost['DropDownListEducationCollegeDateAttendedYearBegin'] == $i) { ?> selected <?php } ?>>
                                                                                    <?php echo $i; ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                        </select>
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="hr-select-dropdown">
                                                                        <select class="invoice-fields" name="DropDownListEducationCollegeDateAttendedYearEnd">
                                                                            <?php for ($i = $starting_year_loop; $i <= date('Y'); $i++) { ?>
                                                                                <option value="<?php echo $i; ?>" <?php if (isset($formpost['DropDownListEducationCollegeDateAttendedYearEnd']) && $formpost['DropDownListEducationCollegeDateAttendedYearEnd'] == $i) { ?> selected <?php } ?>>
                                                                                    <?php echo $i; ?>
                                                                                </option>
                                                                            <?php } ?>
                                                                        </select>
                                                ...
                                                <div class="education-level-block">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-xs-12 col-sm-6">
                                                        <li class="form-col-100 autoheight">
                                                            <div class="hr-radio-btns">
                                                                <input type="radio" value="Yes" id="RadioButtonListEducationOtherGraduated_0" name="RadioButtonListEducationOtherGraduated" <?php
                                                            ...
                                                            <div class="hr-radio-btns">
                                                                <input type="radio" value="No" id="RadioButtonListEducationOtherGraduated_1" name="RadioButtonListEducationOtherGraduated" <?php
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="hr-select-dropdown">
                                                                    <select class="invoice-fields" name="DropDownListEducationOtherDateAttendedYearBegin">
                                                                        <?php for ($i = $starting_year_loop; $i <= date('Y'); $i++) { ?>
                                                                            <option value="<?php echo $i; ?>" <?php if (isset($formpost['DropDownListEducationOtherDateAttendedYearBegin']) && $formpost['DropDownListEducationOtherDateAttendedYearBegin'] == $i) { ?> selected <?php } ?>>
                                                                                <?php echo $i; ?>
                                                                            </option>
                                                                        <?php } ?>
                                                                    </select>
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="hr-select-dropdown">
                                                                    <select class="invoice-fields" name="DropDownListEducationOtherDateAttendedYearEnd">
                                                                        <?php for ($i = $starting_year_loop; $i <= date('Y'); $i++) { ?>
                                                                            <option value="<?php echo $i; ?>" <?php if (isset($formpost['DropDownListEducationOtherDateAttendedYearEnd']) && $formpost['DropDownListEducationOtherDateAttendedYearEnd'] == $i) { ?> selected <?php } ?>>
                                                                                <?php echo $i; ?>
                                                                            </option>
                                                                        <?php } ?>
                                                                    </select>
                                                ...
                                                <div class="form-col-100">
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-xs-12 col-sm-6">
                                                        <li>
                                                            ...
                                                            <div class="hr-select-dropdown">
                                                                <select class="invoice-fields" id="DropDownListEmploymentEmployerDatesOfEmploymentMonthBegin1" name="DropDownListEmploymentEmployerDatesOfEmploymentMonthBegin1">
                                                                    <option vlaue="January" <?php
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="hr-select-dropdown">
                                                                <select class="invoice-fields" id="DropDownListEmploymentEmployerDatesOfEmploymentYearBegin1" name="DropDownListEmploymentEmployerDatesOfEmploymentYearBegin1">
                                                                    <?php for ($i = $starting_year_loop; $i <= date('Y'); $i++) { ?>
                                                                        <option value="<?php echo $i; ?>" <?php if ((isset($formpost['DropDownListEmploymentEmployerDatesOfEmploymentYearBegin1']) && $formpost['DropDownListEmploymentEmployerDatesOfEmploymentYearBegin1'] == $i) || (isset($from_cntrl) && $from_cntrl == 'emp' && $year == $i)) { ?> selected <?php } ?>>
                                                                            <?php echo $i; ?>
                                                                        </option>
                                                                    <?php } ?>
                                                                </select>
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="hr-select-dropdown">
                                                                <select class="invoice-fields" id="DropDownListEmploymentEmployerDatesOfEmploymentYearEnd1" name="DropDownListEmploymentEmployerDatesOfEmploymentYearEnd1">
                                                                    <?php for ($i = $starting_year_loop; $i <= date('Y'); $i++) { ?>
                                                                        <option value="<?php echo $i; ?>" <?php if ((isset($formpost['DropDownListEmploymentEmployerDatesOfEmploymentYearEnd1']) && $formpost['DropDownListEmploymentEmployerDatesOfEmploymentYearEnd1'] == $i) || (isset($from_cntrl) && $from_cntrl == 'emp' && $cur_year == $i)) { ?> selected <?php } ?>>
                                                                            <?php echo $i; ?>
                                                                        </option>
                                                                    <?php } ?>
                                                                </select>
                                                ...
                                                <div class="form-col-100">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-7">
                                                        <li class="autoheight">
                                                            ...
                                                            <div class="hr-radio-btns">
                                                                <input type="radio" id="RadioButtonListEmploymentEmployerContact1_0" value="Yes" name="RadioButtonListEmploymentEmployerContact1_0" <?php
                                                            ...
                                                            <div class="hr-radio-btns">
                                                                <input type="radio" id="RadioButtonListEmploymentEmployerContact1_1" value="No" name="RadioButtonListEmploymentEmployerContact1_0" <?php
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="hr-select-dropdown">
                                                                    <select class="invoice-fields" name="DropDownListEmploymentEmployerDatesOfEmploymentYearBegin2">
                                                                        <?php for ($i = $starting_year_loop; $i <= date('Y'); $i++) { ?>
                                                                            <option value="<?php echo $i; ?>" <?php if (isset($formpost['DropDownListEmploymentEmployerDatesOfEmploymentYearBegin2']) && $formpost['DropDownListEmploymentEmployerDatesOfEmploymentYearBegin2'] == $i) { ?> selected <?php } ?>>
                                                                                <?php echo $i; ?>
                                                                            </option>
                                                                        <?php } ?>
                                                                    </select>
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="hr-select-dropdown">
                                                                    <select class="invoice-fields" name="DropDownListEmploymentEmployerDatesOfEmploymentYearEnd2">
                                                                        <?php for ($i = $starting_year_loop; $i <= date('Y'); $i++) { ?>
                                                                            <option value="<?php echo $i; ?>" <?php if (isset($formpost['DropDownListEmploymentEmployerDatesOfEmploymentYearEnd2']) && $formpost['DropDownListEmploymentEmployerDatesOfEmploymentYearEnd2'] == $i) { ?> selected <?php } ?>>
                                                                                <?php echo $i; ?>
                                                                            </option>
                                                                        <?php } ?>
                                                                    </select>
                                                    ...
                                                    <div class="form-col-100">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-xs-12 col-sm-7">
                                                            <li class="autoheight">
                                                                <label class="contact-to-employee">May we contact this employer?</label>
                                                                <div class="hr-radio-btns">
                                                                    <input type="radio" id="RadioButtonListEmploymentEmployerContact2_0" value="Yes" name="RadioButtonListEmploymentEmployerContact2_0" <?php
                                                                ...
                                                                <div class="hr-radio-btns">
                                                                    <input type="radio" id="RadioButtonListEmploymentEmployerContact2_1" value="No" name="RadioButtonListEmploymentEmployerContact2_0" <?php
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="hr-select-dropdown">
                                                                <select class="invoice-fields" name="DropDownListEmploymentEmployerDatesOfEmploymentYearBegin3">
                                                                    <?php for ($i = $starting_year_loop; $i <= date('Y'); $i++) { ?>
                                                                        <option value="<?php echo $i; ?>" <?php if (isset($formpost['DropDownListEmploymentEmployerDatesOfEmploymentYearBegin3']) && $formpost['DropDownListEmploymentEmployerDatesOfEmploymentYearBegin3'] == $i) { ?> selected <?php } ?>>
                                                                            <?php echo $i; ?>
                                                                        </option>
                                                                    <?php } ?>
                                                                </select>
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="hr-select-dropdown">
                                                                <select class="invoice-fields" name="DropDownListEmploymentEmployerDatesOfEmploymentYearEnd3">
                                                                    <?php for ($i = $starting_year_loop; $i <= date('Y'); $i++) { ?>
                                                                        <option value="<?php echo $i; ?>" <?php if (isset($formpost['DropDownListEmploymentEmployerDatesOfEmploymentYearEnd3']) && $formpost['DropDownListEmploymentEmployerDatesOfEmploymentYearEnd3'] == $i) { ?> selected <?php } ?>>
                                                                            <?php echo $i; ?>
                                                                        </option>
                                                                    <?php } ?>
                                                                </select>
                                                ...
                                                <div class="form-col-100">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-7">
                                                        <li class="autoheight">
                                                            <label class="contact-to-employee">May we contact this employer?</label>
                                                            <div class="hr-radio-btns">
                                                                <input type="radio" id="RadioButtonListEmploymentEmployerContact3_0" value="Yes" name="RadioButtonListEmploymentEmployerContact3_0" <?php
                                                            ...
                                                            <div class="hr-radio-btns">
                                                                <input type="radio" id="RadioButtonListEmploymentEmployerContact3_1" value="No" name="RadioButtonListEmploymentEmployerContact3_0" <?php
                                                ...
                                                <div class="bg-color">
                                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                        <li class="form-col-100 autoheight">
                                                            ...
                                                            <div class="hr-radio-btns">
                                                                <input type="radio" value="Yes" id="RadioButtonListEmploymentEverTerminated_0" name="RadioButtonListEmploymentEverTerminated" <?php
                                                            ...
                                                            <div class="hr-radio-btns">
                                                                <input type="radio" value="No" id="RadioButtonListEmploymentEverTerminated_1" name="RadioButtonListEmploymentEverTerminated" <?php
                                                ...
                                                <div class="form-col-100">
                                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                        <li class="form-col-100 autoheight">
                                                            ...
                                                            <div class="hr-radio-btns">
                                                                <input type="radio" value="Yes" id="RadioButtonListEmploymentEverResign_0" name="RadioButtonListEmploymentEverResign" <?php
                                                            ...
                                                            <div class="hr-radio-btns">
                                                                <input type="radio" value="No" id="RadioButtonListEmploymentEverResign_1" name="RadioButtonListEmploymentEverResign" <?php
...
<script type="text/javascript">
    $(document).ready(function() { //Disable Autocomplete
        ...
        //
        $("#TextBoxAddressEmailConfirm").focusout(function() {
            var confirmEmailLower = $("#TextBoxAddressEmailConfirm").val();
            $("#TextBoxAddressEmailConfirm").val(confirmEmailLower.toLowerCase());
        });
    ...
    //
    if ("<?= $eight_plus ?>" == 1) {
        rules['RadioButtonListWorkOver18'] = {
            required: true
        };
        messages['RadioButtonListWorkOver18'] = {
    ...
    //
    if ("<?= $l_employment ?>" == 1) {
        rules['TextBoxEmploymentEmployerName1'] = {
            required: true
        };
        rules['TextBoxEmploymentEmployerPosition1'] = {
            required: true
        };
        rules['TextBoxEmploymentEmployerAddress1'] = {
            required: true
        };
        rules['DropDownListEmploymentEmployerCountry1'] = {
            required: true
        };
        rules['DropDownListEmploymentEmployerState1'] = {
            required: true
        };
        rules['TextBoxEmploymentEmployerCity1'] = {
            required: true
        };
        rules['TextBoxEmploymentEmployerPhoneNumber1'] = {
            required: true
        };
        rules['DropDownListEmploymentEmployerDatesOfEmploymentMonthBegin1'] = {
            required: true
        };
        rules['DropDownListEmploymentEmployerDatesOfEmploymentYearBegin1'] = {
            required: true
        };
        rules['DropDownListEmploymentEmployerDatesOfEmploymentMonthEnd1'] = {
            required: true
        };
        rules['DropDownListEmploymentEmployerDatesOfEmploymentYearEnd1'] = {
            required: true
        };
        rules['TextBoxEmploymentEmployerSupervisor1'] = {
            required: true
        };
        rules['TextBoxEmploymentEmployerReasonLeave1'] = {
            required: true
        };
        messages['TextBoxEmploymentEmployerName1'] = {
            required: "This field is required."
        };
        messages['TextBoxEmploymentEmployerPosition1'] = {
            required: "This field is required."
        };
        messages['TextBoxEmploymentEmployerAddress1'] = {
            required: "This field is required."
        };
        messages['DropDownListEmploymentEmployerCountry1'] = {
            required: "This field is required."
        };
        messages['DropDownListEmploymentEmployerState1'] = {
            required: "This field is required."
        };
        messages['TextBoxEmploymentEmployerCity1'] = {
            required: "This field is required."
        };
        messages['TextBoxEmploymentEmployerPhoneNumber1'] = {
            required: "This field is required."
        };
        messages['DropDownListEmploymentEmployerDatesOfEmploymentMonthBegin1'] = {
            required: "This field is required."
        };
        messages['DropDownListEmploymentEmployerDatesOfEmploymentYearBegin1'] = {
            required: "This field is required."
        };
        messages['DropDownListEmploymentEmployerDatesOfEmploymentMonthEnd1'] = {
            required: "This field is required."
        };
        messages['DropDownListEmploymentEmployerDatesOfEmploymentYearEnd1'] = {
            required: "This field is required."
        };
        messages['TextBoxEmploymentEmployerSupervisor1'] = {
            required: "This field is required."
        };
        messages['TextBoxEmploymentEmployerReasonLeave1'] = {
            required: "This field is required."
        };
    }

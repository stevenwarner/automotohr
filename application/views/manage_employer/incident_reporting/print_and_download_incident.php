...
<body class="A4" id="safety_checklist">
                ...
                <tbody>
                    ...
                    <?php } else { ?>
                        <tr>
                            <td>
                                <div class="center-col">
                                    <h2>No Witnesses Found Against This Incident</h2>
                                </div>
                            </td>
                        </tr>
                    <?php } ?>
    ...
    <a href="<?php echo base_url('incident_reporting_system/download_incident_all_documents_and_videos/both').'/'.$report_type.'/'.$incident_sid; ?>"  id="download_all_files"></a>
                ...
                .done(function(incident_data) {
                    if ('<?php echo $section; ?>' == 'all') {
                        $.ajax({
                            ...
                            url: "<?php echo base_url('incident_reporting_system/save_incident_pdf'); ?>",

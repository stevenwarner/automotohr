...
<div class="main-content">
    ...
    <!--                                            <a id="btn_apply_filters" class="btn btn-primary" href="--><?php //echo base_url('incident_reporting_system/view_guide/'.$type['id'])?><!--">User Guide</a>-->
    <!--                                        </td>-->
                                        <td class="text-center">
...
<?php } else { ?>
    <?php $this->load->view('manage_employer/incident_reporting/index'); ?>
<?php } ?>
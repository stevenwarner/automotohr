                                    ...
                                    <div class="panel panel-blue">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="col-lg-12 text-right">
                                                <button type="button" class="btn btn-info" id="save_incident_video">Save Video</button>
                                            </div>
...
<script type="text/javascript">
    ...
    $('.video_source').on('click', function() {
        ...
        if (selected == 'youtube') {
            ...
            $('#save_incident_video').text('Save Video');
            ...
            $('#save_incident_video').text('Save Audio');
    ...
    $('#save_incident_video').on('click', function() {
        ...
        if (flag == 1) {
            ...
            $('#save_incident_video').addClass('disabled-btn');
            $('#save_incident_video').prop('disabled', true);

                        ...
                        <div class="create-job-box">
                            <div class="dash-box">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h1>Welcome
                                            <?php echo ucfirst($employerData['first_name']) . ' ' . ucfirst($employerData['last_name']); ?>!
                                        </h1>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12">
                                        <?php if ($companyData['Logo'] != '' && get_company_logo_status($session['company_detail']['sid']) == 1) { ?>
                                            <figure><img width="100" height="80"
                                                    src="<?php echo AWS_S3_BUCKET_URL . $companyData['Logo']; ?>" alt="" />
                                            </figure>
                                        <?php } ?>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                                            ...
                                            <?php if ($employee['is_executive_admin'] == 0) { ?>
                                                <div class="button-panel">
                                                    <a class="site-btn auto-width" href="<?php echo base_url('my_profile') ?>">View
                                                        your Profile</a>
                                                </div>
                                            <?php } ?>
                                        </div>
                                    <?php } else { ?>
                                        <?php if (check_access_permissions_for_view($security_details, 'my_profile')) { ?>
                                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                                                ...
                                                <div class="button-panel">
                                                    <a class="site-btn btn-warning"
                                                        href="<?php echo base_url('employee_management_system') ?>" style="">My
                                                        Personal EMS Dashboard</a>
                                                </div>
                                            ...
                                            <div class="dash-box">
                                                <div class="dashboard-widget-box">
                                                    ...
                                                    <h2 class="post-title"><a
                                                            href="<?php echo base_url('task_management') ?>">Task Management</a>
                                                    </h2>
                                                    <div class="count-box">
                                                    ...
                                                    <div class="form-col-100 view-task-btn">
                                                        <a class="btn btn-success btn-block"
                                                            href="<?php echo base_url('task_management') ?>" class="">View</a>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php } ?>
                                ...
                                <div class="example-link-green">Because of recent Google Security updates, we suggest that
                                    you only use Google Chrome to access your AutomotoHR account. Internet Explorer is not
                                    supported and may cause certain feature glitches and security issues.</div>
                                    ...
                                    <?php if (in_array($employer_sid, $users_with_job_approval_rights)) { ?>
                                        <div class="row approvals_row">
                                            <div class="col-lg-3 col-md-12 col-xs-12 col-sm-12">
                                                <span class="page-heading job-approval-heading count-box">Job Listings
                                                    Approvals</span>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-md-6 col-xs-12 col-sm-6">
                                                <a class="site-btn manage-approvals no-margin"
                                                    href="<?php echo base_url('job_approval_management') ?>"><i></i>
                                                    Manage</a>
                                            </div>
                                        </div>
                                    <?php } ?>
                                ...
                                <?php if ($applicant_approval_module_status == 1) { ?>
                                    ...
                                    <?php if (in_array($employer_sid, $users_with_applicant_approval_rights)) { ?>
                                        <div class="row approvals_row">
                                            ...
                                            <div class="col-lg-3 col-md-6 col-xs-12 col-sm-6">
                                                <a class="site-btn manage-approvals no-margin"
                                                    href="<?php echo base_url('applicant_approval_management') ?>"><i></i>
                                                    Manage</a>
                                            </div>
                                        </div>
                                    <?php } ?>
                        ...
                        <div class="box-wrapper">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                ...
                                                <div class="button-panel">
                                                    <a href="<?php echo base_url('my_listings/active') ?>" class="site-btn">View
                                                        All</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                ...
                                                <h2 class="post-title" style="margin: 2px 0;">
                                                    <a
                                                        href="<?php echo base_url('application_tracking_system/active/all/all/all/all/all/all/all/all/all') ?>">Application
                                                        Tracking System</a>
                                                </h2>
                                                <div class="count-box" style="font-size: 12px">
                                                    <span class="green">'<?php echo $applicants_today; ?>' New Application(s)
                                                        Today</span><br>
                                                    <small style="font-size: 12px"><?php echo $applicants; ?> Active
                                                        Application(s)</small><br>
                                                    <small
                                                        style="font-size: 12px"><?php echo $all_active_inactive_applicants; ?>
                                                        Total Application(s)</small>
                                                </div>
                                                <div class="button-panel">
                                                    <a href="<?php echo base_url('application_tracking_system/active/all/all/all/all/all/all/all/all/all') ?>"
                                                        class="site-btn">View Applicants</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                ...
                                                <div class="count-box">
                                                    <span class="green">'<?php echo $eventCountToday; ?>' Events Scheduled
                                                        Today</span><br>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                ...
                                                <div class="button-panel">
                                                    <a href="<?php echo base_url('private_messages') ?>" class="site-btn">Show
                                                        Messages</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                ...
                                                <h2 class="post-title">
                                                    <a href="<?php echo base_url(); ?>employee_management">Employee / Team
                                                        Members</a>
                                                </h2>
                                                <div class="count-box">
                                                ...
                                                <div class="button-panel">
                                                    <a href="<?php echo base_url(); ?>employee_management"
                                                        class="site-btn">Access & Manage</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                ...
                                                <div class="button-panel">
                                                    <a href="<?php echo base_url('screening_questionnaires') ?>"
                                                        class="site-btn">Create New</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                ...
                                                <div class="button-panel">
                                                    <a href="<?php echo base_url('interview_questionnaire'); ?>"
                                                        class="site-btn">Interview Questionnaires</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                ...
                                                <div class="count-box">
                                                    <span class="green">'<?php echo $checks_monthly_count; ?>' New Check(s) This
                                                        Month</span><br>
                                                    <small><?php echo $checks_total_count; ?> Check(s)</small>
                                                </div>
                                                <div class="button-panel">
                                                    <a href="<?php echo base_url('accurate_background'); ?>"
                                                        class="site-btn">View Report</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                ...
                                                <div class="button-panel">
                                                    <a href="<?php echo base_url('support_tickets'); ?>" class="site-btn">Access
                                                        Support Tickets</a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            -->
                                ...
                                <?php if ($EmsStatus == 1) { ?>
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                <figure><i
                                                        class="fa fa-file-text-o <?= $all_documents_approval ? 'start_animation' : ''; ?>"></i>
                                                </figure>
                                                <h2 class="post-title" style="margin: 2px 0;">
                                                    <a
                                                        href="<?php echo base_url('hr_documents_management/approval_documents') ?>">Approval
                                                        Documents</a>
                                                </h2>
                                                <div class="count-box" style="font-size: 12px">
                                                    <small style="font-size: 12px"><?php echo $all_documents_approval; ?> Total
                                                        Document(s)</small>
                                                </div>
                                                <div class="button-panel">
                                                    <a href="<?php echo base_url('hr_documents_management/approval_documents') ?>"
                                                        class="site-btn">View Documents</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                <figure><i class="fa fa-file-text-o"></i></figure>
                                                <h2 class="post-title">
                                                    <a href="<?php echo base_url('manage_ems'); ?>">Employee Management
                                                        System</a>
                                                </h2>
                                                <div class="button-panel">
                                ...
                                <?php if ($EmsStatus == 1) { ?>
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                <figure><i
                                                        class="fa fa-clipboard <?php echo !empty($total_pending_auth_doc) && $total_pending_auth_doc > 0 ? 'start_animation' : ''; ?>"></i>
                                                </figure>
                                                <h2 class="post-title" style="margin: 2px 0;">
                                                    <a href="<?php echo base_url('authorized_document'); ?>">Pending Authorized
                                                        Documents</a>
                                                </h2>
                                                <div class="count-box" style="font-size: 12px">
                                                    <span class="green"><?php echo $total_assigned_today_doc; ?> Assigned
                                                        Document(s) Today</span><br>
                                                    <small style="font-size: 12px"><?php echo $total_pending_auth_doc; ?>
                                                        Pending Document(s)</small><br>
                                                    <small style="font-size: 12px"><?php echo $total_assigned_auth_doc; ?> Total
                                                        Document(s)</small>
                                                </div>
                                                <div class="button-panel">
                                                    <a href="<?php echo base_url('authorized_document'); ?>"
                                                        class="site-btn">Show Documents</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <?php if ($session['employer_detail']['access_level'] == 'Admin' || $session['employer_detail']['access_level_plus'] == 1 || $session['employer_detail']['pay_plan_flag'] == 1) { ?>
                                        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                            <div class="dash-box">
                                                <div class="dashboard-widget-box">
                                                    <figure><i
                                                            class="fa fa-clipboard <?php echo !empty($PendingEmployerSection['Total']) && $PendingEmployerSection['Total'] > 0 ? 'start_animation' : ''; ?>"></i>
                                                    </figure>
                                                    <h2 class="post-title" style="margin: 2px 0;">
                                                        <a
                                                            href="<?php echo base_url('hr_documents_management/company_varification_document'); ?>">Pending
                                                            Employer Section</a>
                                                    </h2>
                                                    <div class="count-box" style="font-size: 12px">
                                                        <span class="green"><?= $PendingEmployerSection['Total']; ?>
                                                            Total</span><br>
                                                        <small style="font-size: 12px"><?= $PendingEmployerSection['Employee']; ?>
                                                            Employee(s)</small><br>
                                                        <small style="font-size: 12px"><?= $PendingEmployerSection['Applicant']; ?>
                                                            Applicant(s)</small>
                                                    </div>
                                                    <div class="button-panel">
                                                        <a href="<?php echo base_url('hr_documents_management/company_varification_document'); ?>"
                                                            class="site-btn">Show Documents</a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <?php if ($access_level_plus == 1 || $pay_plan_flag == 1) { ?>
                                        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                            <div class="dash-box">
                                                <div class="dashboard-widget-box">
                                                    <figure>
                                                        <i class="fa fa-users <?= $employeeInformationChange['daily'] > 0 ? 'start_animation' : ''; ?>"
                                                            aria-hidden="true"></i>
                                                    </figure>
                                                    <h2 class="post-title" style="margin: 2px 0;">
                                                    ...
                                                    <div class="count-box" style="font-size: 12px">
                                                        <span class="green">Today <?= $employeeInformationChange['daily']; ?>
                                                            changed information</span><br>
                                                        <small style="font-size: 12px">This week
                                                            <?= $employeeInformationChange['week']; ?> changed
                                                            information</small><br>
                                                        <small style="font-size: 12px">This month
                                                            <?= $employeeInformationChange['month']; ?> changed
                                                            information</small><br>
                                                    </div>
                                                    <div class="button-panel">
                                                        <a href="<?php echo base_url('employee/information/report'); ?>"
                                    ...
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                ...
                                                <h2 class="post-title" style="margin: 2px 0;">
                                                    <a href="<?php echo base_url('library_document'); ?>">Employee Forms
                                                        Library</a>
                                                </h2>
                                                <div class="count-box" style="font-size: 12px">
                                                    <small style="font-size: 12px"><?php echo $total_library_doc; ?> Total
                                                        Form(s)<br></small>
                                                    <strong style="font-size: 12px" class="text-danger">Forms allows Employees
                                                        the ability to initiate and complete documents on their own.</strong>

                                                </div>
                                                <div class="button-panel">
                                                    <a href="<?php echo base_url('library_document'); ?>" class="site-btn">View
                                                        Forms</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                            <div class="dash-box">
                                                <a href="<?php echo base_url('cn/redirect'); ?>" target="_blank">
                                                    <div class="dashboard-widget-box">
                                                        <figure>
                                                            <img src="<?= base_url('assets/images/complynet_logo.png'); ?>"
                                                                alt="ComplyNet Image">
                                                        </figure>
                                                        <h2 class="post-title">
                                                            <a href="<?php echo base_url('cn/redirect'); ?>">Compliance <br />
                                                                Management System</a>
                                                        </h2>
                                                        <div class="button-panel col-lg-12">
                                                            <div class="row">
                                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                                    <a href="<?php echo base_url('cn/redirect'); ?>" target="_blank"
                                                                        class="btn btn-success btn-block">Dashboard</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6 hidden">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                ...
                                                <h2 class="post-title">
                                                    <a href="<?php echo base_url('complynet'); ?>">Compliance <br /> Management
                                                        System</a>
                                                </h2>
                                                <div class="button-panel col-lg-12">
                                                    <div class="row">
                                                        <?php if (!empty($complynet_dashboard_link) && $complynet_dashboard_link != NULL && $access_level != 'Employee') { ?>
                                                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                                <a href="<?php echo base_url('complynet/dashboard'); ?>"
                                                                    class="btn btn-success btn-block">Dashboard</a>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                                <a href="<?php echo base_url('complynet/login'); ?>"
                                ...
                                <?php if (checkIfAppIsEnabled('performance_management')) { ?>
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                <figure><i
                                                        class="fa fa-pencil-square-o <?php echo $review['Reviews'] || $review['Feedbacks'] > 0 ? 'start_animation' : ''; ?>"
                                                        aria-hidden="true"></i></figure>
                                                <h2 class="post-title" style="margin: 2px 0;">
                                                    <a href="<?php echo base_url('performance-management/dashboard'); ?>">Performance
                                                        Management</a>
                                                </h2>
                                                <div class="count-box" style="font-size: 12px">
                                                    <small style="font-size: 12px"><?php echo $review['Reviews']; ?> Pending
                                                        Review(s)</small><br>
                                                    <small style="font-size: 12px"><?php echo $review['Feedbacks']; ?> Pending
                                                        Feedback(s)</small>
                                                </div>
                                                <div class="button-panel">
                                                    <a href="<?= base_url("performance-management/dashboard"); ?>"
                                                        class="site-btn">Show</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                ...
                                                <div class="count-box" style="font-size: 12px">
                                                    <small style="font-size: 12px"><?php echo $myAssignedShifts; ?>
                                                        Scheduled</small><br>
                                                </div>
                                                <div class="button-panel">
                                ...
                                <?php if (checkIfAppIsEnabled('timeoff') && $pto_user_access['dashboard'] == 1) { ?>
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                <figure>
                                                    <i class="fa fa-clock-o <?php echo !empty($pending_time_off) && $pending_time_off > 0 ? 'start_animation' : ''; ?>"
                                                        aria-hidden="true"></i>
                                                </figure>
                                                <h2 class="post-title" style="margin: 2px 0;">
                                                ...
                                                <div class="count-box" style="font-size: 12px">
                                                    <span class="green">'<?php echo $TodaysRequests; ?>' Time Off Request(s)
                                                        Today</span><br>
                                                    <small style="font-size: 12px"><?php echo $TotalEmployeeOffToday; ?>
                                                        Employees Off Today</small><br>
                                                    <small style="font-size: 12px"><?php echo $TotalRequests; ?> Total Time Off
                                                        Request(s)</small>
                                                </div>
                                                <div class="button-panel">
                                        ...
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                ...
                                                <div class="count-box" style="font-size: 12px">
                                                    ...
                                                    <small id="jsTotalTimeoffs" style="font-size: 12px">0 Time-offs
                                                        approved</small>
                                                </div>
                                                <div class="button-panel">
                                                    <div class="col-lg-6 col-xs-12">
                                                        <a href="#" data-id="<?= $employee_sid; ?>"
                                                            class="btn btn-success form-control jsBreakdownRequest">View
                                                            Details</a>
                                                    </div>
                                                    <div class="col-lg-6 col-xs-12 pl0">
                                                        <a href="#" data-id="<?= $employee_sid; ?>"
                                                            class="btn btn-success form-control jsCreateRequest">Create
                                                            Request</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                            <div class="dash-box">
                                                <div class="dashboard-widget-box">
                                                    ...
                                                    <h2 class="post-title">
                                                        <a href="#" class="jsCreatePartnerCompanyBtn"
                                                            data-cid="<?= $this->session->userdata('logged_in')['company_detail']['sid']; ?>">Payroll</a>
                                                    </h2>
                                                    <div class="count-box" style="font-size: 12px">
                                                        <small style="font-size: 12px"></small>
                                                    </div>
                                                    <div class="button-panel">
                                                        <a href="#" class="site-btn jsCreatePartnerCompanyBtn"
                                                            data-cid="<?= $this->session->userdata('logged_in')['company_detail']['sid']; ?>">Set-up
                                                            Payroll</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                            <div class="dash-box">
                                                <div class="dashboard-widget-box">
                                                    ...
                                                    <h2 class="post-title">
                                                        <a href="#" class="jsServiceAgreement"
                                                            data-cid="<?= $this->session->userdata('logged_in')['company_detail']['sid']; ?>">Payroll</a>
                                                    </h2>
                                                    <div class="count-box" style="font-size: 12px">
                                                        <small style="font-size: 12px"></small>
                                                    ...
                                                    <div class="button-panel">
                                                        <a href="#" class="site-btn jsServiceAgreement"
                                                            data-cid="<?= $this->session->userdata('logged_in')['company_detail']['sid']; ?>">Payroll
                                                            Service Agreement</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                            <div class="dash-box">
                                                <div class="dashboard-widget-box">
                                                    ...
                                                    <div class="button-panel">
                                                        <a href="<?= base_url('payrolls/dashboard'); ?>" class="site-btn">View
                                                            Dashboard</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                            <div class="dash-box">
                                                <div class="dashboard-widget-box">
                                                    ...
                                                    <div class="count-box" style="font-size: 12px">
                                                        <small style="font-size: 12px"><?= $employeePayStubsCount; ?> pay
                                                            stubs</small>
                                                    </div>
                                                    <div class="button-panel">
                                                        <a href="<?= base_url('payrolls/pay-stubs'); ?>" class="site-btn">View Pay
                                                            stubs</a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                ...
                                                <div class="button-panel">
                                                    <a href="<?= base_url('employee/surveys/overview'); ?>"
                                                        class="site-btn">Overview</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <?php if (checkIfAppIsEnabled('incidents')) { ?>
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                <figure><i
                                                        class="fa fa-exclamation-triangle <?= $incident_count > 0 ? 'start_animation' : ''; ?>"
                                                        aria-hidden="true"></i>
                                                </figure>
                                                <h2 class="post-title">
                                                ...
                                                <div class="button-panel">
                                                    <a href="<?= base_url('incident_reporting_system'); ?>"
                                                        class="site-btn">Report an Incident</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                            <div class="dash-box">
                                                <div class="dashboard-widget-box" style="margin-top: -10px;">
                                                    <figure>
                                                        <i class="fa fa-file <?= $coursesInfo['expire_soon'] > 0 ? 'start_animation' : ''; ?>"
                                                            aria-hidden="true"></i>
                                                    </figure>
                                                    <h2 class="post-title" style="margin: 2px 0;">
                                                    ...
                                                    <div class="count-box" style="font-size: 12px">
                                                        ...
                                                        <span style="font-size: 12px"><?= $lmsCompanyStats["totalCourses"]; ?>
                                                            Total</span><br>
                                    ...
                                    <?php if (!isLoggedInPersonAnExecutiveAdmin()) { ?>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                            <div class="dash-box">
                                                <div class="dashboard-widget-box">
                                                    <figure><i
                                                            class="fa fa-file <?= $pendingTrainings != 0 ? 'start_animation' : ''; ?>"
                                                            aria-hidden="true"></i>
                                                    </figure>
                                                    <h2 class="post-title">
                                                        <a href="<?= base_url('lms/courses/my_lms_dashboard'); ?>">Compliance
                                                            Courses</a>
                                                    </h2>
                                                    <div class="count-box" style="font-size: 12px">
                                                        <span class="green"><?= $pendingTrainings ?? 0; ?> course(s)
                                                            pending</span><br>
                                                    </div>
                                                    <div class="button-panel">
                                                        <a href="<?= base_url('lms/courses/my_lms_dashboard'); ?>"
                                                            class="site-btn">Show</a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <?php if (checkIfAppIsEnabled('performanceevaluation')) { ?>
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                <figure>
                                                    <i class="fa fa-file <?= $pendingVerificationPerformanceDocument != 0 ? 'start_animation' : ''; ?>"
                                                        aria-hidden="true"></i>
                                                </figure>
                                                <h2 class="post-title">
                                                    <a href="<?php echo base_url('fillable/epe/verification/documents'); ?>">Employee
                                                        Performance Evaluation</a>
                                                </h2>
                                                <div class="count-box" style="font-size: 12px">
                                                    <span class="green"><?= $pendingVerificationPerformanceDocument ?? 0; ?>
                                                        pending</span><br>
                                                </div>
                                                <div class="button-panel">
                                ...
                                <?php if (checkIfAppIsEnabled(MODULE_COMPLIANCE_SAFETY) && hasCSPAccess()) { ?>
                                    <?php $cspUrl = isMainAllowedForCSP() ? "dashboard" : "employee/dashboard"; ?>
                                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                        <div class="dash-box">
                                            <div class="dashboard-widget-box">
                                                <figure>
                                                    <i class="fa fa-building <?= $cspPendingCount != 0 ? 'start_animation' : ''; ?>"
                                                        aria-hidden="true"></i>
                                                </figure>
                                                <h2 class="post-title">
                                                    <a href="<?php echo base_url('compliance_safety_reporting/' . $cspUrl); ?>">Compliance
                                                        Safety Reporting</a>
                                                </h2>
                                                <div class="count-box" style="font-size: 12px">

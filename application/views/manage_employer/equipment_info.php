                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                ...
                                <div class="dashboard-conetnt-wrp">
                                    ...
                                    <div class="universal-form-style-v2 equipment-types" id="types" style="display: none">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-xs-12 col-sm-4">
                                                <a id="types-back" href="javascript:;" class="btn btn-success text-right"><i class="fa fa-chevron-left"></i> Back</a>
                                                <!--<input type="button" id="types-back" class="btn btn-success text-right" value="Back">-->
                                            </div>
                                        </div>
                                    </div>
                                                                    ...
                                                                    <?php if (!empty($equipment_info)) { ?>
                                                                        <?php foreach ($equipment_info as $equipment) {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <input type="button" class="btn btn-success btn-sm btn-block" value="View/Edit" onclick="showViewEdit(this);" data-equ-type="<?php echo $equipment['equipment_type']; ?>" data-sid="<?php echo $equipment['sid']; ?>" data-brand-name="<?php echo $equipment['brand_name']; ?>" data-imei-no="<?php echo $equipment['imei_no']; ?>" data-model="<?php echo $equipment['model']; ?>" data-issue-date="<?php echo date('m-d-Y', strtotime($equipment['issue_date'])); ?>" data-color="<?php echo $equipment['color']; ?>" data-notes="<?php echo $equipment['notes']; ?>" data-product-id="<?php echo $equipment['product_id']; ?>" data-specification="<?php echo $equipment['specification']; ?>" data-vin-number="<?php echo $equipment['vin_number']; ?>" data-transmission-type="<?php echo $equipment['transmission_type']; ?>" data-fuel-type="<?php echo $equipment['fuel_type']; ?>" data-serial-number="<?php echo $equipment['serial_number']; ?>" data-serialized='<?php print_r(json_encode($unserialized)); ?>'>
                                                                                </td>
                                                                                <td>
                                                                                    <input type="button" class="btn btn-danger btn-sm btn-block" onclick="deleteEquip(this);" data-sid="<?php echo $equipment['sid']; ?>" value="Delete">
                                                                                </td>
                                                                            </tr>
                                                                        <?php } ?>
                                                                    <?php } else { ?>
                                    ...
                                    <div id="company_vehicles_details" class="universal-form-style-v2 equipment-details">
                                        <div class="tagline-heading">
                                            <h4>Company vehicles Details</h4>
                                        </div>
                                        <ul>
                                            <li class="form-col-50-left">
                                                <label>Company/Brand Name</label>

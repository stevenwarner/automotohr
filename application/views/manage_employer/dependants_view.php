                                    ...
                                    <div class="universal-form-style-v2">
                                        <ul>
                                                ...
                                                <div class="hr-select-dropdown">
                                                    <select class="invoice-fields" id="country" name="Location_Country" onchange="getStates(this.value, <?php echo $states; ?>)">
                                                        ...
                                                        <?php foreach ($active_countries as $active_country) { ?>
                                                            <option value="<?= $active_country["sid"]; ?>" <?php
                                            ...
                                            <li class="form-col-50-left">
                                                ...
                                                <?= $input_group_start; ?>
                                                <input id="PhoneNumber" class="invoice-fields js-phone" value="<?= isset($dependant_info['phone']) ? $dependant_info['phone'] : ''; ?>" name="phone" type="text">
                                                <?= $input_group_end; ?>
                                            </li>
                                            <li class="form-col-50-right">
                                            ...
                                            <div class="btn-panel">
                                                ...
                                                <?php if ($this->uri->segment(2) != null && $this->uri->segment(3) != null && $this->uri->segment(4) != null) { ?>
                                                    <input type="button" value="Cancel" class="submit-btn btn-cancel" onClick="document.location.href = '<?php echo base_url('dependants') . '/' . $this->uri->segment(2) . '/' . $this->uri->segment(3) . '/' . $this->uri->segment(4); ?>'" />
                                                <?php } else if ($this->uri->segment(2) != null && $this->uri->segment(3) != null) { ?>
                                                    <input type="button" value="Cancel" class="submit-btn btn-cancel" onClick="document.location.href = '<?php echo base_url('dependants') . '/' . $this->uri->segment(2) . '/' . $this->uri->segment(3); ?>'" />
                                                <?php } else { ?>
                                                    <input type="button" value="Cancel" class="submit-btn btn-cancel" onClick="document.location.href = '<?php echo base_url('dependants'); ?>'" />
                                                <?php } ?>
                                            </div>
                                        </ul>
                                    </div>

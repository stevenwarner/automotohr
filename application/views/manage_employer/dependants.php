                    ...
                    <div class="col-lg-9 col-md-9 col-xs-12 col-sm-8">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <button class="btn btn-success JsSendReminderEmailLI form-control" data-id="<?= $user_sid; ?>" data-type="<?= $user_type; ?>" data-slug="dependents">Send An Email Reminder</button>
                                    </div>
                                    <div class="col-sm-8">
                                ...
                                <div class="dashboard-conetnt-wrp">
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($emergency_contacts as $emergency_contact) { ?>
                                                            <tr>
                                                                <!--<td> <input name="ej_active[]" type="checkbox" value="<?php //echo $emergency_contact['sid'];         
                                                                                                                            ?>" id="<?php //echo $emergency_contact['sid'];         
                                                                                                                                    ?>"  class="checkbox1"></td>-->
                                    ...
                                    <div class="btn-panel">
                                        ...
                                        <?php if ($this->uri->segment(2) != null && $this->uri->segment(3) != null) { ?>
                                            <a class="delete-all-btn active-btn" id="ej_active_donot" href="<?php echo base_url('add_dependant_information_donthave') . '/' . $this->uri->segment(2) . '/' . $this->uri->segment(3) . '/' . $this->uri->segment(4); ?>">Save</a>
                                        <?php } else { ?>
                                            <a class="delete-all-btn active-btn" id="ej_active_donot" href="<?php echo base_url('add_dependant_information_donthave'); ?>">Save</a>
                                        <?php } ?>

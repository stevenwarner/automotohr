                                        ...
                                        <ul>
                                            <li class="form-col-50-left">
                                                ...
                                                <div class="hr-select-dropdown">
                                                    <select class="invoice-fields" name="license_type">
                                                        <option
                                                            <?php if (isset($license_info['license_type']) && $license_info['license_type'] == "Sales License") {?>
                                                            selected <?php }?> value="Sales License">Sales License
                                                        </option>
                                                        <option
                                                            <?php if (isset($license_info['license_type']) && $license_info['license_type'] == "Commercial Driver’s License") {?>
                                                            selected <?php }?> value="Commercial Driver’s License">
                                                            Commercial Driver’s License</option>
                                                        <option
                                                            <?php if (isset($license_info['license_type']) && $license_info['license_type'] == "Non-commercial Driver’s License") {?>
                                                            selected <?php }?> value="Non-commercial Driver’s License">
                                                            Non-commercial Driver’s License</option>
                                                        <option
                                                            <?php if (isset($license_info['license_type']) && $license_info['license_type'] == "Restricted Driver’s License") {?>
                                                            selected <?php }?> value="Restricted Driver’s License">
                                                            Restricted Driver’s License</option>
                                                        <option
                                                            <?php if (isset($license_info['license_type']) && $license_info['license_type'] == "Basic Driver’s License") {?>
                                                            selected <?php }?> value="Basic Driver’s License">Basic
                                                            Driver’s License</option>
                                                        <option
                                                            <?php if (isset($license_info['license_type']) && $license_info['license_type'] == "Identification Card") {?>
                                                            selected <?php }?> value="Identification Card">
                                                            Identification Card</option>
                                                        <option
                                                            <?php if (isset($license_info['license_type']) && $license_info['license_type'] == "College Diploma") {?>
                                                            selected <?php }?> value="College Diploma">College Diploma
                                                        </option>
                                                        <option
                                                            <?php if (isset($license_info['license_type']) && $license_info['license_type'] == "Training") {?>
                                                            selected <?php }?> value="Training">Training</option>
                                                        <option
                                                            <?php if (isset($license_info['license_type']) && $license_info['license_type'] == "LSR Training") {?>
                                                            selected <?php }?> value="Other">Other</option>
                                                    </select>
                                                </div>
                                            </li>
                                            ...
                                            <li class="form-col-50-left">
                                                ...
                                                <div class="hr-select-dropdown">
                                                    <select class="invoice-fields" name="license_class">
                                                        <option
                                                            <?php if (isset($license_info['license_class']) && $license_info['license_class'] == "None") {?>
                                                            selected <?php }?> value="None">None</option>
                                                        <option
                                                            <?php if (isset($license_info['license_class']) && $license_info['license_class'] == "Class A") {?>
                                                            selected <?php }?> value="Class A">Class A</option>
                                                        <option
                                                            <?php if (isset($license_info['license_class']) && $license_info['license_class'] == "Class B") {?>
                                                            selected <?php }?> value="Class B">Class B</option>
                                                        <option
                                                            <?php if (isset($license_info['license_class']) && $license_info['license_class'] == "Class C") {?>
                                                            selected <?php }?> value="Class C">Class C</option>
                                                        <option
                                                            <?php if (isset($license_info['license_class']) && $license_info['license_class'] == "Other") {?>
                                                            selected <?php }?> value="Other">Other</option>
                                                    </select>
                                                </div>
                                            </li>
                                            ...
                                            <li class="form-col-50-left">
                                                ...
                                                <input class="invoice-fields startdate" readonly="" type="text"
                                                    ...
                                                    value="<?php if (isset($license_info['license_issue_date'])) {echo $license_info['license_issue_date'];}?>">
                                            </li>
                                            ...
                                            <li
                                                class="<?php if (isset($employer['access_level']) && ($employer['access_level'] == 'employee' || $employer['access_level'] == 'Employee')) {echo 'form-col-50-right';} else {echo 'form-col-50-right';}?>  autoheight send-email indefinite">

                                                <input type="checkbox" name="license_indefinite"
                                                    <?php if (isset($license_info['license_indefinite'])) {?> checked
                                                    <?php }?> id="Indefinite">
                                            ...
                                            <li class="form-col-100 autoheight">
                                                ...
                                                <textarea class="invoice-fields" name="license_notes"
                                            ...
                                            <li class="form-col-50-left">
                                                ...
                                                <div class="upload-file invoice-fields">
                                                    ...
                                                    <input type="file" name="license_file" id="license_file"
                                                        onchange="check_file('license_file')">
                                                    <a href="javascript:;">Choose File</a>
                                                </div>
                                                <em style="color:rgb(255, 155, 0);"><i
                                                        class="fa fa-warning"></i>&nbsp;Maximum file size allowed:
                                                    10MB</em>
                                            </li>
                                            ...
                                            <div class="btn-panel">
                                                ...
                                                <input type="button" class="submit-btn btn-cancel" value="Cancel"
                                                    onClick="document.location.href = '<?php echo base_url($cancel_url); ?>'">
                                            </div>
                                        </ul>
                                    </div>
                                </form>

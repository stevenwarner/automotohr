                                        ...
                                        <div class="universal-form-style-v2">
                                            <ul>
                                                ...
                                                <li class="form-col-50-left">
                                                    ...
                                                    <input class="invoice-fields startdate" readonly="" type="text" name="license_issue_date" value="<?php if (isset($license_info['license_issue_date'])) {
                                                ...
                                                <li class="form-col-50-left">
                                                    ...
                                                    <input class="invoice-fields expdate" readonly="" type="text" name="license_expiration_date" value="<?php if (isset($license_info['license_expiration_date'])) {

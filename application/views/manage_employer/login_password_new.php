                                    ...
                                    <div class="universal-form-style-v2">
                                        <ul>
                                            ...
                                            <li class="form-col-100 auto-height">
                                                ...
                                                <input class="invoice-fields" type="password" name="password" id="password" onkeyup="passwordStrength(this.value)">
                                            ...
                                            <li class="form-col-100 auto-height">
                                                ...
                                                <input class="invoice-fields" type="password" name="cpassword" id="cpassword">
                                            </li>
...
<?php } else { ?>
    <?php $this->load->view('manage_employer/login_password_new_ems'); ?>
<?php } ?>
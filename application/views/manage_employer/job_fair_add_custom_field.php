            ...
            <div class="col-lg-9 col-md-9 col-xs-12 col-sm-12">
                ...
                <div class="dashboard-conetnt-wrp">
                    <div class="page-header-area">
                        <span class="page-heading down-arrow"><?php $this->load->view('manage_employer/company_logo_name'); ?><?= $title ?></span>
                    </div>
                                        ...
                                        <li id="show_hide_child" style="display:block;">
                                            <form name="child_question" action="<?php echo $action_url; ?>" method="POST" enctype="multipart/form-data">  
                                                <span class="notes_area" style="height:auto;">
                                                    ...
                                                    <input type="hidden" name="perform_action" value="add_custom_field">
                                                    <div class="btn-panel">
                                                        <input class="submit-btn" type="submit" name="add_child_submit" value="Save Question">
...
<script type="text/javascript">
    ...
    function addAnswerBlock() {
        ...
        $('#' + id).html($('#' + id).html() + "<div class='form-col-100 question-row'><div class='container-fluid'><div class='row'><div class='col-lg-11 col-md-11 col-xs-12 col-sm-11'><div class='form-group'><label>Answer Choice</label><input class='invoice-fields' type='text' name='multilist_value[]' value='' /></div></div><div class='col-lg-1 col-md-1 col-xs-12 col-sm-1'><div class='delete-row-new'><a href='javascript:;' onclick=\"deleteAnswerBlock('" + id + "'); return false;\" class=\"remove\"><i class='fa fa-times'></i><\/a></div></div></div></div></div><\/div>");
        i++;
    }
    ...
    function addAnswerBlocksingle() {
        ...
        $('#' + idj).html($('#' + idj).html() + "<div class='form-col-100 question-row'><div class='container-fluid'><div class='row'><div class='col-lg-11 col-md-11 col-xs-12 col-sm-11'><div class='form-group'><label>Answer Choice</label><input class='invoice-fields' type='text' name='singlelist_value[]' value='' /></div></div><div class='col-lg-1 col-md-1 col-xs-12 col-sm-1'><div class='delete-row-new'><a href='javascript:;' onclick=\"deleteAnswerBlocksingle('" + idj + "'); return false;\" class=\"remove\"><i class='fa fa-times'></i><\/a></div></div></div></div></div><\/div>");
        j++;
    }

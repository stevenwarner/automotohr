                                                ...
                                                <?php if (check_access_permissions_for_view($security_details, 'review_score')) { ?>
                                                    <div class="rating-score">
                                                        <div class="rating-col text-left">
                                                            <a href="javascript:void(0);" onclick="fLaunchReviewModal(this)" class="text-left <?php echo ($employer_job['reviews_count'] > 0) ? 'text-blue' : 'text-success'; ?>" style="font-size: 14px; font-weight: 900" data-applicant-sid="<?= $employer_job["applicant_sid"]; ?>" data-applicant-email="<?= $employer_job["email"]; ?>" data-job-sid="<?= $employer_job["sid"]; ?>" data-document-title="Reviews For <?= $employer_job["first_name"]; ?> <?= $employer_job["last_name"]; ?>">Review Score<span class="btn-tooltip">Reviews</span></a>
                                                        </div>

                                        ...
                                        <div class="box-head">
                                            <div class="row date-bar">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-xs-4 col-sm-4">
                                                    ...
                                                    ?>
                                                    <a href="javascript:void(0);" class="pull-right <?= empty($resume_name) ? 'aplicant-documents' : 'aplicant-notes-span'; ?>" onclick="show_resume_popup(this);" data-preview-url="<?php echo $employer_job["resume_direct_link"]; ?>" data-download-url="<?php echo base_url('hr_documents_management/download_upload_document') . '/' . $employer_job['resume']; ?>" data-fullname="<?php echo urldecode($employer_job['resume']); ?>" data-file-name="<?php echo urldecode($resume_name); ?>" data-file-ext="<?php echo $resume_extension; ?>" data-document-title="<?php echo 'Resume For ' . $employer_job['job_title']; ?>" data-applicant-sid="<?php echo $employer_job['applicant_sid']; ?>" data-job-list-sid="<?php echo $employer_job['sid']; ?>" data-requested-job-sid="<?php echo $requested_job_sid; ?>" data-requested-job-type="<?php echo $requested_job_type; ?>" data-request_datetime="<?php echo $send_request_datetime; ?>">

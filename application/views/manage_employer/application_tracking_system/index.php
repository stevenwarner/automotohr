                                                ...
                                                <div class="col-lg-10 col-md-10 col-xs-12 col-sm-10 custom-col">
                                                    <div class="hr-select-dropdown no-aarow">
                                                        <input type="text" placeholder="Search applicants by Name or Email"
                                                               name="keyword" id="keyword" value="<?php echo isset($keyword) ? $keyword : ''; ?>"
...
<!--                                    <a href="--><?//= base_url() ?><!--manual_candidate" class="btn btn-success btn-block">+ Add Manual Candidate</a>-->
                                </div>
                            <?php }?>
                            <!--<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                <?php /*if ($archive == 'archive') { */?>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                <div class="dropdown email-notification-dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                        ...
                                        <?php }if(check_access_permissions_for_view($security_details, 'send_acknowledgement_email')) {?>
                                            <li><a href="javascript:void(0);" class="btn btn-info" id="send_ack_email">Send Acknowledgement Email</a></li>
                                        <?php }if(check_access_permissions_for_view($security_details, 'send_bulk_email')) {?>
                                            ...
                                            <div class="row date-bar">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-xs-4 col-sm-4">
                                                    ...
                                                    <a href="javascript:void(0);" 
                                                        ...
                                                        data-job-list-sid="<?php echo $employer_job['sid']; ?>" 
                                                        data-requested-job-sid="<?php echo $requested_job_sid; ?>" 
                                                        data-requested-job-type="<?php echo $requested_job_type; ?>" 
                                                        data-request_datetime="<?php echo $send_request_datetime; ?>">
                                                    ...
                                                    <!-- <?php //if($this->session->userdata('logged_in')['company_detail']['ems_status'] && ($session['company_detail']['has_applicant_approval_rights'] == 0 || $session['employer_detail']['has_applicant_approval_rights'] == 1)){?>
                                                        <a href="javascript:void(0);" onclick="fun_hire_applicant(<?php //echo $employer_job["employer_sid"]; ?>, <?php //echo $employer_job["applicant_sid"]; ?>, <?php //echo $employer_job['sid']; ?>);" class="pull-right aplicant-documents"><i class="fa fa-user-plus" aria-hidden="true"></i><span class="btn-tooltip">Direct Hire Candidate</span></a>
                                                    <?php //} ?> -->
                                                </div>
                                                <div class="col-lg-12">
...
<script type="text/javascript">
    ...
    function fLaunchReviewModal(source) {
        ...
        $('#review_modal').find('label').css({ 'width': '100%', 'text-align': 'left' });
    }
    ...
    function show_resume_popup (source) {
        ...
        if (document_preview_url != '') {
            ...
            alertify.confirm('Resume', '<div class="text-center"><b>No Resume Found!</b></div><br>'+request_message,
                ...
                }).set('labels', {ok: 'Send A Resume Request', cancel: 'Ok'});
        }
    }
...
<style>
    .cs-modal-loader{ position: absolute; top: 0; left: 0; bottom: 0; right: 0; background: rgba(255,255,255,.5); z-index: 2; display: none; }
    .cs-modal-loader i{ position: relative; font-size: 30px; text-align: center; display: block; top: 50%; margin-top: -30px; }
    .cs-error{ color: #cc0000; }
    .cs-ms-window{ max-height: 500px; overflow-y: auto; }
            ...
            if($('input[class="review_video_source"]:checked').val() == 'youtube'){
                ...
                if($('#review_yt_vm_video_url').val() != '') {
                    ...
                    $.ajax({
                        type: "POST",
                        url: myurl,
                        data: {url: $('#review_yt_vm_video_url').val()},
                        async : false,
                        success: function (data) {
                            if (data == false) {
                                $('#my_loader').hide();
            ...
            if($('input[class="add_review_video_source"]:checked').val() == 'youtube'){
                ...
                if($('#add_review_yt_vm_video_url').val() != '') {
                    ...
                    $.ajax({
                        type: "POST",
                        url: myurl,
                        data: {url: $('#add_review_yt_vm_video_url').val()},
                        async : false,
                        success: function (data) {
                            if (data == false) {
                                $('#my_loader').hide();

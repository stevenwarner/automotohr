                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                ...
                                                                <span style="float: right; text-align: right; font-size: 12px; margin-top: -5px">Completed At<br /> <?= formatDateToDB($my_questionnaire['attend_timestamp'], DB_DATE_WITH_TIME, DATE_WITH_TIME); ?></span>
                                                            </h4>
                                                        </div>
                                                                    ...
                                                                    <div class="panel-heading">
                                                                        <h4 class="panel-title">
                                                                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse_<?php echo $item; ?>">
                                                                                <span class="glyphicon glyphicon-minus"></span>
                                                                                <?php echo $key; ?>
                                                                                <span style="float: right; text-align: right; font-size: 12px; margin-top: -5px">Completed At<br /> <?= formatDateToDB($job_manual_questionnaire_array['attend_timestamp'], DB_DATE_WITH_TIME, DATE_WITH_TIME); ?></span>
                                                                            </a>
                                                                        </h4>
                                                                    </div>
                                                                    <div id="collapse_<?php echo $item; ?>" class="panel-collapse collapse in">

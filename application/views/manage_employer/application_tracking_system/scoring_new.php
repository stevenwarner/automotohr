                ...
                <div class="tab_container">
                    <div class="panel-group-wrp">
                        <div class="panel-group">
                            <?php foreach ($applicantResumeResult as $resume) { ?>
                                <?php
                                $jobTitle = getApplicantJobTitleByQueueId($resume['portal_applicant_jobs_queue_sid']);
                                ...
                                $screening_questions = json_decode($resume['screening_questions']);
                                $extra_content = $resume['extra_content'];
                                $reports = !empty($interview_logs['reports']) ? json_decode($interview_logs['reports']) : null;
                                $preScore = empty($resume['match_score']) ? '0' : $resume['match_score'];
                                ?>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title" style="width: 100%">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#jobQueue_<?php echo $resume['portal_applicant_jobs_queue_sid']; ?>"> <?php echo $jobTitle; ?> <span class="glyphicon glyphicon-plus"></span></a>
                                        </h4>
                                    </div>
                                    <div id="jobQueue_<?php echo $resume['portal_applicant_jobs_queue_sid']; ?>" class="panel-collapse collapse">
                                                        ...
                                                        <div class="col-lg-4 col-sm-12">
                                                            <div class="hr-widget">
                                                                <div class="score_wrapper">
                                                                    <h3>Job Title:</h3>
                                                                    <?php
                                                                    echo '<b>' . getApplicantJobTitleByQueueId($resume['portal_applicant_jobs_queue_sid']) . '</b>';
                                                                    ?>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="score_wrapper">
                                                                    ...
                                                                    <div style="display: flex;align-items: center;">
                                                                        <span class="score_range">
                                                                            ...
                                                                            /
                                                                            100</span>
                                                                        <a href="javascript:;" class="action-btn jsEditScore" data-id="<?= $resume['sid']; ?>" data-score="<?= $preScore; ?>">
                                                            ...
                                                            <div class="submitted_card_wrapper hr-widget">
                                                                ...
                                                                <div class="panel panel-default">
                                                                    <div class="panel-heading">
                                                                        ...
                                                                        <a href="javascript:;" class="action-btn jsEditQuestions" data-id="<?= $resume['sid']; ?>" data-questions='<?= $resume['screening_questions']; ?>'>
                                                                            <i class="fa fa-pencil"></i>
                                                                            <span class="btn-tooltip">Edit</span>
                                                                        </a>
                                                                    </div>
...
<div id="edit_questionnaire_modal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <form method="post">
            <input type="hidden" name="resume_id" id="jsQuestionsResumeId" value="" />
...
<div id="edit_scoring_modal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <form method="post">
            <input type="hidden" name="resume_id" id="jsScoreResumeId" value="" />
            <div class="modal-content">
                <div class="modal-header modal-header-bg">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                ...
                <div class="modal-body" id="edit_scoring_body_data">
                    <!-- Scoring Input -->
                    <input type="number" class="invoice-fields" name="score" id="jsScoreValue"
...
<script>
    ...
    //
    $(document).on("click", ".jsEditScore", function () {
        var score = $(this).data('score');
        var resumeId = $(this).data('id');
        $('#edit_scoring_modal').modal('show');
        $("#jsScoreValue").val(score);
        $("#jsScoreResumeId").val(resumeId);
    });

    $(document).on("click", ".jsEditQuestions", function () {
        screening_questions = $(this).data('questions');
        var resumeId = $(this).data('id');
        //
        $("#jsQuestionsResumeId").val(resumeId);
        //
        displayQuestions();
    });

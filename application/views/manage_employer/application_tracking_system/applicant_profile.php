                                            ...
                                            <li class="form-col-50-left">
                                                ...
                                                <div class="hr-select-dropdown">
                                                    <select class="invoice-fields" name="notified_by[]" id="employees" multiple="true">
                                                        <option value="email" <?php if(in_array('email', explode(',', $applicant_info['notified_by']))){echo 'selected';}?>>Email</option>
                                                        <option value="sms" <?php if(in_array('sms', explode(',', $applicant_info['notified_by']))){echo 'selected';}?>>SMS</option>
                                                    </select>
                                                </div>
                                            </li>
                                            <?php } ?>

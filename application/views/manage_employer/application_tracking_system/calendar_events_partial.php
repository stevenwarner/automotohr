<div class="form-wrp">
    <form action="<?php echo base_url('calendar/tasks'); ?>" name="event_form" id="add_event_form" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="applicant_sid" value="<?php echo $applicant_sid ?>">
        ...
        <input type="hidden" name="redirect_to_user_sid" value="<?php echo $applicant_sid; ?>">
        <input type="hidden" name="redirect_to_job_list_sid" value="<?php echo $job_list_sid; ?>">
    ...
    <div class="row">
        <div class="col-xs-12">
            <ul class="nav nav-tabs nav-justified">
                ...
                <li onclick="func_get_past_events('applicant', <?php echo $applicant_sid; ?>)"><a data-toggle="tab" href="#past_events">Past Events</a></li>
            </ul>

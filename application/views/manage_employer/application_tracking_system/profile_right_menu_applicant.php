                    ...
                    <div class="start-rating">
                        <form action="<?php echo base_url('applicant_profile/save_rating'); ?>" method="post">
                            ...
                            <div class="rating-comment">
                                ...
                                <!--                            <textarea id="rating_comment" name="comment" required>--><?php //if (!empty($applicant_rating)){ echo $applicant_rating['comment']; } 
                                                                                                                            ?><!--</textarea>-->
                    ...
                    <div class="browse-attachments">
                        <ul>
                            ...
                            if (sizeof($i9_form) > 0) { ?>
                                ...
                                <!--                                --><?php //} else{ 
                                                                        ?>
                                <!--                                    <a href="--><?php //echo base_url('form_i9/applicant') . '/' . $applicant_info['sid'] . "/" . $job_list_sid; 
        ...
        <div class="modal-content">
            ...
            <?php if ($cover_letter_title != "No Cover Letter found!") {
                ...
                <?php } elseif ($cover_type == 'pdf') {
                    ...
                    $pdfSrc = copyObjectAWS($applicant_info['cover_letter']);
                    $pdfSrcPAth="https://docs.google.com/gview?url=https://automotohrattachments.s3.amazonaws.com/".$pdfSrc."&embedded=true";

                ?>
                    <iframe src="<?=$pdfSrcPAth; ?>" id="preview_iframe" class="uploaded-file-preview jsCustomPreview" style="width:100%; height:500px;" frameborder="0"></iframe>

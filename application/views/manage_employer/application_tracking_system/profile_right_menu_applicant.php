...
<div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 hidden-print">
    <aside class="side-bar">
        <a
            href="<?php echo isset($ats_full_url) ? $ats_full_url : base_url('application_tracking_system/active/all/all/all/all/all/all/all/all/all'); ?>">
        ...
        <div class="next-applicant">
            <ul>
                <li class="previous-btn"><a href="<?php echo $prev_app ?>"><i aria-hidden="true"
                            class="fa fa-chevron-left"></i>Prev</a></li>
                <li class="next-btn"><a href="<?php echo $next_app ?>">next<i aria-hidden="true"
                    ...
                    <div class="start-rating">
                        <form action="<?php echo base_url('applicant_profile/save_rating'); ?>" method="post">
                            ...
                            <div class="text-center applicant-rating-container">
                                <input readonly="readonly" id="input-21b" <?php if (!empty($applicant_rating)) { ?>
                                        value="<?php echo $applicant_rating['rating']; ?>" <?php } ?> type="number"
                                    name="rating" class="rating" min=0 max=5 step=0.2 data-size="xs">
                            </div>
                            <div class="rating-comment">
                                <!--                            <h4>comment<samp class="red"> * </samp></h4>-->
                                <input type="button" id="trigger-review" value="Review Comments" class="btn btn-success"
                        ...
                        <ul>
                            <?php if (check_access_permissions_for_view($security_details, 'applicant_profile')) { ?>
                                <li>
                                    ...
                                    <a
                                        href="<?php echo base_url('applicant_profile') . '/' . $applicant_info['sid'] . '/' . $job_list_sid; ?>">View<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                </li>
                            <?php } ?>
                            <?php if (check_access_permissions_for_view($security_details, 'background_check')) { ?>
                                <li>
                                    ...
                                    if ($company_background_check == 1) { ?>
                                        <a
                                            href="<?php echo base_url('background_check') . '/applicant/' . $applicant_info['sid'] . '/' . $job_list_sid; ?>">View<i
                                                aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                    <?php } else { ?>
                                        <a href="<?php echo base_url('background_check/activate') ?>">View<i aria-hidden="true"
                                    ...
                                    <?php if (intval($background_check_count) > 0) { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="Background Check Processed" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/on.gif'); ?>">
                                    <?php } else { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="Background Check Not Processed" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                            ...
                            <?php if (check_access_permissions_for_view($security_details, 'drug_test')) { ?>
                                <li>
                                    ...
                                    <?php if ($company_background_check == 1) { ?>
                                        <a
                                            href="<?php echo base_url('drug_test') . '/applicant/' . $applicant_info['sid'] . '/' . $job_list_sid; ?>">View<i
                                                aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                    <?php } else {
                                    ...
                                    <?php if (intval($background_check_count) > 0) { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="Drug Test Processed" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/on.gif'); ?>">
                                    <?php } else { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="Drug Test Not Processed" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/off.gif'); ?>">
                                    <?php } ?>
                                    <!-- Light Bulb Code - End -->
                            ...
                            <?php if (check_access_permissions_for_view($security_details, 'reference_checks')) { ?>
                                <li>
                                    ...
                                    <a
                                        href="<?php echo base_url('reference_checks') . '/applicant/' . $applicant_info['sid'] . '/' . $job_list_sid; ?>">View<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                    <!-- Light Bulb Code - Start -->
                                    <?php $references_count = count_references_records($applicant_info['sid']); ?>
                                    <?php if (intval($references_count) > 0) { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="Has References Setup" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/on.gif'); ?>">
                                    <?php } else { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="No References Found" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/off.gif'); ?>">
                                    <?php } ?>
                                    <!-- Light Bulb Code - End -->
                            ...
                            <?php if (check_access_permissions_for_view($security_details, 'send_reference_request_email')) { ?>
                                <li>
                                    ...
                                    <form action="<?php echo base_url('applicant_profile/send_reference_request_email'); ?>"
                                        method="post" id="form_request_references_<?php echo $applicant_info['sid']; ?>">
                                        <input type="hidden" id="perform_action" name="perform_action"
                                            value="send_add_reference_request_email" />
                                        <input type="hidden" id="applicant_sid" name="applicant_sid"
                                            value="<?php echo $applicant_info['sid']; ?>" />
                                    </form>
                                    <h4>References Request</h4>
                                    <a href="javascript:;"
                                        onclick="fSendAddReferencesRequestEmail(<?php echo $applicant_info['sid']; ?>);">Send<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                    <!-- Light Bulb Code - Start -->
                                    ...
                                    <?php if ($reference_check_request_status == 'sent') { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="Sent" data-toggle="tooltip" data-placement="top" class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/on.gif'); ?>">
                                    <?php } else { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="Not Sent" data-toggle="tooltip" data-placement="top" class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/off.gif'); ?>">
                                    <?php } ?>
                                    <!-- Light Bulb Code - End -->
                                </li>
                            ...
                            <?php if (check_access_permissions_for_view($security_details, 'send_kpa_onboarding')) { ?>
                                <?php if ($kpa_onboarding_check == 1) { ?>
                                    <li>
                                        ...
                                        <form action="<?php echo base_url('applicant_profile/send_kpa_onboarding'); ?>"
                                            method="post" id="form_kpa_onboarding_<?php echo $applicant_info['sid']; ?>">
                                            <input type="hidden" name="kpa_action" value="send_kpa_onboarding_email" />
                                            <input type="hidden" name="applicant_sid"
                                                value="<?php echo $applicant_info['sid']; ?>" />
                                        </form>
                                        <a href="javascript:;"
                                            onclick="fSendKpaOnboardingEmail(<?php echo $applicant_info['sid']; ?>);">Send<i
                                                aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                            ...
                            <?php if ($this->session->userdata('logged_in')['company_detail']['ems_status'] == 1) { ?>
                                <li>
                                    ...
                                    <a
                                        href="<?php echo base_url('onboarding/send_offer_letter/applicant') . '/' . $applicant_info['sid'] . '/' . $job_list_sid; ?>">View<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                            ...
                            <?php if ($this->session->userdata('logged_in')['company_detail']['ems_status'] == 1) { ?>
                                <li>
                                    ...
                                    <a
                                        href="<?php echo base_url('onboarding/view_offer_letter/applicant') . '/' . $applicant_info['sid'] . '/' . $job_list_sid; ?>">View<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                    <?php $offer_letter_ststus = count_offer_letter('applicant', $applicant_info['sid']); ?>
                                    <!-- Light Bulb Code - Start -->
                            ...
                            <?php if ($session['employer_detail']['access_level_plus'] == 1 || check_access_permissions_for_view($security_details, 'merge_applicant_with_employee')) { ?>
                                <li>
                                    ...
                                    <a class="" href="javascript:0;" data-toggle="modal" data-target="#merge_modal">Merge<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                            ...
                            <?php if (($session['company_detail']['has_applicant_approval_rights'] == 0 || $session['employer_detail']['has_applicant_approval_rights'] == 1)) { ?>
                                <?php if ($session['employer_detail']['access_level_plus'] == 1 || check_access_permissions_for_view($security_details, 'hire_applicant_manually')) { ?>
                                    <li>
                                        ...
                                        <a href="javascript:;" onclick="fun_hire_applicant();">Hire<i aria-hidden="true"
                                                class="fa fa-chevron-circle-right"></i></a>
                                    </li>
                                <?php } ?>
                            <?php } ?>
                            <?php if ($session['company_detail']['has_applicant_approval_rights'] == 0 || $session['employer_detail']['has_applicant_approval_rights'] == 1) { ?>
                                <?php if ($session['employer_detail']['access_level_plus'] == 1 || check_access_permissions_for_view($security_details, 'setup')) { ?>
                                    <li>
                                        ...
                                        <a
                                            href="<?php echo base_url('onboarding/setup/applicant') . '/' . $applicant_info['sid'] . '/' . $job_list_sid; ?>">View<i
                                                aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                        <!-- Light Bulb Code - Start -->
                                        ...
                                        <?php if (intval($applicant_panel_config_count) > 0) { ?>
                                            <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                                title="Applicant Panel Set-up" data-toggle="tooltip" data-placement="top"
                                                class="img-responsive"
                                                src="<?php echo site_url('assets/manage_admin/images/on.gif'); ?>">
                                        <?php } else { ?>
                                            <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                                title="Applicant Panel Not Set-up" data-toggle="tooltip" data-placement="top"
                                                class="img-responsive"
                                                src="<?php echo site_url('assets/manage_admin/images/off.gif'); ?>">
                                        <?php } ?>
                                        <!-- Light Bulb Code - End -->
                            ...
                            <?php if (isset($applicant_job_queue) && $applicant_job_queue) { ?>
                                <li>
                                    ...
                                    <h4>AI Score</h4>
                                    <a
                                        href="<?php echo base_url('applicant_profile/submitted/resume') . '/' . $applicant_info['sid'] . '/' . $job_list_sid; ?>">View<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                    <!-- Light Bulb Code - Start -->
                                    <?php $applicant_panel_config_count = count_onboarding_panel_records('applicant', $applicant_info['sid']); ?>
                                    <?php if (intval($applicant_panel_config_count) > 0) { ?>
                            ...
                            <?php if (
                                ...
                                <li>
                                    ...
                                    <a href="#" data-id="<?= $applicant_info['sid']; ?>" class="jsRevertOnboarding">Revert<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                </li>
                            <?php } ?>
                        ...
                        <ul>
                            <?php if ($form_full_application_flag == 1) { ?>
                                <?php if (check_access_permissions_for_view($security_details, 'send_applicant_full_employment_application')) { ?>
                                    <li>
                                        ...
                                        <form id="form_send_full_employment_application" enctype="multipart/form-data" method="post"
                                            action="<?php echo base_url('form_full_employment_application/send_form'); ?>">
                                            <input type="hidden" id="company_sid" name="company_sid"
                                                value="<?php echo $applicant_info['employer_sid']; ?>" />
                                            <input type="hidden" id="user_type" name="user_type" value="applicant" />
                                            <input type="hidden" id="user_sid" name="user_sid"
                                                value="<?php echo $applicant_info['sid']; ?>" />
                                        ...
                                        <div <?= $full_emp_form_status == 'sent' || $full_emp_form_status == 'signed' ? 'class="view-btn"' : '' ?>>
                                            <a href="javascript:void(0);"
                                                onclick="fSendFullEmploymentForm();"><?= $full_emp_form_status == 'sent' || $full_emp_form_status == 'signed' ? 'Resend' : 'Send'; ?><i
                                                    aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                            <!-- Light Bulb Code - Start -->

                                            <?php if ($full_emp_form_status == 'sent' || $full_emp_form_status == 'signed') { ?>
                                                <img class="img-responsive pull-right"
                                                    style=" width: 22px; height: 22px; margin-right:5px;" title="Sent"
                                                    data-toggle="tooltip" data-placement="top" class="img-responsive"
                                                    src="<?php echo site_url('assets/manage_admin/images/on.gif'); ?>">
                                            <?php } else { ?>
                                                <img class="img-responsive pull-right"
                                                    style=" width: 22px; height: 22px; margin-right:5px;" title="Not Sent"
                                                    data-toggle="tooltip" data-placement="top" class="img-responsive"
                                                    src="<?php echo site_url('assets/manage_admin/images/off.gif'); ?>">
                                            <?php } ?>
                                        </div>
                                ...
                                <?php if (check_access_permissions_for_view($security_details, 'view_applicant_full_employment_application')) { ?>
                                    <li>
                                        ...
                                        <h4>Full Employment Application</h4>
                                        <a
                                            href="<?php echo base_url('applicant_full_employment_application') . '/' . $applicant_info['sid'] . '/' . $job_list_sid; ?>">View<i
                                                aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                        ...
                                        <?php if ($full_employment_application_status == 'signed') { ?>
                                            <img title="Signed" style="width: 22px; height: 22px; margin-right:5px;"
                                                data-toggle="tooltip" data-placement="top" class="img-responsive pull-right"
                                                src="<?php echo site_url('assets/manage_admin/images/on.gif'); ?>">
                                        <?php } else { ?>
                                            <img title="Unsigned" style="width: 22px; height: 22px; margin-right:5px;"
                                                data-toggle="tooltip" data-placement="top" class="img-responsive pull-right"
                                                src="<?php echo site_url('assets/manage_admin/images/off.gif'); ?>">
                                        <?php } ?>
                            ...
                            <?php if (check_access_permissions_for_view($security_details, 'applicant_emergency_contacts')) { ?>
                                <li>
                                    ...
                                    <a
                                        href="<?php echo base_url('emergency_contacts') . '/applicant/' . $applicant_info['sid'] . '/' . $job_list_sid; ?>">View<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                    <!-- Light Bulb Code - Start -->
                                    <?php $emergency_contacts_count = count_emergency_contacts($applicant_info['sid']); ?>
                                    <?php if (intval($emergency_contacts_count > 0)) { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="Has Emergency Contacts Setup" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/on.gif'); ?>">
                                    <?php } else { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="No Emergency Contacts Setup" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/off.gif'); ?>">
                                    <?php } ?>
                                    <!-- Light Bulb Code - End -->
                            ...
                            <?php if (check_access_permissions_for_view($security_details, 'applicant_occupational_license_info')) { ?>
                                <li>
                                    ...
                                    <a
                                        href="<?php echo base_url('occupational_license_info') . '/applicant/' . $applicant_info['sid'] . '/' . $job_list_sid; ?>">View<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                    <!-- Light Bulb Code - Start -->
                                    <?php $occ_licenses_count = count_licenses($applicant_info['sid'], 'occupational'); ?>
                                    <?php if (intval($occ_licenses_count) > 0) { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="Occupational License Saved" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/on.gif'); ?>">
                                    <?php } else { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="No Occupational License Information" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/off.gif'); ?>">
                                    <?php } ?>
                                    <!-- Light Bulb Code - End -->
                            ...
                            <?php if (check_access_permissions_for_view($security_details, 'applicant_drivers_license_info')) { ?>
                                <li>
                                    ...
                                    <a
                                        href="<?php echo base_url('drivers_license_info') . '/applicant/' . $applicant_info['sid'] . '/' . $job_list_sid; ?>">View<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                    <!-- Light Bulb Code - Start -->
                                    <?php $drv_licenses_count = count_licenses($applicant_info['sid'], 'drivers'); ?>
                                    <?php if (intval($drv_licenses_count) > 0) { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="Drivers License Saved" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/on.gif'); ?>">
                                    <?php } else { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="No Drivers License Information" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/off.gif'); ?>">
                                    <?php } ?>
                                    <!-- Light Bulb Code - End -->
                            ...
                            <?php if (check_access_permissions_for_view($security_details, 'applicant_equipment_info')) { ?>
                                <li>
                                    ...
                                    <a
                                        href="<?php echo base_url('equipment_info') . '/applicant/' . $applicant_info['sid'] . '/' . $job_list_sid; ?>">View<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                    <!-- Light Bulb Code - Start -->
                                    <?php $equipments_count = count_equipments($applicant_info['sid']); ?>
                                    <?php if (intval($equipments_count) > 0) { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="Equipment Assigned" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/on.gif'); ?>">
                                    <?php } else { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="No Equipment Assigned" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/off.gif'); ?>">
                                    <?php } ?>
                                    <!-- Light Bulb Code - End -->
                            ...
                            <?php if (check_access_permissions_for_view($security_details, 'applicant_dependants')) { ?>
                                <li>
                                    ...
                                    <h4>Dependents</h4>
                                    <a
                                        href="<?php echo base_url('dependants') . '/applicant/' . $applicant_info['sid'] . "/" . $job_list_sid; ?>">View<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                    <!-- Light Bulb Code - Start -->
                                    <?php $dependant_count = count_dependants($applicant_info['sid']); ?>
                                    <?php if (intval($dependant_count) > 0) { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="Has Dependents" data-toggle="tooltip" data-placement="top" class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/on.gif'); ?>">
                                    <?php } else { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="No Dependents Information Found" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/off.gif'); ?>">
                                    <?php } ?>
                                    <!-- Light Bulb Code - End -->
...
-->
                        ...
                        -->
                            <?php if (check_access_permissions_for_view($security_details, 'send_video_interview_questionnaire') || $is_hiring_manager) { ?>
                                <li>
                                    ...
                                    <a
                                        href="<?php echo base_url() . 'video_interview_system/send_questions/' . $applicant_info['sid'] . '/' . $job_list_sid . '/'; ?>">Send<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                    <?php if ($questions_sent == false) { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="Send Video Interview Questions" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/off.gif'); ?>">
                                    <?php } else { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="Video Interview Questions Sent" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/on.gif'); ?>">
                                    <?php } ?>
                                </li>
                            ...
                            <?php if (check_access_permissions_for_view($security_details, 'view_video_interview_questionnaire') || $is_hiring_manager) { ?>
                                <li>
                                    ...
                                    <!-- change to bulb to on/off state based on previous records whether the questions have been sent or not -->
                                    <a
                                        href="<?php echo base_url() . 'video_interview_system/question_responses/' . $applicant_info['sid'] . '/' . $job_list_sid; ?>">View<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                    <?php if ($questions_answered == false) { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="No Video Interview Response" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/off.gif'); ?>">
                                    <?php } else { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="View Video Interview Response" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/on.gif'); ?>">
                                    <?php } ?>
                                </li>
                            ...
                            <?php if (check_access_permissions_for_view($security_details, 'ats_direct_deposit') || $is_hiring_manager) { ?>
                                <li>
                                    ...
                                    <a
                                        href="<?php echo base_url('direct_deposit') . '/applicant/' . $applicant_info['sid'] . '/' . $job_list_sid; ?>">View<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                    <!-- Light Bulb Code - Start -->
                                    <?php $direct_deposit_count = count_direct_deposit($applicant_info['sid']); ?>
                                    <?php if (intval($direct_deposit_count) > 0) { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="Direct Deposit Info Added" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/on.gif'); ?>">
                                    <?php } else { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="Direct Deposit Info Not Added" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/off.gif'); ?>">
                                    <?php } ?>
                                    <!-- Light Bulb Code - End -->
                            ...
                            <?php if (false) { ?>
                                <li>
                                    ...
                                    <h4>Documents</h4>
                                    <a
                                        href="<?php echo base_url('hr_documents_management/documents_assignment/applicant/' . $applicant_info['sid'] . '/' . $job_list_sid); ?>">View<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                    <?php $direct_deposit_count = count_assigned_documents('applicant', $applicant_info['sid']); ?>
                                    <?php if (intval($direct_deposit_count) > 0) { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="Documents Assigned" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/on.gif'); ?>">
                                    <?php } else { ?>
                                        <img class="img-responsive pull-right" style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="No Documents Assigned" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/off.gif'); ?>">
                                    <?php } ?>
                                    <!-- Light Bulb Code - End -->
                            ...
                            <?php if (check_access_permissions_for_view($security_details, 'ats_learning_center') || $is_hiring_manager) { ?>
                                <li>
                                    ...
                                    <a
                                        href="<?php echo base_url('learning_center/my_learning_center/' . $applicant_info['sid'] . '/' . $job_list_sid); ?>">View<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                            ...
                            <?php }
                            if ((check_access_permissions_for_view($security_details, 'ats_documents') || $is_hiring_manager) && $this->session->userdata('logged_in')['company_detail']['ems_status']) { ?>
                                <li>
                            ...
                            <li style="cursor: pointer;">
                                ...
                                <a href="javascript:void(0)" title="Send An Email Reminder" id="JsSendReminderEmail">Send <i
                                        aria-hidden="true" class="fa fa-chevron-circle-right"></i></a><br>
                                <a href="javascript:void(0)" title="View Email Reminder History"
                                    id="JsSendReminderEmailHistory">View <i aria-hidden="true"
                                        class="fa fa-chevron-circle-right"></i></a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="hr-widget" id="attachment_view">
                <div class="attachment-header">
                    ...
                    <div class="file-container">
                        <a href="<?php echo base_url('onboarding/view_applicant_resume/applicant/' . $applicant_info['sid'] . '/' . $job_list_sid); ?>"
                            title="View Resume Library">
                            <article>
                                <figure><img src="<?php echo base_url() ?>assets/images/attachment-img.png"></figure>
                                <div class="text">Resume</div>
                            </article>
                        </a>
                        <a data-toggle="modal" data-target="#cover_letter_modal" href="javascript:void(0);"
                        ...
                        <ul>
                            <li>
                                ...
                                <?php if (!in_array($applicant_info['employer_sid'], array("0"))) { ?>
                                    <?php if (count($applicant_jobs) == 1) { ?>
                                        <a href="javascript:;" class="confirmation">Send<i aria-hidden="true"
                                                class="fa fa-chevron-circle-right"></i></a>
                                        <div class="" style="display: none;">
                                            <form name="send_resume_request_form" id="send_resume_request_form" method="post"
                                                action="<?php echo base_url('onboarding/send_applicant_resume_request/applicant/' . $applicant_info['sid'] . '/' . $job_list_sid); ?>">
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <a class="" href="javascript:0;" data-toggle="modal"
                                            data-target="#send_resume_request">Send<i aria-hidden="true"
                                                class="fa fa-chevron-circle-right"></i></a>
                                    <?php } ?>
                                <?php } else { ?>
                                    <a href="javascript:;" class="confirmation_old"
                                        src="<?php echo base_url('onboarding/send_applicant_resume_request/applicant/' . $applicant_info['sid'] . '/' . $job_list_sid); ?>">Send<i
                                            aria-hidden="true" class="fa fa-chevron-circle-right"></i></a>
                                <?php } ?>
                                ...
                                <?php if ($resume == 'not_empty') { ?>
                                    <img class="img-responsive pull-right"
                                        style=" width: 22px; height: 22px; margin-right:5px;" title="Resume Request Sent"
                                        data-toggle="tooltip" data-placement="top" class="img-responsive"
                                        src="<?php echo site_url('assets/manage_admin/images/on.gif'); ?>">
                                <?php } else if ($resume == 'empty') { ?>
                                        <img class="img-responsive pull-right"
                                            style=" width: 22px; height: 22px; margin-right:5px;"
                                            title="Resume Request Not Sent" data-toggle="tooltip" data-placement="top"
                                            class="img-responsive"
                                            src="<?php echo site_url('assets/manage_admin/images/off.gif'); ?>">
                                <?php } ?>
                            </li>
                            ...
                            if (isset($applicant_info) && !empty($applicant_info)) {
                                ...
                                if (!empty($last_send_request_date) && $last_send_request_date != NULL) {
                                    ?>
                                    <li>
                                        <p class="text-left">The last resume request was sent on
                                            <br><strong><?php echo date('M d Y, D H:i:s', strtotime($last_send_request_date)); ?></strong>
                                        </p>
                                    </li>
                                <?php }
                            } ?>
            ...
            <div class="hr-widget" id="attachment_edit" style="display: none;">
                <form
                    action="<?php echo base_url('applicant_profile/upload_attachment') ?>/<?php echo $applicant_info['sid'] ?>"
                    ...
                    <div class="attachment-header attachment_edit">
                        <div class="remove-file">
                            ...
                            <?php if ($resume_link_title != "No Resume found!") { ?>
                                <a class="remove-icon" href="javascript:void(0);"
                                    onclick="file_remove(<?php echo $applicant_info['sid'] ?>, 'Resume')"><i
                    ...
                    <div class="attachment-header attachment_edit">
                        <div class="remove-file">
                            ...
                            <?php if ($cover_letter_title != "No Cover Letter found!") { ?>
                                <a class="remove-icon" href="javascript:void(0);"
                                    onclick="file_remove(<?php echo $applicant_info['sid'] ?>, 'Cover Letter')"><i
                                        aria-hidden="true" class="fa fa-remove"></i></a>
                            <?php } ?>
                        </div>
                        <h4>Cover Letter</h4>
                        <div class="btn-inner">
                            <input type="file" id="cover_letter" name="cover_letter"
                                onchange="check_file('cover_letter')" class="choose-file-filed">
                            <a href="" class="select-photo"><i aria-hidden="true" class="fa fa-plus"></i></a>
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="old_letter" id="action"
                        value="<?php echo $applicant_info['cover_letter']; ?>">
                </form>
            </div>

            <!--Extra attachments panel starts-->
            <div class="hr-widget">
                <form action="<?php echo base_url('applicant_profile/upload_extra_attachment') ?>" method="POST"
                    ...
                    <div class="attachment-header">
                        <div class="attachment-header">
                            ...
                            <div class="btn-inner">
                                <input type="file" name="newlife" id="all_file" required="required"
                                    onchange="check_file('all_file')" class="choose-file-filed">
                                <a href="" class="select-photo"><i aria-hidden="true" class="fa fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <li>
                                            ...
                                            <div class="remove-file remove-icon">
                                                <a class="" href="javascript:void(0);"
                                                    onclick="file_remove(<?= $attachment['sid'] ?>, 'file')"><i aria-hidden="true"
                                                        class="fa fa-remove"></i></a>
                                            </div>
                                            <a href="<?php echo AWS_S3_BUCKET_URL . $attachment['uploaded_name']; ?>">Download<i
                                                    aria-hidden="true" class="fa fa-chevron-circle-down"></i></a>
                                            ...
                                            <select class="invoice-fields" name="job_sid" id="job_sid_send" required>
                                                ...
                                                <?php foreach ($applicant_jobs as $value) { ?>
                                                    ...
                                                    <?php if ((!empty($job_sid) || $job_sid > 0) && $job_title != 'Job Not Applied') { ?>
                                                        <option value="<?php echo $job_sid; ?>" data-type="job">
                                                            <?php echo $job_title; ?>
                                                        </option>
                                                    <?php } else if ($job_sid == 0 && $job_title != 'Job Not Applied') { ?>
                                                            <option value="<?php echo $job_listing_sid; ?>" data-type="desired_job">
                                                            <?php echo $job_title; ?>
                                                            </option>
                                                    <?php } else { ?>
                                                        <?php if ($continue == 'on') { ?>
                                                                <option value="0" data-type="job_not_applied"> <?php echo $job_title; ?>
                                                                </option>
                                                            <?php $continue = 'off' ?>
                                                        <?php } ?>
                            ...
                            <div class="universal-form-style-v2">
                                <ul>
                                    ...
                                    <li class="form-col-100">
                                        ...
                                        <div class="hr-select-dropdown">
                                            <input type="file" name="resume" required="required" id="resume"
                                                class="choose-file">
                                        </div>
                                    </li>
                                    <div class="btn-panel">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header modal-header-bg">
                ...
                <h4 class="modal-title" id="review_modal_title">Merge Applicant
                    (<?= $applicant_info['first_name'] . ' ' . $applicant_info['last_name'] ?>)</h4>
            </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <select class="invoice-fields" id="employees-list">
                            ...
                            foreach ($employees as $emp) { ?>
                                <option value="<?= $emp['sid'] ?>">
                                    <?= ucwords($emp['first_name'] . ' ' . $emp['last_name']) . " (" . $emp['email'] . ")" ?>
                                </option>
                            <?php } ?>
                        </select>
                        ...
                        <div class="custom_loader pull-right">
                            <div id="submit-loader" class="loader" style="display: none">
                                <i style="font-size: 25px; color: #81b431;" aria-hidden="true"

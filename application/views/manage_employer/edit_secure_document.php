                            ...
                            <div class="hr-box">
                                <div class="hr-innerpadding">
                                    <div role="tabpanel" id="js-main-page">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <button class="btn btn-success pull-right js-upload-btn">Update</button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="cs-upload-box">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <h4>Upload document <small>(You can use the upload button or drop your document.)</small>
                                                        <p class="pull-right">Selected document: <strong class="js-selected-file-count">0</strong></p>
                                                    </h4>
                                                </div>
                                            </div>
...
<script>
    $(function UploadAndAssignBulkDocuments() {
        ...
        function startUploadProcess(e) {
            ...
            loader('show');
            targets.loaderText.html('Please, be patient as we Upload your document.<br /> It may take a few minutes. <br />File <span>1</span> of ' + (fileArray.length) + '');
        ...
        function uploadAndAssignFiles() {
            ...
            formpost.append('document_sid', '<?php echo $document_sid ;?>');

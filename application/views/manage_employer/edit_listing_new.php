                    ...
                    <div class="dashboard-conetnt-wrp">
                        ...
                        <div class="create-job-wrap">
                            <div class="job-title-text">
                                <p>Enter information about your job.Fields marked with an asterisk (<span>*</span>) are
                                    mandatory.</p>
                                <p><button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                        data-target="#preview_listing">Preview Job</button></p>
                            ...
                            <div class="universal-form-style-v2">
                                <ul>
                                    <form id="employers_add_job" method="POST" enctype="multipart/form-data">
                                                ...
                                                <select class="invoice-fields" name="Location_State" id="state">
                                                    ...
                                                    <?php } else {
                                                        foreach ($active_states[$country_id] as $active_state) { ?>
                                                            <option value="<?= $active_state["sid"] ?>" <?php if (isset($listing['Location_State']) && $listing['Location_State'] == $active_state["sid"]) { ?>
                                                                    selected<?php } ?>>
                                        ...
                                        <?php if (!empty($templates)) { ?>
                                            <li class="form-col-100 autoheight">
                                                ...
                                                <div class="csSelect2WithBg">
                                                    <select class="invoice-fields" style="background-color:#fd7a2a"
                                                        id="select_template">
                                        ...
                                        <?php } else if ($per_job_listing_charge == 1 && $career_site_listings_only == 0 && $listing['active']) { ?>
                                                ...
                                                <?php if ($sponsor_radio == 'yes') { ?>
                                                        ...
                                                        <div class="pre-purchased-products advertising-boxes">
                                                            <p>&nbsp;&nbsp;&nbsp;<b>Product Name: <?= $productDetail['name']; ?></b>
                                                            </p>
                                        ...
                                        <input id="listing_status" type="hidden" name="listing_status"
                                            value="<?php echo $listing['active'] ?>" />
                                            ...
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                ...
                                                <div class="btn-panel">
                                                    ...
                                                    <input type="button" id="cc_sponsor_send"
                                                        value="Confirm payment & Update" class="submit-btn">
                                                </div>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                    <label class="control control--checkbox">
                                                        ...
                                                        <input id="js_sponsor_indeed" type="checkbox" name="sponsor_indeed"
                                                            value="1" <?php echo $listing['indeed_sponsored'] == 1 ? 'checked="checked"' : ''; ?> />
                                                        <div class="control__indicator"></div>
                                                    </label>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 js-sponsor-box"
                                                    <?= $listing['indeed_sponsored'] == 1 ? '' : 'style="display: none;"'; ?>>
                                                    <br />
                                                    <p class="cs-step1-content"
                                                        style="<?= $listing['indeed_sponsored'] == 1 ? 'display: none;' : ''; ?>">
                                                        You can sponsor the job in two simple steps;
                                                    ...
                                                    <div style="border: 1px solid #ccc; padding: 10px;">
                                                        <h3 class="cs-step1-content"
                                                            style="<?= $listing['indeed_sponsored'] == 1 ? 'display: none;' : ''; ?>">
                                                            Sponser job with Indeed <span class="pull-right"><button

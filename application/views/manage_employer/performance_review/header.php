...
<?php if ($this->session->userdata('logged_in')) { // only show the clocked in status bar if logged in
    ...
    if(in_array($company_sid, array())) {
        $get_clocked_status = $this->session->userdata('logged_in');
        $clocked_status = $get_clocked_status['clocked_status'];
        $clocked_class = '';
        $on_break = NULL;
        ...
        if (empty($clocked_status)) {
            $clocked_class = 'clockout';
        } else {
            $attendance_type = $clocked_status['attendance_type'];
            $attendance_date = $clocked_status['attendance_date'];
        }
        ...
        if ($attendance_type != NULL) {
            switch ($attendance_type) {
                ...
                case 'break_start':
                    ...
                    $clocked_class = 'attendance_break';
                    break;
                case 'clock_out':
                    $attendance_status = 'Clocked Out';
                    $break_status = NULL;
        ...
        <div class="notification-wrp closed <?php echo $clocked_class; ?>">
            <div class="notifications-btn"><i class="fa fa-clock-o"></i></div>
            <div class="notify-wrp">
                <h3 class="notification-header">Clocked Status</h3>
                <div class="center-block">
                    <div class="status-block-inner">
                        <strong>You Are</strong>
                        <div class="clocked-status"><?php echo $attendance_status; ?></div>
                    </div>
                    <?php if($break_status!=NULL) { ?>
                        <div class="status-block-inner">
                            <strong>Break Status</strong>
                            <div class="clocked-status"><?php echo $break_status; ?></div>
                        </div>
                    <?php } ?>
                    <div class="dashboard-widget-box">
                        <a href="<?php echo base_url('attendance/my_day'); ?>" class="site-btn">Clock Management</a>
                    </div>
                        <!--<div class="clocked-status"><span>Break End:</span> 01:00PM</div>-->
                </div>
            </div>
...
<div id="wrapper">
    <header class="header<?= $class == 'performance_review' ? ' header-position' : ' header-new-fixed'; ?>">
                                                    ...
                                                    <article id="viewcart_<?php echo $value['sid']; ?>">
                                                        ...
                                                        <div class="text">
                                                            ...
                                                            <p style="display: none;"
                                                               id="product_total_<?php echo $value['sid']; ?>"><?php echo $product_total; ?></p>
                                                            <?php /* if($no_of_days==0){ ?>
                                                                        ...
                                                                        <div class="product-detail-area">
                                                                            <table>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="text-align"><p id="checkout_subtotal"><?php echo '$' . $sub_total; ?></p> </td>
                                                                                ...
                                                                                <?php if($has_coupon) { ?>
                                                                                    ...
                                                                                    <tr id="show_coupon_amount">
                                                                                        ...
                                                                                        <td class="text-align"><p id="coupon_amount"> -$<?php echo $coupon_discount; ?></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr id="show_coupon_total">
                                                                                        ...
                                                                                        <td class="text-align"><p id="checkout_total"><?php echo '$' . $final_total; ?></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                <?php } else { ?>
                        ...
                        ?>        
                            ...
                            <ul id="menus">
                                <li class="active"><a href="javascript:void(0)">Quick Links<i class="fa fa-angle-down"></i></a>
                                    <ul>
                                        <li>
                                            <a <?php if (base_url(uri_string()) == site_url('dashboard')) { echo 'class="active_header_nav"'; } ?> href="<?php echo base_url('dashboard'); ?>">
                                                <figure><i class="fa fa-th"></i></figure> Dashboard</a>
                                        </li>
                                        <?php if ($this->session->userdata('logged_in')['company_detail']['ems_status'])  { ?>
                                        <li>
                                            <a <?php if (base_url(uri_string()) == site_url('employee_management_system')) { echo 'class="active_header_nav"'; } ?> href="<?php echo base_url('employee_management_system'); ?>">
                                                <figure><i class="fa fa-th"></i></figure> EMS</a>
                                        </li>
                                        <?php }?>
                                        ...
                                        <?php if(check_access_permissions_for_view($security_details, 'video_interview_system')) { ?> 
                                            <li>
                                                <a <?php if (base_url(uri_string()) == site_url('video_interview_system')) {
                                                    ...
                                                    <figure><i class="fa fa-file-text-o"></i></figure>
                                                    Video Interview System<span class="beta-label">beta</span></a>
                                            </li>
                                        <?php } ?>
                                            ...
                                            <?php if(in_array($company_sid, array())) { ?>
                                                <li>
                                                    <a <?php if (base_url(uri_string()) == site_url('attendance')) {
                                                        ...
                                                        <figure><i class="fa fa-calendar"></i></figure>
                                                        Time & Attendance <span class="beta-label">beta</span></a>
                                                </li>
                                            <?php } ?>
                                        <?php } ?><!--16-->

...
if ($_ssv) {
    ...
    //
    if ($dob != '')
        $dob = DateTime::createFromFormat('m-d-Y', $dob)->format('M d XXXX, D');
} else {
    if ($dob != '')
        $dob = DateTime::createFromFormat('m-d-Y', $dob)->format('M d Y, D');
}
                                        ...
                                        <form id="edit_employer" method="POST" enctype="multipart/form-data">
                                            <div class="form-title-section"><br>
                                                ...
                                                <div class="form-btns">
                                                    ...
                                                    <input type="submit" id="submit_form" value="Submit Form"
                                                        onclick="validate_employers_form();" style="display: none;">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-3 col-md-3 col-xs-12 col-sm-6 form-group">
                                                    ...
                                                    <input type="text" class="invoice-fields" name="first_name"
                                                        id="first_name" value="<?php if (isset($employer['first_name'])) {
                                                ...
                                                <div class="col-lg-3 col-md-3 col-xs-12 col-sm-6 form-group">
                                                    ...
                                                    <input type="text" class="invoice-fields" name="nick_name"
                                                        id="nick_name" value="<?php if (isset($employer['nick_name'])) {
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 form-group">
                                                    <label>Primary number:
                                                        <?php if (get_company_module_status($company_id = $session["company_detail"]["sid"], 'primary_number_required') == 1) { ?><span
                                                                class="staric">*</span><?php } ?></label>
                                                    <?= $input_group_start; ?>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 form-group">
                                                    <label>Gender:</label>
                                                    <select
                                                        class="invoice-fields <?php if (form_error('gender') !== "") { ?> error <?php } ?>"
                                                        name="gender">
                                                        <option value="">Please Select Gender</option>
                                                        <option <?= $employer["gender"] == 'male' ? 'selected' : ''; ?>
                                                            value="male">Male</option>
                                                        <option <?= $employer["gender"] == 'female' ? 'selected' : ''; ?>
                                                            value="female">Female</option>
                                                        <option <?= $employer["gender"] == 'other' ? 'selected' : ''; ?>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 form-group">
                                                    ...
                                                    <label>Job Title: &nbsp;&nbsp;&nbsp;
                                                        <?php if ($templateTitles) { ?>
                                                            <input type="radio" name="title_option" value="dropdown"
                                                                class="titleoption" <?php echo $employer['job_title_type'] != '0' ? 'checked' : '' ?>> Choose Job Title&nbsp;&nbsp;
                                                            <input type="radio" name="title_option" value="manual"
                                                                class="titleoption" <?php echo $employer['job_title_type'] == '0' ? 'checked' : '' ?>> Custom
                                                            Job Title &nbsp;
                                                        <?php } ?>
                                                    </label>
                                                    ...
                                                    <?php if ($templateTitles) { ?>
                                                        <select name="temppate_job_title" id="temppate_job_title"
                                            ...
                                            <div class="row">
                                                    ...
                                                    <?php if (isCompanyOnComplyNet($employer['parent_sid']) != 0) { ?>
                                                        ...
                                                        <div class="hr-fields-wrap">
                                                            <div class="hr-select-dropdown">
                                                                <select name="complynet_job_title" id="complynet_job_title"
                                                                    ...
                                                                    <option <?= $employer["complynet_job_title"] == 'Body Shop Estimator' ? 'selected' : ''; ?>
                                                                        value="Body Shop Estimator">
                                                                        Body Shop Estimator
                                                                    </option>
                                                                    <option <?= $employer["complynet_job_title"] == 'Body Shop Manager' ? 'selected' : ''; ?>
                                                                    ...
                                                                    <option <?= $employer["complynet_job_title"] == 'Detail Manager' ? 'selected' : ''; ?>
                                                                    ...
                                                                    <option <?= $employer["complynet_job_title"] == 'Fixed Operations Director' ? 'selected' : ''; ?>
                                                                        value="Fixed Operations Director">
                                                                        Fixed Operations Director
                                                                    </option>
                                                                    <option <?= $employer["complynet_job_title"] == 'GM' ? 'selected' : ''; ?> value="GM">
                                                                        GM
                                                                    </option>
                                                                    <option <?= $employer["complynet_job_title"] == 'HR Assistant' ? 'selected' : ''; ?>
                                                                        value="HR Assistant">
                                                                        HR Assistant
                                                                    </option>
                                                                    ...
                                                                    <option <?= $employer["complynet_job_title"] == 'Office Employee' ? 'selected' : ''; ?>
                                                                        value="Office Employee">
                                                                        Office Employee
                                                                    </option>
                                                                    <option <?= $employer["complynet_job_title"] == 'Office Manager' ? 'selected' : ''; ?>
                                                                    ...
                                                                    <option <?= $employer["complynet_job_title"] == 'Parts Manager' ? 'selected' : ''; ?>
                                                                        value="Parts Manager">
                                                                        Parts Manager
                                                                    </option>
                                                                    ...
                                                                    <option <?= $employer["complynet_job_title"] == 'Parts Shipper' ? 'selected' : ''; ?>
                                                                        value="Parts Shipper">
                                                                        Parts Shipper
                                                                    </option>
                                                                    ...
                                                                    <option
                                                                        <?= $employer["complynet_job_title"] == 'Receptionist' ? 'selected' : ''; ?> value="Receptionist">
                                                                        Receptionist
                                                                    </option>
                                                                    <option <?= $data["complynet_job_title"] == 'Sales Employee' ? 'selected' : ''; ?>
                                                                        value="Sales Employee">
                                                                        Sales Employee
                                                                    </option>
                                                                    <option <?= $employer["complynet_job_title"] == 'Sales Manager' ? 'selected' : ''; ?>
                                                                        value="Sales Manager">
                                                                        Sales Manager
                                                                    </option>
                                                                    ...
                                                                    <option <?= $employer["complynet_job_title"] == 'Service Advisor' ? 'selected' : ''; ?>
                                                                        value="Service Advisor">
                                                                        Service Advisor
                                                                    </option>
                                                                    <option <?= $data["complynet_job_title"] == 'Service Director' ? 'selected' : ''; ?>
                                                                        value="Service Director">
                                                                        Service Director
                                                                    </option>
                                                                    <option <?= $employer["complynet_job_title"] == 'Service Manager' ? 'selected' : ''; ?>
                                                                        value="Service Manager">
                                                                        Service Manager
                                                                    </option>
                                                                    <option <?= $employer["complynet_job_title"] == 'Service Office' ? 'selected' : ''; ?>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 form-group">
                                                    ...
                                                    <select class="invoice-fields" name="payment_method">
                                                        <option <?= $employer["payment_method"] == 'direct_deposit' ? 'selected' : ''; ?> value="direct_deposit">Direct Deposit
                                                        </option>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 form-group">
                                                    ...
                                                    <p style="display: none;" id="state_id">
                                                        <?php echo $employer['Location_State']; ?>
                                                    </p>
                                                    <div class="hr-select-dropdown">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 form-group">
                                                    <label>Social Security Number:
                                                        <?= $ssn_required == 1 ? ' <samp class="red"> * </samp>' : ''; ?></label>
                                                    <input class="invoice-fields" type="text" name="SSN"
                                                        <?= $ssn_required == 1 ? 'required' : ''; ?>
                                                        value="<?php echo isset($employer["ssn"]) ? _secret($employer["ssn"], false, true) : ''; ?>">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 form-group">
                                                    ...
                                                    <input class="invoice-fields" id="date_of_birth" readonly=""
                                                        type="text" <?= $dob_required == 1 ? 'required' : ''; ?> name="DOB"
                                                        value="<?php echo $dob != '' ?
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 form-group">
                                                    ...
                                                    ?>
                                                    <input class="invoice-fields js-rehireDate" id="js-rehire-date"
                                                        readonly="" type="text" name="rehireDate"
                                                        value="<?php echo $rehireDate; ?>">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 form-group">
                                                    ...
                                                    ?>
                                                    <input class="invoice-fields js-employmentDate"
                                                        id="js-employment-date" readonly="" type="text"
                                                        name="employment_date" value="<?php echo $employmentDate; ?>">
                                            ...
                                            <div class="row">
                                                ...
                                                <?php if (isPayrollOrPlus(true)) { ?>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 form-group">
                                                        ...
                                                        <input class="invoice-fields"
                                                            value="<?php echo set_value('workers_compensation_code', isset($employer["workers_compensation_code"]) ? $employer["workers_compensation_code"] : ''); ?>"
                                            ...
                                            <?php if (isPayrollOrPlus(true)) { ?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 form-group">
                                                        ...
                                                        <input class="invoice-fields"
                                                            value="<?php echo set_value('eeoc_code', isset($employer["eeoc_code"]) ? $employer["eeoc_code"] : ''); ?>"
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 form-group">
                                                        ...
                                                        <input class="invoice-fields" name="salary_benefits"
                                                            id="salary_benefits"
                                                            value="<?php echo set_value('salary_benefits', isset($employer["salary_benefits"]) ? $employer["salary_benefits"] : ''); ?>" />
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <label class="control control--checkbox">
                                                        <input type="checkbox" name="secondaryLanguages[]"
                                                            value="english" <?= strpos($employer['languages_speak'], 'english') !== false ? 'checked' : ''; ?> /> English
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <label class="control control--checkbox">
                                                        <input type="checkbox" name="secondaryLanguages[]"
                                                            value="spanish" <?= strpos($employer['languages_speak'], 'spanish') !== false ? 'checked' : ''; ?> /> Spanish
                                                        <div class="control__indicator"></div>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <label class="control control--checkbox">
                                                        <input type="checkbox" name="secondaryLanguages[]"
                                                            value="russian" <?= strpos($employer['languages_speak'], 'russian') !== false ? 'checked' : ''; ?> /> Russian
                                                        <div class="control__indicator"></div>
                                                    </label>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-lg-1 col-md-1 col-xs-12 col-sm-1">
                                                        <label class="control control--radio "
                                                            style="margin-left: -10px;">Yes <input type="radio"
                                                                name="union_member" class="unionmember" value="1" <?php echo $employer['union_member'] ? 'checked' : '' ?>>
                                                            <div class="control__indicator"></div>
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-1 col-md-1 col-xs-12 col-sm-1">
                                                        <label class="control control--radio "
                                                            style="margin-left: -20px;">No <input type="radio"
                                                                name="union_member" value="0" class="unionmember" <?php echo $employer['union_member'] ? '' : 'checked' ?>>
                                                            <div class="control__indicator"></div>
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="row jsunionname">
                                                        <div class="col-sm-12">
                                                            <input type="text" class="invoice-fields" name="union_name"
                                                                placeholder="Union Name"
                                                                value="<?php echo $employer['union_name']; ?>" />
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <script>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 form-group">
                                                    ...
                                                    <input class="invoice-fields"
                                                        value="<?php echo set_value('uniform_top_size', isset($employer["uniform_top_size"]) ? $employer["uniform_top_size"] : ''); ?>"
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 form-group">
                                                    ...
                                                    <input class="invoice-fields" name="uniform_bottom_size"
                                                        ...
                                                        value="<?php echo set_value('uniform_bottom_size', isset($employer["uniform_bottom_size"]) ? $employer["uniform_bottom_size"] : ''); ?>" />
                                            ...
                                            <div class="row">
                                                ...
                                                <?php if (IS_NOTIFICATION_ENABLED == 1 && $phone_sid != '') { ?>
                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 form-group">
                                                        ...
                                                        <div class="hr-select-dropdown">
                                                            <select class="invoice-fields" name="notified_by[]"
                                                                id="notified_by" multiple="true">
                                                        ...
                                                        <select name="policies[]" id="js-policies" multiple="true">
                                                            ...
                                                            if (!empty($policies)) {
                                                                foreach ($policies as $key => $policy) {
                                                                    ?>
                                                                    <option <?php if ($policy['Implements'])
                                                                        echo 'selected="true"'; ?> value="<?= $policy['PolicyId']; ?>">
                                                                        <?php
                                            ...
                                            <div class="row">
                                                <div
                                                    class="col-lg-12 col-md-12 col-xs-12 col-sm-12 auto-height form-group">
                                            ...
                                            <div class="row">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <label
                                                                                ...
                                                                                <input type="radio" name="video_source"
                                                                                    class="video_source"
                                                                                    value="uploaded" <?php echo !empty($employer['YouTubeVideo']) && $employer['YouTubeVideo'] != NULL && $employer['video_type'] == 'uploaded' ? 'checked="checked"' : ''; ?>>
                                                                                <div class="control__indicator"></div>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="form-title-section">
                                                    <div class="form-btns">
                                                        ...
                                                        <input type="button" value="Save" id="add_edit_submit"
                                                            onclick="submitResult();">
                                                        <input type="button" value="cancel" class="view_button"
                                                            style="background-color: #d9534f;margin-right: 20px;">
                                                    </div>
                                                </div>
                                            </div>
                                        </form>

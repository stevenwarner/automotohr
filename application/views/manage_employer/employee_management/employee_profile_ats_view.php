                                        ...
                                        <form id="edit_employer" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 form-group">
                                                    ...
                                                    ?>
                                                    <input class="invoice-fields js-employmentDate" id="js-employment-date" readonly="" type="text" name="employment_date" value="<?php echo $employmentDate; ?>">
...
<script language="JavaScript" type="text/javascript">
    ...
    function submitResult() {
       ...
       if ($('#country').val() == 38) {
            zipcodeErrorMessage = 'Alpha Numeric values only';
            zipcodepattren = /^[a-zA-Z0-9\-,' ]+$/;
        }
        else {
            zipcodeErrorMessage = 'Numeric values only';
            zipcodepattren = /^[0-9\-]+$/;         
        }

                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2 col-md-2 col-xs-12 col-sm-2 form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-lg " placeholder="0.0" value="<?php echo $jobTitleData['normal_rate'] ?>" name="normal_rate">
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-xs-12 col-sm-2 form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control input-lg jsEmployeeFlowAmount" placeholder="0.0" value="<?php echo $jobTitleData['overtime_rate']; ?>" name="overtime_rate">
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-xs-12 col-sm-2 form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control input-lg jsEmployeeFlowAmount" placeholder="0.0" value="<?php echo $jobTitleData['double_overtime_rate']; ?>" name="double_overtime_rate">
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-xs-12 col-sm-2 form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control input-lg jsEmployeeFlowAmount" placeholder="0.0" value="<?php echo $jobTitleData['holiday_rate']; ?>" name="holiday_rate">
                                                            </div>

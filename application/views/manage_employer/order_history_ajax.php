                ...
                <div class="dashboard-conetnt-wrp">
                    <div class="page-header-area">
                        <span
                            ...
                            <a href="<?php echo base_url('my_settings'); ?>" class="dashboard-link-btn"><i
                                    class="fa fa-chevron-left"></i>Back to Settings</a>
                            <?php echo $title; ?>
                        </span>
                    </div>
                    <!--  -->
                                        ...
                                        <form id="form-filters" method="post" enctype="multipart/form-data" action="">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="startdate" class="invoice-fields"
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="enddate" class="invoice-fields"
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <select id="customer_name" class="invoice-fields"
                                                        name="customer_name">
                                                        <option <?= $customer == 'all' ? 'selected="true"' : ''; ?>
                                                            value="all">All</option>
                                                        <?php if (sizeof($employees)) { ?>
                                                            <?php foreach ($employees as $k0 => $v0) { ?>
                                                                <option <?= $customer == $v0['sid'] ? 'selected="true"' : ''; ?>
                                                                    value="<?= $v0['sid']; ?>">
                                                                    <?= $v0['sid'] == $employer_sid ? 'You' : remakeEmployeeName($v0); ?>
                                                                </option>
                                                            <?php }
                                                        } ?>
                                                    </select>
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="invoice" class="invoice-fields"
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="hr-select-dropdown ">
                                                        <select class="chosen-select js-payment-method"
                                                            name="payment_method" id="payment_method">
                                                            <option <?= $payment_method == 'any' ? 'selected="true"' : ''; ?> value="any">Any Payment Method</option>
                                                            <option <?= $payment_method == 'background_check_refund' ? 'selected="true"' : ''; ?>
                                                                value="background_check_refund">Background Check Refund
                                                            </option>
                                                            <option <?= $payment_method == 'Free_checkout' ? 'selected="true"' : ''; ?> value="Free_checkout">Free
                                                                Checkout</option>
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    <label>Status</label>
                                                    <div class="hr-select-dropdown">
                                                        <select class="chosen-select js-status" name="status"
                                                            id="status">
                                                            <option <?= $status == 'all' ? 'selected="true"' : ''; ?>
                                                                value="all">All</option>
                                                            <option <?= $status == 'Paid' ? 'selected="true"' : ''; ?>
                                                                value="Paid">Paid</option>
                                                            <option <?= $status == 'UnPaid' ? 'selected="true"' : ''; ?>
                                                                value="UnPaid">UnPaid</option>
                                                            <option <?= $status == 'Pending' ? 'selected="true"' : ''; ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                            <button class="btn btn-success btn-block"
                                                                id="btn_apply_filters">Filter</button>
                                                        </div>
                                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                            <a class="btn btn-success btn-block"
                                                                href="javascript:redirect()">Clear</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="8" class="text-center">
                                                <span class="no-data js-msg-row">Please wait, while we are fetching
                                                    records...</span>
                                            </td>
                                        </tr>
                                    </tfoot>

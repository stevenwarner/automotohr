                                ...
                                <ul>
                                    <form id="add_emergency_contacts" action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <li class="form-col-50-right">
                                            ...
                                            <input type="text" class="invoice-fields" name="last_name" id="last_name" value="<?php
                                        ...
                                        <li class="form-col-50-left">
                                            <label>E-Mail:</label>
                                            <input type="email" class="invoice-fields" name="email" id="email" value="<?php
                                        ...
                                        <li class="form-col-50-right">
                                            ...
                                            <?=$input_group_start;?>
                                            <input id="PhoneNumber" class="invoice-fields startdate js-phone" name="PhoneNumber" type="text" value="<?php echo set_value('PhoneNumber'); ?>">
                                            <?=$input_group_end;?>
                                            ...
                                            <div class="hr-select-dropdown">								
                                                <select class="invoice-fields" id="country" name="Location_Country" onchange="getStates(this.value, <?php echo $states; ?>)">
                                                    ...
                                                    <?php foreach ($active_countries as $active_country) { ?>
                                                        ...
                                                        <?php
                                                        if (isset($formpost['Location_Country']) && $active_country['sid'] == $formpost['Location_Country']) {
                                                            echo "selected";
                                                        }
                                                        ?>>
                                        ...
                                        <p style="display: none;" id="state_id"><?php echo set_value('Location_State'); ?></p>
                                        <li class="form-col-50-right">
                                            <label>State:</label>  
                                            <div class="hr-select-dropdown">								
                                        ...
                                        <li class="form-col-50-left">
                                            <label>City:</label>  
                                            <input type="city" class="invoice-fields" name="city" id="city" value="<?php
                                            if (isset($formpost['Location_City'])) {
                                        ...
                                        <li class="form-col-50-right">
                                            <label>ZipCode:</label>
                                            <input class="invoice-fields startdate" name="Location_ZipCode" type="text" value="<?php echo set_value('Location_ZipCode'); ?>">        
                                            <?php echo form_error('Location_ZipCode'); ?>
                                        </li>
                                        <li class="form-col-100">
                                            <label>Address:</label>
                                            <input type="text" class="invoice-fields" name="Location_Address" id="Location_Address" value="<?php echo set_value('Location_Address'); ?>">
                                            <?php echo form_error('Location_Address'); ?>
                                        </li>
                                        <li class="form-col-50-left">
                                            <label>Relationship:<span class="staric">*</span></label>
                                            <input class="invoice-fields startdate" name="Relationship" type="text" value="<?php echo set_value('Relationship'); ?>">        
                                        ...
                                        <li class="form-col-100 autoheight">
                                            ...
                                            <?php if ($this->uri->segment(2) != null && $this->uri->segment(3) != null) { ?>
                                                <input type="button" value="Cancel" class="submit-btn btn-cancel" onClick="document.location.href = '<?php echo base_url('emergency_contacts') . '/' . $this->uri->segment(2) . '/' . $this->uri->segment(3) . '/' . $this->uri->segment(4); ?>'" />
                                            <?php } else { ?>
                                                <input type="button" value="Cancel" class="submit-btn btn-cancel" onClick="document.location.href = '<?php echo base_url('emergency_contacts'); ?>'" />
                                            <?php } ?>
                                        </li>
                                    </form>
                                </ul>

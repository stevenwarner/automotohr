                        ...
                        <div class="multistep-progress-form">
                            <div class="universal-form-style-v2">
                                <form
                                    ...
                                    action="<?php echo base_url('video_interview_system/add') . ((isset($template_sid)) ? '/'.$template_sid : ''); ?>">
                                            ...
                                            <ul>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-2 col-md-2 col-xs-6 col-sm-4">
                                                                <label class="control control--radio">
                                                                    <input type="radio" name="question_type" value="text" checked="checked">
                                                                    Text
                                                            ...
                                                            <div class="col-lg-2 col-md-2 col-xs-6 col-sm-4">
                                                                <label class="control control--radio">
                                                                    <input type="radio" name="question_type" value="video">
                                                                    Video
                                                                    <div class="control__indicator"></div>
                                                                </label>
                                                            </div>
                                                ...
                                                <li class="form-col-100 autoheight" id="text_div">
                                                    <div class="description-editor">
                                                        ...
                                                        <textarea class="invoice-fields-textarea" name="question_text" id="question_text" cols="60" rows="10">
                                                            <?php echo set_value('question_text'); ?>
                                                        </textarea>
                                                ...
                                                <li class="form-col-100 autoheight" id="video_div">
                                                    <div class="description-editor">
                                                        ...
                                                        <input type="text" class="invoice-fields" name="video_title" id="video_title" value="<?php echo set_value('video_title'); ?>"/>
                                    ...
                                    <div class="dash-box text-center">
                                        <input type="submit" value="Save Question" class="btn btn-lg btn-success" id="add_question_submit" name="add_question_submit">
                                    </div>
                                </form>
                            </div>
                        </div>
...
<script>
    ...
    $('#add_question_submit').click(function () { 
        var ques_text = ($('#question_text').val()).trim();
        $('#question_text').val(ques_text);

                ...
                <div class="col-lg-9 col-md-9 col-xs-12 col-sm-8">
                    <div class="right-content">
                        ...
                        <div class="cs-prpage" style="margin-top: 0;">
                            ...
                            <div class="js-template-step" data-step="0" style="margin-top: 50px;">
                                <div class="row">
                                    <div class="col-sm-4 col-sm-offset-4">
                                        <button class="btn btn-success btn-block js-add-new-review">
                                            ADD A NEW REVIEW
                                        </button>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div>
                                            <h3 class="text-center">Choose from a template <span class="pull-right">
                                                </span></h3>
                                            <hr />
                                            <ul class="list-group list-group-horizontal">
                                                <?php foreach ($templates as $template) {
                                                    ?>
                                                <li class="list-group-item cs-list-group-item js-list-group-item"
                        ...
                        <!-- Step 1  -->
                        <div class="js-template-step cs-hider" data-step="1">
                            <form id="js-template-add-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" id="js-template-start-date"
                                            readonly="true" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div>
                                        ...
                                        <input type="button" class="btn btn-default js-back-btn-step1" value="Back" />
                                    </div>
                                </div>
                            ...
                            <form id="js-edit-question-submit">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="button" value="Cancel"
                                        class="btn btn-default js-edit-question-cancel" />
                                </div>
                            </form>
                        </div>
...
<?php $this->load->view('manage_employer/PerformanceReview/review/scripts/create'); ?>
<?php if(!count($templates)){ ?>
<script>
    loadStep(1);
</script>

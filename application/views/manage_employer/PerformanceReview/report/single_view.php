                    ...
                    <div class="right-content">
                        ...
                        <div class="cs-prpage">
                            ...
                            <div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <a class="btn btn-default" href="<?= base_url("performance/template/view"); ?>"> Cancel</a>
                                    </div>
                                </div>
                                <hr />
                                <?php $answers = []; ?>
                                <?php foreach ($template['questions'] as $k => $question) { ?>
                                    <div class="row">
                                        <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <a href="<?= base_url("performance/template/view"); ?>" class="btn btn-default"> Cancel</a>
                                    </div>
                                </div>
                            </div>
                            <div class="clearfix"></div>

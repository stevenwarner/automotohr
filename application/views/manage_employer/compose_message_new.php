                                  ...
                                  <ul>
                                      ...
                                      <?php } else { ?>
                                          ...
                                          <?php if (strtolower($this->session->userdata("logged_in")["employer_detail"]["access_level"]) != "employee") { ?>
                                              ...
                                              <li class="form-col-100 autoheight">
                                                  <div class="row">
                                                      <div class="col-md-3"><b>Email Template </b></div>
                                                      <div class="col-md-9">
                                ...
                                <!-- ***************************** -->
                                      <li class="form-col-100 autoheight">
                                          <div class="row">
                                              ...
                                              <div class="col-md-9">
                                                  <?php
                                                    echo form_input('subject', set_value('subject'), 'class="hr-form-fileds invoice-fields" id="email_subject"');
                                      ...
                                      <li class="form-col-100 autoheight">
                                          <div class="row">
                                              <div class="col-md-3"><b>Additional Attachments</b></div>
                                              <div class="col-md-9">
  ...
  <?php } else {
        $this->load->view('manage_employer/compose_message_ems');
    } ?>
                    ...
                    <div class="btn-panel text-right">
                        <div class="row">
                            ...
                            <?php if ($archive == 'archive') { ?>
                                <a href="<?= base_url('application_tracking_system/active/all/all/all/all') ?>" class="btn btn-success">Show Active Applicants</a>
                            <?php } else { ?>
                                <a href="<?= base_url('application_tracking_system/archive/all/all/all/all') ?>" class="btn btn-warning">Show Archived Applicants</a>
                            <?php } ?>
                        ...
                        <?php } else { ?>
                            <form method="POST" name="ej_form" id="ej_form">
                                <?php foreach ($employer_jobs as $employer_job) { ?>
                                    <article id="manual_row<?php echo $employer_job["sid"]; ?>" class="applicant-box">
                                        <div class="box-head">
                                        ...
                                        <div class="applicant-info">
                                            <figure><a href="<?php echo base_url('/applicant_profile/' . $employer_job["applicant_sid"]); ?>" title="<?php echo $employer_job["first_name"] . ' ' . $employer_job["last_name"]; ?>">
                                            ...
                                            <div class="text">
                                                <p>
                                                    <a href="<?php echo base_url('/applicant_profile/' . $employer_job["applicant_sid"]); ?>" title="<?php echo $employer_job["first_name"] . ' ' . $employer_job["last_name"]; ?>">
                                                        <?php echo $employer_job["first_name"] . ' ' . $employer_job["last_name"]; ?>
                                                    </a>
                                                </p>
                                                <div class="phone-number">
                                                    <?php
                                                    if (isset($employer_job['phone_number']) && $employer_job['phone_number'] != '') {
                                        ...
                                        <?php } ?>
                                            ...
                                            $(document).ready(function () {
                                                ...
                                                $('#jobs_list, #status').on('change', function () {
                                                    ...
                                                    var myUrl = "<?php echo base_url('application_tracking_system') . '/' . $archive; ?>" + "/all/" + js_job_id + "/" + status;
                                                ...
                                                $('#keyword').on('keyup', function () {
                                                    ...
                                                    var myurl = '<?php echo base_url("application_tracking_system") . '/' . $archive; ?>' + '/' + keyword + '/all/all/';

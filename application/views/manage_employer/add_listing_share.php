                                            ...
                                            <div class = "produt-block">
                                                <div class = "social-media-tagline">
                                                    <h4>
                                                        ...
                                                        Send an e-mail to co-workers to see if they know a candidate for this Job.</h4>
                                                </div>
                                                                ...
                                                                <div class="">
                                                                    <select data-placeholder="Please Select" multiple="multiple" name="employees[]" id="employees"  class="chosen-select">
                                                                        <?php foreach ($active_users as $user) { ?>
                                                                            <option value="<?php echo $user['sid']; ?>" ><?php echo ucwords($user['first_name'] . ' ' . $user['last_name']); ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                                </div>

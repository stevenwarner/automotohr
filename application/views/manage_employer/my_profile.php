                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                            ...
                            <div class="job-title-text">                
                                <p>Enter your personal information. Fields marked with an asterisk (<span>*</span>) are mandatory.</p>
                        ...
                        <div class="dashboard-conetnt-wrp">
                            ...
                            <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12">
                                ...
                                <div class="profile-iamge">
                                    ...
                                    <?php } else { ?>
                                        <img src="<?php echo AWS_S3_BUCKET_URL; ?>default_pic-ySWxT.jpg" class="image-logo"> 
                                    <?php } ?>
                                </div>

                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                                    <div class="form-group autoheight">
                                                                        <label class="control control--radio">
                                                                            Enable
                                                                            <input type="radio" value="1" name="template-status" <?php if(isset($job_fair_data['template_status']) && $job_fair_data['template_status'] == 1){ echo 'checked'; } ?>>
                                                                            <div class="control__indicator"></div>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                                                                ...
                                                                <div class="hr-select-dropdown">
                                                                    <select class="form-control" name="template-id" id="template-id" <?php if(isset($job_fair_data['template_status']) && $job_fair_data['template_status'] == 0){ echo 'disabled="disabled"'; } ?>>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-1 col-md-2 col-xs-12 col-sm-2">
                                                <div class="form-group autoheight checkbox-valign-center">
                                                    <label class="control control--checkbox">
                                                        Enable
                                                        <input value="1" name="<?php echo $field['field_id'].'-display_status';?>" type="checkbox" <?php if($field['field_display_status'] == 1) {echo "checked='checked'";} ?>>
                                                        <div class="control__indicator"></div>
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2 col-md-3 col-xs-12 col-sm-3">
                                                <div class="form-group autoheight checkbox-valign-center">
                                                    <label class="control control--checkbox">
                                                        Is Required
                                                        <input id="is_required" value="1" name="<?php echo $field['field_id'].'-is_required';?>" type="checkbox" <?php if($field['is_required'] == 1) {echo "checked='checked'";} ?>>
                                                        <div class="control__indicator"></div>
                                                    </label>
                                                </div>
                                            </div>

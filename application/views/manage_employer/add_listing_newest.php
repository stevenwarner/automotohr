            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9 col-xs-12 col-sm-8">
                    ...
                    <?php               } ?>
                                    ...
                                    <style>.progressbar li{ width: 33.33%; }</style>
                                    <fieldset id="create_div">
                                        ...
                                        <div class="universal-form-style-v2">
                                            <ul>
                                                ...
                                                <?php               if (set_value('Location_Country') == $active_country["sid"]) { echo 'selected'; } ?>>
                                    ...
                                    <?php       if($per_job_listing_charge == 0 && $career_site_listings_only == 0) { ?>
                                                    <li class="form-col-100 autoheight">
                                                        <label class="control control--checkbox">Advertise This Job With The Major Job Aggregators <!--:<a class="major-jobs" rel="popover" data-img="">Major job Aggregators</a>-->
...
//                }
        ...
        if ($('#employers_add_job').valid()) {
            //alert('form is valid - not submitted');
            $('#create_div').hide();
            $('#details_div').fadeIn("slow");
            $('#create_nav').removeClass('active');
            $('#details_nav').addClass('active');
        } else {
    ...
    $('#cc_confirm_send').on('click', function() {
        ...
        if(!invalid_card && !is_error) {
            $('#cc_confirm_send').prop('disabled', true);
            $('#cc_confirm_send').addClass("disabled-btn");
...
<script type="text/javascript">
    ...
    $('.js-indeed-package-btn').click(function(){
        ...
        var days = $('.js-indeed-package:checked').data('per-day') === undefined ? 0 : $('.js-indeed-package:checked').data('per-day');
        $('.js-indeed-package-skip-btn').after('<input type="hidden" id="js-indeed-package-days" name="indeedPackageDays" value="'+( days )+'"/>');
        // Hide Step 1

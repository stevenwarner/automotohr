            ...
            <div class="col-lg-9 col-md-9 col-xs-12 col-sm-12">
                ...
                <div id="form_div">
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        ...
                        <div class="form-wrp">
                            <form type="post" id="onboarding_help" action="" enctype="multipart/form-data" autocomplete="off">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                        <div class="form-group autoheight">
                                            ...
                                            <input type="text" name="helpboxphonenumber" class="form-control" value="<?php echo !empty($contact_info[0]['box_support_phone_number']) ? $contact_info[0]['box_support_phone_number'] : ''; ?>">
                                            <span class="js-error"></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                        <div class="form-group autoheight">
                                            ...
                                            <input type="text" name="helpboxemail" class="form-control" value="<?php echo !empty($contact_info[0]['box_support_email']) ? $contact_info[0]['box_support_email'] : ''; ?>">
                                            <span class="js-error"></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                        <div class="form-group autoheight">
                                            <label>Button Text</label> <span class="staric">*</span>
                                            <input type="text" name="helpButtonText" class="form-control" value="<?php echo !empty($contact_info[0]['button_text']) ? $contact_info[0]['button_text'] : ''; ?>">
                                            <span class="js-error"></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        <input type="hidden" name="txtId" value="<?php echo isset($companyBlockData['sid']) ? $companyBlockData['sid'] : 0; ?>" />
                                        <button type="submit" class="btn btn-success js_submit_button"><?php echo !empty($companyBlockData) ? "Update" : "Save"; ?></button>
                                    </div>
...
<script>
    ...
    function validate_form(e) {
        ...
        var helpButtonText = $(this).find('input[name="helpButtonText"]');
        ...
        megaOBJ.helpButtonText = helpButtonText.val();
        formSubmit(megaOBJ);
    }

                                                            ...
                                                            <td class="text-center <?php echo $doNotHireWarning['row']; ?>">
                                                                ...
                                                                <?php if ($session['employer_detail']['access_level_plus'] && $employee['is_executive_admin'] == 0) { ?>
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <button class="btn csBG2 jsAddEmployeeToComplyNet" title="Add Employee To ComplyNet" placement="top" data-cid="<?= $employee['parent_sid']; ?>" data-id="<?= $employee['sid']; ?>" data-complynetjobtitle="<?= $employee['complynet_job_title']; ?>">

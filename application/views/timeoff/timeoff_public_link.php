                    ...
                    <div class="csSidebar csRadius5">
                        ...
                        <div class="csSidebarHead csRadius5 csRadiusBL0 csRadiusBR0" style="height: 118px">
                            <div id="jsEmployeeInfoEdit">
                                <figure>
                                    <img src="<?= getImageURL($request['profile_picture']); ?>" class="csRadius50" alt="" />
                                    <div class="csTextBox">
                            ...
                            <div id="jsApproversListingEdit" class="p10">
                                <?php if (!empty($approvers)) { ?>
                                    <?php foreach ($approvers as $approver) { ?>
                                        <div class="csApproverBox" title="" data-content="<?php echo $approver['first_name'] . ' ' . $approver['last_name'] . '' . '(' . $approver['job_title'] . ') [' . $approver['access_level'] . ']'; ?>" data-original-title="Approver">
                                            <img src="https://automotohrattachments.s3.amazonaws.com/<?php echo !empty($approver['profile_picture']) ? $approver['profile_picture'] : 'img-applicant.jpg'; ?>" alt="" />
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <div class="upcoming-time-info">
                                        <div class="text">
                                            ...
                                            <span><?= $request['title']; ?> (<strong class="text-<?=$request['category_type'] == 1 ? 'success' : 'danger';?>"><?=$request['category_type'] == 1 ? 'Paid' : 'Unpaid';?></strong>)</span><br />
                            ...
                            <div class="panel-body">
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?= $policy['Title']; ?> (<strong class="text-<?=$policy['CategoryType'] == 1 ? 'success' : 'danger';?>"><?=$policy['CategoryType'] == 1 ? 'Paid' : 'Unpaid';?></strong>)</td>
                                    ...
                                    <?php } else { ?>
                                        <form action="" method="POST">
                                            ...
                                            <?php if ($request['status'] == 'rejected' ||  $request_status == 'approved') { ?>
                                                <button style="margin-top: 10px" type="submit" class="btn btn-orange form-control jsRequestBtn"><i class="fa fa-clock-o" aria-hidden="true"></i>&nbsp;Approve Time Off</button>
                                            <?php } else if ($request['status'] == 'approved' ||  $request_status == 'rejected') { ?>
                                                <button style="margin-top: 10px" type="submit" class="btn alert-danger btn-theme form-control jsRequestBtn"><i class="fa fa-times-circle-o" aria-hidden="true"></i>&nbsp;Reject Time Off</button>
                                            <?php } else if ($request['status'] == 'pending') { ?>
                                                <button style="margin-top: 10px" type="submit" class="btn alert-danger btn-theme form-control jsRequestBtn"><i class="fa fa-times-circle-o" aria-hidden="true"></i>&nbsp;Cancel Time Off</button>
                                            <?php } ?>
                                        </form>
                                    <?php } ?>
                                </div>

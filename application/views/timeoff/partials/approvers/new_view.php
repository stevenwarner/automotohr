...
<div class="js-page " id="js-page-view" <?=$page != 'view' ? 'style="display: none;"' : '';?>>
    ...
    <div class="csPageBody">
        ...
        <div class="csBalanceBox csShadow csRadius5 jsFilterBoxHolidays dn">
            <div class="col-sm-3">
                <label>Types</label>
                <select class="invoice-fields csRadius100" id="js-filter-types"></select>
            </div>
            <div class="col-sm-3">
            ...
            <div class="col-sm-3">
                ...
                <select id="js-filter-departments" multiple="true"></select>
            </div>
            <div class="col-sm-3">
                <label>Teams</label>
                <select id="js-filter-teams" multiple="true"></select>
            </div>

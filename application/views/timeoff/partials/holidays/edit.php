        ...
        <div class="row margin-top">
            ...
            <div class="col-sm-12">
                <label class="control control--radio">
                    <input type="radio" name="allow_work_on_holiday-edit" class="allow_work_on_holiday-edit" value="0">No&nbsp;
                    <div class="control__indicator"></div>
                </label>
                <label class="control control--radio">
                    <input type="radio" name="allow_work_on_holiday-edit" class="allow_work_on_holiday-edit" value="1"
                        checked="true">Yes
                    <div class="control__indicator"></div>
                </label>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="bottom-section-pto">
                    ...
                    <button id="js-save-edit-btn" type="button" class="btn btn-success ml0">Update</button>
                </div>
            </div>
        </div>
    </div>

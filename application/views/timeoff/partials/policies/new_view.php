...
<div class="js-page p10" id="js-page-view" <?=$page != 'view' ? 'style="display: none;"' : '';?>>
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <span class="pull-right">
                    <a id="js-add-policy-btn"href="javascript:void(0)" class="btn btn-orange">
                        <span><i class="fa fa-plus-circle"></i></span>&nbsp; ADD A POLICY
                    </a>
                </span>
            </div>
        </div>
    ...
    <div class="csPageNav">
        <div class="row">
            <div class="col-sm-12">
                <span class="pull-right">
                    <button class="btn btn-success btn-theme jsFilterBtn" data-target="jsFilterBoxPolicies">
    ...
    <div class="csPageBody">
        <!-- Filter -->
        <div class="csBalanceBox csShadow csRadius5 jsFilterBoxPolicies dn">
            <div class="col-sm-3">
                <label>Policy</label>

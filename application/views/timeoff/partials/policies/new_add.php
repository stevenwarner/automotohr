                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <label class="control control--radio">
                                                    Hours &nbsp;&nbsp;
                                                    <input type="radio" name="js-minimum-applicable-time-add" class="js-employee-minimum-applicable-time-add" checked="true" value="hours" />
                                                    <div class="control__indicator"></div>
                                                </label>
                                                <label class="control control--radio">
                                                    Days &nbsp;&nbsp;
                                                    <input type="radio" name="js-minimum-applicable-time-add" class="js-employee-minimum-applicable-time-add" value="days" />
                                                    <div class="control__indicator"></div>
                                                </label>
                                                <label class="control control--radio">
                                                    Months &nbsp;&nbsp;
                                                    <input type="radio" name="js-minimum-applicable-time-add" class="js-employee-minimum-applicable-time-add" value="months" />
                                                    <div class="control__indicator"></div>
                                                </label>
                                                <label class="control control--radio">
                                                    Years &nbsp;&nbsp;
                                                    <input type="radio" name="js-minimum-applicable-time-add" class="js-employee-minimum-applicable-time-add" value="years" />
                                                    <div class="control__indicator"></div>
                                                </label>
                                            </div>
                                            <div style="margin-top: 5px;">
                                                <input class="invoice-fields" name="template" id="js-employee-minimum-applicable-hours-add" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="js-step" data-type="add" data-step="10">
                        ...
                        <div class="row mb10 csRow" id="js-policy-categories-add">
                            <div class="col-md-12 offset-md-3">
                                ...
                                <div class="col-md-12 offset-md-3">
                                    <div class="row mb10 csRow">
                                        <div class="col-sm-6">
                                            ...
                                            <div>
                                                <h5 class="timeline-title allowed-time-off-title-custom">
                                                    <input type="hidden" name="recordsid" class="js-employe-accural-setting-sid" value="" />
                                                ...
                                                <div>
                                                    <label class="control control--radio">
                                                        Hours &nbsp;&nbsp;
                                                        <input type="radio" name="js-minimum-applicable-time-add" class="js-employee-minimum-applicable-time-update" checked="true" value="hours" />
                                                        <div class="control__indicator"></div>
                                                    </label>
                                                    <label class="control control--radio">
                                                        Days &nbsp;&nbsp;
                                                        <input type="radio" name="js-minimum-applicable-time-add" class="js-employee-minimum-applicable-time-update" value="days" />
                                                        <div class="control__indicator"></div>
                                                    </label>
                                                    <label class="control control--radio">
                                                        Months &nbsp;&nbsp;
                                                        <input type="radio" name="js-minimum-applicable-time-add" class="js-employee-minimum-applicable-time-update" value="months" />
                                                        <div class="control__indicator"></div>
                                                    </label>
                                                    <label class="control control--radio">
                                                        Years &nbsp;&nbsp;
                                                        <input type="radio" name="js-minimum-applicable-time-add" class="js-employee-minimum-applicable-time-update" value="years" />
                                                        <div class="control__indicator"></div>
                                                    </label>
                                                </div>
                                                <div style="margin-top: 5px;">
                                                    <input class="invoice-fields" name="template" id="js-employee-minimum-applicable-hours-update" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="js-step-buttons" data-type="add" data-step="10">
                                        <hr />
                                        <button class="btn btn-black btn-theme js-cancel-employee-settings">Cancel</button>
                                        <button class="btn btn-orange js-employee-accrual-update">Update</button>
                                    </div>
                                </div>

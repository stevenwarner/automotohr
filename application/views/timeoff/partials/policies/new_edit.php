<div class="js-page p10" id="js-page-edit" style="display: none;">
    ...
    <div class="csPageHeader <?php echo $this->agent->is_mobile() ? 'csMobileWrap' : ''; ?>">
        <div class="row">
            <div class="col-sm-6">
                <h4>
                    Edit Policy <strong id="jsPolicyTitleEdit"></strong>
                </h4>
            </div>
            <div class="col-sm-6">
    ...
    <div class="csPageBody">
        <div class="row">
            <!-- Sidebar -->
            <div class="col-sm-2">
                <?php $this->load->view('timeoff/partials/new_steps', ['stepType' => 'edit']); ?>
            </div>
                    ...
                    <div id="jsEditPage">
                        ...
                        <div class="js-step" data-type="edit" data-step="1">
                            ...
                            <div class="js-step-buttons" data-type="edit" data-step="2">
                                ...
                                <button class="btn btn-orange jsStepSave">Save</button>
                        ...
                        <option value="per_month">Per Month</option> -->
                          ...
                          <div class="js-step" data-type="edit" data-step="9">
                        <div class="col-md-12 offset-md-3 text-right">
                            <button class="btn btn-orange js-add-employee-accrual-settings js-step-tab" data-type="edit" data-step="10">Add Employee</button>
                        </div>

                        <table class="table table-bordered table-hover table-striped" id="employeeaccuraltableedit">
                            <thead>
                                <tr>
                                    <th>Employee Name</th>
                                    <th>Accrual</th>
                      ...
                      <div class="js-step" data-type="edit" data-step="10">
                            ...
                            <div class="row mb10 csRow" id="js-accrual-employee-add-div">
                                <div class="col-sm-6">
                                    <div>
                                        ...
                                        <select class="invoice-fields" name="template[]" id="js-accrual-employee-edit">
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <label class="control control--radio">
                                                Hours &nbsp;&nbsp;
                                                <input type="radio" name="js-minimum-applicable-time-edit1" class="js-employee-minimum-applicable-time-edit" checked="true" value="hours" />
                                                <div class="control__indicator"></div>
                                            </label>
                                            <label class="control control--radio">
                                                Days &nbsp;&nbsp;
                                                <input type="radio" name="js-minimum-applicable-time-edit1" class="js-employee-minimum-applicable-time-edit" value="days" />
                                                <div class="control__indicator"></div>
                                            </label>
                                            <label class="control control--radio">
                                                Months &nbsp;&nbsp;
                                                <input type="radio" name="js-minimum-applicable-time-edit1" class="js-employee-minimum-applicable-time-edit" value="months" />
                                                <div class="control__indicator"></div>
                                            </label>
                                            <label class="control control--radio">
                                                Years &nbsp;&nbsp;
                                                <input type="radio" name="js-minimum-applicable-time-edit1" class="js-employee-minimum-applicable-time-edit" value="years" />
                                                <div class="control__indicator"></div>
                                            </label>
                                        </div>
                                        <div style="margin-top: 5px;">
                                            <input class="invoice-fields" name="template" id="js-employee-minimum-applicable-hours-edit" autocomplete="off" />
                                            <input class="invoice-fields" name="oldemployeeid" id="js-old-employee-id-edit" autocomplete="off" value="" type="hidden" />
                        ...
                        <div class="col-sm-6">
                            <div class="js-step-buttons" data-type="edit" data-step="9">
                                <hr />
                                <button class="btn btn-black btn-theme js-cancel-employee-accrual-settings-edit">Cancel</button>
                                <button class="btn btn-orange js-employee-accrual-save-update">Save</button>
                            </div>
                        </div>

    ...
    <div class="modal-dialog modal-lg">`zfr5z9
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success btn-theme" id="save_department_team_changes" style="display: none;">Save</button>
                <button type="button" class="btn btn-black" style="color: #fff !important;" data-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
</div>

<?php $this->load->view('timeoff/partials/steps', ['stepType' => 'add']); ?>
...
<div class="js-step" data-type="add" data-step="1">
    ...
    <div class="row mb10">
        <div class="col-sm-6 col-xs-12">
            <div class="">
                ...
                <div class="js-hint js-hint-deactivate"><?php echo $get_policy_item_info['deactivate_policy']; ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="row mb10">
        <div class="col-sm-6 col-xs-12">
            <div class="">
                ...
                <div class="js-hint js-hint-balance"><?php echo $get_policy_item_info['include_in_balance']; ?></div>
            </div>
        </div>
    </div>
  ...
  <!-- custom Accruals -->
  <div class="row mb10 csRow" id="js-est-policy-box-add" style="display: none;">
            <div class="col-sm-6 col-xs-12">
                ...
                <div class="dash-box">
                    <div class="count-box">
                        <div class="form-group margin-bottom-custom">
                            ...
                            <div>
                                <input class="form-control" name="estPolicyAllowedTime" id="js-est-policy-allowed-time-add" placeholder="72" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    <input class="form-control" name="js-est-policy-applicable-time" id="js-est-policy-applicable-time-add" autocomplete="off" placeholder="120" />
                                </div>
                                <div class="col-sm-4">
                                    <select class="form-control jsTimeTypeSelect-editf" id="js-est-policy-applicable-time-type-add">
                        ...
                        <div style="padding: 20px 0 10px;"> <span>Allow</span>
                            <div class="form-group form-group-custom form-group-custom-settings csIn50">
                                <input class="form-control form-control-custom " placeholder="40" id="js-est-policy-accrual-allowed-time-add">
                            </div>
                            <span> extra <span class="js-plan-type">hours</span> after </span>
                            <div class="form-group form-group-custom form-group-custom-settings csIn50">
                                <input class="form-control form-control-custom" placeholder="2" id="js-est-policy-accrual-time-effectiv-add">
                            </div>
                            <div class="form-group form-group-custom form-group-custom-settings csIn50 csW100">
                                <select class="form-control form-control-custom " id="js-est-policy-accrual-time-type-add">
                                    <option value="days">Days</option>
                                </select>
                            </div>
                        </div>
    ...
    <!-- custom Accruals -->
    <div class="row mb10 csRow" id="js-esta-policy-box-add" style="display: none;">
        <div class="col-sm-6 col-xs-12">
            ...
            <div class="dash-box">
                <div class="count-box">
                    <div class="form-group margin-bottom-custom">
                        ...
                        <div>
                            <input class="form-control" name="estaPolicyAllowedTime" id="js-esta-policy-allowed-time-add" placeholder="72" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <input class="form-control" name="js-esta-policy-applicable-time" id="js-esta-policy-applicable-time-add" autocomplete="off" placeholder="120" />
                            </div>
                            <div class="col-sm-4">
                                <select class="form-control jsTimeTypeSelect-editf" id="js-esta-policy-applicable-time-type-add">
                                    <option value="days">Days</option>
                                    <option value="months">Months</option>
                                    <option value="years">Years</option>
                                </select>
                    ...
                    <div style="padding: 20px 0 10px;"> <span>Allow</span>
                        <div class="form-group form-group-custom form-group-custom-settings csIn50">
                            <input class="form-control form-control-custom " placeholder="40" id="js-esta-policy-accrual-allowed-time-add">
                        </div>
                        <span> extra <span class="js-plan-type">hours</span> after </span>
                        <div class="form-group form-group-custom form-group-custom-settings csIn50">
                            <input class="form-control form-control-custom" placeholder="2" id="js-esta-policy-accrual-time-effectiv-add">
                        </div>
                        <div class="form-group form-group-custom form-group-custom-settings csIn50 csW100">
                            <select class="form-control form-control-custom " id="js-esta-policy-accrual-time-type-add">
                                <option value="days">Days</option>
                            </select>
                        </div>
    ...
    <div class="js-step-buttons" data-type="add" data-step="2">
        <hr />
        <button class="btn btn-black js-to-step-back">Back To Templates</button>
        <button class="btn btn-success js-to-step">Next</button>
    </div>
</div>
...
<div class="js-step" data-type="add" data-step="3">
    ...
    <div class="row mb10 js-hider-add js-carryover-box-add">
        <div class="col-sm-6">
            <div class="form-group">
...
<div class="js-step" data-type="add" data-step="4">
    ...
    <!-- Negative Balance - Edit -->
    <div class="row mb10 js-hider-add js-negative-box-add">
        <div class="col-sm-6">
            <div class="form-group">

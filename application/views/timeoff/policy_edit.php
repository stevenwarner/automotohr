<div id="jsEditPage">
    <?php $this->load->view('timeoff/partials/steps', ['stepType' => 'edit']); ?>

    <!-- Step 1 - Basic Information -->
    <div class="js-step" data-type="edit" data-step="1">
        <!--  -->
        ...
        <!-- Policy Type - Edit -->
        <div class="row mb10" id="js-policy-categories-edit">
            <div class="col-md-6 offset-md-3">
                <div class="form-group margin-bottom-custom">
            ...
            <div class="col-sm-6 col-xs-12">
                <div class="form-group margin-bottom-custom">
                    <div class="form-group margin-bottom-custom">
                        ...
                        <div class="js-hint js-hint-info"><?php echo $get_policy_item_info['policy_title_info']; ?>
                        </div>
                        <div>
        ...
        <div class="row mb10">
            <div class="col-sm-6 col-xs-12">
                ...
                <div class="js-hint js-hint-sort"><?php echo $get_policy_item_info['sort_order_info']; ?></div>
                <div>
        ...
        <div class="row mb10">
            <div class="col-sm-6 col-xs-12">
                ...
                <div class="js-hint js-hint-employees-type"><?php echo $get_policy_item_info['employees_type_info']; ?></div>
                <div>
        ...
        <div class="row mb10">
            <div class="col-sm-6 col-xs-12">
                <div class="">
                    ...
                    <div class="js-hint js-hint-deactivate"><?php echo $get_policy_item_info['deactivate_policy']; ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mb10">
            <div class="col-sm-6 col-xs-12">
                <div class="">
                    ...
                    <div class="js-hint js-hint-balance"><?php echo $get_policy_item_info['include_in_balance']; ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- custom Accruals -->
        <div class="row mb10 csRow" id="js-est-policy-box" style="display: none;">
            <div class="col-sm-6 col-xs-12">

                <div class="dash-box">
                    <div class="count-box">
                        <div class="form-group margin-bottom-custom">
                            <label class=""><?php echo $get_policy_item_info['est_policy_allowed_time_label']; ?>
                                <span class="cs-required">*</span>
                                <i class="fa fa-question-circle" data-hint="js-hint" data-target="info"></i>
                            </label>
                            <div class="js-hint js-hint-info">
                                <?php echo $get_policy_item_info['est_policy_allowed_time_hint']; ?>
                            </div>
                            <div>
                                <input class="form-control" name="estPolicyAllowedTime" id="js-est-policy-allowed-time-edit" placeholder="72" />
                            </div>
                        </div>

                        <div class="form-group">
                            <h5 class="timeline-title allowed-time-off-title-custom">
                                <?php echo $get_policy_item_info['est_policy_applicable_time_lable']; ?> <span class="cs-required">*</span>
                                <i class="fa fa-question-circle" data-hint="js-hint" data-target="rate"></i>
                            </h5>
                            <div class="js-hint js-hint-rate">
                                <?php echo $get_policy_item_info['est_policy_applicable_time_info']; ?></div>
                            <div class="row">
                                <div class="col-sm-8">
                                    <input class="form-control" name="js-est-policy-applicable-time" id="js-est-policy-applicable-time-edit" autocomplete="off" placeholder="120" />
                                </div>
                                <div class="col-sm-4">
                                    <select class="form-control jsTimeTypeSelect-editf" id="js-est-policy-applicable-time-type-edit">
                        ...
                        <div class="form-group">
                            <h5 class="timeline-title allowed-time-off-title-custom">
                                <?php echo $get_policy_item_info['est_policy_accrual_rate_label']; ?> <span class="cs-required">*</span>
                                <i class="fa fa-question-circle" data-hint="js-hint" data-target="rate"></i>
                            </h5>
                            <div class="js-hint js-hint-rate">
                                <?php echo $get_policy_item_info['est_policy_accrual_rate_info']; ?>
                            </div>
                        </div>

                        <div style="padding: 20px 0 10px;"> <span>Allow</span>
                            <div class="form-group form-group-custom form-group-custom-settings csIn50">
                                <input class="form-control form-control-custom " placeholder="40" id="js-est-policy-accrual-allowed-time-edit">
                            </div>
                            <span> extra <span class="js-plan-type">hours</span> after </span>
                            <div class="form-group form-group-custom form-group-custom-settings csIn50">
                                <input class="form-control form-control-custom" placeholder="2" id="js-est-policy-accrual-time-effectiv-edit">
                            </div>
                            <div class="form-group form-group-custom form-group-custom-settings csIn50 csW100">
                                <select class="form-control form-control-custom " id="js-est-policy-accrual-time-type-edit">
                                    <option value="days">Days</option>
                                </select>
                            </div>
                        </div>
        ...
        <!-- Step buttons -->
        <div class="js-step-buttons" data-type="edit" data-step="2">
            <hr />
            <button class="btn btn-black jsViewPoliciesBtn">Cancel</button>
            <button class="btn btn-success jsStepSave">Save</button>
            <button class="btn btn-success js-to-step">Next</button>
        </div>
    </div>

    <!-- Step 2 - Accrual setting -->
    <div class="js-step" data-type="edit" data-step="2">
        <!--  -->
        <?php $this->load->view('timeoff/partials/note'); ?>
        ...
        <div class="row mb10">
            <div class="col-sm-6">
                <!--  -->
                <div>
                    <h5 class="timeline-title allowed-time-off-title-custom"><?php echo $get_policy_item_info['minimum_applicable_time_label']; ?> <i class="fa fa-question-circle" data-hint="js-hint" data-target="minimum-hours"></i></h5>
        ...
        <div class="row mb10 hidden">
            <div class="col-sm-6">
                <div>
                    ...
                    <div class="js-hint js-hint-method"><?php echo $get_policy_item_info['accrual_method_info']; ?>
                    </div>
                    <div>
        ...
        <div class="row mb10 js-hider-edit">
            <div class="col-sm-6">
                <div class="form-group">
                    <h5 class="timeline-title allowed-time-off-title-custom"><?php echo $get_policy_item_info['accrual_time_label']; ?> <span class="cs-required">*</span>
                        <i class="fa fa-question-circle" data-hint="js-hint" data-target="info"></i>
                    </h5>
                    <div class="js-hint js-hint-info"><?php echo $get_policy_item_info['accrual_time_info']; ?></div>
                    <div>
                    ...
                    <br />
                    <p style="color: #c10000; display: none;" id="js-accrual-time-text-edit"></p>
                </div>
            </div>
        </div>
        ...
        <div class="row mb10 js-hider-edit">
            <div class="col-sm-6">
                <div class="form-group">
                    <h5 class="timeline-title allowed-time-off-title-custom"><?php echo $get_policy_item_info['accrual_rate_label']; ?> <span class="cs-required">*</span>
                        <i class="fa fa-question-circle" data-hint="js-hint" data-target="rate"></i>
                    </h5>
                    <div class="js-hint js-hint-rate"><?php echo $get_policy_item_info['accrual_rate_info']; ?></div>
                    <div class="row">
                        <div class="col-sm-8">
        ...
        <div class="row mb10 js-hider-edit">
            <!-- Plans area -->
            <div class="col-sm-12 col-xs-12 jsPlanArea" id="js-plan-area-edit"></div>
        </div>

        <!--  -->
        <div class="js-step-buttons" data-type="edit" data-step="3">
            <hr />
            <button class="btn btn-black js-to-step-back">Back</button>
            <button class="btn btn-success jsStepSave">Save</button>
            <button class="btn btn-success js-to-step">Next</button>
        </div>
    </div>
    ...
    <!-- Step 3 - Carryover -->
    <div class="js-step" data-type="edit" data-step="3">
        <!--  -->
        <?php $this->load->view('timeoff/partials/note'); ?>
        <!-- Carryover - Edit -->
        <div class="row mb10 js-hider-edit">
        ...
        <div class="row mb10 js-hider-edit js-carryover-box-edit">
            <div class="col-sm-6">
                <div class="form-group">
                    <h5 class="timeline-title allowed-time-off-title-custom"><?php echo $get_policy_item_info['carryover_cap_label']; ?>
    ...
    <div class="js-step" data-type="edit" data-step="4">
        <!--  -->
        <?php $this->load->view('timeoff/partials/note'); ?>
        ...
        <div class="row mb10 js-hider-edit">
            <div class="col-sm-6">
                <div class="form-group">
                    <h5 class="timeline-title allowed-time-off-title-custom"><?php echo $get_policy_item_info['negative_balance_label']; ?>
        ...
        <div class="row mb10 js-hider-edit js-negative-box-edit">
            <div class="col-sm-6">
                <div class="form-group">
                    <h5 class="timeline-title allowed-time-off-title-custom"><?php echo $get_policy_item_info['negative_balance_limit_label']; ?>
        ...
        <!--  -->
        <div class="js-step-buttons" data-type="edit" data-step="5">
            <hr />
            <button class="btn btn-black js-to-step-back">Back</button>
            <button class="btn btn-success jsStepSave">Save</button>
            <button class="btn btn-success js-to-step">Next</button>
    ...
    <div class="js-step" data-type="edit" data-step="5">
        <!--  -->
        <?php $this->load->view('timeoff/partials/note'); ?>
        ...
        <div class="row mb10">
            ...
            <div class="col-lg-6">
                ...
                <br />
                <p style="color: #c10000; display: none;" id="js-applicable-date-text-edit">
                    <i><?php echo $get_policy_item_info['applicable_date_msg_label']; ?></i>
                </p>
            </div>
        </div>
        <!--  -->
        <div class="js-step-buttons" data-type="edit" data-step="6">
            <hr />
            <button class="btn btn-black js-to-step-back">Back</button>
            <button class="btn btn-success jsStepSave">Save</button>
            <button class="btn btn-success js-to-step">Next</button>
    ...
    <!-- Step 6 - Reset Date -->
    <div class="js-step" data-type="edit" data-step="6">
        <!--  -->
        <?php $this->load->view('timeoff/partials/note'); ?>
        ...
        <div class="row mb10">
            <div class="col-sm-6">
                <div class="form-group">
                    <h5 class="timeline-title allowed-time-off-title-custom"><?php echo $get_policy_item_info['reset_date_label']; ?>
                        <i class="fa fa-question-circle" data-hint="js-hint" data-target="reset-date"></i>
                    </h5>
                    <div class="js-hint js-hint-reset-date"><?php echo $get_policy_item_info['reset_date_info']; ?>
                    </div>
                    <div class="">
                        <label class="control control--radio">
        ...
        <!--  -->
        <div class="js-step-buttons" data-type="edit" data-step="7">
            <hr />
            <button class="btn btn-black js-to-step-back">Back</button>
            <button class="btn btn-success jsStepSave">Save</button>
            <button class="btn btn-success js-to-step">Next</button>
    ...
    <!-- Step 7 - New Hire -->
    <div class="js-step" data-type="edit" data-step="7">
        <!--  -->
        <?php $this->load->view('timeoff/partials/note'); ?>
        <div class="row">
            <div class="col-lg-12">
        ...
        <div class="row mb10">
            <div class="col-lg-12 js-hider-edit accrual-settings-line-1 mb10">
                <h5 class="timeline-title allowed-time-off-title-custom"><?php echo $get_policy_item_info['probation_period_label']; ?>
        ...
        <div class="row mb10 js-hider-edit">
            <div class="col-sm-6">
                <div class="form-group">
                    <h5 class="timeline-title allowed-time-off-title-custom"><?php echo $get_policy_item_info['probation_period_rate_label']; ?>
                    ...
                    <div class="input-group">
                        <input class="form-control" name="template" id="js-newhire-prorate-edit" />
        ...
        <!--  -->
        <div class="js-step-buttons" data-type="edit" data-step="8">
            <hr />
            <button class="btn btn-black js-to-step-back">Back</button>
            <button class="btn btn-success js-to-step">Save & Finish</button>
        </div>
    </div>
</div>
<!-- Edit page ends -->

<div id="jsResetPage" style="display: none;">
    ...
    <div class="js-step" data-type="reset" data-step="1">
        ...
        <!-- Policy Type - reset -->
        <div class="row mb10" id="js-policy-categories-reset">
            <div class="col-md-6 offset-md-3">
                <div class="form-group margin-bottom-custom">
                    <label><?php echo $get_policy_item_info['policy_type_label']; ?> <span class="cs-required">*</span> <i class="fa fa-question-circle" data-hint="js-hint" data-target="type"></i></label>
                    <div class="js-hint js-hint-type"><?php echo $get_policy_item_info['type_info']; ?></div>
        ...
        <div class="row mb10">
            <div class="col-sm-6 col-xs-12">
                ...
                <div class="js-hint js-hint-employees"><?php echo $get_policy_item_info['entitled_employee_info']; ?>
                </div>
                <div>
        ...
        <!-- FMLA Range -->
        <div class="row mb10 js-fmla-range-wrap-reset hidden" style="display: none;">
            <div class="col-sm-12">
                <h4 class="timeline-title allowed-time-off-title-custom csHeading">FMLA Range</h4>
            </div>
            <div class="col-lg-6">
        ...
        <div class="js-step-buttons" data-type="reset" data-step="2">
            <hr />
            <button class="btn btn-black jsViewPoliciesBtn">Cancel</button>
            <button class="btn btn-success jsStepSaveReset">Save</button>
            <button class="btn btn-success js-to-step">Next</button>
        </div>
    </div>
    ...
    <div class="js-step" data-type="reset" data-step="2">
        ...
        <!-- Accrual Time - reset -->
        <div class="row mb10 js-hider-reset">
            <div class="col-sm-6">
                <div class="form-group">
                    <h5 class="timeline-title allowed-time-off-title-custom"><?php echo $get_policy_item_info['accrual_time_label']; ?> <span class="cs-required">*</span>
                        <i class="fa fa-question-circle" data-hint="js-hint" data-target="info"></i>
        ...
        <div class="row mb10">
            <div class="col-lg-12">
                <h4 class="timeline-title allowed-time-off-title-custom csHeading"><?php echo $get_policy_item_info['accruals_plans_label']; ?>
                    <i class="fa fa-question-circle" data-hint="js-hint" data-target="plans"></i>
                    <span class="pull-right">
                        <button class="btn btn-success js-plan-btn-reset" data-type="reset" style="margin-top: -5px;"><i class="fa fa-plus"></i>&nbsp; Add Plan</button>
                    </span>
                </h4>
                <div class="js-hint js-hint-plans">
                    <?php echo $get_policy_item_info['accrual_plans']; ?></div>
    ...
    <div class="js-step" data-type="reset" data-step="3">
        ...
        <div class="row mb10 js-hider-reset js-carryover-box-reset">
            <div class="col-sm-6">
                <div class="form-group">
                    <h5 class="timeline-title allowed-time-off-title-custom"><?php echo $get_policy_item_info['carryover_cap_label']; ?>
                        <i class="fa fa-question-circle" data-hint="js-hint" data-target="caryval"></i>
    ...
    <div class="js-step" data-type="reset" data-step="4">
        ...
        <!-- Negative Balance - reset -->
        <div class="row mb10 js-hider-reset js-negative-box-reset">
            <div class="col-sm-6">
                <div class="form-group">
                    <h5 class="timeline-title allowed-time-off-title-custom"><?php echo $get_policy_item_info['negative_balance_limit_label']; ?>
                        <i class="fa fa-question-circle" data-hint="js-hint" data-target="negativeval"></i>
    ...
    <div class="js-step" data-type="reset" data-step="5">
        ...
        <div class="row mb10">
            <div class="col-lg-12">
                <h5 class="timeline-title allowed-time-off-title-custom">Applicable date for policy to take affect <i class="fa fa-question-circle" data-hint="js-hint" data-target="applicable-date"></i></h5>
                <div class="js-hint js-hint-applicable-date">
                    <?php echo $get_policy_item_info['applicable_date_for_policy_info']; ?>
                </div>
            </div>

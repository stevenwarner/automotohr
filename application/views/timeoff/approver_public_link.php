                        ...
                        <div class="csSidebar csRadius5">
                            ...
                            <div class="csSidebarHead csRadius5 csRadiusBL0 csRadiusBR0" style="height: 118px">
                                <div id="jsEmployeeInfoEdit">
                                    <figure>
                                        <img src="https://automotohrattachments.s3.amazonaws.com/<?php echo $request['profile_picture']; ?>" class="csRadius50">
                                        <div class="csTextBox">
                                            <p><?php echo $request['first_name']. ' ' .$request['last_name'];?></p>
                                            <p class="csTextSmall"> <?php echo '('.$request['job_title']. ') [' .$request['access_level'] .']';?></p>

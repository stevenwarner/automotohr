                    ...
                    <div class="right-content-2 js-page" id="js-page-add" <?=$page != 'add' ? 'style="display: none;"' : '';?>>
                                    ...
                                    <div class="col-xs-6 col-lg-6">
                                        <div class="pto-top-heading-right-add-plan text-right">
                                            <div class="btn-filter-reset">
                                                <button type="button" class="btn btn-reset js-view-page-btn mr10"><span><i class="fa fa-angle-left"></i></span>&nbsp;VIEW POLICIES</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="js-content-area">
                            ...
                            <!-- <div class="row margin-top">
                                <div class="col-sm-6 col-xs-12">
                                    <div class="form-group margin-bottom-custom margin-right">
                                        <label class="">Policy Start Date <span class="cs-required">*</span>  <i data-toggle="popovers" data-trigger="hover" data-title="Info" data-placement="right" data-html="true" data-content=" It’s an actual Date when Policy will be applicable with all its conditions to all selected employees." class="fa fa-question-circle"></i></label>
                                        <div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        <div class="col-sm-12 mb-20">
                                            ...
                                            <div>
                                                <br />
                                                <label>Minimum Applicable Hours <i data-toggle="popovers" data-trigger="hover" data-title="Info" data-placement="right" data-html="true" data-content="<?php echo $get_policy_item_info['minimum_applicable_hours_info']; ?>" class="fa fa-question-circle"></i></label>
                                                <div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 mb-20">
                                            <div    >
                                                <label>Accrual Method <span class="cs-required">*</span> <i data-toggle="popovers" data-trigger="hover" data-title="Info" data-placement="right" data-html="true" data-content="<?php echo $get_policy_item_info['accrual_method_info']; ?>" class="fa fa-question-circle"></i></label>
                                                <div>
                                    ...
                                    <div class="row js-hider-add">
                                        <div class="col-sm-12 mb-20">
                                            <div class="form-group">
                                                <label>Accrual Rate <span class="cs-required">*</span> <i data-toggle="popovers" data-trigger="hover" data-title="Info" data-placement="right" data-html="true" data-content="<?php echo $get_policy_item_info['accrual_rate_info']; ?>" class="fa fa-question-circle"></i></label>
                                                <div>
                                    ...
                                    <div class="row js-hider-add">
                                        <div class="col-sm-12 mb-20">
                                            <div class="form-group">
                                                <label>Accrual Time <span class="cs-required">*</span> <i data-toggle="popovers" data-trigger="hover" data-title="Info" data-placement="right" data-html="true" data-content="<?php echo $get_policy_item_info['accrual_time_info']; ?>" class="fa fa-question-circle"></i></label>
                                                <div>
                                    ...
                                    <div class="row js-hider-add">
                                        <div class="col-sm-12 mb-20">
                                            <div class="form-group">
                                                <label>Reset Date <i data-toggle="popovers" data-trigger="hover" data-title="Info" data-placement="right" data-html="true" data-content="<?php echo $get_policy_item_info['reset_date_info']; ?>" class="fa fa-question-circle"></i></label>
                                                <div class="radio radio-custom">
                                    ...
                                    <div class="row js-hider-add">
                                        <div class="col-sm-12 mb-20">
                                            <div class="form-group">
                                                <label>Accrual Frequency <span class="cs-required">*</span> <i data-toggle="popovers" data-trigger="hover" data-title="Info" data-placement="right" data-html="true" data-content="<?php echo $get_policy_item_info['accrual_frequency_info']; ?>" class="fa fa-question-circle"></i></label>
                                                <div>
                                    ...
                                    <div class="row js-hider-add">
                                        <div class="col-sm-12 mb-20">
                                            <div class="form-group">
                                                <label>Allow Carryover Cap? (use it or lose it) <span class="cs-required">*</span> <i data-toggle="popovers" data-trigger="hover" data-title="Info" data-placement="right" data-html="true" data-content="<?php echo $get_policy_item_info['allow_carryover_cap_info']; ?>" class="fa fa-question-circle"></i></label>
                                                <div>
                                    ...
                                    <div class="row js-hider-add js-carryover-box-add">
                                        <div class="col-sm-12 mb-20">
                                            <div class="form-group">
                                                <label>Carryover Cap <i data-toggle="popovers" data-trigger="hover" data-title="Info" data-placement="right" data-html="true" data-content="<?php echo $get_policy_item_info['carryover_cap_info']; ?>" class="fa fa-question-circle"></i></label>
                                                <div>
                                    ...
                                    <div class="row js-hider-add">
                                        <div class="col-sm-12 mb-20">
                                            <div class="form-group">
                                                <label>Allow Negative Balance <i data-toggle="popovers" data-trigger="hover" data-title="Info" data-placement="right" data-html="true" data-content="<?php echo $get_policy_item_info['allow_negative_balance_info']; ?>" class="fa fa-question-circle"></i></label>
                                                <div>
                                    ...
                                    <div class="row js-hider-add js-negative-box-add">
                                        <div class="col-sm-12 mb-20">
                                            <div class="form-group">
                                                <label>Allowed negative balance (Hours/Days) <i data-toggle="popovers" data-trigger="hover" data-title="Info" data-placement="right" data-html="true" data-content="<?php echo $get_policy_item_info['new_hire_maximum_days_off_HD_info']; ?>" class="fa fa-question-circle"></i></label>
                                                <div>
                                    ...
                                    <div class="row js-hider-add">
                                        <div class="col-sm-12 mb-20">
                                            <div class="form-group">
                                                <label>New hire maximum days off <i data-toggle="popovers" data-trigger="hover" data-title="Info" data-placement="right" data-html="true" data-content="<?php echo $get_policy_item_info['new_hire_maximum_days_off_info']; ?>" class="fa fa-question-circle"></i></label>
                                                <div>
                                ...
                                <div class="col-lg-12 js-hider-add accrual-settings-line-1 margin-top">
                                    <label>Waiting period <i data-toggle="popovers" data-trigger="hover" data-title="Info" data-placement="right" data-html="true" data-content="<?php echo $get_policy_item_info['waiting_period_info']; ?>" class="fa fa-question-circle"></i></label>
                                    <br />
                            ...
                            <div class="row js-hider-add">
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <h4 class="timeline-title allowed-time-off-title-custom">Accrual Plans <i data-toggle="popovers" data-trigger="hover" data-title="Info" data-placement="right" data-html="true" data-content="<?php echo $get_policy_item_info['accrual_plans']; ?>" class="fa fa-question-circle"></i> </h4>
                                    ...
                                    <div class="row js-hider-edit">
                                        <div class="col-sm-12 mb-20">
                                            <div class="form-group">
                                                <label>Reset Date <i data-toggle="popovers" data-trigger="hover" data-title="Info" data-placement="right" data-html="true" data-content="<?php echo $get_policy_item_info['reset_date_info']; ?>" class="fa fa-question-circle"></i></label>
                                                <div class="radio radio-custom">
                                                    <label><input type="radio" name="js-policy-reset-date-edit" class="js-policy-reset-date-edit" checked="true" value="policyDate" class="js-hire-date-edit"/>Policy Applicable Date</label>
                                                    <label>
                                                        <input type="radio" name="js-policy-reset-date-edit" class="js-policy-reset-date-edit" value="policyDateCustom" class="js-reset-date-edit" />
                                                        <div class="form-group">
                                                            <div class="pto-plan-date ">

    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content model-content-custom">
            ...
            <div class="modal-body full-width modal-body-custom">
                <div class="tab-content">
                    <div id="" class="">
                        ...
                        <!-- Section Four -->
                        <div class="row js-vacation-row-add" style="display: none;">
                            <hr />
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label>Emergency Contact Number</label>
                                    <input type="text" class="form-control" id="js-vacation-contact-number-add" />
                                </div>
                            </div>
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label>Return Date</label>
                                    <input type="text" class="form-control" id="js-vacation-return-date-add" readonly="true" />
                                </div>
                            </div>
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label>Alternate Temporary Address</label>
                                    <input type="text" class="form-control" id="js-vacation-address-add" />
                                </div>
                            </div>
                        </div>

                        <!-- Section Four -->
                        <div class="row js-bereavement-row-add" style="display: none;">
                            <hr />
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label>Relationship</label>
                                    <input type="text" class="form-control" id="js-bereavement-relationship-add" />
                                </div>
                            </div>
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label>Return Date</label>
                                    <input type="text" class="form-control" id="js-bereavement-return-date-add" readonly="true" />
                                </div>
                            </div>
                        </div>

                        <!-- Section Four -->
                        <div class="row js-compensatory-row-add" style="display: none;">
                            <hr />
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label>Compensation Date</label>
                                    <input type="text" class="form-control" id="js-compensatory-return-date-add" readonly="true" />
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-12">
                                <div class="form-group">
                                    <label>Compensation Start Time</label>
                                    <input type="text" class="form-control" id="js-compensatory-start-time-add" readonly="true" />
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-12">
                                <div class="form-group">
                                    <label>Compensation End Time</label>
                                    <input type="text" class="form-control" id="js-compensatory-end-time-add" readonly="true" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <h4>
                                ...
                                <span class="pull-right">
                                    <button class="btn btn-success js-timeoff-attachment" data-type="add" style="background-color: #3554dc"><i class="fa fa-plus"></i>&nbsp; Add Document</button>
                                </span>
                            </h4>
                        </div>
                        <div class="col-sm-12">
                            <br />
                            <div class="reponsive">
                                <table class="table table-striped table-bordered" id="js-attachment-listing-add">
                                    <thead>
                                        <tr>
            ...
            <div class="modal-footer">
                <button class="btn btn-info btn-5" id="js-load-btn" style="display: none;">Creating request...</button>
                <button type="submit" class="btn btn-info btn-5 js-btn" id="js-save-draft-btn">Create Request</button>
                <button type="submit" class="btn btn-info btn-5 js-btn" id="js-save-btn">Create & Submit Request</button>
                <button type="button" class="btn btn-info btn-5 js-btn" data-dismiss="modal" id="js-cancel-btn">Cancel</button>
            </div>
        </div>
  </div>
</div>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('#js-create-pto').click(function(e){
            ...
            $('.js-fmla-popup').prop('id', 'js-fmla-modal');
            $('#js-attachment-listing-add tbody').find('tr.js-attachments-add').remove();
            $('#js-attachment-listing-add tbody').find('tr.js-no-records-add').show();
        ...
        $(document).on('click', '#js-cancel-btn', function(){
            ...
            $('#js-attachment-listing tbody').find('tr.s-attachments').remove();
            $('#js-attachment-listing tbody').find('tr.js-no-records').show();
            attachedDocuments = {};
            localDocument = {};
        });
        ...
        $(document).on('click', '#js-save-btn', async function(){
            ...
            megaOBJ.fmla = fmla;
            //
            if(megaOBJ.isFMLA === undefined) megaOBJ.isFMLA = 'no';
            // Phase 3 code 
            megaOBJ.returnDate = '';
            ...
            switch ($('#js-types').val().toLowerCase()) {
                case 'vacation':
                    megaOBJ.returnDate = $('#js-vacation-return-date-add').val().trim();
                    megaOBJ.temporaryAddress = $('#js-vacation-address-add').val().trim();
                    megaOBJ.emergencyContactNumber = $('#js-vacation-contact-number-add').val().trim();
                break;

                case 'bereavement':
                    megaOBJ.returnDate = $('#js-bereavement-return-date-add').val().trim();
                    megaOBJ.relationship = $('#js-bereavement-relationship-add').val().trim();
                break;

                case 'compensatory/ in lieu time':
                    megaOBJ.returnDate = $('#js-compensatory-return-date-add').val().trim();
                    megaOBJ.compensationStartTime = $('#js-compensatory-start-time-add').val().trim();
                    megaOBJ.compensationEndTime = $('#js-compensatory-end-time-add').val().trim();
                break;
            }
         ...
         // Save TO from modal
        $(document).on('click', '#js-save-draft-btn', async function(){
            var megaOBJ = {};
            megaOBJ.action = 'create_employee_timeoff_draft';
            megaOBJ.reason = CKEDITOR.instances['js-reason'].getData().trim();
            megaOBJ.policyId = $('#js-policies').val();
            megaOBJ.policyName = $('#js-policies').find('option[value="'+(megaOBJ.policyId)+'"]').text();
            megaOBJ.companySid = <?=$companyData['sid'];?>;
        ...
        //
        $(document).on('hide.bs.modal', '#js-fmla-modal',  function(){ 
            $('#js-timeoff-modal').modal('show'); 
        });
        //
        $('#js-timeoff-modal').on('hide.bs.modal', function(){ $('body').css('overflow-y', 'auto'); });
        //
        $(document).on('click', '#js-timeoff-modal .js-shift-page',function(){
            $('#js-fmla-modal').modal('hide');
            $('#js-timeoff-modal').modal('show');
        });
        //
        $(document).on('click','#js-fmla-modal .js-fmla-save-button' ,function(){
        ...
        $('#js-start-partial-time').datetimepicker({
            ...
            onShow: function(d){
                // this.setOptions({
                //     maxTime: $('#js-end-partial-time').val() ? $('#js-end-partial-time').val() : false
                // });
            }
        });
        ...
        //
        $('#js-vacation-return-date-add').datepicker({
            format: 'mm-dd-yyyy',
            beforeShowDay: unavailable,
            minDate: 1
        }).val(moment().add('1', 'day').format('MM/DD/YYYY'));
        //
        $('#js-bereavement-return-date-add').datepicker({
            format: 'mm-dd-yyyy',
            beforeShowDay: unavailable,
            minDate: 1
        }).val(moment().add('1', 'day').format('MM/DD/YYYY'));
        //
        $('#js-compensatory-return-date-add').datepicker({
            format: 'mm-dd-yyyy',
            beforeShowDay: unavailable,
            minDate: 1
        }).val(moment().add('1', 'day').format('MM/DD/YYYY'));
        ...
        //
        $('#js-compensatory-start-time-add').datetimepicker({
            datepicker: false,
            format: 'g:i A',
            formatTime: 'g:i A',
            step: 15
        ...
        $('#js-compensatory-end-time-add').datetimepicker({
            datepicker: false,
            format: 'g:i A',
            formatTime: 'g:i A',
            step: 15,
            onShow: function(d){
                this.setOptions({
                    minTime: $('#js-compensatory-start-time-add').val() ? $('#js-compensatory-start-time-add').val() : false
                });
            }
        });

        //
        function bindDynamicTimePickers(
            t1,
            t2
        ){
            $(t1).datetimepicker('destroy');
            $(t2).datetimepicker('destroy');
            $(t1).datetimepicker({
                datepicker: false,
                format: 'g:i A',
                formatTime: 'g:i A',
        ...
        //
        function _ll( s ){
            if( s === undefined ) $('.js-ilcr').fadeIn(300);
            else $('.js-ilcr').fadeOut(300);
        }
    })

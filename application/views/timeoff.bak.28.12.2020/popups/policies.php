...
<script>
    ...
    async function startPolicyProcess(employeeId){
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            ...
                            <div class="col-sm-10">
                                <span>Policy doesn't implements due to accruals. Click '<i class="fa fa-question-circle"></i>' to see details.</span>
                            </div>
                        </div>
                    </div>
        ...
        Object.keys(policyList).map((p) => {
            ...
            policy.map((pi) => {
              policyOptions += `
                <tr ${ pi.PolicyStatus.Reason != '' ? 'class="bg-danger"' : '' }>
                    <td>${pi.title}${ !pi.PolicyStatus.Implements ? ` <i class="fa fa-question-circle jsPopover" title="Why?" data-content="${pi.PolicyStatus.Reason}"></i>` : '' }</td>

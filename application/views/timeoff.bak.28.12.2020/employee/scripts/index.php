...
$(function() {
    ...
    function setPoliciesList() {
        ...
        policies.map(function(policy) {
            rows += '<li>' + (policy.title) + '<span>' + (policy.timeoff_breakdown !== undefined ?
                policy.timeoff_breakdown.text : 'Unlimited') + '</span></li>';
        });
    ...
    function setPolicySlider() {
        ...
        policies.map(function(policy) {
            ...
            rows += '                    <span style="font-size: 20px;">' + (policy
                    .timeoff_breakdown !== undefined ? policy.timeoff_breakdown.text : 'Unlimited') +
                '</span>';
            rows += '                </div>';
            rows += '            </div>';
            rows += '       </a>';

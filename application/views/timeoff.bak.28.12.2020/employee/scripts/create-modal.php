                            ...
                            <div class="col-sm-6 col-sm-12">
                                <div class="employee-info">
                                    ...
                                    <div class="text cs-info-text">
                                        ...
                                        <p><?=remakeEmployeeName( $employer, false );?></p>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $(document).on('click', '#js-save-btn', async function(){
            ...
            megaOBJ.employeeFullName = "<?=$employer['first_name'].' '.$employer['last_name'];?>";
            megaOBJ.employeeEmail = "<?=$employer['email'];?>";
            //
        ...
        function setTimeView(target, prefix, position){
            ...
            if(policies[0]['format'] == 'D:H:M'){
                ...
                row += '        <input type="text" data-ids="'+(position)+'" data-type="hour" class="form-control js-number" id="js-request-days'+( prefix === undefined ? '' : prefix)+'"  />';
                row += '    </div>';
                row += '</div>';
                row += '<div class="col-sm-4">';
                row += '    <div class="form-group">';
                ...
                row += '    <div class="form-group">';
                row += '        <label>Days </label>';
                row += '        <input type="text" data-ids="'+(position)+'" data-type="day" class="form-control js-number" id="js-request-days'+( prefix === undefined ? '' : prefix)+'" value="'+( getTime(position, 'day') )+'" />';
                row += '    </div>';
                row += '</div>';
                row += '<div class="col-sm-6">';
                row += '    <div class="form-group">';

            ...
            <div class="applicant-profile-wrp">
                <div class="col-lg-9 col-md-9 col-xs-12 col-sm-12">
                    ...
                    <div>
                        <div class="page-header-area">
                            <span class="page-heading down-arrow">
                                ...
                                <a href="" class="dashboard-link-btn js-balance-btn" style="right: 10px; left: auto;">
                                    Balance
                                </a>
                                <?php } ?>
                            </span>
                    ...
                    <div class="cs-main-page">
                        ...
                        <div class="main pto-main-wrp" style="padding-top: 10px !important;">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-6 col-lg-6">
                                                        <div class="pto-top-heading-right text-right">
                                                            <a id="js-create-pto" href="javascript:void(0);" class="dashboard-link-btn2 js-add-btn js-create-pto cs-btn-add cs-green-bg">
                        ...
                        <?php if($session['employer_detail']['access_level_plus'] == 1 || $session['employer_detail']['pay_plan_flag'] == 1) $this->load->view('timeoff/popups/balance'); ?>
                        <?php $this->load->view('timeoff/employee/scripts/holiday-list-modal'); ?>
                        ...
                        <?php $this->load->view('timeoff/employee/scripts/edit-modal'); ?>

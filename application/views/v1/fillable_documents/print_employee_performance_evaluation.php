                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="border: 1px solid; font-size: 14px;" colspan="3">
                                        ...
                                        <strong style="font-size: 14px;" name="termination_voluntary"> <?= $formInputData['selectDD0'] ? 'Yes' : 'NO' ?> </strong>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="border: 1px solid; font-size: 14px;" colspan="3">
                                        ...
                                        <strong style="font-size: 14px;" name="termination_voluntary"><?= $formInputData['selectDD1'] ? 'Yes' : 'No' ?></strong>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="border: 1px solid; font-size: 14px;" colspan="3">
                                        ...
                                        <strong style="font-size: 14px;" name="termination_voluntary"><?= $formInputData['selectDD2'] ? 'Yes' : 'NO' ?> </strong>
                                </tr>

                            ...
                            <table class="table" style="border: 1px solid;   border-collapse: collapse;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px solid; font-size: 14px;">
                                            <input class="invoice-fields short_textbox " type="text" value="<?= $sectionsdata['section2']['data']['accomplishment1'] ? $sectionsdata['section2']['data']['accomplishment1'] : '' ?>" name="accomplishment1" id="accomplishment1" data-type='text' autocomplete="off" readonly />

                                        </td>
                                        <td style="border: 1px solid; font-size: 14px;">
                                            <input class="invoice-fields short_textbox " type="text" value="<?= $sectionsdata['section2']['data']['accomplishment1_emp_comment'] ? $sectionsdata['section2']['data']['accomplishment1_emp_comment'] : '' ?>" name="accomplishment1_emp_comment" id="short_textbox_27_id" data-type='text' autocomplete="off" readonly />
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px solid; font-size: 14px;">
                                            <input class="invoice-fields short_textbox " type="text" value="<?= $sectionsdata['section2']['data']['accomplishment2'] ? $sectionsdata['section2']['data']['accomplishment2'] : '' ?>" name="accomplishment2" id="accomplishment2" data-type='text' autocomplete="off" readonly />
                                        </td>
                                        <td style="border: 1px solid; font-size: 14px;">
                                            <input class="invoice-fields short_textbox " type="text" value="<?= $sectionsdata['section2']['data']['accomplishment2_emp_comment'] ? $sectionsdata['section2']['data']['accomplishment2_emp_comment'] : '' ?>" name="accomplishment2_emp_comment" id="accomplishment2_emp_comment" data-type='text' autocomplete="off" readonly />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px solid; font-size: 14px;">
                                            <input class="invoice-fields short_textbox " type="text" value="<?= $sectionsdata['section2']['data']['accomplishment3'] ? $sectionsdata['section2']['data']['accomplishment3'] : '' ?>" name="accomplishment3" id="accomplishment3" data-type='text' autocomplete="off" readonly />
                                        </td>
                                        <td style="border: 1px solid; font-size: 14px;">
                                            <input class="invoice-fields short_textbox " type="text" value="<?= $sectionsdata['section2']['data']['accomplishment3_emp_comment'] ? $sectionsdata['section2']['data']['accomplishment3_emp_comment'] : '' ?>" name="accomplishment3_emp_comment" id="accomplishment3_emp_comment" data-type='text' autocomplete="off" readonly />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px solid; font-size: 14px;">
                                            <input class="invoice-fields short_textbox " type="text" value="<?= $sectionsdata['section2']['data']['accomplishment4'] ? $sectionsdata['section2']['data']['accomplishment4'] : '' ?>" name="accomplishment4" id="accomplishment4" data-type='text' autocomplete="off" readonly />
                                        </td>
                                        <td style="border: 1px solid; font-size: 14px;">
                                            <input class="invoice-fields short_textbox " type="text" value="<?= $sectionsdata['section2']['data']['accomplishment4_emp_comment'] ? $sectionsdata['section2']['data']['accomplishment4_emp_comment'] : '' ?>" name="accomplishment4_emp_comment" id="accomplishment4_emp_comment" data-type='text' autocomplete="off" readonly />
                                        </td>
                                    </tr>
                            ...
                            <table class="table" style="border: 1px solid;   border-collapse: collapse;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px solid; font-size: 14px;">
                                            <input class="invoice-fields short_textbox " type="text" value="<?= $sectionsdata['section2']['data']['opportunity1'] ? $sectionsdata['section2']['data']['opportunity1'] : '' ?>" name="opportunity1" id="opportunity1" data-type='text' autocomplete="off" readonly />
                                        </td>
                                        <td style="border: 1px solid; font-size: 14px;">
                                            <input class="invoice-fields short_textbox " type="text" value="<?= $sectionsdata['section2']['data']['opportunity1_emp_comment'] ? $sectionsdata['section2']['data']['opportunity1_emp_comment'] : '' ?>" name="opportunity1_emp_comment" id="opportunity1_emp_comment" data-type='text' autocomplete="off" readonly/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px solid; font-size: 14px;">
                                            <input class="invoice-fields short_textbox " type="text" value="<?= $sectionsdata['section2']['data']['opportunity2'] ? $sectionsdata['section2']['data']['opportunity2'] : '' ?>" name="opportunity2" id="opportunity2" data-type='text' autocomplete="off" readonly />
                                        </td>
                                        <td style="border: 1px solid; font-size: 14px;">
                                            <input class="invoice-fields short_textbox " type="text" value="<?= $sectionsdata['section2']['data']['opportunity2_emp_comment'] ? $sectionsdata['section2']['data']['opportunity2_emp_comment'] : '' ?>" name="opportunity2_emp_comment" id="opportunity2_emp_comment" data-type='text' autocomplete="off" readonly />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px solid; font-size: 14px;">
                                            <input class="invoice-fields short_textbox " type="text" value="<?= $sectionsdata['section2']['data']['opportunity3'] ? $sectionsdata['section2']['data']['opportunity3'] : '' ?>" name="opportunity3" id="opportunity3" data-type='text' autocomplete="off" readonly />
                                        </td>
                                        <td style="border: 1px solid; font-size: 14px;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td width="50%" style="border-top:0px;">
                            <strong style="font-size: 14px;">
                                ...
                                <textarea id="section3ManagerComment" name="section3ManagerComment" class="invoice-fields auto-height long_textbox" rows="6" data-type='textarea' ><?php echo $sectionsdata['section3']['data']['section3ManagerComment'] ?></textarea>
                    ...
                    <tr>
                        <td width="50%" style="border-top:0px;">
                            ...
                            <textarea id="section3EmployeeComment" name="section3EmployeeComment" class="invoice-fields auto-height long_textbox" rows="6" data-type='textarea' readonly><?php echo $sectionsdata['section3']['data']['section3EmployeeComment'] ?></textarea>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid; font-size: 14px;">
                                                ...
                                                <?php if ($sectionsdata['section4']['data']['section4managerSignature']) { ?>
                                                    ...
                                                    <?php } ?><br>
                                                    <strong> Signature Date : </strong> <span id="section4managerSignatureDate"><?php echo $sectionsdata['section4']['data']['section4employeeSignatureDate'] ? formatDateToDB($sectionsdata['section4']['data']['section4employeeSignatureDate'], DB_DATE_WITH_TIME, SITE_DATE) : ''; ?></span><br>
                                        ...
                                        <tr>
                                            <td style="border: 1px solid; font-size: 14px;">
                                                ...
                                                <?php if ($sectionsdata['section4']['data']['section4nextLevelSignature']) { ?>
                                                    ...
                                                    <?php } else { ?>
                                                        ...
                                                        <a class="btn btn-success btn-sm jsSetAuthorizedSignature jsSetAuthorizedSignature_2" data-key="2">
                                                            Create E-Signature
                                                        </a><img style="max-height: 75px" alt="" class="authorized_signature_img_2" id="section4nextLevelSignature">
                                                    <?php } ?> <br>
                                                    <strong> Signature Date : </strong><span id="section4nextLevelSignatureDate"><?php echo $sectionsdata['section4']['data']['section4nextLevelSignatureDate'] ? formatDateToDB($sectionsdata['section4']['data']['section4nextLevelSignatureDate'], DB_DATE_WITH_TIME, SITE_DATE) : ''; ?></span><br>

                                            </td>
                                            <td style="border: 1px solid; font-size: 14px;">

                                                <?php if ($sectionsdata['section4']['data']['section4hrSignature']) { ?>
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <a class="btn btn-success btn-sm jsSetAuthorizedSignature jsSetAuthorizedSignature_3" data-key="3">
                                                        Create E-Signature
                                                    </a><img style="max-height: 75px" alt="" class="authorized_signature_img_3" id="section4hrSignature" data-documentId='<?php echo $document['sid']; ?>'>
                                                <?php } ?> <br><br>
                                                <strong> Signature Date : </strong><span id="section4hrSignatureDate"><?php echo $sectionsdata['section4']['data']['section4hrSignatureDate'] ? formatDateToDB($sectionsdata['section4']['data']['section4hrSignatureDate'], DB_DATE_WITH_TIME, SITE_DATE) : ''; ?></span><br>
...
<script language="JavaScript" type="text/javascript">
    ...
    //revoke_library_document


    $('#section4hrSignature').on('load', function() {

        let hrSignatrue = $('#section4hrSignature').attr('src');
        $('#loader').show();

        var baseURI = "<?= base_url('hr_documents_management/handler'); ?>";

        var formData = new FormData();
        formData.append('document_sid', '<?php echo $document['sid']; ?>');
        formData.append('action', 'section4hrSignature');
        formData.append('hrSignatrue', hrSignatrue);
        formData.append('user_type', '<?php echo $document['user_type']; ?>');
        formData.append('user_sid', '<?php echo $document['user_sid']; ?>');
        ...
        $.ajax({
            ...
            var successMSG = 'Docuemnt Signed successfully.';
    ...
    $('#section4managerSignature').on('load', function() {
        let managerSignatrue = $('#section4managerSignature').attr('src');
        $('#loader').show();
        ...
        var formData = new FormData();
        formData.append('document_sid', '<?php echo $document['sid']; ?>');
        formData.append('action', 'section4managerSignature');
        formData.append('managerSignatrue', managerSignatrue);
        formData.append('user_type', '<?php echo $document['user_type']; ?>');
        formData.append('user_sid', '<?php echo $document['user_sid']; ?>');
    ...
    $('#section4nextLevelSignature').on('load', function() {
        let nextLevelSignatrue = $('#section4nextLevelSignature').attr('src');
        $('#loader').show();
        ...
        var formData = new FormData();
        formData.append('document_sid', '<?php echo $document['sid']; ?>');
        formData.append('action', 'section4nextLevelSignature');
        formData.append('nextLevelSignatrue', nextLevelSignatrue);
        formData.append('user_type', '<?php echo $document['user_type']; ?>');
        formData.append('user_sid', '<?php echo $document['user_sid']; ?>');

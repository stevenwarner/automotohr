                    ...
                    <tr>
                        <td>
                            ...
                            <strong style="font-size: 10px;"> Use this form to officially notify the Company that an employee who reports to you is
                                now Terminated. This will insure that appropriate action is taken and that the employee receives
                                their final check.</strong><br>
        ...
        <section class="pdf-cover-page">
            ...
            <table class="table table-border-collapse" style="width: 93%;">
                <tbody>
                    ...
                    <tr>
                        <td class="" width="100%"><br>
                            <strong style="font-size: 14px;">Employee name: </strong>
                            <input class="invoice-fields short_textbox" type="text" value="<?= $formInputData['short_textbox_0'] ? $formInputData['short_textbox_0'] : '' ?>" name="short_textbox_0" id="short_textbox_0_id" data-type='text' readonly style="width: 70%;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td width="50%">
                            ...
                            <input class="invoice-fields" type="text" value="<?= $formInputData['short_textbox_1'] ? $formInputData['short_textbox_1'] : '' ?>" name="job_title" readonly style="width: 79%;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td width="50%">
                            ...
                            <input class="invoice-fields" type="text" value="<?= $formInputData['short_textbox_2'] ? $formInputData['short_textbox_2'] : '' ?>" name="supervisor" readonly style="width: 74%;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td width="50%">
                            ...
                            <input class="invoice-fields" type="text" value="<?= $formInputData['short_textbox_3'] ? $formInputData['short_textbox_3'] : '' ?>" name="last_day_of_work" readonly style="width: 74%;" /><br>
                        </td>
                    </tr>

                ...
                <tbody>
                    ...
                    <tr>
                        <td class="" width="100%"><br>
                            ...
                            <input class="invoice-fields" type="text" value="<?= $formInputData['short_textbox_1'] ? $formInputData['short_textbox_1'] : '' ?>" name="department" readonly style="width: 73%;" />
                        </td>
                    </tr>
                    <tr>
                        <td width="50%">
                            <strong style="font-size: 14px;">Date of occurrence: </strong>
                            <input class="invoice-fields" type="text" value="<?= $formInputData['short_textbox_2'] ? $formInputData['short_textbox_2'] : '' ?>" name="date_of_occurrence" readonly style="width: 68%;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td width="100%"><br>
                            <strong style="font-size: 14px;">Summary of violation:</strong><br>
                    ...
                    <tr>
                        <td width="100%"><br> <br>
                            <strong style="font-size: 14px;">Summary of corrective plan:</strong><br>
                            <?= $formInputData['long_textbox_0'] ? $formInputData['long_textbox_0'] : '' ?>
                    ...
                    <tr>
                        <td width="50%">
                            ...
                            <input class="invoice-fields" type="text" value="<?= $formInputData['short_textbox_4'] ? $formInputData['short_textbox_4'] : '' ?>" name="follow_up_dates" readonly style="width: 67%;" />
                        </td>
                    </tr>
                </tbody>
            </table>

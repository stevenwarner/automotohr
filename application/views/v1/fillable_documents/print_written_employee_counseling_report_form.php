                ...
                <tbody>
                    <tr>
                        <td width="100%">
                            ...
                            <input class="invoice-fields" type="text" value="<?= $formInputData['short_textbox_0'] ? $formInputData['short_textbox_0'] : '' ?>" name="employee_name" readonly style="width: 70%;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td width="100%">
                            ...
                            <input class="invoice-fields" type="text" value="<?= $formInputData['short_textbox_1'] ? $formInputData['short_textbox_1'] : '' ?>" name="employee_number" readonly style="width: 68%;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td width="100%">
                            ...
                            <input class="invoice-fields" type="text" value="<?= $formInputData['short_textbox_2'] ? $formInputData['short_textbox_2'] : '' ?>" name="job_title" readonly style="width: 75%;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td width="100%">
                            ...
                            <input class="invoice-fields" type="text" value="<?= $formInputData['short_textbox_3'] ? $formInputData['short_textbox_3'] : '' ?>" name="department" readonly style="width: 73%;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td width="100%">
                            ...
                            <input class="invoice-fields" type="text" value="<?= $formInputData['short_textbox_4'] ? $formInputData['short_textbox_4'] : '' ?>" name="location" readonly style="width: 75%;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td width="100%">
                            ...
                            <input class="invoice-fields" type="text" value="<?= $formInputData['short_textbox_5'] ? $formInputData['short_textbox_5'] : '' ?>" name="supervisor" readonly style="width: 74%;" />
                        </td>
                    </tr>

                    <tr>
                        <td width="100%">
                            <strong style="font-size: 14px;">Description of problem, including relevant dates and other people involved</strong><br>
                    ...
                    <tr>
                        <td width="100%">
                            <strong style="font-size: 14px;">Description of performance or behavior that is expected</strong><br>
                    ...
                    <tr>
                        <td width="100%">
                            <strong style="font-size: 14px;">Other information you would like to provide</strong><br>

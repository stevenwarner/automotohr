             ...
             <div class="panel-body">
                 ...
                 <div class="form-group">
                     ...
                     <select name="flsa_status" class="form-control jsFLSAStatus">
                         <option <?= $jobWageData["flsaStatus"] == "Exempt" ? "selected" : ""; ?> value="Exempt">Salary/No overtime</option>
                         <option <?= $jobWageData["flsaStatus"] == "Salaried Commission" ? "selected" : ""; ?> value="Salaried Commission">Salary/Commission</option>
                         <option <?= $jobWageData["flsaStatus"] == "Salaried Nonexempt" ? "selected" : ""; ?> value="Salaried Nonexempt">Salary/Eligible for overtime</option>
                         <option <?= $jobWageData["flsaStatus"] == "Nonexempt" ? "selected" : ""; ?> value="Nonexempt">Paid by the hour</option>
                         <option <?= $jobWageData["flsaStatus"] == "Owner" ? "selected" : ""; ?> value="Owner">Owner's draw</option>
                     </select>
                 </div>
                 ...
                 <div class="form-group">
                     ...
                     <select name="overtime_rule" class="form-control jsOvertimeRule">
                         <option value="0">Please select over time rule</option>
                         <?php
                            if ($overtimeRules) {
                         ...
                         <?php
                            ...
                            ?>
                                 ...
                                 <?php foreach ($v0 as $v1) { ?>
                                     <option value="<?= $v1["sid"]; ?>" <?php echo in_array($v1["gusto_uuid"], $jobWageData["minimumWages"]) ? "selected" : ''; ?>><?= $v1["wage_type"]; ?> $<?= $v1["wage"]; ?> effected at <?= formatDateToDB($v1["effective_date"], DB_DATE, DATE); ?></option>
                                 <?php } ?>
                         <?php
                                }
                            }
                 ...
                 <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                         <div class="form-group">
                             ...
                             <input type="number" class="form-control readonly jsEmployeeGuaranteeRate" placeholder="0.00" value="<?= $jobWageData["guaranteeInfo"]["guarantee_rate"]; ?>" />
                         </div>
                         ...
                         <div class="form-group">
                             ...
                             <select class="form-control jsEmployeeGuaranteePayType">
                                 <option <?= $jobWageData["guaranteeInfo"]["guarantee_per"] == "Hour" ? "selected" : ""; ?> value="Hour">Per hour</option>
                                 <option <?= $jobWageData["guaranteeInfo"]["guarantee_per"] == "Week" ? "selected" : ""; ?> value="Week">Per week</option>
                                 <option <?= $jobWageData["guaranteeInfo"]["guarantee_per"] == "Month" ? "selected" : ""; ?> value="Month">Per month</option>
                                 <option <?= $jobWageData["guaranteeInfo"]["guarantee_per"] == "Year" ? "selected" : ""; ?> value="Year">Per year</option>
                                 <option <?= $jobWageData["guaranteeInfo"]["guarantee_per"] == "Paycheck" ? "selected" : ""; ?> value="Paycheck">Per paycheck</option>
                             </select>
                         </div>
                         ...
                         <div class="form-group">
                             ...
                             <input type="number" class="form-control readonly jsEmployeeGuaranteeTimes" placeholder="1" value="<?= $jobWageData["guaranteeInfo"]["guarantee_times"]; ?>" />
                         </div>
                     </div>
                 </div>
             </div>

                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-lg-6 order-1-on-mobile">
                            <div class="position-relative">
                                <img src="./assets/v1/app/images/WhyUsBackCover.png" class="whyUsBackCover" alt="why us back cover" />
                                <img src="./assets/v1/app/images/girlWithBook.png" class="girl-width-book" alt="girl with book" />
                                <img src="./assets/v1/app/images/fullPurpleCircle.png" class="whyus-full-purple" alt="purple circle" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-lg-6 ">
                            ...
                            <div class="row margin-top-30">
                                <div class="col-3 col-sm-3 text-center ">
                                    <img src="./assets/v1/app/images/Group 6901.png" alt="database icon" />
                                </div>
                            ...
                            <div class="row margin-top-20">
                                <div class="col-3 text-center ">
                                    <img src="./assets/v1/app/images/Group 6903.png" alt="attendance tracking icon" />
                                </div>
                                <div class="col-9">
                            ...
                            <div class="row margin-top-20">
                                <div class="col-3 text-center ">
                                    <img src="./assets/v1/app/images/Group 6905.png" alt="workflow  icon" />
                                </div>
                                <div class="col-9">
                        ...
                        <div class="col-xs-12 col-lg-6 flex-end">
                            <div class="image-containing-div position-relative">
                                <img src="./assets/v1/app/images/singleGirlWithDocuments.png" class="full-width-height-img" alt="girl with documents" />
                                <img src="./assets/v1/app/images/lightbluehalfcircle.png" class="whyus-half-blue-circle" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-80 section-two-padding-whyus">
                    <div class="row">
                        <div class="col-xs-12 col-lg-6 order-2-product">
                            ...
                            <div class="row margin-top-30">
                                <div class="col-3 col-sm-3 text-center ">
                                    <div class="whyus-icons">
                                        <img src="./assets/v1/app/images/Group 6974.png" alt="database icon" />
                                    </div>
                            ...
                            <div class="row margin-top-20">
                                <div class="col-3 text-center ">
                                    <img src="./assets/v1/app/images/Group 6975.png" alt="database icon" />
                                </div>
                                <div class="col-9">
                            ...
                            <div class="row margin-top-20">
                                <div class="col-3 text-center ">
                                    <img src="./assets/v1/app/images/twoPersonsClappingIcon.png" alt="database icon" />
                                </div>
                                <div class="col-9">
                        ...
                        <div class="col-xs-12 col-lg-6 flex-start order-1-product">
                            <div class="image-containing-div position-relative">
                                <img src="./assets/v1/app/images/singleManWithDocumnets.png" class="full-width-height-img" alt="man with documents" />
                                <img src="./assets/v1/app/images/lightbluehalfcircle.png" class="whyus-half-blue-circle-start" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-80 section-two-padding-whyus">
                    <div class="row">
                        <div class="col-xs-12 col-lg-6 ">
                            ...
                            <div class="row margin-top-30">
                                <div class="col-3 col-sm-3 text-center ">
                                    <img src="./assets/v1/app/images/Group_h_1.png" alt="speaker icon" />
                                </div>
                                <div class="col-9 col-sm-9 ">
                            ...
                            <div class="row margin-top-20">
                                <div class="col-3 text-center ">
                                    <img src="./assets/v1/app/images/Group_h_3.png" alt="settings icon" />
                            ...
                            <div class="row margin-top-20">
                                <div class="col-3 text-center ">
                                    <img src="./assets/v1/app/images/Group_h_2.png" alt="checklist icon" />
                                </div>
                                <div class="col-9">
                        ...
                        <div class="col-xs-12 col-lg-6 flex-end">
                            <div class="image-containing-div position-relative">
                                <img src="./assets/v1/app/images/twoPersonsHandShaking.png" class="full-width-height-img" alt="girl with documents" />
                                <img src="./assets/v1/app/images/lightbluehalfcircle.png" class="whyus-half-blue-circle" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-lg-6 order-2-product">
                            ...
                            <div class="row margin-top-30">
                                <div class="col-3 col-sm-3 text-center ">
                                    <div class="whyus-icons">
                                        <img src="./assets/v1/app/images/office_face_icon.png" alt="officer icon" />
                                    </div>
                            ...
                            <div class="row margin-top-20">
                                <div class="col-3 text-center ">
                                    <img src="./assets/v1/app/images/clockUmbrella.png" alt="attendance tracking icon" />
                                </div>
                                <div class="col-9">
                            ...
                            <div class="row margin-top-20">
                                <div class="col-3 text-center ">
                                    <img src="./assets/v1/app/images/alienShip.png" alt="workflow  icon" />
                                </div>
                                <div class="col-9">
                        ...
                        <div class="col-xs-12 col-lg-6 flex-start order-1-product">
                            <div class="image-containing-div position-relative">
                                <img src="./assets/v1/app/images/manSmilingWithBook.png" class="full-width-height-img" alt="man sitting with book" />
                                <img src="./assets/v1/app/images/lightbluehalfcircle.png" class="whyus-half-blue-circle-start" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-80 section-two-padding-whyus">
                    <div class="row">
                        <div class="col-xs-12 col-lg-6 ">
                            ...
                            <div class="row margin-top-30">
                                <div class="col-3 col-sm-3 text-center ">
                                    <img src="./assets/v1/app/images/selfServiceOne.png" alt="database icon" />
                                </div>
                                <div class="col-9 col-sm-9 ">
                            ...
                            <div class="row margin-top-20">
                                <div class="col-3 text-center ">
                                    <img src="./assets/v1/app/images/selfServiceTwo.png" alt="attendance tracking icon" />
                                </div>
                                <div class="col-9">
                        ...
                        <div class="col-xs-12 col-lg-6 flex-end">
                            <div class="image-containing-div position-relative">
                                <img src="./assets/v1/app/images/girlWithPhoneAndTablet.png" class="full-width-height-img" alt="girl with phone and tablet" />
                                <img src="./assets/v1/app/images/lightbluehalfcircle.png" class="whyus-half-blue-circle" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-lg-6 order-2-product">
                            ...
                            <div class="row margin-top-30">
                                <div class="col-3 col-sm-3 text-center ">
                                    <div class="whyus-icons">
                                        <img src="./assets/v1/app/images/scaleableOne.png" alt="Businesses of All Sizes" />
                                    </div>
                            ...
                            <div class="row margin-top-20">
                                <div class="col-3 text-center ">
                                    <img src="./assets/v1/app/images/scaleableTwo.png" alt="Industry Relevant icon" />
                                </div>
                                <div class="col-9">
                        ...
                        <div class="col-xs-12 col-lg-6 flex-start order-1-product">
                            <div class="image-containing-div position-relative">
                                <img src="./assets/v1/app/images/manAndWomenClapping.png" class="full-width-height-img" alt="man sitting with book" />
                                <img src="./assets/v1/app/images/lightbluehalfcircle.png" class="whyus-half-blue-circle-start" />
                            </div>
                        </div>
                    </div>
        ...
        <div class="row whyus-bluish-background">
            <div class="col-xs-12 column-flex-center">
                <div class="w-80 section-padding-whyus">
                    <div class="row">
                        <div class="col-xs-12 col-lg-6">
                            <img src="./assets/v1/app/images/whyUsLastSectionImage.png" class="w-h-100" />
                        </div>
                        <div class="col-xs-12 col-lg-6">
                            <div class="row">
                                <div class="col-xs-12 ">

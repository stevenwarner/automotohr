<main>
    <div class="row">
        <div class="col-xs-12 column-flex-center background-border-radius top-background-div" style="background-image: url(/assets/v1/app/images/frame85.png);">
            ...
            <div class="row margin-top-40 boxes-absolute ">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 padding-right-box">
                    <div class="background-white contact-boxes-width py-4">
                        <div class="sales-support-div">
                            <h2 class="sales-support"> <?php echo $contactUsContent['page']['salesHeading']['text'] ?></h2>
                        </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 ">
                    <div class="background-white contact-boxes-width py-4">
                        <div class="sales-support-div">
                            <h2 class="sales-support"><?php echo $contactUsContent['page']['technicalHeading']['text'] ?></h2>
                        </div>
                        <div class="flex-center justify-content-center-mobile">
                            <div class="anchor-span-grey ">
                                <a href="#" class="simple-anchor-icons "><i class="fa-solid dark-grey-color fa-phone"></i></a>
                        ...
                        <div class="row">
                            <div class="col-xs-12 ">
                                ...
                                <div class="form-adjustment">
                                    <h2 class="send-us-text margin-bottom-20 text-center-mobile"><?php echo $contactUsContent['page']['formHeading1']['text'] ?> </h2>
                                    <p class="dark-grey-color margin-bottom-30 text-center-mobile"><?php echo $contactUsContent['page']['formHeading2']['text'] ?></p>
                                    ...
                                    <input class="contact-us-input dark-grey-color" placeholder="Your Name*" value="<?php echo set_value('name'); ?>" type="text" name="name" id="name" />
                                    <?php echo form_error('name');
                                    ?>
                                    <input class="contact-us-input dark-grey-color" placeholder="Your Email*" value="<?php echo set_value('email'); ?>" type="Email" id="email" name="email" />
                                    <?php echo form_error('email');
                                    ?>

                                    <textarea placeholder="Your Message" class="form-control border-radius-25 dark-grey-color" id="message" rows="4" name="message"><?php echo set_value('message'); ?> </textarea>
                                    ...
                                    <br><button class="d-flex justify-content-center align-items-center forgot-password-buttons btn-animate" type="submit" onclick="validate_form()">

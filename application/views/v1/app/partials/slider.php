    ...
    <div class="carousel-inner">
        ...
        <?php foreach ($pageContent["slider"] as $index => $slide) : ?>
            ...
            <div class="carousel-item <?= $index === 0 ? 'active' : '' ?> position-relative">
                <div class="slider-one-background d-flex" style="background-image: url('<?= AWS_S3_BUCKET_URL.$slide['image'] ?>')">
                        ...
                        <div class="d-flex mb-xl-5 mb-0 slider-content">
                            <div class="px-5 ms-lg-5 me-lg-3 mx-0 d-flex flex-column align-items-lg-start align-items-center justify-content-center text-center-onmobile">
                                <h1 class="slider_heading title w-70">
                                    <?= convertToStrip($slide['heading']); ?>
                                </h1>
                                <p class="slider-detail mt-4 slider_detail opacity-eighty auto-mobile-slider-detail-color">
                                    <?= convertToStrip($slide['headingDetail']); ?>
                                </p>
                                <a href="<?= base_url($slide['btnSlug']); ?>" class="button jsButtonAnimate explore_btn d-flex top-button text-white mt-5">
                                    <p class="btn-text mb-0"><?= convertToStrip($slide['btnText']); ?></p>

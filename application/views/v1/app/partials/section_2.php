        ...
        <div class="row d-flex align-items-center justify-content-center">
            ...
            <div class="col-lg-6 col-12 order-lg-2 order-1">
                <div class="position-relative d-flex justify-content-center align-items-center career_section_inner">
                    ...
                    <img src="<?= base_url('assets/v1/app/images/hiring_section_img.png'); ?>" class="width_80 margin-left-onmobile hiring_section_laptop_img section_img" alt="laptop image" />
                    ...
                    <div class="hiring_section_bubble_3 d-lg-flex d-none">
                        <div class="bubble_3"></div>
                    </div>
                    <div class="hiring_section_bubble_4 d-lg-block d-none">
...
<!-- Slide 2 -->
<div class="payroll_section_main py-5 width_100 d-flex justify-content-center position-relative z-index-one">
    <div class="row d-flex flex-lg-row flex-column align-items-center width_90">
        <div class="col-lg-6 col-12">
            <div class="position-relative d-flex justify-content-center">
                <img src="<?= base_url('assets/v1/app/images/payroll_section_img.png'); ?>" class="payroll_img width_100 section_img" alt="laptop with ipad image" />
        ...
        <div class="row d-flex align-items-center justify-content-lg-between justify-content-center">
            ...
            <div class="col-lg-6 col-12 d-flex justify-lg-content-end justify-content-center order-lg-2 order-1">
                <div class="position-relative">
                    ...
                    <img src="<?= base_url('assets/v1/app/images/employee_experience_img.png'); ?>" class="employee_img width_100 section_img" alt="mobile and tablet image" />
                </div>
            </div>
        </div>
    </div>
...
<div class="payroll_section_main py-5 width_100 d-flex justify-content-center position-relative">
    <div class="row d-flex flex-lg-row flex-column align-items-center width_80">
        <div class="col-lg-6 col-12">
            <div class="position-relative d-flex justify-content-center">
                <img src="<?= base_url('assets/v1/app/images/monitoring_section_img.png'); ?>" class="payroll_img section_img" alt="mobile and tablet image" />
                <div class="payroll_section_bubble_1 d-lg-block d-none"></div>
                <div class="payroll_section_bubble_2 d-lg-block d-none">
                    <div class="bubble_2"></div>
                </div>
        ...
        <div class="row d-flex align-items-center justify-content-lg-between justify-content-center">
            ...
            <div class="col-lg-6 col-12 d-flex justify-lg-content-end justify-content-center order-lg-2 order-1">
                <div class="position-relative">
                    ...
                    <img src="<?= base_url('assets/v1/app/images/succeed_section_img.png'); ?>" class="employee_img section_img" alt="mobile and tablet image" />
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row d-flex align-items-center justify-content-center">
            <div class="col-lg-6 col-12 d-flex justify-content-center">
                <div class="position-relative d-flex justify-content-center career_section_inner">
                    <img src="<?= base_url('assets/v1/app/images/career_section_img.png'); ?>" class="width_80 margin-left-onmobile section_img" alt="mobile and tablet image with jobs search screen" />

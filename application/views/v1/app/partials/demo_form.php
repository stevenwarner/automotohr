...
<form method="post" action="javascript:void(0)" class="form" id="<?= $id ?? "jsScheduleFreeDemoMain"; ?>">
    ...
    <div class="form-group mt-4">
        <textarea class="form-control textarea" id="client_message" rows="5" placeholder="Please let us know the types of Features that are most important to you and what you are looking for in your new system." name="client_message"></textarea>
    </div>
    ...
    <button class="button p-3 explore_btn schedule-btn schedule-btn-demo d-flex text-white mt-4 width_100 mb-lg-0 mb-5 auto-schedule-btn jsButtonAnimate jsScheduleDemoMainBtn <?= $buttonClass ?? ""; ?>" id="schedule-free-demo-form-submit" type="submit">
        <p class="mb-0 btn-text">
            <?= $buttonText ?? "Schedule Your No Obligation Consultation"; ?>
        </p>

                                ...
                                <div class="col-xs-12 col-md-6 col-lg-4">
                                    <div class="card card-margin-bottom">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">
                                                <?= substr(strip_tags($resource['title']), 0, 200) . '...'; ?>
                                            </p>
                    ...
                    <div class="row resources-subscribe-row ">
                        <div class="col-xs-12 col-xl-7 column-center">
                            ...
                            <div class="file-btn-div subscribe-input-div">
                                ...
                                <button for="file-input" id="jsSubscribeCommunity" class="custom-file-upload " data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    Subscribe
                                    <i class="fa-solid fa-arrow-right top-button-icon ps-3"></i>
                                </button>
                            </div>
            ...
            .success(function(response) {
                ...
                if (response.length) {
                    response.map(function(blog) {
                        var strippedtitleblog = blog.title.replace(/(<([^>]+)>)/ig, "");
            ...
            .success(function(response) {
                ...
                if (response.length) {
                    response.map(function(resource) {
                        ...
                        //
                        var strippedtitle = resource.title.replace(/(<([^>]+)>)/ig, "");

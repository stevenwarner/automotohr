        ...
        <div class="row">
            <div class="col-md-12 image-section-padding-product">
                <div class=" linebackround column-flex-center">
                    <h2>HR Electronic Onboarding</h2>
                </div>
            </div>
        </div>
        <div class="row">
                            ...
                            <form method="post" action="<?= base_url('schedule_your_free_demo'); ?>" class="form" id="schedule-free-demo-form2">
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="form-div">
                                        ...
                                        <input type="text" class="title-field" placeholder="title*" name="title" name="title2" required />
                                        <?php echo form_error('title'); ?>
                                        ...
                                        <textarea class="form-control border-radius-25 dark-grey-color" id="client_message" rows="4" placeholder="Message" name="client_message" id="client_message2"></textarea>

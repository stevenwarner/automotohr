        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xs-8" style="border: 1px solid #000; padding: 10px;">
                    ...
                    <input type="checkbox" name="" id="" /> 4. A noncitizen (other than Item Numbers 2. and 3. above) authorized to work until (exp. date, if any) <br>
                </div>
            </div>
        </div>
        <!--  -->
        ...
        <table class="i9-table">
            <tr>
                ...
                <td style="width: 40%;">
                    ...
                    <span class="value-box" id=""><?php echo isset($form['section1_today_date']) ? DateTime::createFromFormat('Y-m-d H:i:s', $form['section1_today_date'])->format('m/d/Y') : ''; ?></span>
                </td>
            </tr>
        </table>
        <?php
            ...
            <tbody>
                <tr>
                    ...
                    <td style="width: 30%" colspan="3">
                        <label>Today's Date (mm/dd/yyyy)</label>
                        <span class="value-box" id=""><?php echo isset($form['section1_preparer_today_date']) ? DateTime::createFromFormat('Y-m-d H:i:s', $form['section1_preparer_today_date'])->format('m/d/Y') : ''; ?></span>
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%">
        ...
        <section class="sheet padding-10mm">
                            ...
                            <table class="nested-table">
                                ...
                                <tr class="thick-border">
                                    <td class="thick-border">
                                        ...
                                        <span class="value-box no-border" id="">
                                            <?php echo isset($form['section2_lista_part1_expiration_date']) ? DateTime::createFromFormat('Y-m-d H:i:s', $form['section2_lista_part1_expiration_date'])->format('m/d/Y') : ''; ?>
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr class="thick-border">
                                    <td class="thick-border">
                                        <label>Expiration Date (if any)(mm/dd/yyyy)</label>
                                        <span class="value-box no-border" id="">
                                            <?php echo isset($form['section2_lista_part2_expiration_date']) ? DateTime::createFromFormat('Y-m-d H:i:s', $form['section2_lista_part2_expiration_date'])->format('m/d/Y') : ''; ?>
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="thick-border">
                                        <label>Expiration Date (if any)(mm/dd/yyyy)</label>
                                        <span class="value-box no-border" id="">
                                            <?php echo isset($form['section2_lista_part3_expiration_date']) ? DateTime::createFromFormat('Y-m-d H:i:s', $form['section2_lista_part3_expiration_date'])->format('m/d/Y') : ''; ?>
                                        </span>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table class="nested-table no-border">
                                ...
                                <tr class="thick-border">
                                    <td>
                                        <label>Expiration Date (if any)(mm/dd/yyyy)</label>
                                        <span class="value-box no-border" id="">
                                            <?php echo isset($form['section2_listb_expiration_date']) ? DateTime::createFromFormat('Y-m-d H:i:s', $form['section2_listb_expiration_date'])->format('m/d/Y') : ''; ?>
                                        </span>
                                    </td>
                                    <td>
                                        <label>Expiration Date (if any)(mm/dd/yyyy)</label>
                                        <span class="value-box no-border" id="">
                                            <?php echo isset($form['section2_listc_expiration_date']) ? DateTime::createFromFormat('Y-m-d H:i:s', $form['section2_listc_expiration_date'])->format('m/d/Y') : ''; ?>
                                        </span>
                                    </td>
                                </tr>
                            </table>
            ...
            <div class="mb-2">
                <strong>The employee's first day of employment (mm/dd/yyyy): <div class="inline-value-box">
                        <span class="value-box" id=""><?php echo isset($form['section2_firstday_of_emp_date']) ? DateTime::createFromFormat('Y-m-d H:i:s', $form['section2_firstday_of_emp_date'])->format('m/d/Y') : ''; ?></span>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <label>Today's Date (mm/dd/yyyy)</label>
                            <span class="value-box no-border" id="">
                                <?php echo isset($form['section2_today_date']) ? DateTime::createFromFormat('Y-m-d H:i:s', $form['section2_today_date'])->format('m/d/Y') : ''; ?>
                            </span>
                        </td>
                        <td colspan="2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="value-box no-border" id="">
                                <?php echo isset($form['section3_rehire_date']) ? DateTime::createFromFormat('Y-m-d H:i:s', $form['section3_rehire_date'])->format('m/d/Y') : ''; ?>
                            </span>
                        </td>
                    </tr>
                </tbody>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 35%;">
                            <label>Expiration Date (if any) (mm/dd/yyyy)</label>
                            <span class="value-box no-border" id="">
                                <?php echo isset($form['section3_expiration_date']) ? DateTime::createFromFormat('Y-m-d H:i:s', $form['section3_expiration_date'])->format('m/d/Y') : ''; ?>
                            </span>
                        </td>
                    </tr>
                </tbody>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="width: 20%;">
                            <label>Today's Date (mm/dd/yyyy)</label>
                            <span class="value-box no-border" id="">
                                <?php echo isset($form['section3_today_date']) ? DateTime::createFromFormat('Y-m-d H:i:s', $form['section3_today_date'])->format('m/d/Y') : ''; ?>
                            </span>
                        </td>
                        <td style="width: 40%;">

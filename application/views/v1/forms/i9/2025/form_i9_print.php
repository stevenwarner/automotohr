                                ...
                                <tr class="thick-border">
                                    <td class="thick-border">
                                        ...
                                        <span class="value-box no-border" id="">
                                            <?php echo isset($pre_form['section2_lista_part1_expiration_date']) && !empty($pre_form['section2_lista_part1_expiration_date']) ? DateTime::createFromFormat('Y-m-d H:i:s', $pre_form['section2_lista_part1_expiration_date'])->format('m/d/Y') : ''; ?>
                                        </span>
                                    </td>
                                </tr>
                                <tr>

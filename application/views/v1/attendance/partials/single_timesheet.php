                        ...
                        ?>
                                <div class="row jsEventRow" data-id="<?= $v0["sid"]; ?>">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" name="start_time_<?= $v0["sid"]; ?>" class="form-control jsTimeField" value="<?= $v0[$indexStart] ? reset_datetime([
                                                                                                                                            "datetime" => $v0[$indexStart],
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" name="end_time_<?= $v0["sid"]; ?>" class="form-control jsTimeField" value="<?= $v0[$indexEnd] ? reset_datetime([
                                                                                                                                            "datetime" => $v0[$indexEnd],
                                                                                                                                            "from_format" => DB_DATE_WITH_TIME,
                                                                                                                                            "format" => "h:i a",
                                                                                                                                            "_this" => $this,
                                                                                                                                            "from_timezone" => "UTC"

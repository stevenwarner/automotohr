        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="site_name" value="<?= $record["site_name"]; ?>" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="street_1" value="<?= $record["street_1"]; ?>" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="street_2" value="<?= $record["street_2"]; ?>" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="state">
                        ...
                        ?>
                                <option value="<?= $v0["sid"]; ?>" <?= $record["state"] === $v0["sid"] ? "selected" : ""; ?>><?= $v0["state_code"]; ?></option>
                        <?php
                            }
                        } ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="zip_code" value="<?= $record["zip_code"]; ?>" />
                </div>

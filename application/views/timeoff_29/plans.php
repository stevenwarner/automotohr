                ...
                <div class="col-lg-9 col-md-9 col-xs-12 col-sm-8">
                    ...
                    <div class="right-content-2 js-page" id="js-page-add" <?=$page != 'add' ? 'style="display: none;"' : '';?>>
                        ...
                        <div class="row">
                            <div class="col-lg-12 checkbox-styling margin-top">
                                <label>
                                    <input type="checkbox" class="checkbox-sizing" id="js-archived-add" /> <span>Archive</span>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="right-content-2 js-page" id="js-page-edit" <?=$page != 'edit' && $planSid != null ? 'style="display: none;"' : '';?>>
                        ...
                        <div class="row">
                            <div class="col-lg-12 checkbox-styling margin-top">
                                <label>
                                    <input type="checkbox" class="checkbox-sizing" id="js-archived-edit" /> <span>Archive</span>
                                </label>
                            </div>
                        </div>

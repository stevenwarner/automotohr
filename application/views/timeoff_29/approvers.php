                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="">
                                                            <select class="invoice-fields" id="js-filter-departments"></select>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                ...
                                <div class="border-top-section border-bottom">
                                    ...
                                    <div class="col-xs-6 col-lg-6">
                                        <div class="pto-top-heading-right-add-plan text-right">
                                            <div class="btn-filter-reset">
                                                <button type="button" class="btn btn-reset js-view-page-btn"><span><i class="fa fa-angle-left"></i></span>&nbsp;VIEW APPROVERS</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="js-content-area">
                            ...
                            <div class="row margin-top">
                                <div class="col-sm-6 col-xs-12">
                                    ...
                                    <div class="">
                                        <select class="invoice-fields" id="js-departments-add"></select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="js-content-area">
                            ...
                            <div class="row margin-top">
                                <div class="col-sm-6 col-xs-12">
                                    <label>Departments <span class="cs-required">*</span></label>
                                    <div class="">
                                        <select class="invoice-fields" id="js-departments-edit"></select>
                                    </div>
                                </div>
                            </div>

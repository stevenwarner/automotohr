                        ...
                        <td style="width: 70%;">
                            <table class="i9-table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="" <?php echo $pre_form['section1_penalty_of_perjury'] == 'alien-work' ? 'checked' : '' ?> disabled> 4. A noncitizen (other than Item Numbers 2. and 3. above) authorized to work until (exp. date, if any)
                                            <div class="inline-value-box">

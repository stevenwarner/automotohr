                    ...
                    <div class="col-md-12 col-xs-12">
                        ...
                        <select class="form-control jsEWD">
                            <?php foreach ($locations as $location) : ?>
                                <option value="<?= $location['gusto_uuid']; ?>" <?php echo $workAddressId == $location['gusto_location_id'] ? 'selected="selected"' : ''; ?>><?php echo $location['street_1'] . ', ' . $location['city'] . ', ' . $location['state'] . ' - ' . $location['zip']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>

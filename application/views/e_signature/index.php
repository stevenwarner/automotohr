...
?>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                ...
                                <span class="page-heading down-arrow">
                                    <a class="dashboard-link-btn" href="<?php echo base_url('my_profile'); ?>"><i class="fa fa-chevron-left"></i>My Profile</a>
                                    <?php echo $title; ?>
                                </span>
                                </div>
                                <?php if (isset($consent) && $consent == 1) { ?>
                                <button onclick="func_regenerate_e_signature();" type="button" class="btn btn-success break-word-text margin-bottom-20">
                            ...
                            <?php } ?></h1>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                        ...
                                        <?php } ?>
                                        <p class="e_signature_type_fixed_p e_signature_font_family_5" id="tergit"><?php echo isset($e_signature_data['signature_bas64_image']) && !empty($e_signature_data['signature_bas64_image']) ? '<img style="max-height: '.SIGNATURE_MAX_HEIGHT.';" src="'.$e_signature_data['signature_bas64_image'].'"/>' : ''; ?></p>
                                    </div>
                                </div>        
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                        ...
                                        <?php } ?>
                                        <p class="e_signature_type_fixed_p e_signature_font_family_5" id="init_tergit"><?php echo isset($e_signature_data['init_signature_bas64_image']) && !empty($e_signature_data['init_signature_bas64_image']) ? '<img style="max-height: '.SIGNATURE_MAX_HEIGHT.';" src="'.$e_signature_data['init_signature_bas64_image'].'"/>' : ''; ?></p>
                                    </div>
                                </div>    
    ...
    <script src="<?php echo base_url('assets/js/jcanvas.js'); ?>"></script>
...
<?php }  else { ?>
    <?php $this->load->view('onboarding/e_signature'); ?>
<?php } ?>
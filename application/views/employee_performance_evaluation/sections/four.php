                                    ...
                                    <div class="row jsSectionOne">
                                        <div class="col-sm-6">
                                            <div class="form-group autoheight">
                                                ...
                                                <input type="text" readonly name="epe_employee_name" class="form-control input-bg" value="<?= $section_1['epe_employee_name'] ?? 'abc' ?>" />
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group autoheight">
                                                <label for="">Job Title</label>
                                                <input type="text" readonly name="epe_job_title" class="form-control input-bg" value="<?= $section_1['epe_job_title'] ?? 'abc' ?>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group autoheight">
                                                ...
                                                <input type="text" readonly name="epe_department" class="form-control input-bg" value="<?= $section_1['epe_department'] ?? 'abc' ?>" />
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group autoheight">
                                                <label for="">Manager</label>
                                                <input type="text" readonly name="epe_manager" class="form-control input-bg" value="<?= $section_1['epe_manager'] ?? 'abc' ?>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group autoheight">
                                                ...
                                                <input type="text" readonly name="epe_hire_date" class="form-control input-bg" value="<?= $section_1['epe_hire_date'] ?? 'abc' ?>" />
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group autoheight">
                                                <label for="">Start Date in Current Position</label>
                                                <input type="text" readonly name="epe_start_date" class="form-control input-bg" value="<?= $section_1['epe_start_date'] ?? 'abc' ?>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group autoheight">
                                                ...
                                                <input type="text" readonly name="epe_review_start" class="form-control input-bg" value="<?= $section_1['epe_review_start'] ?? 'abc' ?>" />
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group autoheight">
                                                <label for="">Review Period End</label>
                                                <input type="text" readonly name="epe_review_end" class="form-control input-bg" value="<?= $section_1['epe_review_end'] ?? 'abc' ?>" />
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" <?= $readonly ?> name="equipment_resources_needed" class="form-control jsEquipmentResourcesNeeded" value="<?= $section_2['equipment_resources_needed'] ?? '' ?>">
                                                    </div>
                                                </div>

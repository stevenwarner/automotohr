                                            ...
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group autoheight">
                                                    <div class="row">   
                                                        <div class="col-lg-4">
                                                            <div class="form-group autoheight">
                                                                <label class="control control--checkbox">
                                                                    ...
                                                                    <input type="radio" name="available_paid_leave" value="1" <?php echo !empty($pre_form['available_paid_leave']) && $pre_form['available_paid_leave'] == 1 ? 'checked="checked"': ''?>>
                                                                    <div class="control__indicator"></div>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group autoheight">
                                                                <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; means that you will receive your paid leave and the leave will also be considered protected FMLA leave and counted against your FMLA leave entitlement. </p>
                                                            </div>
                                                        </div>     
                                                    </div>
                                                </div>

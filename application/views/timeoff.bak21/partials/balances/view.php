        ...
        <div class="border-top-section border-bottom csHeader">
            ...
            <div class="col-xs-6 col-lg-6">
                <div class="pto-top-heading-right text-right pr0">
                    <a class="btn btn-success" target="_blank" href="<?=base_url('timeoff/print/balance/0');?>"><i class="fa fa-print"></i> Print</a>
                    <a class="btn btn-success" target="_blank" href="<?=base_url('timeoff/download/balance/0');?>"><i class="fa fa-download"></i> Download</a>
                    
                    <?php if($session['employer_detail']['access_level_plus'] == 1 || $session['employer_detail']['pay_plan_flag'] == 1) { ?>
                    <button class="btn btn-success jsImportBalance">Import Consumed Balance</button>

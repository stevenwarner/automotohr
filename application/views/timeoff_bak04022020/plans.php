                    ...
                    <div class="right-content-2 js-page" id="js-page-add" <?=$page != 'add' ? 'style="display: none;"' : '';?>>
                        ...
                        <div class="row123 margin-custom">
                            <div class="">
                                ...
                                <div class=""  id="js-plan-add-select">
                                ...
                                <div id="js-plan-add-input" style="display: none;">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="input-group">
                                                <input type="number" value="" class="form-control" id="js-plan-period-month-add-input" />
                                                <span class="input-group-addon">Months(s)</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 checkbox-styling margin-top">
                                <label class="control control--checkbox">
                                    <input type="checkbox" class="checkbox-sizing" id="js-archived-add" /> Archive
                    ...
                    <div class="right-content-2 js-page" id="js-page-edit" <?=$page != 'edit' && $planSid != null ? 'style="display: none;"' : '';?>>
                        ...
                        <div class="row123 margin-custom">
                            <div class="">
                                ...
                                <div class="" id="js-plan-edit-select">
                                ...
                                <div id="js-plan-edit-input" style="display: none;">
                                    <div class="row">
                                        <div class="col-sm-6 col-md-2 col-xs-12">
                                            <div class="input-group">
                                                <input type="number" value="" class="form-control" id="js-plan-period-edit-input" />
                                                <span class="input-group-addon">Year(s)</span>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-2 col-xs-12">
                                            <div class="input-group">
                                                <input type="number" value="" class="form-control" id="js-plan-period-month-edit-input" />
                                                <span class="input-group-addon">Months(s)</span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 checkbox-styling margin-top">
                                <label class="control control--checkbox">
                                    <input type="checkbox" class="checkbox-sizing" id="js-archived-edit" /> Archive
                                    <span class="control__indicator"></span>
                                </label>
                            </div>
                        </div>

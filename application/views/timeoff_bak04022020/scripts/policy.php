<script type="text/javascript">
    ...
    $(function(){
        ...
        function showEditPage(policy){
            ...
            // $('#js-category-edit').select2MultiCheckboxes({
            //     templateSelection: function(selected, total) {
            //         return "Selected " +( $.inArray('all', $('#js-category-edit').val()) !== -1 ? total : selected.length )+ " of " + total;
            //     }
            // });
            ...
            // $('#js-policy-start-date-edit').val(
            //     moment(policy.policy_start_date, 'YYYY-MM-DD').format('MM-DD-YYYY')
            // );
            //
            ...
            if(policy.carryover_cap_check == 1){
                $('.js-carryover-box-edit').show();
            }
            if(policy.allow_negative_balance == 1){

...
<html>
    ...
    <body>
        <?php if ($this->ion_auth->logged_in()) { ?>
                                    ...
                                    <div class="logo"><a href="<?php echo site_url('manage_admin/'); ?>"><img src="<?php echo site_url('assets/manage_admin/images/new_logo.JPG'); ?>"></a></div>
                                        ...
                                        <div class="btn-group pull-right notify-me">
                                            <button type="button" data-toggle="dropdown" aria-expanded="false" class="notification-bell">
                                                <i class="fa fa-bell <?php if($header_notifications['awaiting_response'] > 0 || $header_notifications['feedback_required'] > 0 || $header_notifications['pending_jobs_to_feed'] > 0){ echo 'faa-shake animated'; } ?>"></i>
            ...
            <style>
                .notify-me .dropdown-menu.dropdown-menu-wide{ min-height: 300px; max-height: 400px; }
            </style>
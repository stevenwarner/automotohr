...
if (base_url(uri_string()) == site_url('manage_admin/users') ||
    ...
    <div class="nav-menu">
        <ul>
            ...
            <?php if (check_access_permissions_for_view($security_details, $functions_names)) { ?>
                <li>
                    <a class="hr-closed-menu <?php if ($admin_management_menu) { echo 'hr-opened-menu'; } ?>" href="javascript:;"> Admin Management</a>

                    <div class="submenu" <?php if ($admin_management_menu) { echo 'style="display:block;"'; } ?>>
                ...
                <li>
                    ...
                    <div class="submenu" <?php echo $company_employers_menu ? 'style="display:block;"' : ''; ?>>
                        ...
                        <?php if (check_access_permissions_for_view($security_details, 'copy_applicants')) { ?>
                            <div class="menu-item">
                                <a <?php if(strpos(base_url(uri_string()), site_url('manage_admin/copy_applicants')) !== false) { echo 'class="active"'; } ?>
                        ...
                        <?php if (check_access_permissions_for_view($security_details, 'copy_employees')) { ?>
                            <div class="menu-item">
                                <a <?php if(strpos(base_url(uri_string()), site_url('manage_admin/copy_employees')) !== false) { echo 'class="active"'; } ?>
                        ...
                        <?php if (check_access_permissions_for_view($security_details, 'merge_employees')) { ?>
                            <div class="menu-item">
                                <a <?php if(strpos(base_url(uri_string()), site_url('manage_admin/merge_employees')) !== false) { echo 'class="active"'; } ?>
                ...
                <li>
                    ...
                    <div class="submenu" <?php echo $billing_menu ? 'style="display:block;"' : ''; ?>>
                        ...
                        <?php if (check_access_permissions_for_view($security_details, 'invoices_panel')) { ?>
                            <div class="menu-item">
                                <a <?php if (base_url(uri_string()) == site_url('manage_admin/invoice') || base_url(uri_string()) == site_url('manage_admin/invoice/add_new_invoice') || ($this->uri->segment(3) == 'edit_invoice')) { echo 'class="active"';
                        ...
                        <?php if (check_access_permissions_for_view($security_details, 'list_products')) { ?>
                            <div class="menu-item">
                                <a <?php if (base_url(uri_string()) == site_url('manage_admin/products') || (($this->uri->segment(3) == 'edit' && $this->uri->segment(2) == 'products') || ($this->uri->segment(3) == 'add_new_product' && $this->uri->segment(2) == 'products'))) { echo 'class="active"';
                        ...
                        <?php if (check_access_permissions_for_view($security_details, 'list_promotions')) { ?>
                            <div class="menu-item">
                                <a <?php
                                if (base_url(uri_string()) == site_url('manage_admin/promotions') || ($this->uri->segment(3) == 'edit_promotion' || $this->uri->segment(3) == 'add_new_promotion' && $this->uri->segment(2) == 'promotions')) { echo 'class="active"';
                        ...
                        <?php if (check_access_permissions_for_view($security_details, 'recurring_payments')) { ?>
                            <div class="menu-item">
                                <a <?php if (base_url(uri_string()) == site_url('manage_admin/recurring_payments') || (($this->uri->segment(3) == 'edit' || $this->uri->segment(3) == 'add') && $this->uri->segment(2) == 'recurring_payments')) { echo 'class="active"';
                        ...
                        <?php if (check_access_permissions_for_view($security_details, 'exclude_companies')) { ?>
                            <div class="menu-item">
                                <a <?php if(strpos(base_url(uri_string()), site_url('manage_admin/exclude_companies')) !== false) { echo 'class="active"';
                        ...
                        <?php if (check_access_permissions_for_view($security_details, 'list_marketing_agencies')) { ?>
                            <div class="menu-item">
                                <a <?php if(strpos(base_url(uri_string()), site_url('manage_admin/marketing_agencies')) !== false || $this->uri->segment(2) == 'marketing_agency_documents') { echo 'class="active"';
                        ...
                        <?php if (check_access_permissions_for_view($security_details, 'unpaid_invoice')) { ?>
                            <div class="menu-item">
                                <a <?php if(in_array($this->uri->segment(3), array('pending_invoices', 'view_pending_invoices'))) { echo 'class="active"';
                        ...
                        <?php if (check_access_permissions_for_view($security_details, 'pending_commissions')) { ?>
                            <div class="menu-item">
                                <a <?php if(in_array($this->uri->segment(3), array('pending_commissions', 'view_pending_commissions'))) { echo 'class="active"';
                ...
                <li>
                    ...
                    <div class="submenu" <?php echo $customize_pages ? 'style="display:block;"' : ''; ?>>
                        <?php  if (check_access_permissions_for_view($security_details, 'customize_home_page')) { ?>
                            <div class="menu-item">
                                <a <?php if (base_url(uri_string()) == site_url('manage_admin/home_page/customize_home_page')) { echo 'class="active"'; }
                        ...
                        <?php  //if (check_access_permissions_for_view($security_details, 'customize_home_page')) { ?>
                            <div class="menu-item">
                                <a <?php if (base_url(uri_string()) == site_url('manage_admin/resource_page')) { echo 'class="active"'; }
                        ...
                        <?php  //if (check_access_permissions_for_view($security_details, 'customize_home_page')) { ?>
                        <div class="menu-item">
                            <a <?php if ($this->uri->segment(2) == 'hr_documents_content') { echo 'class="active"'; }
...
//                                     echo 'class="active"';
//                                } ?><!-- href="--><?php //echo site_url('manage_admin/reports/time_to_hire_job_report'); ?><!--">Time to Hire a Candidate for Job Report</a>-->
<!--                            </div>-->
<!--                        --><?php //} ?>
                        <!--
...
<!--                        <div class="menu-item">
            ...
            <?php if (check_access_permissions_for_view($security_details, $functions_names)) { ?>
                <li>
                <a class="hr-closed-menu <?php if ($activity_reports_menu) { echo 'hr-opened-menu'; } ?>" href="javascript:;">Employer Activity Reports</a>
                <div class="submenu" <?php if ($activity_reports_menu) { echo 'style="display:block;"'; } ?>>
            ...
            <?php if (check_access_permissions_for_view($security_details, $functions_names)) { ?>
                <li>
                    <a class="hr-closed-menu <?php if ($incident_reporting_menu) { echo 'hr-opened-menu'; } ?>" href="javascript:;">Incidents Reports</a>
                    <div class="submenu" <?php if ($incident_reporting_menu) { echo 'style="display:block;"'; } ?>>
            ...
            <?php } ?>
            <?php $functions_names = array('safety_sheet','category_management'); if(check_access_permissions_for_view($security_details, $functions_names)) { ?>
            <li>
                <a class="hr-closed-menu <?php if ($safety_data_sheet_menu) { echo 'hr-opened-menu'; } ?>" href="javascript:;">Safety Data Sheet</a>
                <div class="submenu" <?php if ($safety_data_sheet_menu) { echo 'style="display:block;"'; } ?>>
            ...
            <?php if (check_access_permissions_for_view($security_details, $functions_names)) { ?>
                <li>
                    ...
                    <div class="submenu" <?php if ($documents_library_menu) { echo 'style="display:block;"'; } ?>>
                        ...
                        <?php if (check_access_permissions_for_view($security_details, 'document_library')) { ?>
                            <div class="menu-item">
                                ...
                                <a <?php if(strpos(base_url(uri_string()), site_url('manage_admin/default_categories')) !== false ) {
                                    echo 'class="active"';
                                } ?> href="<?php echo site_url('manage_admin/default_categories'); ?>">Documents Default Categories</a>
                            </div>
                        <?php } ?>
                    </div>
                </li>
            <?php } ?>
            <?php $functions_names = array('affiliate_request','referred_affiliate','referred_clients'); if(check_access_permissions_for_view($security_details, $functions_names)) { ?>
            <li>
                <a class="hr-closed-menu <?php if ($affiliate_program_menu) { echo 'hr-opened-menu'; } ?>" href="javascript:;">Affiliate Program</a>
                <div class="submenu" <?php if ($affiliate_program_menu) { echo 'style="display:block;"'; } ?>>
                    ...
                    <div class="menu-item">
                        ...
                        <?php } ?>
                        <!-- <a <?php// echo $this->uri->segment(2)  == 'referred' ? 'class="active"' : ''; ?> href="<?php echo site_url('manage_admin/referred'); ?>">Referred</a> -->
                        ...
                        <?php } if (check_access_permissions_for_view($security_details, 'referred_clients')) { ?>
...
<!--                <li>
            ...
            <?php if (check_access_permissions_for_view($security_details, 'job_feeds_management')) { ?>
                <li>
                    <a class="hr-closed-menu <?php if ($job_feed) { echo 'hr-opened-menu'; } ?>" href="javascript:;">Job Feed</a>

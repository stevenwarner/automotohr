                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th class="col-xs-4">Assign Date</th>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <select class="invoice-fields managers" name="manager" id="selected_manager">
    ...
    $( "#authorized_e_Signature_Modal" ).on('shown.bs.modal', function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#doc_assign_to").html(assign_to);
                $("#document_assign_date").html(assign_date);

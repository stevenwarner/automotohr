                                                                            ...
                                                                            <?php } else { ?>
                                                                                ...
                                                                                <td class="col-lg-2">
                                                                                    <?php if (in_array($document['document_sid'], $signed_document_sids)) { ?>
                                                                                        <?php if ($document['is_document_authorized'] == 1) { ?>
                                                                                            <!-- <button class="btn btn-success btn-sm btn-block" 
                                                                                                onclick="preview_submitted_authorized_document(this);" 
                                                                                                authorized-document-sid="<?php //echo $document['sid']; ?>"
                                                                                                company-sid="<?php //echo $document['company_sid']; ?>"
                                                                                                user-sid="<?php //echo $document['user_sid']; ?>"
                                                                                                user-type="<?php //echo $document['user_type']; ?>"
                                                                                                >
                                                                                                Preview Submitted
                                                                                            </button> -->

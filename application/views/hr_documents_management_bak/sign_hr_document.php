                            ...
                            <div class="hr-innerpadding">
                                <div class="row">
                                    <div class="col-xs-12" id="required_fields_div" style="padding: 0 30px">
                                        <?php if ($document['document_type'] == 'uploaded' || $document['offer_letter_type'] == 'uploaded') { ?>
                                        ...
                                        <?php  if (($document['signature_required'] == 1 || $save_offer_letter_type == 'consent_only') && ($document_type == 'generated' || ($document_type == 'offer_letter' &&  $document['offer_letter_type'] == 'generated'))) { ?>
...
<script>
    ...
    function save_print() {
        ...
        var document_sid = '<?php echo $document['document_sid']; ?>';

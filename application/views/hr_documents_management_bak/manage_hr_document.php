                            ...
                            <div class="page-header-area margin-top">
                                <span class="page-heading down-arrow">
                                    <?php if($user_type == 'applicant'){ ?>
                                        <a class="dashboard-link-btn" href="<?php echo base_url('hr_documents_management/documents_assignment/'.$user_type .'/'.$users_sid.'/'.$job_list_sid); ?>"><i class="fa fa-chevron-left"></i>Document Management</a>
                                    <?php } else { ?>
                                        <a class="dashboard-link-btn" href="<?php echo base_url('hr_documents_management/documents_assignment/'.$user_type .'/'.$users_sid); ?>"><i class="fa fa-chevron-left"></i>Document Management</a>
                                    <?php }
                                    echo $title; ?>
                                </span>
                            </div>
    ...
    function deactivate_document(document_sid) {
        alertify.confirm(
            ...
            function () {
                ...
                $.ajax({
                    url: '<?= base_url('hr_documents_management/deactivate_document') ?>',
                    cache: false,
                    contentType: false,
                    processData: false,
                    type: 'post',
                    ...
                    success: function (data) {
                        var reload_url = '<?= base_url('hr_documents_management/documents_assignment/employee').'/'.$users_sid; ?>';

                    ...
                    <div class="panel panel-default _csMt10">
                        <div class="panel-heading _csP0">
                            ...
                            <ul class="_csPageTabs">
                                <li>
                                    <a href="javascript:void(0)" data-survey_type="running"  id="jsRunningTab" class="active jsSurveyTab" data-toggle="tab">
                                        Running <span id="jsRunningTabCount">(0)<span>
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" data-survey_type="finished" id="jsFinishedTab" class="jsSurveyTab" data-toggle="tab">
                                        Finished <span id="jsFinishedTabCount">(0)<span>
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" data-survey_type="assigned" id="jsAssignedTab" class="jsSurveyTab" data-toggle="tab">
                                        Assigned <span id="jsAssignedTabCount">(0)<span>
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" data-survey_type="draft" id="jsDraftTab" class="jsSurveyTab" data-toggle="tab">

<div id="jsSurveyManageModal" class="modal" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header _csB4">
                <h4 class="modal-title">Manage Engagement</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 _csMt10">
                        <label>Engagement Period <span class="text-danger">*</span></label>
                        <p>When the Engagement will start and end.</p>
                    </div>
                </div>  
                <input type="hidden" class="form-control" id="jsSurveyId" readonly>
                <div class="row">  
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn _csF2 _csB4 _csR5 jsSaveSurveyDates">Update</button>
            </div>
        </div>
    </div>
</div>
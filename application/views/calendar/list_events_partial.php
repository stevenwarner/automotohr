                ...
                <div class="hr-box" id="remove_li<?= $event["sid"] ?>">
                    <div class="hr-box-header">
                        <span class="pull-left">
                            <strong>Event : <?php echo ( $event['title'] != '' ? $event['title'] : 'No Title Specified'); ?></strong>
                        </span>
                        <span class="pull-right">
                            ...
                            <button class="btn btn-info btn-xs" data-toggle="tooltip" title="Edit Event" onclick="func_edit_event(<?php echo $event["sid"] ?>, <?php echo isset($applicant_sid) ? $applicant_sid : $employer_id; ?>, <?php echo isset($job_list_sid) ? $job_list_sid : 0; ?>)">
                                    ...
                                    foreach ($employees as $employee) {
                                        foreach ($event['interviewer'] as $interviewer) {
                                            if ($interviewer == $employee['sid']) { ?>
                                                ...
                                                <div class="badge"><?php echo $employee['first_name'].'&nbsp;'.$employee['last_name'].' ('.$employee_type.')'; ?></div>
                                            <?php }
                                        }
                                    } ?>

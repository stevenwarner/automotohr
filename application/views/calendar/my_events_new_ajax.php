                                ...
                                <div class="row">
                                    <div class="col-sm-4 col-xs-8 col-sm-offset-1 col-xs-offset-2">
                                        <div class="cs-pill-wrap">
                                            <a class="fc-popover" href="javascript:void(0)" data-placement="top" data-content="Event Status" style="
                                        ...
                                        "></a>
                                            <a class="fc-day-grid-event fc-h-event fc-event fc-start fc-end fc-event-cc fc-event-cc-confirmed fc-popover" style="background-color:#0000ff;border-color:#0000ff; border-width: 0" data-placement="bottom" data-content="Event Type">
                                    ...
                                    <div class="col-sm-4 col-xs-8 col-sm-offset-1 col-xs-offset-2">
                                        <div class="cs-pill-wrap js-event-tab-blinker">
                                            ...
                                            border-radius: 3px 0 0 3px;
                                        "></a>
                                            <a class="fc-day-grid-event fc-h-event fc-event fc-start fc-end fc-event-cc fc-event-cc-confirmed fc-popover" style="background-color:#b910ff;border-color:#b910ff; border-width: 0" data-placement="bottom" data-content="New Reschedule/Cancellation requests">
                                                <div class="fc-content">

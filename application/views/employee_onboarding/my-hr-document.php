                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                            <div class="tabs-wrp">					
                                <ul class="tabs"> 
                                    <li  rel="tab1"><a href="<?php echo base_url('received_offer_letter/' . $verificationKey);?>">Offer Letter</a></li>
                                    <li rel="tab2"><a href="<?php echo base_url('onboard_eligibility_verification/' . $verificationKey);?>">Eligibility verification</a></li>
                                    <li rel="tab3" class="active"><a href="<?php echo base_url('onboard_received_document/' . $verificationKey);?>">HR Docs <i class="fa fa-arrow-down"></i></a></li>
                                </ul>
                                                                                                                ...
                                                                                                                <div id="uploaded_document_<?php echo $document['user_document_sid'] ?>" class="modal fade file-uploaded-modal" role="dialog">
                                                                                                                    <div class="modal-dialog">
                                                                                                                        ...
                                                                                                                        <div class="modal-content">
                                                                                                                            ...
                                                                                                                            <iframe class="uploaded-file-preview" src="https://docs.google.com/gview?url=<?php echo AWS_S3_BUCKET_URL . urlencode($document['uploaded_file']); ?>&embedded=true" style="width:100%; height:500px;" frameborder="0"></iframe>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            <?php } ?>
                ...
                <div id="document_<?php echo $document['sid'] ?>" class="modal fade file-uploaded-modal" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <iframe class="uploaded-file-preview" src="https://docs.google.com/gview?url=<?php echo AWS_S3_BUCKET_URL . urlencode($document['document_name']); ?>&embedded=true" style="width:100%; height:500px;" frameborder="0"></iframe>
                        </div>
                    </div>
                </div>
                <?php
...
<script>
    ...
    function employerLogin(userId) {
        url_to = "<?= base_url() ?>/users/employer_login_independant";

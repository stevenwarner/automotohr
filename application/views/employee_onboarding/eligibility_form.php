...
<html>
    <head>
        ...
        <script src="<?= base_url() ?>assets/manage_admin/js/jquery-ui.js"></script>
                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                            <div class="tabs-wrp">					
                                <ul class="tabs"> 
                                    ...
                                    <li rel="tab2" class="active"><a href="<?php echo base_url('onboard_eligibility_verification/' . $verificationKey);?>">Eligibility verification <i class="fa fa-arrow-down"></i></a></li>
                                    <li rel="tab3"><a href="<?php echo base_url('onboard_received_document/' . $verificationKey);?>">HR Docs</a></li>
                                </ul>
                                <div class="tab_container">
                                    <div id="tab2" class="tab_content">
                                        <div class="top-title-area">
                                            <h2>Instructions for Employment Eligibility Verification</h2>
                                            <p>Read all instructions carefully before completing this form.</p>
                                        </div>
                                            ...
                                            <div class="middle-text-area">
                                                <div class="table-responsive table-outer">
                                                    ...
                                                    <div class="i9form-wrp">
                                                        ...
                                                        <input type="submit" class="submit-btn" style="float: right" value="Save & Continue">
                                                        <DIV id="page_1">

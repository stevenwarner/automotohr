            ...
            <?php if ($page == "employee_courses_history") { ?>
                <div class="text-center">
                    <span class="">	
                        ...
                        <br>
                        <br>
                        <?php echo $companyName ?> <?php echo $reviewAs == "plus" ? "Employee LMS History" : "Subordinate LMS History"; ?>
                    </span>
                </div>
            <?php } ?>    
                        ...
                        <h1 class="section-ttile">
                            ...
                            <div style="float: right;">
                                <?php if ($page == "my_courses_history") { ?>
                                    <a href="<?php echo base_url('lms/courses/my_lms_dashboard'); ?>" class="btn btn-info btn-orange csRadius5 csF16"><i class="fa fa-shield"></i> Active Courses</a>
                                <?php } else if ($page == "employee_courses_history") { ?>
                                    <?php if ($reviewAs == 'non_plus') { ?>
                                        <a href="<?php echo base_url('lms/subordinate/dashboard/' . $subordinateId); ?>" class="btn btn-info btn-orange csRadius5 csF16"><i class="fa fa-shield"></i> Active Courses</a>
                                    <?php } else if ($reviewAs == 'plus') { ?>
                                        <a href="<?php echo base_url('lms/employee/courses/dashboard/' . $subordinateId); ?>" class="btn btn-info btn-orange csRadius5 csF16"><i class="fa fa-shield"></i> Active Courses</a>
                                    <?php } ?>
                                <?php } ?>
                                <?php if (isPayrollOrPlus() || $haveSubordinate == "yes") { ?>

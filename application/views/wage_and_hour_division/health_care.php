                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                <div class="form-group autoheight">
                                                    ...
                                                    <input type="text" value="<?php echo !empty($pre_form['emp_name'])>0 ? $pre_form['emp_name']: ''?>" name="emp_name" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                <div class="form-group autoheight">
                                                    <label>Employer Contact:</label>
                                                    <input type="text" value="<?php echo !empty($pre_form['emp_contact']) ? $pre_form['emp_contact']: ''?>" name="emp_contact" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                <div class="form-group autoheight">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                <div class="form-group autoheight">
                                                    ...
                                                    <input type="text" value="<?php echo !empty($pre_form['emp_reg_work_sch']) ? $pre_form['emp_reg_work_sch']: ''?>" name="emp_reg_work_sch" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group autoheight">
                                                    <label>Employee’s essential job functions:</label>
                                                    <input type="text" value="<?php echo !empty($pre_form['emp_esse_job_func']) ? $pre_form['emp_esse_job_func']: ''?>" name="emp_esse_job_func" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group autoheight">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-xs-12 col-sm-4">
                                                <div class="form-group autoheight">
                                                    ...
                                                    <input type="text" value="<?php echo !empty($pre_form['first_name']) ? $pre_form['first_name']: ''?>" name="first_name" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-xs-12 col-sm-4">
                                                <div class="form-group autoheight">
                                                    <label>Middle Name:</label>
                                                    <input type="text" value="<?php echo !empty($pre_form['middle_name']) ? $pre_form['middle_name']: ''?>" name="middle_name" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-xs-12 col-sm-4">
                                                <div class="form-group autoheight">
                                                    <label>Last Name:</label>
                                                    <input type="text" value="<?php echo !empty($pre_form['last_name']) ? $pre_form['last_name']: ''?>" name="last_name" class="form-control" />
                                                </div>
                                            </div>    
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group autoheight">
                                                    ...
                                                    <input type="text" value="<?php echo !empty($pre_form['provider_name']) ? $pre_form['provider_name']: ''?>" name="provider_name" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group autoheight">
                                                    <label>Business Address:</label>
                                                    <input type="text" value="<?php echo !empty($pre_form['business_address']) ? $pre_form['business_address']: ''?>" name="business_address" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group autoheight">
                                                    <label>Type of practice / Medical specialty:</label>
                                                    <input type="text" value="<?php echo !empty($pre_form['type_of_PM_sep']) ? $pre_form['type_of_PM_sep']: ''?>" name="type_of_PM_sep" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                <div class="form-group autoheight">
                                                    <label>Telephone:</label>
                                                    <input type="text" value="<?php echo !empty($pre_form['telephone']) ? $pre_form['telephone']: ''?>" name="telephone" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                <div class="form-group autoheight">
                                                    <label>Fax:</label>
                                                    <input type="text" value="<?php echo !empty($pre_form['fax']) ? $pre_form['fax']: ''?>" name="fax" class="form-control" />
                                                </div>
                                            </div>  
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group autoheight">
                                                    ...
                                                    <input type="text" value="<?php echo !empty($pre_form['app_date_cond_comm']) ? $pre_form['app_date_cond_comm']: ''?>" name="app_date_cond_comm" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group autoheight">
                                                    <label>Probable duration of condition:</label>
                                                    <input type="text" value="<?php echo !empty($pre_form['prob_dur_of_con']) ? $pre_form['prob_dur_of_con']: ''?>" name="prob_dur_of_con" class="form-control" />
                                                </div>
                                            </div> 
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group autoheight">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group autoheight">
                                                                <label class="control control--checkbox">
                                                                    No
                                                                    <input type="radio" name="overnight_stay_in_hospital" value="0" <?php echo !empty($pre_form['overnight_stay_in_hospital']) && $pre_form['overnight_stay_in_hospital'] == 0 ? 'checked="checked"': ''?>>
                                                                    <div class="control__indicator"></div>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group autoheight">
                                                                <label class="control control--checkbox">
                                                                    Yes
                                                                    <input type="radio" name="overnight_stay_in_hospital" value="1" <?php echo !empty($pre_form['overnight_stay_in_hospital']) && $pre_form['overnight_stay_in_hospital'] == 1 ? 'checked="checked"': ''?>>
                                                                    <div class="control__indicator"></div>
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group autoheight">
                                                    ...
                                                    <input type="text" value="<?php echo !empty($pre_form['date_of_admission']) ? $pre_form['date_of_admission']: ''?>" name="date_of_admission" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group autoheight">
                                                    <label>Date(s) you treated the patient for condition:</label>
                                                    <input type="text" value="<?php echo !empty($pre_form['dates_you_treated_the_patient']) ? $pre_form['dates_you_treated_the_patient']: ''?>" name="dates_you_treated_the_patient" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group autoheight">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group autoheight">
                                                                <label class="control control--checkbox">
                                                                    No
                                                                    <input type="radio" name="visit_twice_per_year" value="0" <?php echo !empty($pre_form['visit_twice_per_year']) && $pre_form['visit_twice_per_year'] == 0 ? 'checked="checked"': ''?>>
                                                                    <div class="control__indicator"></div>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group autoheight">
                                                                <label class="control control--checkbox">
                                                                    Yes
                                                                    <input type="radio" name="visit_twice_per_year" value="1" <?php echo !empty($pre_form['visit_twice_per_year']) && $pre_form['visit_twice_per_year'] == 1 ? 'checked="checked"': ''?>>
                                                                    <div class="control__indicator"></div>
                                                                </label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group autoheight">
                                                                <label class="control control--checkbox">
                                                                    No
                                                                    <input type="radio" name="over_the_counter_medication" value="0" <?php echo !empty($pre_form['over_the_counter_medication']) && $pre_form['over_the_counter_medication'] == 0 ? 'checked="checked"': ''?>>
                                                                    <div class="control__indicator"></div>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group autoheight">
                                                                <label class="control control--checkbox">
                                                                    Yes
                                                                    <input type="radio" name="over_the_counter_medication" value="1" <?php echo !empty($pre_form['over_the_counter_medication']) && $pre_form['over_the_counter_medication'] == 1 ? 'checked="checked"': ''?>>
                                                                    <div class="control__indicator"></div>
                                                                </label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group autoheight">
                                                                <label class="control control--checkbox">
                                                                    No
                                                                    <input type="radio" name="refer_to_other_heal_care_provid_for_eval_or_trea" value="0" <?php echo !empty($pre_form['refer_to_other_heal_care_provid_for_eval_or_trea']) && $pre_form['refer_to_other_heal_care_provid_for_eval_or_trea'] == 0 ? 'checked="checked"': ''?>>
                                                                    <div class="control__indicator"></div>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group autoheight">
                                                                <label class="control control--checkbox">
                                                                    Yes
                                                                    <input type="radio" name="refer_to_other_heal_care_provid_for_eval_or_trea" value="1" <?php echo !empty($pre_form['refer_to_other_heal_care_provid_for_eval_or_trea']) && $pre_form['refer_to_other_heal_care_provid_for_eval_or_trea'] == 1 ? 'checked="checked"': ''?>>
                                                                    <div class="control__indicator"></div>
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group autoheight">
                                                    ...
                                                    <input type="text" value="<?php echo !empty($pre_form['nature_of_such_treat_and_expec_dura']) ? $pre_form['nature_of_such_treat_and_expec_dura']: ''?>" name="nature_of_such_treat_and_expec_dura" class="form-control" />
                                                </div>
                                            </div> 
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group autoheight">

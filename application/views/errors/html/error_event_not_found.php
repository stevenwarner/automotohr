	...
	<div class="wrap">
		...
		<div class="content">
			...
			<div class="logo-404">
				...
				<span><img src="<?php echo config_item('base_url');?>assets/images/exclamation-mark-sign.png">Event Not Found!</span>
				<div>
					<br/>
					<h6>The event does not exist or has been deleted </h6>
				</div>
			</div>
			<!--end-logo-->

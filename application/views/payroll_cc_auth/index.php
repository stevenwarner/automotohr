            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                    ...
                    <div class="credit-card-authorization">
                        ...
                        ?>
                        <!-- page print -->
                        <span class="page-heading down-arrow"><?php $this->load->view('manage_employer/company_logo_name'); ?>PAYROLL CREDIT CARD AUTHORIZATION FORM</span>
                        <div class="end-user-agreement-wrp recurring-payment-authorization">
                            ...
                            <form id="form_credit_card_authorization_form" action="<?php echo base_url('payroll_form_credit_card_authorization' . '/' . $verification_key . $pre_fill_flag); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div>
                                    <h2 class="credit-card-form-heading">Contract Type / Length:</h2>
                                    <div>

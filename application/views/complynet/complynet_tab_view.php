<div class="row">
    <div class="col-xs-12">
        <ul class="nav nav-tabs nav-justified doc_assign_nav_tab">
            <li class="<?= $activeTab == 'dashboard' ? 'active' : '';?> doc_assign_nav_li"><a data-toggle="tab" href="#dashboard_frame">Dashboard</a></li>
            <li class="<?= $activeTab == 'login' ? 'active' : '';?> doc_assign_nav_li"><a data-toggle="tab" href="#login_frame">Login</a></li>
        </ul>
        <div class="tab-content hr-documents-tab-content">
            <!-- Login Start -->
            <div id="login_frame" class="tab-pane fade in <?= $activeTab == 'login' ? 'active' : '';?> hr-innerpadding">
            ...
            <!-- Dashboard Start -->
            <div id="dashboard_frame" class="tab-pane fade in <?= $activeTab == 'dashboard' ? 'active' : '';?> hr-innerpadding">
                <div class="panel-body">
                    <div class="box-wrapper">
                        <div class="row">
                            <div class="col-lg-12">

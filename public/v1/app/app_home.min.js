!function () {
    let a, n = 0; $(document).on("click", ".jsModalCancel", e => { e.preventDefault(), "yes" == $(e.target).data("ask") ? alertify.confirm("Any unsaved changes will be lost.", () => { $(e.target).closest(".csModal").fadeOut(300), $("body").css("overflow-y", "auto"), $("#ui-datepicker-div").remove(), $(".jsMsModal").remove() }).set("labels", { ok: "LEAVE", cancel: "NO, I WILL STAY" }).set("title", "Notice!") : ($(e.target).closest(".csModal").fadeOut(300), $("body").css("overflow-y", "auto"), $(".jsMsModal").remove(), $("#ui-datepicker-div").remove()) }), window._ml = window.ml = function (e, t, o) { t = void 0 === t ? ".jsIPLoader" : `.jsIPLoader[data-page="${t}"]`, void 0 !== a && document.getElementsByClassName("csModalBody").length && (document.getElementsByClassName("csModalBody")[0].scrollTop = 0), void 0 !== a && e && $(".jsIPLoader").height($(`#${a}Body`).height() + n), void 0 === e || !1 === e ? $(t).hide() : $(t).show(), void 0 !== o && $(".jsIPLoaderText").html(o), e || $(".jsIPLoaderText").html("Please wait, while we are generating a preview.") }, window.Model = window.Modal = function (e, t) {
        var o = `
			<!-- Custom Modal -->
			...
			`; a = e.Id, n = $(`#${e.Id} .csModalHeader`).height() + 50, $(".jsMsModal").remove(), $("#" + e.Id).remove(), $("body").append(o), $("#" + e.Id).fadeIn(300), $("body").css("overflow-y", "hidden"), $(`#${e.Id} .csModalBody`).css("top", n), void 0 !== t && t()
    }
}(), function (m) {
    let g = {}; m.fn.msFileUploader = function (e) {
        let t = 1 < this.length ? this[0] : this; if ("string" == typeof e) { switch (e) { case "get": return g[t.selector]; case "clear": return delete g[t.selector] }return } let r = {}, o = Math.ceil(1e3 * Math.random()), i = {}, a = (g[t.selector] = r, i.s3 = void 0 !== e && e.s3 || "https://automotohrattachments.s3.amazonaws.com/", i.path = void 0 === e || void 0 === e.path || e.path, i.placeholderImage = void 0 !== e && e.placeholderImage || "", i.fileLimit = void 0 === e || -1 === m.inArray("mp4", e.allowedTypes) ? -1 : e.fileLimit, i.allowedTypes = void 0 !== e && e.allowedTypes || ["jpg", "jpeg", "png", "gif", "pdf", "doc", "docx", "rtf", "ppt", "xls", "xlsx", "csv", "zip", "mov", "mp4"], i.text = void 0 !== e && e.text || "Click / Drag to upload", i.onSuccess = void 0 !== e && e.onSuccess || function () { }, i.onError = void 0 !== e && e.onError || function () { }, i.onClear = void 0 !== e && e.onClear || function () { }, i.mainDivName = "jsUploadArea" + o, i.mainImageViewer = "jsUploadedImageArea" + o, i.errorMSG = "jsUploadedAreaError" + o, i.jsMFUPreviewFile = "jsMFUPreviewFile" + o, i.jsMFUClearFile = "jsMFUClearFile" + o, i.jsMFUModal = "jsMFUModal" + o, i.jsMFUD = "jsMFUD" + o, i.allowLinks = e.allowLinks || !1, i.activeLink = e.activeLink || "upload", i.allowCapture = e.allowCapture || !1, { size: "File size exceeded from " + i.fileLimit, type: "Invalid file type." }); m(t.selector).siblings("div.jsMainUploadAreaWrapper").remove(), m.fn.msFileUploader.__proto__.instances[t.selector] = {}, void 0 !== m.fn.msFileUploader.instances[t.selector] && (m(t.selector).siblings("div.csUploadArea").remove(), m.fn.msFileUploader.__proto__.instances[t.selector] = {}); const n = function () { var e = navigator.userAgent || navigator.vendor || window.opera; return /android|ipad|iphone|ipod|tablet|mobile/i.test(e) }, l = () => {

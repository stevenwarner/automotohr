!function(){let a,n=0;$(document).on("click",".jsModalCancel",e=>{e.preventDefault(),"yes"==$(e.target).data("ask")?alertify.confirm("Any unsaved changes will be lost.",()=>{$(e.target).closest(".csModal").fadeOut(300),$("body").css("overflow-y","auto"),$("#ui-datepicker-div").remove(),$(".jsMsModal").remove()}).set("labels",{ok:"LEAVE",cancel:"NO, I WILL STAY"}).set("title","Notice!"):($(e.target).closest(".csModal").fadeOut(300),$("body").css("overflow-y","auto"),$(".jsMsModal").remove(),$("#ui-datepicker-div").remove())}),window._ml=window.ml=function(e,t,o){t=void 0===t?".jsIPLoader":`.jsIPLoader[data-page="${t}"]`,void 0!==a&&document.getElementsByClassName("csModalBody").length&&(document.getElementsByClassName("csModalBody")[0].scrollTop=0),void 0!==a&&e&&$(".jsIPLoader").height($(`#${a}Body`).height()+n),void 0===e||!1===e?$(t).hide():$(t).show(),void 0!==o&&$(".jsIPLoaderText").html(o),e||$(".jsIPLoaderText").html("Please wait, while we are generating a preview.")},window.Model=window.Modal=function(e,t){var o=`
			...
			`;a=e.Id,n=$(`#${e.Id} .csModalHeader`).height()+50,$(".jsMsModal").remove(),$("#"+e.Id).remove(),$("body").append(o),$("#"+e.Id).fadeIn(300),$("body").css("overflow-y","hidden"),$(`#${e.Id} .csModalBody`).css("top",n),void 0!==t&&t()}}(),function(m){let p={};m.fn.msFileUploader=function(e){let t=1<this.length?this[0]:this;if("string"==typeof e){switch(e){case"get":return p[t.selector];case"clear":return delete p[t.selector]}return}let r={},o=Math.ceil(1e3*Math.random()),i={},a=(p[t.selector]=r,i.s3=void 0!==e&&e.s3||"https://automotohrattachments.s3.amazonaws.com/",i.path=void 0===e||void 0===e.path||e.path,i.placeholderImage=void 0!==e&&e.placeholderImage||"",i.fileLimit=void 0===e?-1:e.fileLimit,i.allowedTypes=void 0!==e&&e.allowedTypes||["jpg","jpeg","png","gif","pdf","doc","docx","rtf","ppt","xls","xlsx","csv","zip","mov","mp4"],i.text=void 0!==e&&e.text||"Click / Drag to upload",i.onSuccess=void 0!==e&&e.onSuccess||function(){},i.onError=void 0!==e&&e.onError||function(){},i.onClear=void 0!==e&&e.onClear||function(){},i.mainDivName="jsUploadArea"+o,i.mainImageViewer="jsUploadedImageArea"+o,i.errorMSG="jsUploadedAreaError"+o,i.jsMFUPreviewFile="jsMFUPreviewFile"+o,i.jsMFUClearFile="jsMFUClearFile"+o,i.jsMFUModal="jsMFUModal"+o,i.jsMFUD="jsMFUD"+o,i.allowLinks=e.allowLinks||!1,i.activeLink=e.activeLink||"upload",{size:"File size exceeded from "+i.fileLimit,type:"Invalid file type."});m(t.selector).siblings("div.jsMainUploadAreaWrapper").remove(),m.fn.msFileUploader.__proto__.instances[t.selector]={},void 0!==m.fn.msFileUploader.instances[t.selector]&&(m(t.selector).siblings("div.csUploadArea").remove(),m.fn.msFileUploader.__proto__.instances[t.selector]={});const n=()=>{var e="";return e+'<div class="row">'+'\t<div class="col-sm-2 col-xs-12">'+('<label class="control control--radio">     \t\t\t\t\t<input type="radio" name="jsSourceType'+o+'" value="upload" /> Upload     \t\t\t\t\t<div class="control__indicator"></div> \t\t\t\t\t</label>')+"\t</div>"+'\t<div class="col-sm-2 col-xs-12">'+('<label class="control control--radio">     \t\t\t\t\t<input type="radio" name="jsSourceType'+o+'" value="youtube" /> YouTube     \t\t\t\t\t<div class="control__indicator"></div> \t\t\t\t\t</label>')+"\t</div>"+'\t<div class="col-sm-2 col-xs-12">'+('<label class="control control--radio">     \t\t\t\t\t<input type="radio" name="jsSourceType'+o+'" value="vimeo" /> Vimeo     \t\t\t\t\t<div class="control__indicator"></div> \t\t\t\t\t</label>')+"\t</div>"+"</div><br />"+'<div class="row hidden">'+'\t<div class="col-sm-12">'+('<div class="input-group">     \t\t\t\t\t<div class="input-group-addon">YouTube</div>     \t\t\t\t\t<input type="text" class="form-control" id="jsYoutubeLink'+o+'" placeholder="https://www.youtube.com/watch?v=g4BsAB3PliY" value="'+i.placeholderImage+'" /> \t\t\t\t\t</div>')+"\t</div>"+"<br /></div>"+'<div class="row hidden">'+'\t<div class="col-sm-12">'+('<div class="input-group">     \t\t\t\t\t<div class="input-group-addon">Vimeo</div>     \t\t\t\t\t<input type="text" class="form-control" id="jsVimeoLink'+o+'" placeholder="https://vimeo.com/XXXXXXXXX"  value="'+i.placeholderImage+'"/> \t\t\t\t\t</div>')+"\t</div>"+"<br /></div>"},l=()=>`
            <div class="jsMainUploadAreaWrapper">
                ...
                <div class="csUploadArea hidden" id="${i.mainDivName}">
                    <div class="csUploadInnerArea">
                        ...
                        <span>(${i.allowedTypes})</span> <br /><br />
                        <span style="color: red; font-weight: bold; display: none;" id="${i.errorMSG}"></span>
            ...
            `,s=e=>{e=(void 0===e?r.name:e).split(".");return e[e.length-1].toLowerCase().trim()},d=()=>{var e=i.fileLimit.replace(/\s+/,"").toUpperCase().split(/([0-9]+)([A-Za-z]+)/);return"MB"==(e=[e[1],e[2]])[1]?1e6*e[0]:"GB"==e[1]?1e3*e[0]*1e6:"KB"==e[1]?1e3*e[0]:0},c=e=>{var t;e&&((t=new FileReader).onload=e=>{m("#"+i.jsMFUPreviewFile).data("key",e.target.result),m("#"+i.jsMFUPreviewFile).parent().show(),m("#"+i.jsMFUClearFile).show()},t.readAsDataURL(e))},u=e=>{m("#"+i.jsMFUPreviewFile).parent().hide(0),m("#"+i.jsMFUClearFile).hide(0),m("#"+i.errorMSG).hide(),m("#"+i.mainImageViewer).parent().hide(),m("#"+i.mainImageViewer).attr("src",null),m("#"+i.mainImageViewer).parent().find("label span").text(""),r.hasOwnProperty("hasError")&&(r.hasError=!1),-1===m.inArray(s(),i.allowedTypes)?(m("#"+i.errorMSG).text(a.type).show(),i.onError(a.type,e),r.hasError=!0,r.errorCode=a.type,p[t.selector]=r,r={}):-1!==i.fileLimit&&r.size>d()?(m("#"+i.errorMSG).text(a.size).show(),i.onError(a.size,e),r.hasError=!0,r.errorCode=a.size,p[t.selector]=r,r={}):(c(r),r.hasError=!1,p[t.selector]=r,i.onSuccess(r,e))};return this.getValue=()=>r,m(document).on("drop","#"+i.mainDivName,function(e){e.preventDefault(),r=e.originalEvent.dataTransfer.files[0],u(e)}),m(document).on("dragenter","#"+i.mainDivName,function(e){e.preventDefault(),m(this).css("opacity",".8")}),m(document).on("dragover","#"+i.mainDivName,function(e){e.preventDefault(),m(this).css("opacity","1")}),m(document).on("click","#"+i.mainDivName,function(e){e.preventDefault(),m(t).trigger("click")}),m(document).on("change",t.selector,function(e){r=e.target.files[0],u(e)}),m(document).on("click","."+i.jsMFUD,function(e){e.preventDefault(),e.stopPropagation();let t="",o="";o=null===m("#"+i.jsMFUPreviewFile).data("key").match(/data:/)?(t=m("#"+i.jsMFUPreviewFile).data("key"),i.path?i.s3+t:t):(t=r.name,m("#"+i.jsMFUPreviewFile).data("key"));e=document.createElement("a");e.target="_blank",e.href=o,e.download=t,e.dispatchEvent(new MouseEvent("click"))}),m(document).on("click","#"+i.jsMFUClearFile,function(e){e.preventDefault(),e.stopPropagation(),m("#"+i.jsMFUPreviewFile).parent().hide(0),m("#"+i.jsMFUClearFile).hide(0),r={},p[t.selector]=r,""!=i.placeholderImage&&"upload"===i.activeLink&&(m("#"+i.jsMFUPreviewFile).data("key",i.placeholderImage),m("#"+i.jsMFUPreviewFile).parent().show(0)),i.onClear()}),m(document).on("click","#"+i.jsMFUPreviewFile,function(e){e.preventDefault(),e.stopPropagation();let t="",o="",a="",n="";n=null===m(this).data("key").match(/data:/)?(t=m(this).data("key"),o=s(t),a=i.path?i.s3+t:t,-1!==m.inArray(o,["xls","xlsx","ppt","pptx","doc","docx","rtf","csv"])?`<iframe frameborder="0" width="100%" height="600" class="jsMFUIframe" src="https://view.officeapps.live.com/op/embed.aspx?src=${encodeURI(a)}"></iframe>`:-1!==m.inArray(o,["png","jpg","jpeg","gif","webp","svg"])?`<img class="img-responsive" src="${a}" />`:-1!==m.inArray(o,["mp4"])?`<video style="width: 100%;" class="img-responsive" src="${a}" controls></video>`:-1!==m.inArray(o,["zip"])?`<iframe frameborder="0" style="width: 100%; height: 600px;" class="jsMFUIframe" src="${a}"></iframe>`:`<iframe frameborder="0" style="width: 100%; height: 600px;" class="jsMFUIframe" src="https://docs.google.com/gview?url=${a}&embedded=true"></iframe>`):(t=r.name,o=s(),a=m(this).data("key"),-1!==m.inArray(o,["png","jpg","jpeg","gif","svg"])?`<img class="img-responsive" src="${a}" />`:-1!==m.inArray(o,["mp4"])?`<video class="img-responsive" src="${a}" controls></video>`:`<iframe frameborder="0" style="width: 100%; height: 600px;" class="jsMFUIframe" src="${a}"></iframe>`),e=t;e=`
            <!-- Modal -->

!function(){let o,s=0;$(document).on("click",".jsModalCancel",e=>{e.preventDefault(),"yes"==$(e.target).data("ask")?alertify.confirm("Any unsaved changes will be lost.",()=>{$(e.target).closest(".csModal").fadeOut(300),$("body").css("overflow-y","auto"),$("#ui-datepicker-div").remove(),$(".jsMsModal").remove()}).set("labels",{ok:"LEAVE",cancel:"NO, I WILL STAY"}).set("title","Notice!"):($(e.target).closest(".csModal").fadeOut(300),$("body").css("overflow-y","auto"),$(".jsMsModal").remove(),$("#ui-datepicker-div").remove())}),window._ml=window.ml=function(e,a,t){a=void 0===a?".jsIPLoader":`.jsIPLoader[data-page="${a}"]`,void 0!==o&&document.getElementsByClassName("csModalBody").length&&(document.getElementsByClassName("csModalBody")[0].scrollTop=0),void 0!==o&&e&&$(".jsIPLoader").height($(`#${o}Body`).height()+s),void 0===e||!1===e?$(a).hide():$(a).show(),void 0!==t&&$(".jsIPLoaderText").html(t),e||$(".jsIPLoaderText").html("Please wait, while we are generating a preview.")},window.Model=window.Modal=function(e,a){var t=`
			...
			`;o=e.Id,s=$(`#${e.Id} .csModalHeader`).height()+50,$(".jsMsModal").remove(),$("#"+e.Id).remove(),$("body").append(t),$("#"+e.Id).fadeIn(300),$("body").css("overflow-y","hidden"),$(`#${e.Id} .csModalBody`).css("top",s),void 0!==a&&a()}}(),String.prototype.verifyEmail=function(){return null!==this.match(/^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$/g)},String.prototype.isValidYoutubeLink=function(){return null!==this.match(/^(https?\:\/\/)?((www\.)?youtube\.com|youtu\.be)\/.+$/g)},String.prototype.isValidVimeoLink=function(){return null!==this.match(/^(http|https)?:\/\/(www\.|player\.)?vimeo\.com\/(?:channels\/(?:\w+\/)?|groups\/([^\/]*)\/videos\/|video\/|)(\d+)(?:|\/\?)$/gim)},String.prototype.isValidInteger=function(){return null!==this.match(/^[1-9]\d*$/g)};{function ml(e,a,t){e?($(".jsIPLoader[data-page='"+a+"']").show(),$(".jsIPLoader[data-page='"+a+"']").find(".jsIPLoaderText").html(t||"Please wait, while we are processing your request.")):($(".jsIPLoader[data-page='"+a+"']").hide(),$(".jsIPLoader[data-page='"+a+"']").find(".jsIPLoaderText").html("Please wait, while we are processing your request."))}}{function CB(){}}{function getErrorsStringFromArray(e,a){return"<strong><p>"+(a||"Please, resolve the following errors")+"</p></strong><br >"+e.join("<br />")}}{function getBrowserVersion(){var e,a=navigator.userAgent,t=a.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i)||[];return/trident/i.test(t[1])?"IE "+((e=/\brv[ :]+(\d+)/g.exec(a)||[])[1]||""):"Chrome"===t[1]&&null!=(e=a.match(/\b(OPR|Edge)\/(\d+)/))?e.slice(1).join(" ").replace("OPR","Opera"):(t=t[2]?[t[1],t[2]]:[navigator.appName,navigator.appVersion,"-?"],null!=(e=a.match(/version\/(\d+)/i))&&t.splice(1,1,e[1]),t)}}{function generateBrowserAlert(){var e={chrome:55,edge:14,firefox:52,opera:42,safari:10.1,chromeandroid:55,firefoxandroid:52,operaandroid:42,safariios:10.3,samsumginternet:6},a=getBrowserVersion();if(e[a[0].toLowerCase()]&&a[1]<e[a[0].toLowerCase()])return alert("This module require '"+a[0]+"' with version greater or equal then '"+a[1]+"'.")}}{function uploadFile(t){return new Promise(function(a){var e=new FormData;e.append("file",t),$.ajax({url:apiURL+"uploader",method:"POST",timeout:0,processData:!1,mimeType:"multipart/form-data",contentType:!1,data:e}).success(function(e){a(e)}).fail(function(e){a(e.responseText)})})}}{function uploadStream(e){return new Promise(function(a){$.ajax({url:apiURL+"uploader/stream",method:"POST",timeout:0,contentType:"application/json",data:JSON.stringify({stream:e})}).success(function(e){a(e)}).fail(function(){a({})})})}}"undefined"!=typeof $&&($(".jsFilterPanel").height($(document).height()),$(document).on("click",".jsFilterSectionBtn",function(e){e.preventDefault();e=$(this).data("key");$(".jsFilterSection[data-key='"+e+"']").removeClass("hidden")}),$(document).on("click",".jsFilterSectionHideBtn",function(e){e.preventDefault();e=$(this).data("key");$(".jsFilterSection[data-key='"+e+"']").addClass("hidden")}),$(document).on("click",".jsExpandAdminView",function(e){e.preventDefault(),$(this).toggleClass("btn-success"),$(".jsExpandContent").toggleClass("col-sm-12 col-md-12 col-lg-12 col-xs-12 col-lg-9 col-md-9 col-sm-9"),$(".jsExpandSideBar").toggleClass("hidden")}));{function handleErrorResponse(e){return 0==e.status?alertify.alert("Errors!","The connection to the server has been lost. Kindly reach out to the system administrator for assistance.",CB):404==e.status?_error("The requested route doesn't exists."):(e=e.responseJSON||JSON.parse(e.responseText),alertify.alert("Errors!",e.errors.join("<br />"),CB))}}{function getQuestionsFromArray(e,a){return"<strong><p>"+(a||"Please, provide the following question answer.")+"</p></strong><br >"+e.join("<br />")}}{function baseUrl(e=""){return window.location.origin+"/"+e}}{function callButtonHook(e,a=!0){if(a)return a={pointer:e,html:e.html()},e.html('<i class="fa fa-circle-o-notch fa-spin csW csF16" aria-hidden="true"></i>'),e.off("click"),a;e.pointer.html(e.html)}}{function _error(e){alertify.alert("Error!",e,CB).setHeader("Error!").set("labels",{ok:"Ok",cancel:"cancel"})}}{function _success(e,a=CB){alertify.alert("Success!",e,a).setHeader("Success!").set("labels",{ok:"Ok",cancel:"cancel"})}}{function _confirm(e,a){alertify.confirm(e,a,CB).setHeader("Confirm").set("labels",{ok:"Yes",cancel:"No"})}}{function getSegment(e){let a=window.location.pathname.split("/");return(a=a?.filter(function(e){return e?.trim()}))[e]}}{function getRandomCode(){return(new Date).getTime()+Math.floor(5e6*Math.random())}}$(function(){const e=getSegment(2);function a(){ml(!0,"jsPageLoader","Please wait, while we are clearing draft data."),XHR=$.ajax({url:baseUrl("payrolls/off-cycle/"+e+"/clear"),method:"POST",cache:!1}).success(function(e){return _success(e.msg,function(){window.location.href=baseUrl("payrolls/off-cycle")})}).fail(handleErrorResponse).always(function(){XHR=null,ml(!1,"jsPageLoader")})}$(".jsClearDraftData").click(function(e){return e.preventDefault(),_confirm("<p><strong>Are you sure you want to clear this draft data?</strong></p><br /><p>Draft data may be present in multiple steps of this draft payroll.</p>",a)})}),$(function(){let a=null;const t=getSegment(2);getSegment(1);$(document).on("click",".jsRegularPayrollStep2Save",function(e){e.preventDefault(),$(".jsRegularPayrollEmployeeRowTimeOff").map(function(){const e=$(this).data("id");$(this).find(".jsTimeOffField").map(function(){payroll.employees[e].fixed_compensations[$(this).prop("name")].amount=parseFloat($(this).val().trim()||0)})}),ml(!0,"jsPageLoader","Please wait, while we are saving data."),null===a&&(a=$.ajax({url:baseUrl("payrolls/regular/"+t+"/save/1"),method:"POST",data:{payrollId:t,action:"Time Off",employees:payroll.employees},cache:!1}).success(function(e){return _success(e.msg,function(){ml(!0,"jsPageLoader","Please wait while we are generating a view."),window.location.href=baseUrl("payrolls/regular/"+t+"/review")})}).fail(handleErrorResponse).always(function(){a=null,ml(!1,"jsPageLoader")}))}),$(document).on("click",".jsToggleHoursPay",function(e){e.preventDefault(),$(".jsToggleHoursPay").removeClass("active"),$(this).addClass("active"),$('table[data-key="hours"]').addClass("hidden"),$('table[data-key="pay"]').addClass("hidden"),$('table[data-key="'+$(this).data("target")+'"]').removeClass("hidden")}),$(document).on("click",".jsSubmitPayroll",function(e){e.preventDefault(),null===a&&(ml(!0,"jsPageLoader","Please wait, while we are submitting the regular payroll. This might takes a few minutes."),a=$.ajax({url:baseUrl("payrolls/regular/"+t+"/submit"),method:"PUT",cache:!1}).success(function(e){return _success(e.msg,function(){window.location.href=baseUrl("payrolls/history/"+t)})}).fail(handleErrorResponse).always(function(){a=null,ml(!1,"jsPageLoader")}))}),null===a&&(ml(!0,"jsPageLoader","Please wait, while we are generating a view. This might take a few minutes."),a=$.ajax({url:baseUrl("payrolls/regular/"+t+"/view/3"),method:"GET",cache:!1}).success(function(e){$(".jsContentArea").html(e.view)}).fail(handleErrorResponse).always(function(){a=null,ml(!1,"jsPageLoader")}))});

!function(){let a,s=0;$(document).on("click",".jsModalCancel",t=>{t.preventDefault(),"yes"==$(t.target).data("ask")?alertify.confirm("Any unsaved changes will be lost.",()=>{$(t.target).closest(".csModal").fadeOut(300),$("body").css("overflow-y","auto"),$("#ui-datepicker-div").remove(),$(".jsMsModal").remove()}).set("labels",{ok:"LEAVE",cancel:"NO, I WILL STAY"}).set("title","Notice!"):($(t.target).closest(".csModal").fadeOut(300),$("body").css("overflow-y","auto"),$(".jsMsModal").remove(),$("#ui-datepicker-div").remove())}),window._ml=window.ml=function(t,e,o){e=void 0===e?".jsIPLoader":`.jsIPLoader[data-page="${e}"]`,void 0!==a&&document.getElementsByClassName("csModalBody").length&&(document.getElementsByClassName("csModalBody")[0].scrollTop=0),void 0!==a&&t&&$(".jsIPLoader").height($(`#${a}Body`).height()+s),void 0===t||!1===t?$(e).hide():$(e).show(),void 0!==o&&$(".jsIPLoaderText").html(o),t||$(".jsIPLoaderText").html("Please wait, while we are generating a preview.")},window.Model=window.Modal=function(t,e){var o=`
			<!-- Custom Modal -->

    ...
    <div class="copyright">
        <div class="container">
            <?php if($eeo_footer_text == 1) { ?>
                <div class="row">
                    <div class="col-sm-12 theme-3-law-and-email-section">
                        <p class="theme-3-law-and-email">
                        ...
                        <p class="theme-3-law-and-email">
                            <?php echo $company_details['CompanyName']; ?> is committed to being an Equal Employment Opportunity Employer and offers opportunities to all job seekers including any job seeker with a disability. If you need a reasonable accommodation to assist with your job search or application for employment, please contact us by sending an email to <a href="mailto:jobaccommodation@automotohr.com" class="theme-3-email">jobaccommodation@AutomotoHR.com</a>. In your email please include a description of the specific accommodation you are requesting and the Job Title and Company of the position for which you are applying.
                        </p>
                        <p class="theme-3-notice-supplement">
                        ...
                        <p class="theme-3-law-and-email theme-3-english-spanish">

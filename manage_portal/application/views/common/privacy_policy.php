...
and “<span class=SpellE><?php echo STORE_NAME; ?></span>, “We” or “Our”) provides the Talent
Network on behalf of the employer whose career and employment opportunities are
promoted on this Talent Network. We have drafted this Privacy Policy to provide
you notice of our data and security practices and policies as you use the
Talent Network. This Privacy Policy describes the types of Personal Information
...
incorporates by reference the Terms and Conditions for the Talent Network,
which apply to this Privacy Policy. When you visit the Talent Network or
...
practices. We will post a prominent notice on the Talent Network to notify you
...
Talent Network or that may be provided to us by the employer whose career and
employment opportunities are promoted on this Talent Network. The types of
...
or to read the content portions of the Talent Network.</p>
...
searches that you make on the Talent Network. We do this in order to present
...
<p class=MsoNormal>In addition, when you visit the Talent Network, we may
...
<p class=MsoNormal>Pages and URLs that refer visitors to the Talent Network,
also pages and URLs that visitors exit to once they leave the Talent Network.</p>

<p class=MsoNormal>Dates and times of visits to the Talent Network.</p>

<p class=MsoNormal>Information on actions taken on the Talent Network (such as
...
from which a visitor accesses the Talent Network.</p>

<p class=MsoNormal>Search terms that visitors use to reach the Talent Network.</p>
...
<p class=MsoNormal>Register, manage and maintain your account on the Talent
Network.</p>
...
to your use of the Talent Network.</p>
...
Talent Network and the jobs viewed or applied to on the Talent Network.</p>
...
<p class=MsoNormal>Enforce the Talent Network’ Terms and Conditions.</p>
...
certain technical information about your computer and your access of the Talent
Network (including your internet protocol address) in order to operate,
maintain and manage the Talent Network. We collect this information by
...
<p class=MsoNormal>When you join the Talent Network or apply for a job through
the Talent Network, we provide your Personal Information to the employer
customer who has hired <span class=SpellE><?php echo STORE_NAME; ?></span> to create and
operate this Talent Network on its behalf, (including your e-mail address and
...
<p class=MsoNormal>Additionally, when you join the Talent Network or apply for
a job through the Talent Network, the information supplied by you is stored by <span
class=SpellE><?php echo STORE_NAME; ?></span> on a dedicated database on behalf of the
...
that company, and <span class=SpellE><?php echo STORE_NAME; ?></span> is not responsible for
that company’s use of your information. <span class=SpellE><?php echo STORE_NAME; ?></span> is
...
to operate this Talent Network will receive reports that contain non-personally
identifiable information about its Talent Network. We also use non-personally
identifiable information and certain technical information about your computer
and your access of the Talent Network (including your internet protocol
address) in order to operate, maintain and manage the Talent Network.</p>
...
report from <span class=SpellE><?php echo STORE_NAME; ?></span> that states the number of account
...
Information while registering to join the Talent Network, provide it via a job
...
Talent Network or any other distribution method, that information can be
collected and used by others. This may result in unsolicited messages, for
which <span class=SpellE><?php echo STORE_NAME; ?></span> is not responsible, from third
parties.</p>
...
<p class=MsoNormal><span class=SpellE><?php echo STORE_NAME; ?></span> also may disclose
...
security, or to protect the interests or safety of <span class=SpellE><?php echo STORE_NAME; ?></span>
or other users of the Talent Network.</p>
...
bankruptcy or other corporate reorganization of <span class=SpellE><?php echo STORE_NAME; ?></span>.</p>
...
<p class=MsoNormal><span class=SpellE><?php echo STORE_NAME; ?></span> uses cookies and other
...
class=SpellE><?php echo STORE_NAME; ?></span> also uses cookies to store non-personally
identifying information about you such as past Talent Network jobs viewed and
job searches within the Talent Network conducted by your computer in a cookie
...
searches. Lastly, <span class=SpellE><?php echo STORE_NAME; ?></span> uses cookies to ensure
the proper functioning and efficiency of the Talent Network. Most internet
...
that some <span class=SpellE><?php echo STORE_NAME; ?></span> features or services may not
function properly without cookies.</p>

<p class=MsoNormal><span class=SpellE><?php echo STORE_NAME; ?></span> permits third party
cookies on its Talent Network. For example, third party tools located on the
Talent Network may use cookies to remember user preference settings. <span
class=SpellE><?php echo STORE_NAME; ?></span> also uses web analytics services provided by
third parties, which use cookies to collect non-personal information about
details of our users’ visits to the Talent Network (including IP addresses) and
the resources they access on the Talent Network. These third party web
analytics services provide us with reports based on this information in order
to help us understand how visitors engage with the Talent Network.</p>

<p class=MsoNormal>In addition, the employer that uses this Talent Network may
...
information has been uploaded to the Talent Network.</p>
...
<p class=MsoNormal>The Talent Network may contain links to other sites for your
convenience and information. These sites may be operated by companies not owned
by <span class=SpellE><?php echo STORE_NAME; ?></span>. These other sites or linked
...
not owned by <span class=SpellE><?php echo STORE_NAME; ?></span>, any use of those sites, or
...
you are located. Further, the employer for whom we operate this Talent Network
...
Principles, <span class=SpellE><?php echo STORE_NAME; ?></span> commits to resolve complaints
...
privacy policy should first contact <span class=SpellE><?php echo STORE_NAME; ?></span> with EU
...
<p class=MsoNormal><span class=SpellE><?php echo STORE_NAME; ?></span> maintains
...
user of the Talent Network, you understand and agree that you assume all
responsibility and risk for your use of the Talent Network, the internet
...
class=SpellE><?php echo STORE_NAME; ?></span> account user name and password and not share
that information with anyone. You should also sign off your account and close
your browser window when you have finished your visit to the Talent Network.
Please note that we will never ask for your <span class=SpellE><?php echo STORE_NAME; ?></span>
account user name or password via email. You agree to notify <span
class=SpellE><?php echo STORE_NAME; ?></span> immediately of any unauthorized use of your
...
California resident and a user of any of the Talent Network, you can request a
copy of this information from <span class=SpellE><?php echo STORE_NAME; ?></span> by sending
...
anyone under the age of 13. If you are under 13, please do not use the Talent
Network. In the event that we learn that we have collected personal information
...
<p class=MsoNormal>You can direct questions regarding this Privacy Policy to <?php echo STORE_NAME; ?>
by emailing us at Support@AutomotoHR.com Attention: Customer Service.

    ...
    function validate_form() {
        ...
        $("#register-form").validate({
            ...
            highlight: function(element, errorClass, validClass) {
                ...
                $(element).parent().find('.input-group-addon').addClass('cs-error');
                <?php } ?>
            },
            unhighlight: function(element, errorClass, validClass) {
                <?php if($is_regex === 1){ ?>
                $(element).removeClass(errorClass).addClass(validClass);
                $(element).parent().find('.input-group-addon').removeClass('cs-error');
                <?php } ?>
            },
                    ...
                    <form class="popup-form" method="post" name="register-form" enctype="multipart/form-data" id="register-form">
                        <ul>
                            ...
                            <li>
                                ...
                                <input class="form-fields" type="text" name="last_name" required="required" placeholder="Enter Last Name"
                                       value="<?php
                            ...
                            <li>
                                ...
                                <input class="form-fields" type="email" name="email" required="required" placeholder="Enter Email"
                                       value="<?php
                            ...
                            <li>
                                ...
                                <input class="form-fields" type="text" name="address" placeholder="Enter Address"
                                       value="<?php
                            ...
                            <li>
                                ...
                                <input class="form-fields" type="text" name="city" required="required" placeholder="Enter City"
                                       value="<?php
                                ...
                                <select class="form-fields" name="country" onchange="getStates(this.value, '<?php echo $states; ?>')" required="required" >
                                    <?php foreach ($active_countries as $active_country) { ?>
                                        <option value="<?php echo $active_country['sid']; ?>"
                                            <?php
                                            if ($active_country['sid'] == $country_id) {
                                                echo "selected";
                                    ...
                                    <div class="questionnaire-form panel-collapse collapse">
                                        ...
                                        <div class="question-block">
                                            ...
                                            <div class="question-block-inner">
                                                <div class="question-row">
                                                    <label for="q1">
                                                        <input type="radio" value="Hispanic or Latino" name="group_status" id="q1"> <span><p class="text"><strong>Hispanic or Latino </strong></span>
                                                        - A person of Cuban, Mexican, Puerto Rican, South or Central American, or other Spanish culture or origin regardless of race.</p>
                                                    </label>
                                                </div>
                                                <div class="question-row">
                                                    <label for="q2">
                                                        <input type="radio" value="White" name="group_status" id="q2"> <span><p class="text"><strong>White (Not Hispanic or Latino)</strong></span>
                                                        - A person having origins in any of the original peoples of Europe, the Middle East or North Africa.</p>
                                                    </label>
                                                </div>
                                                <div class="question-row">
                                                    <label for="q3">
                                                        <input type="radio" value="Black or African American" name="group_status" id="q3"> <span><p class="text"><strong>Black or African American (Not Hispanic or Latino) </strong></span>
                                                        -  A person having origins in any of the black racial groups of Africa.</p>
                                                    </label>
                                                </div>
                                                <div class="question-row">
                                                    <label for="q4">
                                                        <input type="radio" value="Native Hawaiian or Other Pacific Islander" name="group_status" id="q4"> <span><p class="text"><strong>Native Hawaiian or Other Pacific Islander (Not Hispanic or Latino) </strong></span>
                                                        - A person having origins in any of the peoples of Hawaii, Guam, Samoa or other Pacific Islands.</p>
                                                    </label>
                                                </div>
                                                <div class="question-row">
                                                    <label for="q5">
                                                        <input type="radio" value="Asian" name="group_status" id="q5"> <span><p class="text"><strong>Asian (Not Hispanic or Latino) </strong></span>
                                                ...
                                                <div class="question-row">
                                                    <label for="q6">
                                                        <input type="radio" value="American Indian or Alaska Native" name="group_status" id="q6"> <span><p class="text"><strong>American Indian or Alaska Native (Not Hispanic or Latino)</strong></span>
                                                ...
                                                <div class="question-row">
                                                    <label for="q7">
                                                        <input type="radio" value="Two or More Races" name="group_status" id="q7"> <span><p class="text"><strong>Two or More Races (Not Hispanic or Latino)</strong></span>
                                        ...
                                        <div class="question-block">
                                            ...
                                            <div class="question-block-inner">
                                                <div class="question-row">
                                                    <label for="q8">
                                                        <input type="radio" value="Disabled Veteran" name="veteran" id="q8"> <span><p class="text"><strong>Disabled Veteran:</strong></span>
                                                ...
                                                <div class="question-row">
                                                    <label for="q9">
                                                        <input type="radio" value="Recently Separated Veteran" name="veteran" id="q9"> <span><p class="text"><strong>Recently Separated Veteran: </strong></span>
                                                ...
                                                <div class="question-row">
                                                    <label for="q10">
                                                        <input type="radio" value="Active Duty Wartime or Campaign Badge Veteran" name="veteran" id="q10"> <span><p class="text"><strong>Active Duty Wartime or Campaign Badge Veteran: </strong></span>
                                                ...
                                                <div class="question-row">
                                                    <label for="q11">
                                                        <input type="radio" value="Armed Forces Service Medal Veteran" name="veteran" id="q11"> <span><p class="text"><strong>Armed Forces Service Medal Veteran:</strong></span>
                                                ...
                                                <div class="question-row">
                                                    <label for="q12">
                                                        <input type="radio" value="I Am Not a Protected Veteran" name="veteran" id="q12"> <span><p class="text"><strong>I Am Not a Protected Veteran </strong></span></p>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="question-block">
                                            ...
                                            <div class="question-row">
                                                <label for="disability">
                                                    <input type="radio" value="YES, I HAVE A DISABILITY" name="disability" id="disability"> <span><p class="text">YES, I HAVE A DISABILITY (or previously had a disability)</span></p>
                                                </label>
                                            </div>
                                            <div class="question-row">
                                                <label for="no-disability">
                                                    <input type="radio" value="NO, I DON'T HAVE A DISABILITY" name="disability" id="no-disability"> <span><p class="text">NO, I DON'T HAVE A DISABILITY</span></p>
                                                </label>
                                            </div>
                                            <div class="question-row">
                                                <label for="no-answer">
                                                    <input type="radio" value="I DON'T WISH TO ANSWER" name="disability" id="no-answer"> <span><p class="text">I DON'T WISH TO ANSWER </span></p>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="separator-border"></div>
                            ...
                            <li>
                                ...
                                <div class="spinner" id="cc_spinner"><i class="fa fa-refresh fa-spin"></i> Processing...</div>

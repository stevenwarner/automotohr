                    ...
                    <form class="popup-form" method="post" name="register-form" enctype="multipart/form-data" id="register-form">
                        <ul>
                            ...
                            <li>
                                ...
                                <?= $input_group_start; ?>
                                <input class="form-fields js-phone" id="PhoneNumber" type="text" name="phone_number" required="required" placeholder="Phone Number" value="<?= $primary_phone_number; ?>" />
                                <?= $input_group_end; ?>
                            ...
                            <li>
                                ...
                                <select class="form-fields" name="country" onchange="getStates(this.value, '<?php echo $states; ?>')" required="required">
                                    <?php foreach ($active_countries as $active_country) { ?>
                                        <option value="<?php echo $active_country['sid']; ?>" <?php
                            ...
                            <li>
                                ...
                                <input class="form-fields" type="email" id="referred_by_email" name="referred_by_email" placeholder="Enter Referrer Email" value="<?php if (isset($formpost['referred_by_email'])) {

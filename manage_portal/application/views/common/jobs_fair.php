            ...
            <div class="col-md-12">
                ...
                <div class="join-our-network">
                                    ...
                                    <li class="form-col-right">
                                        ...
                                        <div class="input-group cs-input-group">
                                            ...
                                            <input 
                                                ...
                                                name="phone_number" 
                                                placeholder=""
                                                value="<?=isset($formpost['phone_number']) ?  phonenumber_format($formpost['phone_number']) : ''; ?>"
                    ...
                    <?php                                   if($default_data_fields['field_id'] == 'email') {$input_type = 'email';} else {$input_type = 'text';} ?>
                                                            ...
                                                            <?php if( $default_data_fields['is_phone_field'] ) { ?>
                                                                <div class="input-group cs-input-group">
                                                                    <div class="input-group-addon">
                                                            ...
                                                            class="join-from-fields  <?=$default_data_fields['is_phone_field'] === 1  ? 'js-phone' : ''; ?>" <?php if($default_data_fields['is_required'] == 1) { ?>required <?php } ?>>
                                                            <?php if( $default_data_fields['is_phone_field'] ) { ?>
                                                                </div>
                                                            <?php } ?>
...
<script>
    ...
    $('.js-phone').keyup(function(e){
        ...
        }else { $(this).val( val ); val2 = val; }
        // check and place error
        if(val2.match(/_/g) === null) { $(this).parent().parent().find('span.txt_phonenumber').remove(); return; }
        //
        var is_valid = fpn($(this).val().trim(), '', true);
        //
        if(is_valid === false){
            $(this).parent().parent().find('span.txt_phonenumber').remove();
            $(this).parent().parent().append('<span class="txt_phonenumber" style="color: #cc0000;">Invalid phone number. e.g. (XXX) XXX-XXXX</span>');
        }
    })

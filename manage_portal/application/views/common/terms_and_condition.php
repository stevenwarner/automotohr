...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'><span
    ...
    Conditions”) governing your access to and use of the Talent Network (as defined
    below) provided by <span class=SpellE>AutomotoSocial</span>, LLC (“<span
        class=SpellE><?php echo STORE_NAME; ?></span>”) on behalf of the Employer. If you do not
    accept these Terms and Conditions or you do not meet or comply with their
    provisions, you may not use the <span class=SpellE><?php echo STORE_NAME; ?></span> Talent
    Network or Services. These Terms and Conditions are effective as of November 17,
    2015.</p>
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'><span
    ...
    These Terms and Conditions (as they may be amended from time to time by <span
        class=SpellE><?php echo STORE_NAME; ?></span>) form a binding agreement (the
    &quot;Agreement&quot;) between you and <span class=SpellE><?php echo STORE_NAME; ?></span>.
    Your access to or use of the <span class=SpellE><?php echo STORE_NAME; ?></span> Talent
    Network or Services indicates your acceptance of these Terms and Conditions.
    You are agreeing to use the Talent Network at your own risk.</p>
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>3.1 “<span
            class=SpellE><?php echo STORE_NAME; ?></span> Materials”</b> includes any materials,
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>3.2 “Content”</b>
    includes all Text, Graphics, Design and Programming used on the Talent Network.</p>

<p class=MsoNormal><o:p>&nbsp;</o:p></p>

<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>3.3 “Design”</b>
    includes the color combinations and the page layout of the Talent Network.</p>

<p class=MsoNormal><o:p>&nbsp;</o:p></p>

<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>3.4 “Document”</b>
    refers to any posting to the Talent Network, whether job or resume.</p>
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>3.5 “Employer”</b>
    ...
    promoted on this Talent Network.</p>

<p class=MsoNormal><o:p>&nbsp;</o:p></p>

<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>3.6 “Graphics”</b>
    includes all logos, buttons, and other graphical elements on the Talent
    Network, with the exception of paid advertising banners.</p>

<p class=MsoNormal><o:p>&nbsp;</o:p></p>

<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>3.7 “Job Seeker”</b>
    means a User who is accessing the Talent Network to search for a job or in any
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>3.8 “Programming”</b>
    ...
    code (e.g. active server pages, VBScript, databases, etc.) used on the Talent
    Network.</p>

<p class=MsoNormal><o:p>&nbsp;</o:p></p>

<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>3.9 “Services”</b>
    means any services provided by <span class=SpellE><?php echo STORE_NAME; ?></span> or its
    agents.</p>

<p class=MsoNormal><o:p>&nbsp;</o:p></p>

<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>3.10 “Talent Network”</b>
    means a recruiting platform operated by <span class=SpellE><?php echo STORE_NAME; ?></span> on
    behalf of the Employer and includes the Content, Text, Graphics, Design,
    Programming, <span class=SpellE><?php echo STORE_NAME; ?></span> Materials and Services (as
    applicable in each context).</p>

<p class=MsoNormal><o:p>&nbsp;</o:p></p>

<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>3.11 “Text”</b>
    includes all text on every page of the Talent Network, whether editorial,
    navigational, or instructional.</p>

<p class=MsoNormal><o:p>&nbsp;</o:p></p>

<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>3.12 “User”</b>
    refers to any individual or entity that uses any aspect of the Talent Network.</p>
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'><span
            ...
            Acceptable Use of the Talent Network and Services.<o:p></o:p></span></b></p>

<p class=MsoNormal><o:p>&nbsp;</o:p></p>

<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>4.1 General Use
        Rules.</b> The Talent Network is intended for individuals seeking employment
    and for employers or recruiters seeking candidates for employment. You may use
    the Talent Network only for lawful purposes within the stated context of <span
        class=SpellE><?php echo STORE_NAME; ?></span> intended and acceptable use of the Talent
    Network. <span class=SpellE><?php echo STORE_NAME; ?></span> is the sole interpreter of the
    Talent Network’s intended and acceptable use.</p>

<p class=MsoNormal><o:p>&nbsp;</o:p></p>

<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>4.2 <span
            class=SpellE><?php echo STORE_NAME; ?></span> Intellectual Property Rights.</b> The Talent
    Network, the <span class=SpellE><?php echo STORE_NAME; ?></span> Materials and all right,
    title and interest in and to the Talent Network and <span class=SpellE><?php echo STORE_NAME; ?></span>
    Materials are the sole property of <span class=SpellE><?php echo STORE_NAME; ?></span> or its
    ...
    these Terms and Conditions, <span class=SpellE><?php echo STORE_NAME; ?></span> reserves for
    ...
    distribute the Content or <span class=SpellE><?php echo STORE_NAME; ?></span> Materials, or
    ...
    copying or adapting the HTML code used to generate web pages on the Talent
    Network; (b) using or attempting to use engines, manual or automated software,
    ...
    any web pages or any Services provided on the Talent Network other than the
    search engine and search agents available from <span class=SpellE><?php echo STORE_NAME; ?></span>
    on such Talent Network and other than generally available third party web
    ...
    available from any of the Talent Network, without the express written consent
    of <span class=SpellE><?php echo STORE_NAME; ?></span>. The use of the Content on any other
    web site or in a networked computer environment for any purpose is strictly
    prohibited. &quot;<span class=SpellE><?php echo STORE_NAME; ?></span> “Personified”, the <span
        class=SpellE><?php echo STORE_NAME; ?></span> design logo and certain other names or logos are
    service marks or trademarks of <span class=SpellE><?php echo STORE_NAME; ?></span>, and all
    related product and service names, design marks and slogans are the service marks
    or trademarks of <span class=SpellE><?php echo STORE_NAME; ?></span>. In addition, the
    &quot;look&quot; and &quot;feel&quot; of the Talent Network (including color
    combinations, button shapes, layout, design and all other graphical elements)
    are also protected by <span class=SpellE><?php echo STORE_NAME; ?></span> trademarks, service
    marks and copyrights. Any code that <span class=SpellE><?php echo STORE_NAME; ?></span>
    creates to generate or display the Content or the pages making up the Talent
    Network is also protected by <span class=SpellE><?php echo STORE_NAME; ?></span> copyright.
    You must retain all copyright, trademark, service mark and other proprietary
    notices contained on the Content or <span class=SpellE><?php echo STORE_NAME; ?></span>
    Materials on any authorized copy you make of the Content or <span class=SpellE><?php echo STORE_NAME; ?></span>
    Materials. All other product and service marks contained on the Talent Network
    are the trademarks of their respective owners.</p>

<p class=MsoNormal><o:p>&nbsp;</o:p></p>

<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>4.3 License for Use
        by Job Seekers.</b> <span class=SpellE><?php echo STORE_NAME; ?></span> hereby grants you a
    limited, terminable, non-exclusive right to access and use the Talent Network
    only for your personal use seeking employment opportunities for yourself. This
    authorizes you to view and download a single copy of the material on the Talent
    Network solely for your personal, noncommercial use. You agree that you are
    solely responsible for the content of any Document you post to the Talent
    Network and any consequences arising from such posting. Your use of the Talent
    Network is a privilege. <span class=SpellE><?php echo STORE_NAME; ?></span> reserves the right
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>4.4 Other Specific
    ...
    majority as that is defined in your jurisdiction, you will only use the Talent
    Network and Services under the supervision of a parent, legal guardian, or
    other responsible adult; and (b) will not use (or plan, encourage or help
    others to use) the Talent Network for any purpose or in any manner that is
    prohibited by these Terms and Conditions or by applicable law. It is your
    responsibility to ensure that your use of the Talent Network complies with
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>4.5 User Submissions.</b>
    <span class=SpellE><?php echo STORE_NAME; ?></span> welcomes your comments regarding the
    Services and the Talent Network and appreciates hearing from you. Please note,
    however, that <span class=SpellE><?php echo STORE_NAME; ?></span> does not accept or consider
    ...
    suggestions, or materials. If, despite this notice, you send <span
        class=SpellE><?php echo STORE_NAME; ?></span> creative suggestions, ideas, drawings, concepts,
    ...
    understand and agree that the User Submission shall become the property of <span
        class=SpellE><?php echo STORE_NAME; ?></span>. User Submissions and any elements contained in
    User Submissions, shall not be subject to any obligation of confidentiality on <span
        class=SpellE><?php echo STORE_NAME; ?></span> part, and <span class=SpellE><?php echo STORE_NAME; ?></span> will
    not be liable for any use or disclosure of any User Submission. <span
        class=SpellE><?php echo STORE_NAME; ?></span> shall exclusively own all now known or later
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'><span
            style='font-size:14.0pt;line-height:115%'>5. Disclaimers and Limitations on <span
                class=SpellE><?php echo STORE_NAME; ?></span> Liability.<o:p></o:p></span></b></p>

<p class=MsoNormal><o:p>&nbsp;</o:p></p>

<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>5.1 Allocation of
        Responsibility</b> <span class=SpellE><?php echo STORE_NAME; ?></span> assumes no
    responsibility for Documents posted by Users and no responsibility for the
    activities, omissions or other conduct of Users. <span class=SpellE><?php echo STORE_NAME; ?></span>
    ...
    these Terms and Conditions, <span class=SpellE><?php echo STORE_NAME; ?></span> may
    ...
    discretion whether to remove or request the removal of such Document. <span
        class=SpellE><?php echo STORE_NAME; ?></span> has no liability or responsibility to Users for
    performance or nonperformance of such activities. <span class=SpellE><?php echo STORE_NAME; ?></span>
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>5.2 No endorsements</b>
    by <span class=SpellE><?php echo STORE_NAME; ?></span>. Nothing on the Talent Network shall be
...
<p class=MsoNormal>(a) THE TALENT NETWORK IS PROVIDED ON AN 'AS IS' BASIS
    WITHOUT ANY WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED. <?php echo STORE_NAME; ?>, TO THE
    ...
    PARTIES’ RIGHTS, AND FITNESS FOR PARTICULAR PURPOSE. <?php echo STORE_NAME; ?> MAKES NO
...
<p class=MsoNormal>(<span class=SpellE>i</span>) <?php echo STORE_NAME; ?> DOES NOT WARRANT
    THAT THE TALENT NETWORK WILL OPERATE ERROR-FREE OR THAT THE TALENT NETWORK AND
    ITS SERVERS ARE FREE OF COMPUTER VIRUSES OR OTHER HARMFUL MECHANISMS. IF YOUR
    USE OF THE TALENT NETWORK RESULTS DIRECTLY OR INDIRECTLY IN THE NEED FOR SERVICING
    OR REPLACING EQUIPMENT OR DATA, <?php echo STORE_NAME; ?> IS NOT RESPONSIBLE FOR THOSE COSTS.</p>

<p class=MsoNormal><o:p>&nbsp;</o:p></p>

<p class=MsoNormal>(ii) <?php echo STORE_NAME; ?> MAKES NO REPRESENTATIONS OR GUARANTEES
...
<p class=MsoNormal>(iii) <?php echo STORE_NAME; ?> MAKES NO REPRESENTATIONS OR GUARANTEES
    REGARDING THE CONTENT OF THE TALENT NETWORK, INCLUDING, BUT NOT LIMITED TO,
    BROKEN LINKS, INACCURACIES OR TYPOGRAPHICAL ERRORS.</p>

<p class=MsoNormal><o:p>&nbsp;</o:p></p>

<p class=MsoNormal>(<span class=GramE>iv</span>) <?php echo STORE_NAME; ?> MAKES NO
    REPRESENTATIONS OR GUARANTEES REGARDING THE EFFECTIVENESS OF THE SERVICES OR
    TIMELINESS OF THE SERVICES IN MEETING YOUR EMPLOYMENT OBJECTIVES. <?php echo STORE_NAME; ?>
    DOES NOT GUARANTEE THAT THE SERVICES WILL RESULT IN CANDIDATES BEING HIRED,
...
<p class=MsoNormal>(a) YOU ASSUME ALL RESPONSIBILITY AND RISK FOR YOUR USE OF
    THE TALENT NETWORK, THE INTERNET GENERALLY, AND THE DOCUMENTS YOU POST OR
    ACCESS AND FOR YOUR CONDUCT ON AND OFF THE TALENT NETWORK.</p>

<p class=MsoNormal><o:p>&nbsp;</o:p></p>

<p class=MsoNormal>(b) IN NO EVENT SHALL <?php echo STORE_NAME; ?> (OR ANY OF ITS OFFICERS,
    ...
    OR THE INABILITY TO USE OR ACCESS, THE TALENT NETWORK AND/OR ANY DOCUMENT,
    WHETHER BASED ON WARRANTY, CONTRACT, TORT, OR ANY OTHER LEGAL THEORY, AND
    WHETHER OR NOT <?php echo STORE_NAME; ?> IS ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. THIS
...
<p class=MsoNormal>(c) BECAUSE SOME STATES OR JURISDICTIONS DO NOT ALLOW THE
    ...
    ANY ARE HELD INAPPLICABLE OR UNENFORCEABLE FOR ANY REASON, THEN <?php echo STORE_NAME; ?>
    MAXIMUM LIABILITY TO YOU FOR ANY NON-DIRECT TYPE OF DAMAGES SHALL BE LIMITED TO
    U.S. $200.00 IN THE AGGREGATE.</p>

<p class=MsoNormal><o:p>&nbsp;</o:p></p>

<p class=MsoNormal>(d) IN NO EVENT SHALL <?php echo STORE_NAME; ?> (OR ANY OF ITS OFFICERS,
...
<p class=MsoNormal>(e) DUE TO THE NATURE OF THIS AGREEMENT, IN ADDITION TO
    MONEY DAMAGES, YOU AGREE THAT <?php echo STORE_NAME; ?> WILL BE ENTITLED TO EQUITABLE RELIEF
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>5.5 User
        ...
        class=SpellE><?php echo STORE_NAME; ?></span> cannot and does not confirm that each User is
    who they claim to be. Because <span class=SpellE><?php echo STORE_NAME; ?></span> does not and
    cannot be involved in User-to-User dealings or control the behavior of
    participants on the Talent Network, in the event that you have a dispute with
    one or more Users, you release <span class=SpellE><?php echo STORE_NAME; ?></span> from
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>6. Links to Other
        Sites.</b> The Talent Network may contain links to third party web sites. These
    links are provided solely as a convenience to you and not as an endorsement by <span
        class=SpellE><?php echo STORE_NAME; ?></span> of the contents on such third-party web sites. <span
        class=SpellE><?php echo STORE_NAME; ?></span> is not responsible for the content of linked
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>7. Amendments to this
        Agreement and Changes to the Talent Network. </b><span class=SpellE><?php echo STORE_NAME; ?></span>
    may revise these Terms and Conditions at any time by updating this page.
    Changes will be binding on you on the date they are posted on the Talent
    Network (or as otherwise stated in any notice of such changes). Any use of the
    Talent Network will be considered acceptance by you of the then-current Terms
    and Conditions (including any exhibits thereto) contained on such Talent
    Network. If at any time you find the Terms and Conditions unacceptable, you
    must not use the applicable Talent Network any longer. Any new or different
    terms supplied by you are specifically rejected by <span class=SpellE><?php echo STORE_NAME; ?></span>
    unless <span class=SpellE><?php echo STORE_NAME; ?></span> agrees to them in a signed writing
    specifically including those new or different terms. <span class=SpellE><?php echo STORE_NAME; ?></span>
    may change the Talent Network at any time.</p>

<p class=MsoNormal><o:p>&nbsp;</o:p></p>

<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>8. Indemnity.</b> You
    agree to defend, indemnify, and hold harmless <span class=SpellE><?php echo STORE_NAME; ?></span>
    ...
    connection with your use of the Talent Network, any Document posted by you,
    your use of the Services or your breach of this Agreement. <span class=SpellE><?php echo STORE_NAME; ?></span>
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>9.1 When you register
        on the Talent Network</b> or in connection with the Services, you will be asked
    to create an account and provide <span class=SpellE><?php echo STORE_NAME; ?></span> with
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>9.2 All User
        Information</b> will be used in accordance with the terms of the Talent Network
    Privacy Policy. Please note, as set forth in the Privacy Policy, that <span
        class=SpellE><?php echo STORE_NAME; ?></span> may collect certain User Information (including
    ...
    communications from <span class=SpellE><?php echo STORE_NAME; ?></span>. In addition, as set
    forth in the Talent Network Privacy Policy, <span class=SpellE><?php echo STORE_NAME; ?></span>
    also will share your contact information (including your email address) with
    the employer on whose behalf <span class=SpellE><?php echo STORE_NAME; ?></span> operates this
    Talent Network. That employer may use your information to contact you directly,
    including by email, at the contact information you have provided. In addition, <span
        class=SpellE><?php echo STORE_NAME; ?></span> reserves the right to comply, in its sole
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'><span
    ...
    Questions concerning the use of the Talent Network should be directed to
    Feedback. Notices to <span class=SpellE><?php echo STORE_NAME; ?></span> should be sent to the
    address listed on the Talent Network. We will send notice to you at the address
    submitted by you or to such other address as <span class=SpellE><?php echo STORE_NAME; ?></span>
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'><span
        ...
        class=SpellE><?php echo STORE_NAME; ?></span> contact information is listed on the Talent
    Network. <span class=SpellE><?php echo STORE_NAME; ?></span> makes no claims that the Content
    ...
    persons have no right to access or use the Talent Network. If you access the
    Talent Network from outside of the United States, you do so at your own risk
    ...
    of California. The sole relationship between you and <span class=SpellE><?php echo STORE_NAME; ?></span>
    ...
    access or use to the Talent Network, and you shall cease all your use and
    ...
    expressly provided by <span class=SpellE><?php echo STORE_NAME; ?></span> in a particular
    &quot;Legal Notice,&quot; or material on particular web pages of the Talent
    Network, this Agreement and your Service Activation Agreement where applicable,
    constitute the entire agreement between you and <span class=SpellE><?php echo STORE_NAME; ?></span>.</p>
...
<p class=MsoNormal>The following rules apply to your use of the Talent Network
...
<p class=MsoNormal>(a) You may not post any Document to the Talent Network that
...
<p class=MsoNormal>(e) <span class=SpellE><?php echo STORE_NAME; ?></span> is under no
    obligation to monitor the Documents posted on the Talent Network, but it may
    monitor Documents at random. Documents found to violate the above Posting Rules
    may be removed at <span class=SpellE><?php echo STORE_NAME; ?></span> sole discretion.</p>
...
<p class=MsoNormal>(c) Protect your password. You are responsible for
    ...
    you. If others use your password to post inappropriate material on the Talent
    Network, you risk losing your access to the Talent Network. You agree to notify
    <span class=SpellE><?php echo STORE_NAME; ?></span> immediately of any unauthorized use of
...
<p class=MsoNormal>(f) If at any time <span class=SpellE><?php echo STORE_NAME; ?></span>
    comes to the understanding that you: (<span class=SpellE>i</span>) misled <span
        class=SpellE><?php echo STORE_NAME; ?></span> regarding your business practices and/or
    services, or (ii) purchased services that do not represent your precise
    business, <span class=SpellE><?php echo STORE_NAME; ?></span> reserves the right to terminate
    your Agreement.</p>
...
<p class=MsoNormal>(a) Users are prohibited from violating or attempting to violate
    the security of the Talent Network, including, without limitation: (<span
    ...
    including, without limitation, via means of submitting a virus to the Talent Network,
...
<p class=MsoNormal>(b) Violation of these Security Rules may result in civil or
    criminal liability. <span class=SpellE><?php echo STORE_NAME; ?></span> will investigate
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>13.1 <span
            class=SpellE><?php echo STORE_NAME; ?></span> respects the intellectual property of others.</b>
    It is <?php echo STORE_NAME; ?>'s policy to respond to claims of copyright and other intellectual
    property infringement. <span class=SpellE><?php echo STORE_NAME; ?></span> will promptly
    ...
    of notices complying with the DMCA, <span class=SpellE><?php echo STORE_NAME; ?></span> may
    ...
    or activity that is claimed to be infringing. <span class=SpellE><?php echo STORE_NAME; ?></span>
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>13.2 Notifying <span
            class=SpellE><?php echo STORE_NAME; ?></span> of Copyright Infringement:</b> To provide <span
        class=SpellE><?php echo STORE_NAME; ?></span> notice of an infringement, you must provide a
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'>13.3 Providing <span
            class=SpellE><?php echo STORE_NAME; ?></span> with Counter-Notification:</b> If we remove or
    ...
    you may provide <span class=SpellE><?php echo STORE_NAME; ?></span> with a counter

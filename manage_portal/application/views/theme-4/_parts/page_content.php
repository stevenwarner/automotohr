                ...
                <div class="hr-text-editor">
                    ...
                    <?php if ($pageData['video_location'] == 'top') { ?>
                        <?php if ($pageData['page_youtube_video_status'] == 1) { ?>
                            <?php if (!empty($pageData['page_youtube_video']) && $pageData['video_type'] == 'youtube') { ?>
                            ...
                            <?php if (!empty($pageData['page_youtube_video']) && $pageData['video_type'] == 'vimeo') { ?>
                                <div class="comapny-video <?php if ($header_video_overlay == 0) {
                                                                echo 'no_overlay';
                                                            } ?>">
                                    <div class="embed-responsive embed-responsive-16by9">
                                        <iframe id="vimeo_player" src="https://player.vimeo.com/video/<?php echo $pageData['page_youtube_video']; ?>?title=0&byline=0&portrait=0&autoplay=0&loop=0&muted=0&controls=1" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                                    </div>
                                </div>
                            <?php } ?>

                            <?php if (!empty($pageData['page_youtube_video']) && $pageData['video_type'] == 'upload') { ?>
                                <div class="comapny-video <?php if ($header_video_overlay == 0) {
                                                                echo 'no_overlay';
                                                            } ?>">
                                    <div class="embed-responsive embed-responsive-16by9">
                                        <video controls width="100%">
                                            <source src="<?php echo UPLOADED_VIDEO_PATH . $pageData['page_youtube_video']; ?>" type='video/mp4'>
                                        </video>
                                    </div>
                                </div>
                            <?php } ?>

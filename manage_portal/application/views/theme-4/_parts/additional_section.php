<div class="about-section">
    ...
    if ($section['column_type'] == 'left_right' || $section['column_type'] == 'top_down') { ?>
        <div class="<?php echo $class; ?>">
            <div class="about-work">
                ...
                ?>
                <div class="<?php echo $section['column_type'] == 'top_down' ? 'text-center' : '' ?>">
        ...
        <div class="<?php echo $class; ?> babau ji">
            <?php if ($section['show_video_or_image'] == 'image') { ?>
                <div class="about-work">
                    <img class="img-responsive" src="<?php echo AWS_S3_BUCKET_URL;
                                                        echo (isset($section['image']) && $section['image'] != '' ? $section['image'] : '') ?>" alt="Tab Image">
                </div>
            ...
            <?php } else if ($section['show_video_or_image'] == 'vimeo_video') { ?>
                <div class="about-work Hassan">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe id="vimeo_player" src="https://player.vimeo.com/video/<?php echo $section['vimeo_video']; ?>?title=0&byline=0&portrait=0&autoplay=0&loop=0&muted=0&controls=1" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                    </div>
                </div>
            <?php } else if ($section['show_video_or_image'] == 'uploaded_video') { ?>
                <div class="about-work Hassan">
                    <video controls width="100%">
                        <source src="<?php echo UPLOADED_VIDEO_PATH . $section['uploaded_video']; ?>" type='video/mp4'>
                    </video>
                </div>
            <?php } ?>
    ...
    <?php } elseif ($section['column_type'] == 'right_left' || $section['column_type'] == 'top_down') { ?>
        <?php if ($section['show_video_or_image'] != '') { ?> <div class="<?= $class ?>"> <?php } ?>
            <?php if ($section['show_video_or_image'] == 'image') { ?>
                <div class="about-work">
                    <img class="img-responsive" src="<?php echo AWS_S3_BUCKET_URL;
                                                        echo (isset($section['image']) && $section['image'] != '' ? $section['image'] : '') ?>" alt="No Image Selected">
                </div>
            <?php } else if ($section['show_video_or_image'] == 'video') {
                $url_prams = array();
                parse_str(parse_url($section['video'], PHP_URL_QUERY), $url_prams);
            ...
            <?php if ($section['show_video_or_image'] != '') { ?>
            </div> <?php } ?>
        <div class="<?= $class ?>">
            <div class="about-work">
                <?php

$(function() {
    ...
    function loadTimeLineGraph(ob) {
        var myDoughnutChart2 = new Chart(document.getElementById('jsTimeoffLineGraph'), {
            type: 'bar',
            data: {
                datasets: [{
    ...
    function loadHourGraph(p, c, pt, ct) {
        var myDoughnutChart = new Chart(document.getElementById('jsTimeoffPieGraph'), {
            type: 'doughnut',
            data: {
                datasets: [{
                    label: '# of hours',
                ...
                tooltips: {
                    callbacks: {
                        label: function(tooltipItem, data) {
                            ...
                            return `Consumed Time: ${ct}`;
                            //
                            return `${data.datasets[0].data[tooltipItem.index]} hours ${tooltipItem.index == 0 ? 'remaining' : 'consumed'}`;
                        }
                    }
                },
                responsive: true,

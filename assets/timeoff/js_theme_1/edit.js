...
*/
    ...
    $(document).on('click', '.jsEditTimeOff', function (e) {
        ...
        Modal({
            ...
            Body: '',
            Buttons: [
                '<button class="btn btn-success jsCreateTimeOffBalanceEdit" style="margin-right: 10px;" title="See employee balance" placement="left"><i class="fa fa-balance-scale" aria-hidden="true"></i>&nbsp;View Balance History</button>',

$(function () {
                ...
                getPageUI("Add", "add", function () {
                    ...
                    $("#jsAddForm").validate({
                        ...
                        submitHandler: function (form) {
                            ...
                            //
                            return processCommonPageSection(
                                formDataObj,
                                $(".jsAddBtn"),
                                "section0"
                            );
                ...
                getPageUI("Add", "add_card", function () {
                    ...
                    $("#jsAddCardForm").validate({
                        ...
                        submitHandler: function (form) {
                            ...
                            //
                            return processCommonCardSection(
                                formDataObj,
                                $(".jsAddCardBtn"),
                                "sectionTag" + index
                            );
    ...
    $(".jsDeleteTagCard").click(function (event) {
        ...
        //
        return _confirm("Do you really wan to delete this card?", function () {
                    ...
                    function () {
                        ...
                        $("#jsEditCardForm").validate({
                            ...
                            submitHandler: function (form) {
                                ...
                                // attach the section id
                                formDataObj.append("pageId", getSegment(4));
    ...
    function deleteTag(index) {
        //
        $.ajax({
            url: baseUrl("cms/" + getSegment(4) + "/tag/" + index),
            method: "delete",
        })
            .fail(handleErrorResponse)
            .done(function (resp) {
    ...
    function deleteTagCard(index, tagIndex) {
        ...
        $.ajax({
            url: baseUrl(
                "cms/" + getSegment(4) + "/tag/" + index + "/" + tagIndex
            ),
            method: "delete",
        })
            .fail(handleErrorResponse)
    ...
    /**
         ...
         * @returns
         */
    function processCommonPageSection(formDataObj, buttonRef, redirectTo) {
        //
        if (XHR !== null) {
            return false;
        }

...
$(function manageShifts() {
    ...
    $(".js-reset-my-filter-btn").click(function (event) {
        ...
        newSearchurl =
            "settings/myshifts/manage?mode=month";
        //
    ...
    $(".js-apply-my-filter-btn").click(function (event) {
        ...
        if (start_Filter_Date == '') {
            alertify.alert('Please Enter From Date');
            return;
        }

        if (end_Filter_Date == '') {
            alertify.alert('Please Enter To Date');
            return;
        }

        newSearchurl =
            "settings/myshifts/manage?mode=week" +
            "&start_date=" +
            start_Filter_Date +
            "&end_date=" +
            end_Filter_Date;

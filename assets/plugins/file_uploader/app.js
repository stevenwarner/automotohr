...
(function($) {
        ...
        let instances = {};
        //
        let ADF = 0; //Already Defined Flag
        //
        $.fn.mFileUploader = function(opt) {
                ...
                options['allowedTypes'] = opt !== undefined && opt.allowedTypes || ['jpg', 'jpeg', 'png', 'gif', 'pdf', 'doc', 'docx', 'rtf', 'ppt', 'xls', 'xlsx', 'csv', 'zip']
        ...
        $(document).on('click',  `#${options['jsMFUPreviewFile']}`, function(e){
            ...
            // Generate and load modal on dom

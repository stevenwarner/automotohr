...
function mVideoRecorder(opt) {
     ...
     */
    this.pauseRecordingButton = document.getElementById(`${opt.pauseRecordedVideoBTN}`);
    /**
     * Saves reference to resume button
     */
    this.resumeRecordingButton = document.getElementById(`${opt.resumeRecordedVideoBTN}`);
    /**
     * Saves reference to remove button
     */
    this.removeButton = document.getElementById(`${opt.removeRecordedVideoBTN}`);
    ...
    this.pauseRecording = () => {
        this.pauseRecordingButton.classList.add('dn');
        this.resumeRecordingButton.classList.remove('dn');
    ...
    this.successCallback = (stream) => {
        ...
        //
        this.recordButton.classList.remove('dn');
    };
    ...
    this.getVideo = () => {
        return new Promise((res) => {
            ...
            reader.onload = function(event) { res(event.target.result); };
            reader.readAsDataURL(new Blob(this.recordedBlobs, { type: 'video/webm' }));
        });
    };
    ...
    this.init = () => {
        //
        const isSecureOrigin = location.protocol === 'https:' || location.host === 'localhost';
        if (!isSecureOrigin) {

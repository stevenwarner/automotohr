...
function GetAllEmployee(e, o) { null != isXHRInProgress && isXHRInProgress.abort(), isXHRInProgress = $.get(window.location.origin + "/get_all_company_employees").done((function(a) { if (isXHRInProgress = null, !1 === a.Status) return $('.jsIPLoader[data-page="' + o + 'Loader"]').hide(0), void $("#" + o + "Body").html(a.Msg);
        $('.jsIPLoader[data-page="' + o + 'Loader"]').hide(0); var t = "";

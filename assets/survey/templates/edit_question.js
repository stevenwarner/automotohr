$(function editQuestion() {
    ...
    $(document).on("change", "#jsEditQuestionType", function () {
        ...
        if (
            ...
            $(".jsEditQuestionRating").removeClass("hidden");
        }
    });
    ...
    async function setQuestionObject() {
        ...
        if (
            ...
            //
            questionObj.choice_list = {
                rating: $("#jsEditQuestionRatingScale option:checked").val(),
                min: $("#jsEditQuestionRatingMinText").val() || "Very poor",
                max: $("#jsEditQuestionRatingMaxText").val() || "Very good",
            };
        }

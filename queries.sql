...
-- email template 393
INSERT INTO `email_templates` (`sid`, `name`, `group`, `from_name`, `from_email`, `cc`, `subject`, `file`, `text`, `user_defined`, `template_code`, `status`) VALUES
(393, 'Time-off update notification for approvers', 'alerts', '{{company_name}}', 'no-reply@automotohr.com', '', '{{requester_first_name}} {{requester_last_name}} has updated a time-off for {{requested_date}}.', NULL, '<p>Dear <strong>{{approver_first_name}} {{approver_last_name}}</strong>,</p>\r\n\r\n<p>{{first_name}} {{last_name}} has updated a time-off request with the following details.</p>\r\n\r\n<p><strong>Policy:</strong> {{policy_name}}</p>\r\n\r\n<p><strong>Time-off Date:</strong> {{requested_date}}</p>\r\n\r\n<p><strong>Reason:</strong> {{reason}}</p>\r\n\r\n<p>{{approve_link}}</p>\r\n\r\n<p>{{reject_link}}</p>', 1, 'time-off-update-notification-for-approvers', 1);

INSERT INTO `email_templates` (`sid`, `name`, `group`, `from_name`, `from_email`, `cc`, `subject`, `file`, `text`, `user_defined`, `template_code`, `status`) VALUES
(404, 'Time-off approve/reject notification for approvers', 'alerts', '{{company_name}}', 'no-reply@automotohr.com', '', '{{approver_or_rejecter_first_name}} {{approver_or_rejecter_last_name}} has {{request_type}} a time-off for {{requested_date}}.', NULL, '<p>Dear <strong>{{approver_first_name}} {{approver_last_name}}</strong>,</p>\r\n\r\n<p>{{approver_or_rejecter_first_name}} {{approver_or_rejecter_last_name}} has {{request_type}} a time-off request with the following details.</p>\r\n\r\n<p><strong>Policy:</strong> {{policy_name}}</p>\r\n\r\n<p><strong>Time-off Date:</strong> {{requested_date}}</p>\r\n\r\n<p><strong>Reason:</strong> {{reason}}</p>\r\n\r\n<p>{{approve_link}}</p>\r\n\r\n<p>{{reject_link}}</p>', 1, 'time-off-update-notification-for-approvers', 1);

INSERT INTO `email_templates` (`sid`, `name`, `group`, `from_name`, `from_email`, `cc`, `subject`, `file`, `text`, `user_defined`, `template_code`, `status`) VALUES
(405, 'time-off request approved/rejected', 'alerts', '{{company_name}}', 'no-reply@automotohr.com', '', 'A time-off request {{request_type}}', NULL, '<p>Dear {{user_first_name}} {{user_last_name}},</p>\r\n\r\n<p>Your time-off request has been {{request_type}} by the approver {{approver_or_rejecter_first_name}} {{approver_or_rejecter_last_name}}.', 1, 'performance-management-review-created', 1);
